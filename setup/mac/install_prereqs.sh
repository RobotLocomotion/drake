...
while [ "${1:-}" != "" ]; do
  case "$1" in
    ...
    --with-maintainer-only)
      echo 'Warning: Maintainer-only tools are only supported on Ubuntu.  The "--with-maintainer-only" flag will do nothing.  This flag will be removed from Drake on or after 2023-06-01.'
      ;;
