...
class InstallPrereqsActor:
    ...
    def _set_up_source(self):
        ...
        install_prereqs script into there. We'll return the new path to
        install_prereqs inside self._source.
        """
    ...
    def expect_call(self, *, exact=None, stdout="", returncode=0):
        """Inbetween `start()` and `finish()`, wait for install_prereqs to call
        ...
        command line is specifed as an `exact` list of arguments (where the
