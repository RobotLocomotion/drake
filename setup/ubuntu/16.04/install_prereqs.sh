...
# https://launchpad.net/~dreal/+archive/ubuntu/dreal/+sourcepub/8561897/+listing-archive-extra
...
# Install dReal. See https://github.com/dreal/dreal4#how-to-build-dreal for
# build instructions.
