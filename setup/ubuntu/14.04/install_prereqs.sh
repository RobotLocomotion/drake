...
add-apt-repository "deb http://apt.llvm.org/${lsb_release_codename}/ llvm-toolchain-${lsb_release_codename}-3.9 main"
...
curl --location --remote-name "https://github.com/bazelbuild/bazel/releases/download/${bazel_version}/${bazel_deb_filename}"
echo "b14c8773dab078d3422fe4082f3ab4d9e14f02313c3b3eb4b5b40c44ce29ed59 ${bazel_deb_filename}" > "${bazel_deb_filename}.sha256"
sha256sum --check "${bazel_deb_filename}.sha256" && dpkg --install "${bazel_deb_filename}"
