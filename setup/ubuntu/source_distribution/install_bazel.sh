...
if [[ $(arch) = "aarch64" ]]; then
  ...
  dpkg_install_from_wget \
    bazel 7.1.0 \
    https://github.com/bazelbuild/bazel/releases/download/7.1.0/bazel_7.1.0-linux-x86_64.deb \
    d722ece7412e4112f7e23cdb6f5e56ff2ac8101fe244a3cfd601dcaa5686ad8c
fi
