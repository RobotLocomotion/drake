...
class MathematicalProgram {
 public:
   ...
   * @param is_convex If is_convex=nullopt, then Drake will determine if `e` is
   * a convex quadratic cost or not. To improve the computation speed, the user
   ...
   * @param is_convex If is_convex=nullopt, then Drake will determine if `e` is
   * a convex cost or not. To improve the computation speed, the user
   * can set is_convex if the user knows whether the cost `e` is convex or not.
