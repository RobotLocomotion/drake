...
#pragma GCC diagnostic pop
   ...
   * doesn't contain @p cost, then return 0. If this program contains multiple
   * @p cost objects, then return the repeatition of @p cost in this program.
   */
 ...
 private:
  ...
  // program in @p existings. If @p removal does not belong to @p existings,
  // then do nothing. If @p removal appears multiple times in @p existings, then
  ...
  // @return The number of @p removal object in @p existins.
  template <typename C>
