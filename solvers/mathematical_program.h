...
class MathematicalProgram {
 public:
   ...
   * Q_ee has smaller size than Q, these PSD constraint are easier to solve
   ...
   * @param degree The total degree of the polynomil p. This should be an
   * even number.
