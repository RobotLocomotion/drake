...
class MathematicalProgram {
 public:
   ...
   * indeterminates which are declared in this MathematicalProgram.  A common
   * mistake is to use `Polynomial(e)` which treats all symbolic variable in `e`
   * as indeterminates, which is probably *not* what the user want. Here is an
   * example:
   *
   *   e = ax + bx + c
   *
   ...
   *   variables `{a, b, x}` are indeterminates.
   *
