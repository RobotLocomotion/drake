...
class MathematicalProgram {
 public:
   ...
   * @return (s, linear_cost, lorentz_cone_constraint). @param s is the slack
   * variable, @param linear_cost is the cost on @param s, and
   * @lorentz_cone_constraint is the constraint s≥|Ax+b|₂
   */
