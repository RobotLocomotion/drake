...
This class is intended a short-lived helper (i.e., a local variable on the call
stack). It aliases an immutable list of overall SolverOptions, and provides
...
are static or dynamic: CopyToCallbacks or CopyToSerializableStruct.
