...
///  - rel_eps_f <double>: Relative precision on the objective.
///  - abs_eps_f <double>: Absolute precision on the objective.
///  - eps_h <double>: Equality relaxation value.
///  - rigor <int>: Activate rigor mode (certify feasibility of equations).
///  - random_seed <double>: Random seed (useful for reproducibility).
///  - eps_x <double>: Precision on the variable.
...
///  - timeout <double>: Timeout (time in seconds). 0.0 indicates +oo.
