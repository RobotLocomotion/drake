...
/** Create linear constraints, when these constraints are satisfied, match = 1
 * if and only if code = expected, otherwise match = 0
 ...
 * function CreateCodeMatchConstraint({b1, b2, b3}, {0, 1, 1}, match) to create
 * the constraint.
 */
