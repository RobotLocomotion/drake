...
// @param[in/out] second_order_cone_length The lengths of each second order cone
// s in K in the Cartesian product K.
...
// (not in the MathematicalProgram object).
