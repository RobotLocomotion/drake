...
void ThrowForInvalidOption(MSKrescodee rescode, const std::string& option,
  ...
  if (rescode != MSK_RES_OK) {
    ...
    throw std::runtime_error(fmt::format(
        ...
        "code {}, check "
        "https://docs.mosek.com/{}/capi/response-codes.html for the "
        "meaning of the response code, check "
        "https://docs.mosek.com/{}/capi/param-groups.html for allowable "
        "values in C++, or "
        "https://docs.mosek.com/{}/pythonapi/param-groups.html "
        "for allowable values in python.",
        option, val, rescode, mosek_version, mosek_version, mosek_version));
  }
}
