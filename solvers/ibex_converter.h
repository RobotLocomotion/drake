...
/// corresponding ibex::ExprCtr and ibex::ExprNode.
class IbexConverter {
 public:
  /// Constructs a converter from `variables`. The constructed IbexConverter
  /// can only handle symbolic expressions and formulas which include the passed
