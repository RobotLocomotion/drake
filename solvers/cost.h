...
class QuadraticCost : public Cost {
 public:
  ...
  QuadraticCost(const Eigen::MatrixBase<DerivedQ>& Q,
    ...
    if (is_hessian_psd.has_value()) {
      ...
      is_convex_ = CheckHessianPsd<DerivedQ>(Q);
    }
  }
  ...
  void UpdateCoefficients(const Eigen::MatrixBase<DerivedQ>& new_Q,
    ...
    if (is_hessian_psd.has_value()) {
      ...
      is_convex_ = CheckHessianPsd(new_Q);
    }
  }
 ...
 private:
  ...
  bool CheckHessianPsd(const Eigen::MatrixBase<Derived>& Q) const {
    Eigen::LDLT<Eigen::Matrix<double, Derived::RowsAtCompileTime,
