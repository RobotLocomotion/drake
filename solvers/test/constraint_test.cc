...
void TestLorentzConeEvalType1And2(const Eigen::Ref<const Eigen::MatrixXd>& A,
                                  const Eigen::Ref<const Eigen::VectorXd>& b,
                                  const VectorXd& x_test) {
  LorentzConeConstraint cnstr1(A, b, LorentzConeConstraint::EvalType::kType1);
  LorentzConeConstraint cnstr2(A, b, LorentzConeConstraint::EvalType::kType2);
...
// Tests if the Lorentz Cone constraint (with eval type 3) is imposed correctly.
void TestLorentzConeEvalType3(const Eigen::Ref<const Eigen::MatrixXd>& A,
                              const Eigen::Ref<const Eigen::VectorXd>& b,
                              const VectorXd& x_test, bool is_in_cone) {
  LorentzConeConstraint cnstr(A, b, LorentzConeConstraint::EvalType::kType3);
...
GTEST_TEST(testConstraint, testLorentzConeConstraint) {
  ...
  TestLorentzConeEvalType1And2(Eigen::Matrix3d::Identity(),
                               Eigen::Vector3d::Zero(), x1);
  TestLorentzConeEvalType3(Eigen::Matrix3d::Identity(), Eigen::Vector3d::Zero(),
                           x1, true);
  ...
  TestLorentzConeEvalType1And2(A2, b2, x2);
  TestLorentzConeEvalType3(A2, b2, x2, true);
  ...
  TestLorentzConeEvalType1And2(A3, b3, x3);
  TestLorentzConeEvalType3(A3, b3, x3, false);
  ...
  TestLorentzConeEvalType1And2(A4, b4, x4);
  TestLorentzConeEvalType3(A4, b4, x4, false);
}

GTEST_TEST(testConstraint, testLorentzConeConstraintAtZeroZ) {
  // Test LorentzConeConstraint with type 2 evaluated at z = 0
  Vector2d x(1, 2);
  Eigen::Matrix<double, 3, 2> A;
  A << 1, 2, -2, -1, 2, 3;
  Eigen::Vector3d b = -A * x;
  LorentzConeConstraint cnstr(A, b, LorentzConeConstraint::EvalType::kType2);
