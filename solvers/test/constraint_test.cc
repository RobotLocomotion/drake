...
void TestLorentzConeEvalConvex(const Eigen::Ref<const Eigen::MatrixXd>& A,
  ...
  LorentzConeConstraint cnstr1(A, b, LorentzConeConstraint::EvalType::kConvex1);
  LorentzConeConstraint cnstr2(A, b, LorentzConeConstraint::EvalType::kConvex2);
...
GTEST_TEST(testConstraint, testLorentzConeConstraintAtZeroZ) {
  ...
  LorentzConeConstraint cnstr(A, b, LorentzConeConstraint::EvalType::kConvex2);
