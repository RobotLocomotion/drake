...
void CheckParseQuadraticConstraint(
  ...
  if (hessian_type.has_value()) {
    EXPECT_EQ(binding.evaluator()->hessian_type(), hessian_type.value());
  }
}
...
TEST_F(ParseQuadraticConstraintTest, Test0) {
  ...
  CheckParseQuadraticConstraint(x0_ * x0_ + 2 * x0_ + 3, 0, 2, std::nullopt);
  ...
  CheckParseQuadraticConstraint(x0_ * x0_ + 2 * x0_ * x1_ + 4 * x1_ * x1_, 1,
                                kInf, std::nullopt);
  CheckParseQuadraticConstraint(
      x0_ * x0_ + 2 * x0_ * x1_ + 4 * x1_ * x1_ + 2, 1, kInf,
      QuadraticConstraint::HessianType::kPositiveSemidefinite);
  CheckParseQuadraticConstraint(
      -x0_ * x0_ + 2 * x0_ * x1_ - 4 * x1_ * x1_ + 2, -kInf, 3,
