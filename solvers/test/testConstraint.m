...
cnstr1 = FunctionHandleDifferentiableConstraint(0,1,1,@(x) x+1);
...
cnstr2 = FunctionHandleDifferentiableConstraint([0;1],[0;2],2,@cnstr_userfun2);
...
cnstr3 = FunctionHandleDifferentiableConstraint([0;1],[0;2],2,@cnstr_userfun3);
...
cnstr4 = FunctionHandleDifferentiableConstraint([0;0],[0;1],3,@cnstr_userfun4);
