...
GTEST_TEST(ProgramAttributeTest, Supported) {
  ...
  cases{
    {quad_cost, quad_cost, ""s},
    {quad_cost, quad_cost_cons, ""s},
    {quad_cost, quad_cost_cons_generic_cost, ""s},
    {quad_cost_cons, quad_cost_cons, ""s},
    {quad_cost_cons, quad_cost_cons_generic_cost, ""s},
    {lin_cons, quad_cost,
     "a LinearConstraint was declared but is not supported"s},
  ...
  for (const auto& one_case : cases) {
    ...
    SCOPED_TRACE(to_string(required) + " vs "s + to_string(supported));
