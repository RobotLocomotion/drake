...
% (x1-2)^2+x2^2<=5
% x1 >= 0
cnstr1 = FunctionHandleDifferentiableConstraint(-inf(2,1),[4;5],2,@cnstr1_userfun);
xind1 = [1;2];
...
% 0<=x1+2*x3 <=10
% x1+3*x3 = 0
nlp1 = nlp1.addCost(FunctionHandleDifferentiableObjective(1,@cost1_userfun),2);
nlp1 = nlp1.addCost(FunctionHandleDifferentiableObjective(2,@cost2_userfun),[1;3]);
...
nc2 = FunctionHandleDifferentiableConstraint([1/6;-10],[1/6;30],3,@cnstr2_userfun);
...
cnstr3 = FunctionHandleDifferentiableConstraint(-inf(2,1),[4;5],2,@cnstr3_userfun);
cost3 = FunctionHandleDifferentiableObjective(2,@cost3_userfun);
xind1 = {1;2};
