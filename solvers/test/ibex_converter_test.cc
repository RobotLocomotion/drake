...
class IbexConverterTest : public ::testing::Test {
 public:
  IbexConverterTest()
      : variables_{var_x_, var_y_, var_z_}, converter_{variables_} {}

 protected:
  // void TearDown() override { converter_.set_need_to_delete_variables(true); }
  ...
  Vector3<Variable> variables_;

  IbexConverter converter_;
};
