...
// some common functions in ClarabelSolver and ScsSolver
#pragma once
...
// @param dual_length The length of the dual solution (as a congruent chunk of
// memory).
...
// dual variables.
// @param lorentz_cone_y_start_indices
