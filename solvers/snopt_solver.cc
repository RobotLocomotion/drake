...
// With compiled using SNOPT 7.6, these static methods are mere aliases to the
...
//
// Below, we use the `Int` template trick so that SFINAE ignores the function
// bodies when the user has SNOPT 7.6
template<>
