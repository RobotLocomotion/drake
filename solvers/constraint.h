...
class Constraint : public EvaluatorBase {
 public:
   ...
   * @param x A `num_vars` x 1 vector. @throws an exception if the size isn't
   * correct.
...
class QuadraticConstraint : public Constraint {
 public:
   ...
   * @throw an exception if Q0 isn't a square matrix, or b.rows() != Q0.rows().
   */
...
class RotatedLorentzConeConstraint : public Constraint {
 public:
  ...
  /**
   @throw an exception if A.rows() < 3.
   */
