...
class Constraint : public EvaluatorBase {
 public:
  ...
  /** Virtual method to facilitate GSG-compliant dynamic-downcasting to
   * LinearConstraints. Only returns true for derived classes that have type
   * LinearConstraint.  (A generic constraint that happens to
   * be linear should return false).
   */
  virtual bool is_linear_constraint() const { return false; }
...
class LinearConstraint : public Constraint {
 public:
  ...
  bool is_linear_constraint() const override { return true; }
