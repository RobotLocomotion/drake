 ...
 public:
  ...
  MSKrescodee SetDualSolution(
      ...
      const std::unordered_map<
          ...
          bb_con_dual_indices,
      const std::unordered_map<Binding<LinearConstraint>,
                               ConstraintDualIndices>& linear_con_dual_indices,
  ...
  decision_variable_index_to_mosek_matrix_variable() const {
    return map_decision_var_to_mosek_var_
        .decision_variable_index_to_mosek_matrix_variable;
  }

  const std::unordered_map<int, int>&
  decision_variable_index_to_mosek_nonmatrix_variable() const {
    return map_decision_var_to_mosek_var_
        .decision_variable_index_to_mosek_nonmatrix_variable;
  }
