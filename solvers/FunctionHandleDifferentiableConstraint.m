classdef FunctionHandleDifferentiableConstraint < DifferentiableConstraint
  ...
  methods
    function obj = FunctionHandleDifferentiableConstraint(lb,ub,xdim,eval_handle)
  ...
  methods (Access = protected)
    function varargout = constraintEval(obj,varargin)
      ...
      elseif nargout == 3,
        ...
        error('Drake:FunctionHandleDifferentiableConstraint:UnsupportedEval','Only support 2nd order gradient at most');
      end      
    end
  end
end
