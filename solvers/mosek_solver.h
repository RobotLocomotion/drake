 ...
 * parameters in
 * https://docs.mosek.com/9.2/capi/param-groups.html#doc-param-groups for C API
 * and https://docs.mosek.com/9.2/pythonapi/param-groups.html#doc-param-groups
 * for python API. On top of these parameters, we also provide the following
 * additional parameters
 * 1. "write", set to a file name so that Mosek solver will write the
