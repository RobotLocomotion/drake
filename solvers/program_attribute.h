...
enum class ProgramType {
  ...
  kGP,    ///< Geometric Programming, with a linear cost and exponential cone
          ///< constraints.
  kCGP,   ///< Conic Geometric Programming, this is a superset that unifies GP
         ///< and SDP. Refer to http://people.lids.mit.edu/pari/cgp_preprint.pdf
         ///< for more details.
  kMILP,    ///< Mixed-integer Linear Programming. LP with some variables taking
            ///< binary values.
  ...
  kMISDP,   ///< Mixed-integer Semidefinite Programming. SDP with some variables
            ///< taking binary values.
  ...
  kUnknown,  ///< Not fall into any types above.
};
