 ...
 * environtment variable `SNOPT_SOLVER_ENABLED` to "0" to force-disable SNOPT,
 * in which case SolverInterface::enabled() will return false.
 */
class SnoptSolver final : public SolverBase {
 public:
  ...
  /// Returns true iff the environment variable SNOPT_ENABLED is unset or
