...
template <typename T>
void MeshcatVisualizer<T>::SetAlphas(bool individual_geometries) const {
  if (individual_geometries) {
    ...
    // requires that all instantiation of objects is complete in the visualizer
    // instance.
