...
/* DeformableContactData characterizes the contact between a single deformable
 ...
 public:
  ...
  /* Append contact data between the deformable geometry and a rigid geometry.
   ...
   @param[in] tetrahedra_indexes
      ...
      index semantics as `tetrahedron_indices`.
  ...
  /* Returns the GeometryIds for all rigid geometries in contact with the
   deformable geometry. The i-th GeometryId corresponds to the i-th contact mesh
