...
// TODO(DamrongGuoy) Remove this when we clean up the namespace.
using ReferenceDeformableGeometry =
    drake::geometry::internal::deformable::ReferenceDeformableGeometry;
