...
class ContactParticipation {
 public:
  ...
  /* Returns the vertex partial permutation and the induced dof partial
   permutation. The vertex partial permutation p is such that p(i) gives the
   permuted vertex index for vertex i, if vertex i is participating in contact.
   If both vertex i and vertex j are participating in contact, and i < j, then
   p(i) < p(j).
