 ...
 public:
  ...
  /** @name  Evaluation of constituent pressure fields
   ...
   contact surface. In order for these values to be included in an instance:
     ...
     - the gradient must be well defined (e.g., as stiffness goes to infinity,
       the geometry becomes rigid and the gradient _direction_ converges to the
       direction of the rigid mesh's surface normals, but the magnitude goes
       to infinity, producing a pressure gradient that would be some variant of
       <∞, ∞, ∞>).
