...
void DeformableContactData<T>::Append(
  ...
  signed_distances_.insert(signed_distances_.end(),
                           make_move_iterator(signed_distances.begin()),
                           make_move_iterator(signed_distances.end()));
  barycentric_coordinates_.insert(
      barycentric_coordinates_.end(),
      make_move_iterator(barycentric_coordinates.begin()),
      make_move_iterator(barycentric_coordinates.end()));
}
