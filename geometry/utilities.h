...
/** @name Isometry scalar conversion
 ...
 manner to allow SceneGraph to mindlessly convert Value<T> to
 Value<double> efficiently. There is *particular* emphasis on making the
 Value<double> -> Value<double> as cheap as possible.  */
//@{
