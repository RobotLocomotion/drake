...
RenderEngineVtk::RenderingPipeline::RenderingPipeline(bool use_egl)
    : using_egl{use_egl}, window{MakeRenderWindow(use_egl)} {}
...
RenderEngineVtk::RenderEngineVtk(const RenderEngineVtk& other)
    : RenderEngine(other),
      ...
      pipelines_{
          {make_unique<RenderingPipeline>(other.pipelines_[0]->using_egl),
           make_unique<RenderingPipeline>(other.pipelines_[1]->using_egl),
           make_unique<RenderingPipeline>(other.pipelines_[2]->using_egl)}},
