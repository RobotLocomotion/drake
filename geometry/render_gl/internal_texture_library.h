...
/* TODO(SeanCurtis-TRI) Using file paths as unique identifiers prevents a
 texture library instance from recognizing changes to images on disk. This
 doesn't seem like much of a risk. In order for this failing to affect a user,
 the user would would have to:
