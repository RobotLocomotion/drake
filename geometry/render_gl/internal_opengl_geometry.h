...
/* @group Frames, Geometries, and Instances
 ...
 Relationships between these frames:
   ...
   P_, S_, T_, and N_ prefixes. All transforms used here are implemented as
...
struct OpenGlGeometry {
  ...
  /* The immutable transform mapping vertex position to the model frame. */
  Eigen::Matrix4f T_MN{Eigen::Matrix4f::Identity()};
  /* The immutable transform mapping vertex normals to the model frame. */
