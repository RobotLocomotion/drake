...
// use it to confirm that VTK is properly _invoking_ the obj material handling;
// the _correctness_ of the material handling is tested in render_mesh_test.cc.
// For the non-textured, we make sure we use a mesh without material file or
// matching foo.png to preclude it being textured.
