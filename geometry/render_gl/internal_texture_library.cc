...
void TextureLibrary::AddInMemoryImage(
    const std::string& name, const std::vector<unsigned char>& file_bytes) {
  ...
  ImageIo::ByteSpan texture_bytes{.data = file_bytes.data(),
