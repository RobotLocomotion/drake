...
class DummyRenderEngine : public render::RenderEngine, private ShapeReifier {
 ...
 protected:
  /* Dummy implements named visuals; as such, we won't allow derived classes to
   override this anymore. Leaving it overridable might allow erring downstream
   implementations that would simply become dead code. */
