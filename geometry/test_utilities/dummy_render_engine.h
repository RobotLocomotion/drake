...
class DummyRenderEngine : public render::RenderEngine, private ShapeReifier {
 ...
 protected:
  /* Dummy implements named visuals; as such, we won't allow derived classes
   override this anymore, because the new implementation of
   DoRegisterNamedVisual() means this doesn't get exercised and attempts to
   override it would lead to dead code.*/
