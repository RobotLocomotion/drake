...
GeometryState<T>::GeometryState()
  ...
  //   - the arbitrary, big number is selected so that it won't be interpreted
  //     as a random initialization, but still large enough that it the
  //     the probability of collision with user-defined groups/cliques is
  //     essentially zero.
  frames_[world] = InternalFrame(self_source_, world, "world", 1234567890,
                                 FrameIndex(0), world, 1234567890);
