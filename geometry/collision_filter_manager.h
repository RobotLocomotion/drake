...
/** Class for configuring "collision filters"; collision filters limit the scope
 ...
 The sole source of %CollisionFilterManager instaces is SceneGraph. See
 ...
 Declaring a change to the set C will increment the proximity version (wee
 ...
 <!-- NOTE TO DEVELOPERS
   ...
   by SceneGraph, the tests for this simple wrapper API is part of those tests
