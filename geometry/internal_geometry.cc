...
InternalGeometry::InternalGeometry(SourceId source_id,
  ...
  // Construct the mesh in frame G.
  reference_mesh_F_ = mesh_builder.Build(*shape_spec_, resolution_hint);
  // Transform it into from F.
  reference_mesh_F_->TransformVertices(X_FG_);
}
