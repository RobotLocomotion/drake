...
class TestShader final : public ShaderProgram {
 public:
  ...
  bool SetInstanceParametersCalled() const {
    return set_instance_params_called_;
  }

  bool SetDepthCameraParametersCalled() const {
...
TEST_F(ShaderProgramTest, SetInstanceParameters) {
  ...
  ASSERT_FALSE(shader.SetInstanceParametersCalled());
  shader_ptr->SetInstanceParameters(data);
  ASSERT_TRUE(shader.SetInstanceParametersCalled());
}
...
TEST_F(ShaderProgramTest, SetDepthCameraParameters) {
  ...
  ASSERT_FALSE(shader.SetDepthCameraParametersCalled());
  shader_ptr->SetDepthCameraParameters(camera);
  ASSERT_TRUE(shader.SetDepthCameraParametersCalled());
}
