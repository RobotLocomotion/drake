...
/* Creates an OpenGL-compaptible mesh representation of a unit sphere
 ...
 @param longitude_bands     The number of triangle strip bands running
                            longitudinally.
 @param latitude_bands      The number of triangle sti bands running parallel
                            with the sphere equator.
 @pre `longitude_bands` >= 2 and `latitude_bands` >= 3 (otherwise the sphere
      will have no volume).  */
