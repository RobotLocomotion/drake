...
pair<VertexBuffer, IndexBuffer> MakeLongLatUnitSphere(int longitude_bands,
  ...
  */
  ...
  // If v_index spans the range [11, 12, 13, 14, ... 20] in this for loop, then
  // p covers [20, 11, 12, ..., 19]. It's always one "behind", although
  // initially it is the index of a vertex that hasn't been added yet.
