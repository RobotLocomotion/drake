...
/**
 ...
 - `empty`: a pixel with the `empty` %RenderLabel value indicates that _no_
   ...
   inadvisable and will typically lead to unexpected or undesired results.
 ...
 - `unspecified`: in the absence of an explicitly assigned render label, a
   geometry receives the `unspecified` label. It is likely a defect for an
...
class RenderLabel {
 public:
  ...
  RenderLabel() : RenderLabel(kUnspecified, false) {}
  ...
  static RenderLabel empty_label() { return RenderLabel{kEmpty, false}; }
  ...
  static RenderLabel dont_care_label() { return RenderLabel{kDontCare, false}; }

  /** Reports if the label is the "dont_care" label.  */
  bool is_dont_care() const { return value_ == kDontCare; }

  /** Returns a label representing the "unspecified" label.  */
  static RenderLabel unspecified_label() {
    return RenderLabel{kUnspecified, false};
  }

  /** Reports if the label is the "unspecified" label.  */
  bool is_unspecified() const { return value_ == kUnspecified; }
 ...
 private:
  ...
  static constexpr ValueType kUnspecified =
      std::numeric_limits<ValueType>::max();
  static constexpr ValueType kDoNotRender = kUnspecified - 1;
