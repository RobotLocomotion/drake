...
/**
 ...
 between that %RenderLabel and its declared semantic class, or exploit the
 fact that SceneGraph maintains that mapping for all %RenderLabel values it
 allocates and simply queries for the registered semantic class name associated
 with the label via SceneGraphInspector::GetSemanticClassNameFromLabel().
