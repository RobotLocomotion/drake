...
// Confirms that invocations of the render API using full camera intrinsics
// defaults to the simple intrinsics when the sub-class hasn't implemented
// their own.
GTEST_TEST(RenderEngine, FullIntrinsicsDefaultsToSimple) {
