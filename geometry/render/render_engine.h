...
class RenderEngine : public ShapeReifier {
 ...
 protected:
  ...
  /** Provides access to the light for manual configuration since it's currently
   ...
   @param X_DL The pose of the light in a coordinate space D that is attached to
               the camera position. In this coordinate frame D, the camera is
               located at (0, 0, 1), looking towards (0, 0, 0) at a distance of
               1, with up being (0, 1, 0).  */
