...
struct RenderEngineParams {
  /** The render label to @ref render_engine_default_label
   apply to geometries that have not otherwise specified a (label, id) property.
   The value _must_ be either RenderLabel::kUnspecified or
   RenderLabel::kDontCare. (See @ref render_engine_default_label "this section"
   for more details.) Defaults to RenderLabel::kUnspecified.  */
