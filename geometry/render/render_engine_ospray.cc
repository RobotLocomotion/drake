...
void RenderEngineOspray::ImplementGeometry(const Capsule& capsule,
                                           void* user_data) {
  // TODO(tehbelinda): Keep this implementation in sync with render_engine_vtk
  // until issue #11964 is resolved.
  ...
  ImplementGeometry(append_filter.GevttPointer(), user_data);
}
