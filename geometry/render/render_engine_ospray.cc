...
void RenderEngineOspray::SetSphereOptions(vtkSphereSource* vtk_sphere,
                                          double radius) {
...
void RenderEngineOspray::SetCylinderOptions(vtkCylinderSource* vtk_cylinder,
...
void RenderEngineOspray::TransformToDrakeCylinder(
