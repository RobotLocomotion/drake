...
class RenderEngineVtk : public RenderEngine,
 ...
 private:
  // TODO(svenevs): The RenderEngineGltfClient class from the work-in-progress `dev`
  // folder needs access to the rendering pipelines.  We should reconsider the
  // need for private friendship prior to promoting the RenderEngineGltfClient class
  // out of `dev`.
