...
RenderLabelManager::RenderLabelManager(SourceId id)
  ...
  // The reserved labels all belong to the scene graph.
  name_label_map_["empty"].push_back(
      RenderLabelClass("empty", id, RenderLabel::empty_label()));
  name_label_map_["ignored"].push_back(
      RenderLabelClass("ignored", id, RenderLabel::ignored_label()));
  name_label_map_["unclassified"].push_back(
      RenderLabelClass("unclassified", id, RenderLabel::unclassified_label()));
}
