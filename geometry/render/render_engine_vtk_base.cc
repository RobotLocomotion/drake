...
/* A custom poly data algorithm for creating a Box for Drake. This differs from
 (and is preferred over) the vtkCubeSource for the following reasons.
   ...
   2. The vtkCubeSource generates texture coordinates (uvs) in a strange way.
      The vertices are assigned uv values basd on where they are in space. This
 ...
 regardless of the size or aspect ratio of the face. It does suppor the ability
 to scale those texture coordinates if tiling is desired or aspects ratios
 should be tweaked.  */
