...
struct RenderMesh {
  ...
  /* The specification of the material associated with this mesh data. If
  `material` is set to std::nullopt, then the RenderMesh has no material
  assigned. Consumer of a RenderMesh without material can choose to create an
  untextured, single diffuse color material by calling MakeDiffuseMaterial. */
