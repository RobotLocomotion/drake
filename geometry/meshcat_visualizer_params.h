...
struct MeshcatVisualizerParams {
  ...
  void Serialize(Archive* a) {
    ...
    a->Visit(DRAKE_NVP(include_geometry_with_unspecified_destination));
  }
  ...
  /** (Advanced) For a given geometry, if the GeometryProperies for our `role`
   ...
   `include_geometry_with_unspecified_destination` is true. */
  bool include_geometry_with_unspecified_destination{true};
};
