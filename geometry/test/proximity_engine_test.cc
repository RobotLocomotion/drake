...
class SimplePenetrationTest : public ::testing::Test {
 protected:
  ...
  //       *|*         o o
  //    *   |   *   o       o
  // __*____|____*_o_________o_________ x
  //   *    |    * o         o
  //    *   |   *   o       o
  //       *|*         o o
  //
  ...
  //       *|*    o o
  //    *   |  o*      o
  // __*____|_o__*______o_________ x
  //   *    | o  *      o
  //    *   |  o*      o
  //       *|*    o o
...
// Performs the same collision test between two spheres which belong to the
// same source
TEST_F(SimplePenetrationTest, PenetrationDynamicSameSource) {
