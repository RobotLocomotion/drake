...
// The goal is to have one corner of the box be a unique point of deepest
// penetration `p_WC` = (0, 0, -depth). The box is positioned and oriented
// such that the corner `p_BoC_B` = (-0.5, -0.5, -0.5) is coincident with
// `p_WC`.  And all other transformed corners lie above the z = 0 plane.
//
...
TEST_F(BoxPenetrationTest, TangentProneCylinder2) {
  ...
  // is in the position of the contact points.
