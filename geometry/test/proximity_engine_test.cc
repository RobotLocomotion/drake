...
// "extruded_u_refined.vtk" was derived from the surface mesh "extruded_u.obj",
// and both have the expected exterior shape described above.
//
// It is not expected or encouraged to pass concave geometry using the Convex
// shape specification type, but the evaluation implemented above will yield
// the same result as for the Mesh type.
