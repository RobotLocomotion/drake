...
def main():
    ...
    parser.add_argument(
        ...
        help="websocket URL")
    parser.add_argument(
        "--send_message", type=json.loads, default=None,
        help="send this message (given as a json string) to the websocket")
    parser.add_argument(
        "--expect_num_messages", type=int, default=0,
        help="the expected number of messages to receive")
    parser.add_argument(
        "--expect_message", type=json.loads, default=None,
        help="the expected contents of the the Nth message (as a json string)")
    parser.add_argument(
        "--expect_success", type=int, default=True,
