...
- From left to right along the x axis, you should see:
  ...
  meshcat->AddButton("Press r or t Key", "KeyR");
  meshcat->AddButton("Press r or t Key", "KeyT");
  ...
  std::cout << "- Press the 'r' and/or 't' key in the meshcat window, which "
  ...
  std::cout << "Got " << meshcat->GetButtonClicks("ButtonTest")
            ...
            << "Got " << meshcat->GetButtonClicks("Press r or t Key")
            << " clicks on \"Press r or t Key\".\n"
