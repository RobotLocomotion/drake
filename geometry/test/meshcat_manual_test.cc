...
int do_main() {
  ...
  // TODO(russt): Fix the texture map processing (in meshcat?) for this one. The
  // box should be bright green.
  meshcat->SetObject(
...
- From left to right along the x axis, you should see:
  ...
  - a gray cube (the texture in box.obj.mtl is not yet supported)
