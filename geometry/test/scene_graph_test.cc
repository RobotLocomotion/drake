...
// Smoke test augmented context configuration. Fine detail should be
// tested in geometry_state_test.
TEST_F(SceneGraphTest, ApplyConfig) {
  ...
  // Replace the role, removing an arbitrary property. The property stays
  // removed.
