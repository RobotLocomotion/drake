...
// Smoke test automatic hydroelastic configuration. Fine detail should be
// tested in internal_hydroelasticate_test.
TEST_F(SceneGraphTest, AutoHydroelasticConfig) {
  EXPECT_EQ(
  ...
  // XXX hydro group now appears from nowhere.
  ...
  // Hydroelastic configured context.
  CreateDefaultContext();
