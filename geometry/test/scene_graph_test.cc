...
// Tests that sources can be registered after context allocation. It also
// implicitly tests that the model inspector is available _after_ allocation.
...
// Tests operations on a transmogrified SceneGraph. Whether an context has been
