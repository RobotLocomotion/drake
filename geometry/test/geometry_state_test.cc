...
// calls GeometryState::AssignRole, we don't bother testing whether proximity
...
TEST_F(ApplyProximityDefaultsTests, NoRole) {
  ...
  geometry_state_.ApplyProximityDefaults(empty_defaults_);
  ...
  EXPECT_EQ(geometry_state_.GetProximityProperties(geometry_id), nullptr);
  geometry_state_.ApplyProximityDefaults({});
  EXPECT_EQ(geometry_state_.GetProximityProperties(geometry_id), nullptr);
}
