...
GTEST_TEST(InternalGeometryTest, DeformableMeshedGeometry) {
  ...
  // TODO(xuchenhan): This is a slight abuse of `internal_mesh`. We are only
  // interested in comparing the connectivity of `mesh` and `internal_mesh`.
  // There is no guarantee that their vertex positions match.
