...
using internal::ModifyLcmChannelForRole;
 ...
 protected:
  ...
  struct Subscribers {
    ...
    explicit Subscribers(lcm::DrakeLcm* lcm, Role role)
        : draw(lcm, ModifyLcmChannelForRole(kDrawChannel, role)),
          load(lcm, ModifyLcmChannelForRole(kLoadChannel, role)),
          deformable(lcm, ModifyLcmChannelForRole(kDeformableDrawChannel,
                                                  role)) {
    }
