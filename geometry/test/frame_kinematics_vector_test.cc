...
GTEST_TEST(FrameKinematicsVector, InitializerListCtorDeprecated) {
  const auto& id_0 = FrameId::get_new_id();
...
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
GTEST_TEST(FrameKinematicsVector, InitializerListAssignDeprecated) {
  const auto& id_0 = FrameId::get_new_id();
  const Isometry3<double> pose_0 = Isometry3<double>::Identity();
  const auto& id_1 = FrameId::get_new_id();
  const Isometry3<double> pose_1 =
...
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
GTEST_TEST(FrameKinematicsVector, WorkingWithValuesDeprecated) {
  int kPoseCount = 3;
  std::vector<FrameId> ids;
  for (int i = 0; i < kPoseCount; ++i) ids.push_back(FrameId::get_new_id());
  FramePoseVector<double> poses;
...
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
GTEST_TEST(FrameKinematicsVector, AutoDiffInstantiationDeprecated) {
  FramePoseVector<AutoDiffXd> poses;
...
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
GTEST_TEST(FrameKinematicsVector, SymbolicInstantiationDeprected) {
  using symbolic::Expression;
  using symbolic::Variable;
