...
class GeometryProperties {
 public:
  ...
  void AddProperty(const std::string& group_name, const std::string& name,
    ...
    AddPropertyAbstract(group_name, name, AbstractValue::Make(value));
  }
  ...
  void AddPropertyAbstract(
    ...
    AddPropertyAbstract(group_name, name, value.Clone());
  }
 ...
 private:
  ...
  // unqiue_ptr overload to allow avoiding multiple copies when adding via
  // `AddProperty<>`.
  void AddPropertyAbstract(
      const std::string& group_name, const std::string& name,
