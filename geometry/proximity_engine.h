...
class GeometryStateCollisionFilterAttorney {
 ...
 private:
  ...
  // index. This is intended to be used for filtering collisions between
  // "sibling" geometries -- geometries rigidly affixed to the same frame. By
  // definition, those geometries are "dynamic".
  template <typename T>
