...
class DrivenTriangleSurfaceMesh {
 public:
  /* Constructs a DrivenTriangleSurfaceMesh with the given `triangle_mesh` as a
  ...
  /* Constructs a DrivenTriangleSurfaceMesh with the given `triangle_mesh` whose
   deformation is interpolated with the explicitly supplied `interpolator`.
