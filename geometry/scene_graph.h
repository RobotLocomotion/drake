...
class SceneGraph final : public systems::LeafSystem<T> {
 public:
  ...
  /** Returns a function that can be used to look up geometry names for
   ...
   created it; the %SceneGraph must outlive the look up. When in doubt, do not
   save the function; instead ask %SceneGraph for the function for each unique
   scope of usage.
