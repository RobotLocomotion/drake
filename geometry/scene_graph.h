...
class SceneGraph final : public systems::LeafSystem<T> {
 public:
  ...
  /** Extracts a reference to the scene graph configuration from the given
   context. The context's scene graph configuration is copied from the main
   scene graph configuration at context construction time. Thereafter, the
