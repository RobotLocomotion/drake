...
class Meshcat {
  ...
  */
  ...
  /** @name Meshcat Controls Meshcat "Controls" are user interface elements in
   the browser.  These currently include buttons and sliders.
   ...
   - Users of this Meshcat instance are responsible for polling the GUI to
     retrieve the user interface events.lp
  ...
  */
  ...
  /** Adds a slider with the label `name` to the meshcat browser controls GUI.
   ...
   increment by which the slider can change values. `value` specifies the
   initial value; it will be truncated to the slider range and rounded to the
   nearest increment.
   */
