...
class Meshcat {
  ...
  */
  ...
  /** Applies a number of settings to make Meshcat act as a 2D renderer. The
   ...
   positive x in the 2D frame.  Note that the Meshcat camera has a rotated
   coordinate system relative to the typical OpenGL camera defaults:
   https://github.com/rdeits/meshcat#camera-control
  ...
  /** Resets the camera, background, grid lines, and axes to the defaults. */
