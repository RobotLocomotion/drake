...
class Meshcat {
 public:
  ...
  /** Sets the web_url.  This method is provided to enable workflows where the
   default localhost url is made available through a web server or proxy.
   This should not be required if you are using Meshcat on the localhost. */
