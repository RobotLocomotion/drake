...
class CspaceFreeBoxTester {
 public:
  ...
  struct CertifyPolynomials {
    CspaceFreeBox::CertifyPolynomials data;
  };

  void GenerateCertifyPolynomials(
      ...
      CertifyPolynomials* certify_polynomials) const {
    return cspace_free_box_.GenerateCertifyPolynomials(
