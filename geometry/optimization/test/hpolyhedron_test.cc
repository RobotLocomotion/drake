...
GTEST_TEST(HPolyhedronTest, ConstructorFromVPolytope) {
  ...
  EXPECT_TRUE(hpoly1.PointInSet(Eigen::Vector3d(1E-5, 1E-5, 1E-5)));
  EXPECT_TRUE(hpoly1.PointInSet(Eigen::Vector3d(1 - 1E-5, 1E-5, 1E-5)));
  EXPECT_TRUE(hpoly1.PointInSet(Eigen::Vector3d(1E-5, 1 - 1E-5, 1E-5)));
  EXPECT_TRUE(hpoly1.PointInSet(Eigen::Vector3d(1E-5, 1E-5, 1 - 1E-5)));
