...
// having options.num_infeasible_samples > 1.
...
<robot name="pendulum_on_vertical_track">
  ...
  // With num_infeasible_samples == 1, we found that SNOPT misses this point (on
  // some platforms with some random seeds).

  options.num_infeasible_samples = 5;
