...
// A block on a vertical track, free to rotate (in the plane) with width `w`
// and height `h`, plus a ground plane at z=0.  The true configuration space
// is min(q₀ ± .5w sin(q₁) ± .5h cos(q₁)) ≥ 0, where the min is over the ±.
