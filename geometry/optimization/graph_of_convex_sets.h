 ...
 public:
  ...
  class Vertex final {
    ...
    */
    ...
    activated (e.g. not in the shorest path) in the solution. */
  ...
  class Edge final {
    ...
    */
    ...
    `edge->xu().GetSolution(result)`. First, a deactivated edge will return the
    zero vector here, while the vertex version will return std::nullopt. Second,
    in the case of a loose convex relaxation, the vertex version will return the
