...
class GraphOfConvexSets {
 public:
  ...
  class Vertex final {
   ...
   private:
    const std::unique_ptr<ConvexSet> set_;
  ...
  class Edge final {
   public:
    ...
    adding edges with GraphOfConvexSets::AddEdge().  The Vertex objects must
    persist for the lifetime of this Edge. */
  ...
  /** Adds an edge to the graph from Vertex @p u to Vertex @p v.  The Vertex
  objects must persist for the lifetime of the constructed Edge. */
