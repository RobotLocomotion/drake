...
class GraphOfConvexSets {
  ...
  */
  ...
  If a `initial_guess` is provided, the solution inside this result will be used
  to set the initial guess for the convex restriction. Typically, this will be
  the result obtained by solving the convex relaxation.

  @throws std::exception if the initial guess does not contain solutions for the
  decision variables required in this convex restriction.
  */
