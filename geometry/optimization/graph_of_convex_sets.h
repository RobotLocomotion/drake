 ...
 public:
  ...
  class Edge final {
    ...
    */
    ...
    /** Returns the vector value of the slack variables associated with xu() in
    a solvers::MathematicalProgramResult */
    Eigen::VectorXd GetSolutionXu(
        const solvers::MathematicalProgramResult& result) const;

    /** Returns the vector value of the slack variables associated with xv() in
    a solvers::MathematicalProgramResult */
    Eigen::VectorXd GetSolutionXv(
        const solvers::MathematicalProgramResult& result) const;
