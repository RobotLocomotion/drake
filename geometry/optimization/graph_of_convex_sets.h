 ...
 public:
  ...
  class Edge final {
    ...
    */
    ...
    /** Returns the vector value of the slack variables associated with ϕ times
    xu() in a solvers::MathematicalProgramResult */
    Eigen::VectorXd GetSolutionPhiXu(
        const solvers::MathematicalProgramResult& result) const;

    /** Returns the vector value of the slack variables associated with ϕ times
    xv() in a solvers::MathematicalProgramResult */
