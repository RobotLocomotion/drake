...
struct GraphOfConvexSetsOptions {
  ...
  /** Round solution after solving convex relaxation. If convex relaxation is
  ...
  convex relaxation is false, this option is ignored. */
  ...
  /** Random seed to use for random rounding. If convex relaxation is false,
