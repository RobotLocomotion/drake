...
struct GraphOfConvexSetsOptions {
  ...
  /** Maximum number of distinct paths to compare during random rounding,
  returning the lowest cost rounded path. If convex_relaxation is false or this
  is less than or equal to zero, rounding is not performed. */
  size_t max_rounded_paths{0};
