...
struct GraphOfConvexSetsOptions {
  ...
  /** Optimizer to be used to solve the MIP and relaxation of the shortest path
  ...
  problem generated, the calling solvers::SolverInterface::Solve()  method will
  throw. */
  const solvers::SolverInterface* solver{nullptr};

  /** Optimizer to be used in SolveConvexRestriction().
  ...
  /** Optional solver options for the restriction.
 ...
 public:
  ...
  enum class Transcription {
    kMIP,          //< The mixed integer formulation of the GCS problem.
                   //< Used when adding or retrieving constraints or costs.
    kRelaxation,   //< The relaxation of the GCS problem. Used when
                   //< adding or retrieving constraints or costs.
    kRestriction,  //< The restrction of the GCS problem where the path is
                   // fixed. < Used when adding or retrieving constraints or
                   // costs.
  };
  ...
  class Vertex final {
    ...
    */
    ...
    @param use_in_transcription specifies the component of the problem to which
    the constraint should be added.
    ...
    */
    solvers::Binding<solvers::Constraint> AddConstraint(
        ...
        std::unordered_set<Transcription> use_in_transcription = {
    ...
    */
    ...
    @param used_in_transcription specifies the component of the problem from
    which the constraint should be retrieved.
    */
    std::vector<solvers::Binding<solvers::Constraint>> GetConstraints(
        std::unordered_set<Transcription> used_in_transcription = {
            Transcription::kMIP, Transcription::kRelaxation,
   ...
   private:
    ...
    std::vector<solvers::Binding<solvers::Constraint>> mip_constraints_{};
    std::vector<solvers::Binding<solvers::Constraint>>
        relaxation_constraints_{};
    std::vector<solvers::Binding<solvers::Constraint>>
        restriction_constraints_{};
