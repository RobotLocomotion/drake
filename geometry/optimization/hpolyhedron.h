...
class HPolyhedron final : public ConvexSet {
  ...
  */
  ...
  pow(1/ambient_dimension()), to have units of volume:
    - `scale = 0` will result in a point,
    - `0 < scale < 1` shrinks the region,
    - `scale = 1` returns a copy of the `this`, and
    - `1 < scale` grows the region. If `center` is not provided (or empty),
      then the value returned by ChebyshevCenter() will be used.
