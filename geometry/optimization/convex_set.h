...
class ConvexSet : public ShapeReifier {
 public:
  ...
  // Note: Use a virtual interface here because the subclass implementation
...
class HPolyhedron final : public ConvexSet {
  ...
  */
  ...
  // AHPolytope: "If ambient_dimension() != 3, then consider using the AH
  // polytope representation to project it to 3D."
  ...
  /** Constructs a Convex shape description of this polytope, writing the mesh
  to a temporary .obj file on disk.
