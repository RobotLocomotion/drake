...
collision in `options.num_infeasible_samples` consecutive attempts.
...
increasing `options.num_infeasible_samples` increases the chances that the IRIS
regions are collision free but can also significantly increase the run-time of
the algorithm. The same goes for
