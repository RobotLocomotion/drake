...
class AffineBall final : public ConvexSet {
 public:
  ...
  center. B will describe how the unit ball is stretched and rotated to obtain
  the ellipsoid, and center describes the translation of the center of the
  ellipsoid from the origin.
  @pre B.rows() == B.cols().
