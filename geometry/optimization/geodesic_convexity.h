...
function does not check that the entries are indeed the AABBs corresponding
to the sets in `convex_sets_A`.
...
in `convex_sets`. If an empty vector is passed, then the AABBs are computed
automatically.
