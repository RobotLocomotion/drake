...
CspaceFreePolytope::ConstructPolytopeSearchProgram(
    const IgnoredCollisionPairs& ignored_collision_pairs,
...
void CspaceFreePolytope::AddOuterPolytope(
...
HPolyhedron CspaceFreePolytope::GetPolyhedron(const Eigen::MatrixXd& C,
