...
TEST_F(CollisionGeometryTest, Box) {
  ...
  EXPECT_EQ(box.num_plane_side_rationals(), 8);
...
TEST_F(CollisionGeometryTest, Convex) {
  ...
  EXPECT_EQ(convex.num_plane_side_rationals(), polytope.vertices().cols());
...
TEST_F(CollisionGeometryTest, Sphere) {
  ...
  EXPECT_EQ(sphere.num_plane_side_rationals(), 1);
...
TEST_F(CollisionGeometryTest, Capsule) {
  ...
  EXPECT_EQ(capsule.num_plane_side_rationals(), 2);
