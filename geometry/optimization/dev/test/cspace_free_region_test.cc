#include "drake/geometry/optimization/dev/cspace_free_region.h"
...
TEST_F(CIrisToyRobotTest, CspaceFreeRegionConstructor) {
  // Test CspaceFreeRegion constructor.
  CspaceFreeRegion dut(plant_, scene_graph_, SeparatingPlaneOrder::kAffine);
