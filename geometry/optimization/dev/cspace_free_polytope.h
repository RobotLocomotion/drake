...
class CspaceFreePolytope {
 ...
 private:
  ...
  // λ₁(y, s) is sos. Use this polytope_lagrangians when we search for C and d
  // and fix polytope_lagrangians to certain values.
  ...
  */
  ...
  /**
   ...
   This program takes C and d as decision variables, and search for the
   ...
   FindSeparationCertificateGivenPolytope().
   @param gram_total_size The return of GetGramVarSizeForolytopeSearchProgram().
   */
