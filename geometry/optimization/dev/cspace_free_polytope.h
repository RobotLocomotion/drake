...
class CspaceFreePolytope {
 public:
  ...
  /** Search the collision-free C-space polytope
   ...
   @param search_margin If set to true, then we also maximize the separating
   ...
   @retval result If we successfully find the collision-free C-space polytope,
