...
void ImplementPolytopeGeometry(const Eigen::Ref<const Eigen::Matrix3Xd>& p_GV,
  ...
  // from C to the polytope boundary. Note that in the condition
  // aᵀ*p_AC+b ≥ 0.5r (or ≤ -0.5r), in the right hand side we can use any
  // strictly positive scalar <= r. We choose 0.5r here.
