...
Spectrahedron::DoAddPointInNonnegativeScalingConstraints(
  ...
  // Treat bounding box constraints as general linear constraints.
  linear_constraints.insert(linear_constraints.end(),
  ...
  for (const auto& binding : linear_constraints) {
