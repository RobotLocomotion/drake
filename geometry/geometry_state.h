...
/**
 ...
 SceneGraph's context-dependent state includes values (the poses/positions) and
...
class GeometryState {
 public:
  ...
  /** @name                Position-dependent queries

   These quantities all depend on the most recent pose values assigned to the
   registered frames and position values assigned to deformable geometries.  */
  //@{
