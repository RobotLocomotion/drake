...
class GeometryState {
 public:
  ...
  /** Implementation of SceneGraphInspector::AllGeometryIds().  */
  std::vector<GeometryId> AllGeometryIds() const {
 ...
 private:
  ...
  // TODO(SeanCurtis-TRI): Rename this to X_PFs_ to reflecti multiplicity.
  ...
  // TODO(SeanCurtis-TRI): Rename this to X_WFs_ to reflecti multiplicity.
