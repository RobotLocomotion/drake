...
class GeometryState {
 ...
 public:
  ...
  /** Reports the id for the named geometry affixed to the indicated frame.
 ...
 private:
  ...
  // Provides a detailed report about the validity of the proposed name. This
  // assumes the frame_id is valid.
