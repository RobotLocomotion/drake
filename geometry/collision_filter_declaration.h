...
class CollisionFilterDeclaration {
 public:
  ...
  /** @name  Excluding pairs from consideration (adding collision filters)
   ...
   subtracts each implied pair from the set C (see the documentation for
   CollisionFilterManager for definition of set C). The documentation of each
   method explains the relationship between the input parameters and the set of
   implied geometry pairs.
