...
/** Enum that defines the scope of the geometries that are considered for the
 collision filtering mechanism. */
enum class CollisionFilterCandidates {
...
class CollisionFilterDeclaration {
 public:
  ...
  explicit CollisionFilterDeclaration(CollisionFilterCandidates candidates)
 ...
 private:
  ...
  CollisionFilterCandidates candidates() const { return candidates_; }

  // The sequence of statements in this declaration.
  std::vector<Statement> statements_;

  // Defines the scope of the filter. Defaults to all geometries.
  CollisionFilterCandidates candidates_{CollisionFilterCandidates::kAll};
};
