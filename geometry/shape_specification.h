...
extern double CalcMeshVolume(const Mesh& mesh);
extern double CalcConvexVolume(const Convex& convex);

template <typename T>
std::optional<Eigen::Vector3<T>> GetNormalAtPointForConvex(
    const Convex& convex, const Eigen::Vector3<T>& p);
extern template std::optional<Eigen::Vector3<double>> GetNormalAtPointForConvex(
    const Convex& convex, const Eigen::Vector3<double>& p);
extern template std::optional<Eigen::Vector3<float>> GetNormalAtPointForConvex(
    const Convex& convex, const Eigen::Vector3<float>& p);
extern template std::optional<Eigen::Vector3<::drake::AutoDiffXd>>
GetNormalAtPointForConvex(const Convex& convex,
                          const Eigen::Vector3<::drake::AutoDiffXd>& p);
extern template std::optional<Eigen::Vector3<::drake::symbolic::Expression>>
GetNormalAtPointForConvex(
    const Convex& convex,
...
extern template std::optional<Eigen::Vector3<double>> GetNormalAtPointForMesh(
    const Mesh& mesh, const Eigen::Vector3<double>& p);
extern template std::optional<Eigen::Vector3<float>> GetNormalAtPointForMesh(
    const Mesh& mesh, const Eigen::Vector3<float>& p);
extern template std::optional<Eigen::Vector3<::drake::AutoDiffXd>>
GetNormalAtPointForMesh(const Mesh& mesh,
                          const Eigen::Vector3<::drake::AutoDiffXd>& p);
extern template std::optional<Eigen::Vector3<::drake::symbolic::Expression>>
GetNormalAtPointForMesh(
    const Mesh& mesh,
    const Eigen::Vector3<::drake::symbolic::Expression>& p);
