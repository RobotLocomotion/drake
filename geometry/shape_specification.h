...
/** Definition of a finite section of a Lorentz cone (aka "second-order cone"),
 defined by
 ...
 This shape is currently only supported by Meshcat and for visualization only.
 In particular, it is *not* supported by SceneGraphs' proximity queries.
*/
