...
/** The interface for converting shape descriptions to real shapes. Any entity
 ...
 _and_ invoke the Shape::Reify() method. For example,

 ```
 class ConcreteReifier : public ShapeReifier {
   void ProcessShape(const Shape& shape) {
     shape.Reify(this);
   }
   ...
   void ImplementGeometry(const Sphere& sphere, void* user_data) override {
     // Do work to create a sphere (optionally using the provided user data.
   }
 };
 ```
