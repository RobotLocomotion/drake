...
struct DefaultProximityProperties {
  ...
  If none is provided, MultibodyPlant uses an estimate based on
  MultibodyPlantConfig::penetration_allowance. However, keep in mind that
  penetration allowance will no longer be supported in future releases. Either
  specify point contact stiffness for each of your geometries or use this
  default.

  @warning This value is also used for contact with deformable bodies. If not
  provided, dissipation defaults to zero for contact with deformable bodies.
  */
  ...
  /** A measure of material stiffness, in units of Newtons per meter.
   ...
   MultibodyPlantConfig::penetration_allowance. However, keep in mind that
   penetration allowance will no longer be supported in future releases. Either
   specify dissipation for each of your geometries or use this default.
