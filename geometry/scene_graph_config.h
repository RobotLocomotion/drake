...
struct DefaultProximityProperties {
  ...
  These properties affect hydroelastic contact only. For complete descriptions
  of the numeric parameters, @see geometry::AddRigidHydroelasticProperties,
  ...
  */
  ...
  These properties contact in general. For complete descriptions of the numeric
  parameters, @see geometry::AddContactMaterial, multibody::CoulombFriction,
