...
struct DefaultProximityProperties {
  ...
  These properties affect contact in general. For complete descriptions of the
  numeric parameters, @see geometry::AddContactMaterial,
  multibody::CoulombFriction, @ref mbp_contact_modeling,
  @ref mbp_dissipation_model. */
  /// @{
