...
/* The macro's whole purpose is to make sure that all benchmarks (the power
 set of all renderers against all image types) are executed with the same set
 of parameters. Typical google benchmark usage would look like:

   BENCHMARK_REGISTER_F(Benchmark, TestName)
       ->Unit(...)
       ->Args(...)
       ->Args(...);

 In other words, the BENCHMARK_REGISTER_F macro provides limted access to a
 pointer to benchmark::internal::Benchmark which is configured by these
 successive invocations of methods. With this macro, the invocation now looks
 like:

   BENCHMARK_REGISTER_F(Benchmark, TestName)
   CONFIGURATIONS;

 Be sure not to inject any spurious whitespace or terminal characters.

Args are: sphere count, camera count, image width, image height.  */
...
// NOLINTNEXTLINE(runtime/references)
BENCHMARK_DEFINE_F(RenderBenchmark, VtkColor)(benchmark::State& state) {
  ColorImage<RenderEngineVtk>(state, "VtkColor");
}
BENCHMARK_REGISTER_F(RenderBenchmark, VtkColor)
CONFIGURATIONS;

// NOLINTNEXTLINE(runtime/references)
BENCHMARK_DEFINE_F(RenderBenchmark, GlColor)(benchmark::State& state) {
  ColorImage<RenderEngineGl>(state, "GlColor");
}
BENCHMARK_REGISTER_F(RenderBenchmark, GlColor)
CONFIGURATIONS;


// NOLINTNEXTLINE(runtime/references)
BENCHMARK_DEFINE_F(RenderBenchmark, VtkDepth)(benchmark::State& state) {
  DepthImage<RenderEngineVtk>(state, "VtkDepth");
}
BENCHMARK_REGISTER_F(RenderBenchmark, VtkDepth)
CONFIGURATIONS;

// NOLINTNEXTLINE(runtime/references)
BENCHMARK_DEFINE_F(RenderBenchmark, GlDepth)(benchmark::State& state) {
  DepthImage<RenderEngineGl>(state, "GlDepth");
}
BENCHMARK_REGISTER_F(RenderBenchmark, GlDepth)
CONFIGURATIONS;


// NOLINTNEXTLINE(runtime/references)
BENCHMARK_DEFINE_F(RenderBenchmark, VtkLabel)(benchmark::State& state) {
  LabelImage<RenderEngineVtk>(state, "VtkLabel");
}
BENCHMARK_REGISTER_F(RenderBenchmark, VtkLabel)
CONFIGURATIONS;

// NOLINTNEXTLINE(runtime/references)
BENCHMARK_DEFINE_F(RenderBenchmark, GlLabel)(benchmark::State& state) {
  LabelImage<RenderEngineGl>(state, "GlLabel");
}
BENCHMARK_REGISTER_F(RenderBenchmark, GlLabel)
CONFIGURATIONS;
