...
/* The macro's whole purpose is to make sure that all benchmarks (the power
 ...
 In other words, the return value of BENCHMARK_DEFINE_F is a pointer to
 benchmark::internal::Benchmark which is configured by these successive
 invocations of methods. With this macro, the invocation now looks like:
