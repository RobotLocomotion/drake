...
// clang-format off
/* @defgroup compliant_mesh_intersection_benchmarks Compliant Mesh Intersection Benchmarks
...
CompliantMeshIntersectionBenchmark/SoftSoftMesh/4/3/min_time:0.020/min_warmup_time:0.010     483407 us       483390 us      3.5M            1
 ...
 ```
 CompliantMeshIntersectionBenchmark/SoftSoftMesh/resolution/contact_overlap/min_time/min_warmup_time
 ```
