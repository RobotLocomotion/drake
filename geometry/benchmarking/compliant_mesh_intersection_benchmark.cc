...
/* @defgroup compliant_mesh_intersection_benchmarks Compliant Mesh Intersection Benchmarks  // NOLINT
 ...
 Arguments include:
 - __resolution__: An enumeration in the integer range from 0 to 4 that guides
   the level of mesh refinement, where 0 produces the coarsest meshes and 4
...
---------------------------------------------------------------------------------------------------------------------------------------------  // NOLINT(*)
CompliantMeshIntersectionBenchmark/SoftSoftMesh/0/0/min_time:0.020/min_warmup_time:0.010      0.125 us        0.125 us   140.438       228197  // NOLINT(*)
CompliantMeshIntersectionBenchmark/SoftSoftMesh/0/1/min_time:0.020/min_warmup_time:0.010       10.1 us         10.1 us   160.438         2687  // NOLINT(*)
CompliantMeshIntersectionBenchmark/SoftSoftMesh/0/2/min_time:0.020/min_warmup_time:0.010       46.4 us         46.4 us   297.438          594  // NOLINT(*)
CompliantMeshIntersectionBenchmark/SoftSoftMesh/0/3/min_time:0.020/min_warmup_time:0.010        625 us          625 us      2.7k           44  // NOLINT(*)
CompliantMeshIntersectionBenchmark/SoftSoftMesh/1/0/min_time:0.020/min_warmup_time:0.010      0.116 us        0.116 us   657.188       237007  // NOLINT(*)
CompliantMeshIntersectionBenchmark/SoftSoftMesh/1/1/min_time:0.020/min_warmup_time:0.010       10.4 us         10.4 us   679.188         2667  // NOLINT(*)
CompliantMeshIntersectionBenchmark/SoftSoftMesh/1/2/min_time:0.020/min_warmup_time:0.010       96.9 us         96.9 us      1.0k          292  // NOLINT(*)
CompliantMeshIntersectionBenchmark/SoftSoftMesh/1/3/min_time:0.020/min_warmup_time:0.010       2500 us         2500 us     11.2k           11  // NOLINT(*)
CompliantMeshIntersectionBenchmark/SoftSoftMesh/2/0/min_time:0.020/min_warmup_time:0.010      0.117 us        0.117 us      1.2k       233711  // NOLINT(*)
CompliantMeshIntersectionBenchmark/SoftSoftMesh/2/1/min_time:0.020/min_warmup_time:0.010       11.9 us         11.9 us      1.2k         2356  // NOLINT(*)
CompliantMeshIntersectionBenchmark/SoftSoftMesh/2/2/min_time:0.020/min_warmup_time:0.010        198 us          198 us      1.9k          135  // NOLINT(*)
CompliantMeshIntersectionBenchmark/SoftSoftMesh/2/3/min_time:0.020/min_warmup_time:0.010       7181 us         7181 us     36.1k            4  // NOLINT(*)
CompliantMeshIntersectionBenchmark/SoftSoftMesh/3/0/min_time:0.020/min_warmup_time:0.010      0.117 us        0.117 us     10.1k       242614  // NOLINT(*)
CompliantMeshIntersectionBenchmark/SoftSoftMesh/3/1/min_time:0.020/min_warmup_time:0.010       27.8 us         27.8 us     10.2k         1016  // NOLINT(*)
CompliantMeshIntersectionBenchmark/SoftSoftMesh/3/2/min_time:0.020/min_warmup_time:0.010        841 us          841 us     12.7k           34  // NOLINT(*)
CompliantMeshIntersectionBenchmark/SoftSoftMesh/3/3/min_time:0.020/min_warmup_time:0.010      59971 us        59969 us    433.0k            1  // NOLINT(*)
CompliantMeshIntersectionBenchmark/SoftSoftMesh/4/0/min_time:0.020/min_warmup_time:0.010      0.120 us        0.120 us     83.4k       226392  // NOLINT(*)
CompliantMeshIntersectionBenchmark/SoftSoftMesh/4/1/min_time:0.020/min_warmup_time:0.010       19.8 us         19.8 us     83.4k         1311  // NOLINT(*)
CompliantMeshIntersectionBenchmark/SoftSoftMesh/4/2/min_time:0.020/min_warmup_time:0.010       3736 us         3735 us    203.2k            7  // NOLINT(*)
CompliantMeshIntersectionBenchmark/SoftSoftMesh/4/3/min_time:0.020/min_warmup_time:0.010     483407 us       483390 us      3.5M            1  // NOLINT(*)
 ...
 ```
 CompliantMeshIntersectionBenchmark/SoftSoftMesh/resolution/contact_overlap/min_time/min_warmup_time  // NOLINT(*)
 ```

   - __resolution__: Affects the resolution of the ellipsoid and sphere
     meshes. Valid values must be one of [0, 1, 2, 3, 4], where 0 produces the
     coarsest meshes and 4 produces the finest meshes. This is converted behind
...
const double kResolutionHint[5] = {4., 3., 2., 1., 0.5};
...
(benchmark::State& state) {
  ...
  for (auto _ : state) {
    surface_SR = DispatchCompliantCompliantCalculation(
        geo0, RigidTransformd::Identity(), id0, geo1, X_SR_, id1,
        HydroelasticContactRepresentation::kPolygon);
  }
}
// clang-format off
BENCHMARK_REGISTER_F(CompliantMeshIntersectionBenchmark, SoftSoftMesh)
