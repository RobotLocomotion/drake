...
// These benchmarks help measure the impact of apply proximity defaults during
// scene graph context creation. Applying those settings can trigger expensive
// operations in proximity engine. These benchmarks can help demonstrate that
// caching within SceneGraph can avoid repeating expensive operations when they
// are not necessary: in creating multiple contexts when the configuration has
// not changed.
