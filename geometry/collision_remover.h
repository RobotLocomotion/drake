...
/// `Context<double>` of that plant to remove collisions.  This is intended
/// for heuristically projecting randomly generated states to similar but
/// collision-free neighbors.
///
