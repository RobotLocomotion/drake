...
/* Computes the contact surface between two deformable geometries and appends
 ...
 @param[in, out] deformable_contact
     The deformable contact data tp be appended to.
 ...
 @note Internally it uses deformable0_mesh_W.bvh() and
       deformable1_mesh_W.bvh(), so we could consider passing Bvh instead of
       DeformableVolumeMesh. */
