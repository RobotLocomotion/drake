...
/* Generates tetrahedral elements of a long cylinder conforming to its medial
 ...
 @param[in] bottom         Indices into mesh_vertices of the points on the
                           bottom circular rim of the cylinder in the
                           counterclockwise order around +Z axis of rotation
                           of the cylinder.
 @param[in] top_center     Index into mesh_vertices of the center of the top
                           circular rim of the cylinder.
 @param[in] top            Indices into mesh_vertices of the points on the
                           top circular rim of the cylinder in the same order
                           as `bottom`.
 @param[in,out] mesh_vertices  As input, it contain vertices on the surface of
                               ...
                               output.
 @return  The generated tetrahedral elements.
*/
template <typename T>
...
std::vector<VolumeElement> CalcShortCylinderVolumeMeshWithMa(
  ...
  // is also the center of the medial circular disk.
...
VolumeMesh<T> MakeCylinderVolumeMeshWithMa(const Cylinder& cylinder,
  ...
  // bottom and the top circular caps of the cylinder.
