...
ComputeContactSurfaceFromSoftHalfSpaceRigidMesh(
    const GeometryId id_S, const math::RigidTransform<T>& X_WS,
    double pressure_scale, const GeometryId id_R,
...
ComputeContactSurfaceFromSoftHalfSpaceRigidMesh(
    const GeometryId id_S, const math::RigidTransform<double>& X_WS,
    double pressure_scale, const GeometryId id_R,
    const SurfaceMesh<double>& field_R,
    const BoundingVolumeHierarchy<SurfaceMesh<double>>& bvh_R,
    const math::RigidTransform<double>& X_WR);

template<> std::unique_ptr<ContactSurface<AutoDiffXd>>
ComputeContactSurfaceFromSoftHalfSpaceRigidMesh(
    const GeometryId, const math::RigidTransform<AutoDiffXd>&, double,
