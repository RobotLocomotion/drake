...
/* Creates a pressure field on a tetrahedral mesh of a generally non-convex
 shape. This function complements MakeConvexPressureField().

 @param[in] mesh_M   A pointer to a tetrahedral mesh of a non-convex shape.
