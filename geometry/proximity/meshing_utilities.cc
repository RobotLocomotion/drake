...
double CalcEnclosedVolume(const TriangleSurfaceMesh<double>& surface_mesh) {
  ...
  // = (0,0,0) in the mesh's frame. The choice of o is arbitrary and need not
  // be on the interior of surface_mesh. For efficiency we compute 6*Vi for the
  // signed volume Vi of the ith element and 6*V for the signed volume V of the
  // region.
