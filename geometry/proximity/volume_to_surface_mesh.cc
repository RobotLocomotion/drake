...
TriangleSurfaceMesh<T> ConvertVolumeToSurfaceMeshWithBoundaryVertices(
  ...
  auto mesh = ConvertVolumeToSurfaceMeshWithBoundaryVertices(
...
template TriangleSurfaceMesh<double>
ConvertVolumeToSurfaceMeshWithBoundaryVertices(const VolumeMesh<double>&,
                                               std::vector<int>*,
                                               std::vector<TetFace>*);
template TriangleSurfaceMesh<AutoDiffXd>
ConvertVolumeToSurfaceMeshWithBoundaryVertices(const VolumeMesh<AutoDiffXd>&,
                                               std::vector<int>*,
                                               std::vector<TetFace>*);
template TriangleSurfaceMesh<double>
ConvertVolumeToSurfaceMeshWithBoundaryVertices(const VolumeMesh<double>&,
