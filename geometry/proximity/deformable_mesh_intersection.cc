...
class DeformableSurfaceVolumeIntersector : public
 ...
 public:
  /* See SurfaceVolumeIntersector::SampleVolumeFieldOnSurface().
   Assume the deformable mesh is expressed in World frame, and
   the rigid surface is expressed in frame R. */
