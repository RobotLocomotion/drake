...
struct CallbackData {
  /* Constructs the fully-specified callback data. The values are as described
   ...
   @param polygon_representation  Controls the mesh representation of
  ...
  CallbackData(
      ...
      HydroelasticContactRepresentation polygon_representation_in,
  ...
  const HydroelasticContactRepresentation polygon_representation;
