...
class SurfaceVolumeIntersector {
 ...
 private:
  ...
  /* Determines whether a triangle of a rigid surface N and a tetrahedron of a
   compliant volume M are suitable for building contact surface based on the face
...
/* Computes the contact surface between a compliant geometry S and a rigid
 ...
 @param[in] field_S
     A scalar field defined on the compliant volume mesh S. Mesh S's vertices are
