...
class VolumeMeshRefiner {
 ...
 private:
  ...
  //
  // This function preserves tetrahedron orientation. The signs of the signed
  // volumes of the new tetrahedra is the same as the sign of the signed
  // volume of the old tetrahedron.
  //
  ...
  //
  // @param v0,v1,v2   Three vertex indices of the triangle.
  ...
  // such tetrahedra, return an empty list.
  //
  // @param v0,v1   Two vertex indices of the edge.
