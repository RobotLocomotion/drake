...
/*
 Computes the intersecting polygon (a.k.a. contact polygon) of two tetrahedra
 from meshes of two piecewise-linear pressure fields on their equilibrium plane
 (plane of equal pressure).

 @param[in] element0  The index of the first tetrahedron in the mesh of the
                      first pressure field.
 @param[in] field0_M  The first pressure field on a tetrahedral mesh expressed
                      in frame M.
 @param[in] field1_N  The second pressure field on a tetrahedral mesh
                      expressed in frame N.
 @param[in] X_MN      Pose of frame N in frame M.
 @param[in] equilibrium_plane_M  The equilibrium plane between the two
                      linear fields on the two tetrahedra, expressed in frame M.

 @retval `polygon_M`  A sequence of vertex positions of the intersecting
                      polygon expressed in frame M. Its unit normal vector
                      pointing out of element1 and into element0, i.e., the
                      direction of increasing field0 value and decreasing
                      field1 value.
...
/* Creates the mesh and the pressure field of the contact surface between two
 tetrahedral meshes with pressure fields.
 ...
 @param[in] builder   The builder of the output mesh.
