...
int ContactSurfaceCalculator<T>::IntersectTetWithLevelSet(
  ...
  // If a vertex is binary, we assign a "1", otherwise "0". We then from the
  ...
  // triangle is formed. The right handed normal points in the direction of
  // the positive side.
  ...
  // normals point towards the positive side.
