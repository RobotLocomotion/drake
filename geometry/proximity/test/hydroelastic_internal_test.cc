...
GTEST_TEST(SoftMeshTest, TestCopyMoveAssignConstruct) {
  ...
  // ownership and the source of the move has lost it.
  {
...
// SoftGeometry can represent either a half space or a mesh. For copy/move
// constructor, the test only constructs a SoftGeometry representing a mesh as
// a representative case. For copy/move assignment operator, the test starts
// with a SoftGeometry representing a half space and assign over it a
// SoftGeometry representing a mesh as a representative case.
...
// RigidGeometry can represent either a half space or a mesh. For copy/move
// constructors, the test only constructs a RigidGeometry representing a mesh
// as a representative case. For copy/move assignment operator, the test
// starts with a RigidGeometry representing a half space and assign over it a
// RigidGeometry representing a mesh as a representative case.
