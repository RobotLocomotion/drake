...
TEST_F(HydroelasticSoftGeometryTest, Sphere) {
  ...
  {
    // Defining kDenseInteriorVertices produces a mesh with dense number tets.
...
TEST_F(HydroelasticSoftGeometryTest, Ellipsoid) {
  ...
  {
    // Defining explicitly specifying the two strategies produces meshes with
    // different numbers of tets.
