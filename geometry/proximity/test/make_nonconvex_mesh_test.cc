...
GTEST_TEST(MakeNonConvexVolumeMeshTest, ScalingWithDouble) {
...
GTEST_TEST(MakeNonConvexVolumeMeshTest, NonConvexMesh) {
...
GTEST_TEST(MakeNonConvexVolumeMeshTest, NegativeVolumeThrow) {
  ...
  DRAKE_EXPECT_THROWS_MESSAGE(
      ...
      "MakeNonConvexVolumeMeshFromVtk: .* tetrahedron.*"
