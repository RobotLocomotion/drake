...
TYPED_TEST_SUITE(HydroelasticRejectResultTyped, ScalarTypes);

// Test infrastructure for the RejectResult() method for arbitrary scalar
// type. This method has the following responsibilities:
...
TYPED_TEST(HydroelasticRejectResultTyped,
...
TYPED_TEST(HydroelasticRejectResultTyped, ThrowForRigidRigid) {
  using T = TypeParam;
...
// exception is thrown.
TYPED_TEST(HydroelasticRejectResultTyped, ThrowForTwoHalfSpaces) {
  using T = TypeParam;
