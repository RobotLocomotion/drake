...
class SliceTetWithPlaneTest : public ::testing::Test {
  ...
  */
  ...
  unordered_map<SortedPair<int>, SurfaceVertexIndex> cut_edges_;
};
...
TEST_F(SliceTetWithPlaneTest, DuplicateOutputFromDuplicateInput) {
  ...
  unordered_map<SortedPair<int>, SurfaceVertexIndex> min_cut_edges;
  ...
  unordered_map<SortedPair<int>, SurfaceVertexIndex> dupe_cut_edges;
...
TEST_F(SliceTetWithPlaneTest, NoDoubleCounting) {
  ...
  for (const auto representation :
    ...
    unordered_map<SortedPair<int>, SurfaceVertexIndex> cut_edges;
    VolumeElementIndex tet_index{0};
