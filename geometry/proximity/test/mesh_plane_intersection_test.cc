...
/* Test of ComputeContactSurfaceFromCompliantVolumeRigidHalfSpace(). This function
...
GTEST_TEST(MeshPlaneIntersectionTest, CompliantVolumeRigidHalfSpace) {
...

  {
    ...
    // indicators.
    auto contact_surface = ComputeContactSurfaceFromCompliantVolumeRigidHalfSpace(
