...
class SliceTetWithPlaneTest : public ::testing::Test {
  ...
  */
  ::testing::AssertionResult CallSliceTetWithPlane(
    ...
    PlaneVolumeIntersector intersector;
    intersector.SliceTetWithPlane(tet_index, field_F, plane_F, X_WF_, &faces_,
                                  &vertices_W_, &surface_pressure_,
                                  &cut_edges_);
...
TEST_F(SliceTetWithPlaneTest, DuplicateOutputFromDuplicateInput) {
  ...
  for (VolumeElementIndex i{0}; i < 2; ++i) {
    intersector.SliceTetWithPlane(i, min_field_F, plane_F, X_WF_, &min_faces,
                                  &min_vertices_F, &min_surface_pressure,
                                  &min_cut_edges);
    intersector.SliceTetWithPlane(i, dupe_field_F, plane_F, X_WF_, &dupe_faces,
...
TEST_F(SliceTetWithPlaneTest, NoDoubleCounting) {
...

  {
    ...
    VolumeElementIndex tet_index{0};
    intersector.SliceTetWithPlane(tet_index, field_M, plane_M, I, &faces,
