...
class SliceTetWithPlaneTest
 ...
 protected:
  ...
  /* Invokes SliceTetrahedronWithPlane() on a trivial mesh in frame F. This
   ...
   heavyweight SliceTetWithPlane() method. The mesh and field
   created by building the mesh after this single slicing operation are
   returned. The mesh *may* be empty.
...
TEST_P(SliceTetWithPlaneTest, NonIntersectingConfiguration) {
...
/* This tests the cases where the plane intersects with the tet, creating a
 ...
 set of polygons. */
TEST_P(SliceTetWithPlaneTest, TriangleIntersections) {
...
/* Similar for the TriangleIntersections test, but for intersections that form
 quads. */
TEST_P(SliceTetWithPlaneTest, QuadIntersections) {
...
INSTANTIATE_TEST_SUITE_P(
    SliceFunctionCases, SliceTetWithPlaneTest,
