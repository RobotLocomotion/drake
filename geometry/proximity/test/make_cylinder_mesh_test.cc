...
// point outside the cylinder to this functor might gets the wrong value of
...
struct DistanceToCylinderBoundaryFromPointInside {
  DistanceToCylinderBoundaryFromPointInside(const Cylinder& cylinder_in)
      : cylinder(cylinder_in) {}

  double operator()(const Vector3d& point_in_cylinder) {
