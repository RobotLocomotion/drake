...
// cylinder's face to which all four vertices are _closest_. Here a vertex is
// _closest_ to a cylinder's face when there is no other closer face. Notice
// that a vertex may have multiple closest faces, i.e., it is on the medial
// axis.
//
...
bool IsTetrahedronRespectingMa(const VolumeElement& tetrahedron,
  ...
  // Face 2 is the cylindrical surface.
