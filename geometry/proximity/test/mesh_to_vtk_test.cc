...
GTEST_TEST(MeshToVtkTest, BoxTetrahedra) {
  ...
  WriteVolumeMeshToVtk("box_tet.vtk", mesh, "Tetrahedral Mesh of Box");
}
...
GTEST_TEST(MeshToVtkTest, BoxTriangles) {
  ...
  WriteSurfaceMeshToVtk("box_tri.vtk", mesh, "Triangular Mesh of Box");
}
...
GTEST_TEST(MeshToVtkTest, BoxTetrahedraPressureField) {
  ...
  WriteVolumeMeshFieldLinearToVtk("box_tet_pressure.vtk", pressure,
...
GTEST_TEST(MeshToVtkTest, BoxContactSurfacePressure) {
  ...
  WriteSurfaceMeshFieldLinearToVtk("box_rigid_soft_contact_pressure.vtk",
                                   *contact_pressure,
