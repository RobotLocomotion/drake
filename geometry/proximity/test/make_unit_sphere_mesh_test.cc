...
GTEST_TEST(MakeSphereMesh, SplitOctohedron) {
  ...
  // 1, 2, and 3. The axis under test is scaled by 1, the "next" axis by 2, and
  // the third axis by 3. SplitOctohedron() will favor splitting along the
  // shortest axis. In the tests above, it's clear that EJ is aligned with the
