 ...
 protected:
  ...
  void TestPositionDerivative(
    ...
    /* Definition of a test configuration: a name, a relative pose between soft
     ...
     frame origins and relative orientation, the expected number of faces in the
     resultant contact surface, and the pose enumeration that the
     `evaluate_quantity` method will use to predict the expected results. */
   ...
   - For vertices at the intersection of plane and tri edge, the derivative of
     ...
     that:
          ...
          ∂V/∂Ro = | 0  1  -ê.y / ê.z |
                   ...
                   | 1  0  -e.x / e.z |   // We don't actually required ê, e
