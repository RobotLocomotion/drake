...
class MeshIntersectionFixture : public testing::Test {
 protected:
  ...
  void VerifySampleVolumeFieldOnSurface(
      const MeshType& surface_S, const FieldType<MeshType>& e_field,
  ...
  void VerifyComputeContactSurfaceFromSoftRigid(
    ...
    const FieldType<MeshType>* field_SR_raw{};
    const MeshType* mesh_RS_raw{};
    const FieldType<MeshType>* field_RS_raw{};
    ...
    const FieldType<MeshType>& field_SR_W = *field_SR_raw;
    const MeshType& mesh_RS_W = *mesh_RS_raw;
    const FieldType<MeshType>& field_RS_W = *field_RS_raw;
...
// contact surface's mesh and then confirms that the we've sampled the compliant
...
/* This test fixture enables some limited testing of the autodiff-valued contact
 ...
 TriangleSurfaceMesh and PolygonalMesh is inconsequential to this test. */
