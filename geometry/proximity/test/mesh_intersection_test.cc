...
/* @file Tests the the main function
 ComputeContactSurfaceFromCompliantVolumeRigidSurface and it's supporting code. The
...
// ComputeContactSurfaceFromCompliantVolumeRigidSurface(). The latter is the main API
...
class MeshIntersectionFixture : public testing::Test {
 protected:
  ...
  void VerifyComputeContactSurfaceFromCompliantRigid(
    ...
    // The gradients for the pressure field of the compliant mesh are expressed in
...
// Tests the generation of the ContactSurface between a compliant volume and rigid
