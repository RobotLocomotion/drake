...
// TODO(SeanCurtis-TRI): Unit test Halfspace.
...
GTEST_TEST(MeshIntersectionTest, ClipTriangleByTetrahedron) {
  ...
  //  respecitvely) as being far more literal. It's not like each of those
  ...
  // The triangle trivially intersects tetrahedron `element0` and is clipped.
  {
