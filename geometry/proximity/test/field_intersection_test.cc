...
TEST_F(FieldIntersectionVizTest, FieldIntersection_BoxBall) {
  ...
  std::unique_ptr<ContactSurface<double>> contact_patch_W =
      ComputeContactSurfaceFromCompliantVolumes(
          GeometryId(), box_field0_M_, box_bvh0_M_, X_WM,
          GeometryId(), ball_field1_N_, ball_bvh1_N_, X_WN,
          ContactPolygonRepresentation::kCentroidSubdivision);
...
TEST_F(FieldIntersectionVizTest, FieldIntersection_BoxBox) {
  ...
  std::unique_ptr<ContactSurface<double>> contact_patch_W =
      ComputeContactSurfaceFromCompliantVolumes(
          GeometryId(), box_field0_M_, box_bvh0_M_, X_WM,
          GeometryId(), box2_field2_M, box2_bvh2_M, X_WM,
          ContactPolygonRepresentation::kCentroidSubdivision);
...
TEST_F(FieldIntersectionVizTest, FieldIntersection_BoxCylinder) {
  ...
  std::unique_ptr<ContactSurface<double>> contact_patch_W =
      ComputeContactSurfaceFromCompliantVolumes(
          GeometryId(), box_field0_M_, box_bvh0_M_, X_WM,
          GeometryId(), cylinder_field3_C_, cylinder_bvh3_C_, X_WC,
          ContactPolygonRepresentation::kCentroidSubdivision);
