...
// with a candidate pair that calculates a part of the contact surface. Thus,
// only if the surfaces do not intersect AND all leaf nodes of the BVHs are
// disjoint, then no contact surface will be reported. This test quantifies that
// difference.
