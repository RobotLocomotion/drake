...
/* Creates a transform to align two planes. The planes are defined by a point
 P on the plane and the normal n of the plane. In this case, we have planes
 (P, m⃗) and (Q, n⃗). We produce a transform X = [R t] such that:
   X ⋅ Q = P
   R ⋅ n⃗ = -m⃗
