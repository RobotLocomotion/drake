...
GTEST_TEST(AABBTest, TestObbOverlap) {
  ...
  // along the +x and +z axis (as suggested in the above illustration). Point
  // Bq will be a small epsilon away from the nearby edge either outside (if
  // expect_overlap is false) or inside (if true).
