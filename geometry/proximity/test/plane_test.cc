...
GTEST_TEST(PlaneTest, Construction) {
...

  {
    ...
    const Planed plane_F{0.5 * nhat_F, p_FP, false /* needs_normalization */};
...
GTEST_TEST(PlnaeTest, CalcHeight) {
...

  {
    ...
    // think it is normalized, it is documented that the height values will be
    // scaled; confirm that.
    const double scale = 0.5;
    Planed plane_F{scale * nhat_F, p_FB, false /* needs_normalization */};
    for (int i = 0; i < 2; ++i) {
