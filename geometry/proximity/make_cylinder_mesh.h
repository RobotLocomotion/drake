...
/* Generates a tetrahedral volume mesh approximating a given cylinder by medial
 ...
 cylinder accurately and economically. The same thing is true for the kind of
 hydroelastic pressure field that is a constant scaling of φ, which is what
 we use for hydroelastics at the moment. However, this mesh may not be
 suitable for other kinds of pressure fields, e.g., a squared distance field.
