...
/* Generates a tetrahedral volume mesh of a given cylinder by medial axis (MA)
 subdivision. The cylinder is subdivided into blocks using its MA, and then
 the blocks are subdivided into tetrahedra. Using this mesh with
 MeshFieldLinear, we can represent the distance-to-boundary function φ of the
 cylinder accurately and economically. The same thing is true for a hydroelastic
 pressure field that is a constant scaling of φ.
 ...
 The following three pictures show examples of a mesh of a long cylinder,
 a mesh of a medium cylinder, and a mesh of a short cylinder.
 @image html geometry/proximity/images/LongCylinderWithMaPressureField.png "A cut-away tetrahedral mesh of a long cylinder with medial axis." width=5cm // NOLINT(*)
 @image html geometry/proximity/images/MediumCylinderWithMaPressureField.png "A cut-away tetrahedral mesh of a medium cylinder with medial axis." width=5cm // NOLINT(*)
 @image html geometry/proximity/images/ShortCylinderWithMaPressureField.png "A cut-away tetrahedral mesh of a short cylinder with medial axis." width=5cm  // NOLINT(*)
