...
/* Generates a tetrahedral volume mesh of a given cylinder by medial axis (MA)
 ...
 The following three pictures show X-Z cross sections of three kinds of
 ...
 1. The long cylinder has cylinder.length()/2 > cylinder.radius(). Its MA
    ...
    circular caps of the cylinder. The two cones have their apices at the two
 ...
 The output mesh will have these properties:
   ...
   3. Let n be ⌈2πr/h⌉, where r = cylinder.radius(), and h is `resolution_hint`,
      ...
      3.1 The mesh of a long cylinder has 5n tetrahedra.
      3.2 The mesh of a medium cylinder has 4n tetrahedra.
      3.3 The mesh of a short cylinder has 9n tetrahedra.
