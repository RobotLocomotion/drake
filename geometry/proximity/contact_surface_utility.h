...
/* @name "MeshBuilder" implementations
 ...
 Please note the frame expectations on the various function parameters. In the
 classes' documentation, we refer to the builder's frame as B. Some of the APIs
 require the fields or meshes that are colliding, and their frames will be named
 in the scope of those functions. */
//@{
