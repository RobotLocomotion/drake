...
/* Determines if the indicated triangle has a face normal that is "in the
 direction" of the given normal. The definition of "in the direction" is within
 a hard-coded tolerance (see documentation of IsFaceNormalAlongPressureGradient
 in mesh_intersection.h for details on the tolerance value).
