...
// TODO(DamrongGuoy): Remove the following overload of CalcPolygonCentroid()
//  when it's not needed anymore. This function supports a short-term solution
//  for ComputePolygonalContactSurface() using representative triangles instead
//  of polygons.
...
// TODO(DamrongGuoy): Remove the following CalcPolygonArea() when it's not
//  needed anymore. This function supports a short-term solution for
//  ComputePolygonalContactSurface() using representative triangles instead
//  of polygons.
...
/* Calculates area of a planar convex polygon represented as an ordered list
 ...
 in frame F.
 @pre `p_FVs.size()` >= 3.
 @pre the polygon is convex. It has no holes.
 */
template <typename T>
