...
void CalcDistanceFallback<double>(const fcl::CollisionObjectd& a,
  ...
  // out of A and into B.
  pair_data->p_WCa = contact.pos - 0.5 * pair_data->depth * drake_normal;
  pair_data->p_WCb = contact.pos + 0.5 * pair_data->depth * drake_normal;
