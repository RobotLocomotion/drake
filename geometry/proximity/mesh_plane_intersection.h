...
/* Class for generating a ContactSurface from a plane and volume mesh's
 intersection.  */
class PlaneVolumeIntersector {
 public:
  ...
  static constexpr std::array<std::pair<int, int>, 6> kTetEdges = {
  ...
  static const std::array<std::vector<int>, 16> kMarchingTetsTable;
};

const std::array<std::vector<int>, 16>
    PlaneVolumeIntersector::kMarchingTetsTable = {
        /* bits    3210 */
        {{},           /* 0000 */
         {0, 3, 2},    /* 0001 */
         {0, 1, 4},    /* 0010 */
