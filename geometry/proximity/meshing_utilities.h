...
/* Subdivides a virtual cube to have up to six tetrahedra such that they
 ...
 this ordering:
   1. Four vertices v0,v1,v2,v3 of the "bottom" face are in counterclockwise
      order when look from "above" the cube.
   2. Four vertices v4,v5,v6,v7 of the "top" face match v0,v1,v2,v3,
      respectively.
...
/* Subdivides a triangular prism into three tetrahedra such that they share the
 diagonal v0v5 (see ordering below).
...
/* Subdivide a pyramid into two tetrahedra sharing the diagonal v0v2.
