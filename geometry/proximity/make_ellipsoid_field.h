...
/**
 ...
 as E * e(x) where e e ∈ [0,1] is the extent -- a measure of penetration into
 ...
 @tparam T               The Eigen-compatible scalar for representing the mesh
...
VolumeMeshFieldLinear<T, T> MakeEllipsoidPressureField(
  ...
  //  unit sphere and assign extent on the ellipsoid from the extent on the
