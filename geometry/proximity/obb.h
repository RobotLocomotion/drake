...
class ObbMaker {
 ...
 private:
  /* Calculates an orientation of the bounding box of the specified set of
   ...
   component. Intuitively, Bx_M is along the best fit line, By_M is along
   the best fit line among all lines orthogonal to Bx_M, and Bz_M is
   orthogonal to both Bx_M and By_M (Bz_M = Bx_M × By_M). Here, the fitting is
   measured in terms of squared distance.
