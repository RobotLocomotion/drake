...
///@{
/**
 * @throws std::logic_error if `elastic_modulus` is not positive,
 *         `dissipation` is negative, `point_stiffness` is not positive, or any
 *         of the contact material properties have already been defined in
 *         `properties`.
 */
