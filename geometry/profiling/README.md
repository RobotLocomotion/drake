...
## contact_surface_rigid_bowl_compliant_ball.cc:
...
```
bazel-bin/geometry/profiling/contact_surface_rigid_bowl_compliant_ball --polygons=false
```
...
```
bazel-bin/geometry/profiling/contact_surface_rigid_bowl_compliant_ball
```
- default rigid bowl with a compliant box option,
```
bazel-bin/geometry/profiling/contact_surface_rigid_bowl_compliant_ball --compliant=box
```
- rigid box option and default compliant ball,
```
bazel-bin/geometry/profiling/contact_surface_rigid_bowl_compliant_ball --rigid=box
```
