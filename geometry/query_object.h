...
/** The %QueryObject serves as a mechanism to perform geometry queries on the
 ...
 types involved, and the scalar type. Therefore, the results will vary widely
 spanning range including: no support at all, limited scalar support, results
 with limited precision, or full, accurate support. The queries below provide
 tables to help inform your expectations when evaluating queries. The tables all
 use a common methodology and admit a common interpretation.
...
class QueryObject {
 public:
  ...
  /** Computes the penetrations across all pairs of geometries in the world
   ...
   | HalfSpace |  3e-15  |   4e-15  | 3e-15ᶜ  |   4e-15   |   2e-15    |   throwsᵃ  |  ░░░░░  |  ░░░░░  |
   | Mesh      |    ᵇ    |    ᵇ     |    ᵇ    |     ᵇ     |      ᵇ     |     ᵇ      |    ᵇ    |  ░░░░░  |
   | Sphere    |  2e-15  |  3e-15   |  3e-5ᶜ  |   2e-15   |    2e-4ᶜ   |   2e-15    |    ᵇ    |  3e-15  |
   ...
   | Mesh      |    ᵇ    |    ᵇ     |    ᵇ    |     ᵇ     |      ᵇ     |     ᵇ      |    ᵇ    |  ░░░░░  |
   | Sphere    |  2e-15  |  3e-15   | throwsᵈ |   2e-15   |   throwsᵈ  |   2e-15    |    ᵇ    |  3e-15  |
