...
class QueryObject {
 public:
  ...
  DRAKE_DEPRECATED("2021-02-01", "Please use GetPoseInWorld(FrameId) instead.")
  ...
  DRAKE_DEPRECATED("2021-02-01", "Please use GetPoseInParent(FrameId) instead.")
