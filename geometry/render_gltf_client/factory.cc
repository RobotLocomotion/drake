...
// RenderEngineGl is available conditionally, based on DRAKE_ALLOW_NETWORK.
const bool kHasRenderEngineGltfClient = drake::internal::IsNetworkingAllowed("render_gltf_client");
