...
class Meshcat::WebSocketPublisher {
 public:
  ...
  void Flush() const {
    ...
    // Set a very conservative iteration limit; since we sleep for 1 second on
    // each iteration, this corresponds to (approximately) 10 minutes.
    const int kIterationLimit{600};
    int iteration = 0;
