...
class Meshcat::Impl {
 public:
  ...
  void LoadStaticAssets() {
    ...
    auto meshcat_js = internal::GetMeshcatStaticResource("/meshcat.js");
    auto stats_js = internal::GetMeshcatStaticResource("/stats.min.js");
    ...
    auto meshcat_html = internal::GetMeshcatStaticResource("/meshcat.html");
