...
class Meshcat::Impl {
 public:
  ...
  // implementation allows for an override so that PoseCamera() can orient
  ...
  // This function is public via the PIMPL.
  void PoseCamera(const Eigen::Vector3d& p_WC, const Eigen::Vector3d& p_WT) {
...
void Meshcat::PoseCamera(const Eigen::Vector3d& camera_in_world,
                         const Eigen::Vector3d& target_in_world) {
  impl().PoseCamera(camera_in_world, target_in_world);
}
