...
To view or run them from the Drake `nightly-release` branch on GitHub:
...
GitHub's interface lets your render notebooks,
...
`https://nbviewer.jupyter.org/github/{user}/drake/blob/nightly-release/tutorials/`
