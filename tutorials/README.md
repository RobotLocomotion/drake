...
[installation methods](https://drake.mit.edu/installation.html) methods
(e.g., [pip install drake](https://drake.mit.edu/pip.html)), be sure your
`PYTHONPATH` has been set per the installation instructions, and then run
`python3 -m pydrake.tutorials` to launch a Jupyter browser.
...
- To rebuild from source and run tutorials using Bazel, use:
```
