...
[![Deepnote](https://deepnote.com/buttons/launch-in-deepnote-white-small.svg)](https://deepnote.com/project/Tutorials-K0_FCa7yQX2kDWBx3-2RmQ)
...
For now, users must manually add and run `!pip install drake` in the top cell
the notebook in order to install Drake and run the tutorial.
<!-- TODO(russt): Add a commented out `#!pip install drake # uncomment this to install drake (required for google colab)` cell at the top of each notebook -->
...
When you add a notebook, please make the first cell be a Markdown cell with the
tutorial's title and the following preamble:
...
Use this [maintainers
  notebook](https://deepnote.com/project/Tutorials-K0_FCa7yQX2kDWBx3-2RmQ/%2F.for_maintainers.ipynb)
  to update Deepnote once the PR has landed and the nightly binaries support
  it.  Drake developers should request access through the deepnote interface if
  they do not have it.
