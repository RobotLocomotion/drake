...
* TBD simulator: Add test to track heap hygiene ([#14900][_#14900])  # Relevant to: #14543, #14802 This is the beginning of a PR train to make heapless simulation possible, with careful system construction.  All the good ideas are inspired by @edrumwri's PR #14707; all the sketchy ones are mine.
New features
...
* TBD doc: Refactor pydrake sphinx builds to use common code ([#14887][_#14887])  # Tweak defs.py to be silent about files not found, because pydrake's sphinx_rtd_theme has broken references to woff2 fonts. Tweak defs.py to use threads for serving, because the 404 from woff2 otherwise gums up the pipeline.
...
[_#14887]: https://github.com/RobotLocomotion/drake/pull/14887
[_#14888]: https://github.com/RobotLocomotion/drake/pull/14888
[_#14890]: https://github.com/RobotLocomotion/drake/pull/14890
[_#14900]: https://github.com/RobotLocomotion/drake/pull/14900
<!-- <end issue links> -->

<!--
  Current oldest_commit 306baa8e0fd2a600c7d07c99f85ca1b940877603 (exclusive).
  Current newest_commit a005c4081e1830078525177e51be9d7812db57dd (inclusive).
-->
