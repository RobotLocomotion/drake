...
* TBD Removes unused prototype hydroelastic code ([#14903][_#14903])  # Early in hydroelastics implementations, MBP introduced this code as a stop gap to support hydroelastic-based dynamics. This code has long been supplanted by more complete support in geometry.
New features
...
* New hydroelastic contact model in progress ([#14897][_#14897])
...
* TBD limit_malloc: Avoid ASAN heap hazard ([#14905][_#14905])  # * limit_malloc: Avoid ASan heap hazard Closes #14901. ASan instrumentation hooks more heap-returning API than just the basic set. strdup() is one; there may be others. The returned heap blocks come from a private heap and can't be returned by libc's free(). Avoid the potential crashes by removing hooks completely when ASan is detected at compile time.
None
...
* TBD Split out ability to download and extract a wheel from PyPI ([#14906][_#14906])
* TBD Move semantic-version to source distribution requirements ([#14907][_#14907])
* TBD drake_visualizer: Silence deprecation warning ([#14908][_#14908])  # Hotfix for ec769b1ce5611d7e992a911cfb7857963a2fa69e.
...
[_#14905]: https://github.com/RobotLocomotion/drake/pull/14905
...
<!--
  ...
  Current newest_commit 661f257f3e63b3e1e58843dacc4e519a81c7c9d4 (inclusive).
-->
