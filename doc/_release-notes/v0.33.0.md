...
* Add sugar for declaring vector ports by size ([_#15538])
...
* TBD [geometry/optimization] MinkowskiSum isa ConvexSet ([#15543][_#15543])  # Adds the concept of a Minkowski sum of convex sets, which enables geoemtry optimization support for the Capsule geometry in SceneGraph.
New features
...
<!--
  ...
  Current newest_commit 4d6a8a63235c9a4a30c6486f48714240e615bb29 (inclusive).
-->
