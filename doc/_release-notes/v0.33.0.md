...
* TBD SnoptSolver respects CommonSolverOption::kPrintFileName ([#15493][_#15493])  # Relates to issue #12867
New features
...
* TBD parsing: Use libsdformat's Interface API to parse URDF files ([#15140][_#15140])
New features
...
* TBD [common,systems] common: provides ExtractDoubleOrThrow for Eigen::MatrixBase ([#15518][_#15518])
...
* TBD wrap_function: Preserve return type for mutable and const class methods ([#15507][_#15507])
...
<!--
  ...
  Current newest_commit 905c2d7f0d59827fbcba450a5a21f74e969b0a59 (inclusive).
-->
