...
* TBD  TriggerTypeSet in systems:: and systems::lcm::. The systems::lcm:: definition is deprecated (likely with no downstream impact), and aliased to the identical systems:: definition. The surviving definition is moved to event.h to prepare for a possible future refactoring of redundant code using TriggerTypeSet. ([#15581][_#15581])
