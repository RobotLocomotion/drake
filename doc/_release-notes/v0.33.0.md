...
* TBD [framework] Tidy up ValueProducer loose ends ([#15557][_#15557])  # These fix some code review questions that were noted during the PR train.
* TBD [systems/lcm] Narrow the subscriber output port dependencies ([#15563][_#15563])  # This is likely to reduce unnecessary downstream re-calculations, e.g., when only the context time changes.
New features
...
* TBD MosekSolver accepts option write to write the model file ([#15568][_#15568])
New features
...
[_#15557]: https://github.com/RobotLocomotion/drake/pull/15557
...
<!--
  ...
  Current newest_commit dbb6f4edfefee96e20358a12055dd478820e5fe9 (inclusive).
-->
