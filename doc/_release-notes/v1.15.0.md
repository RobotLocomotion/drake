...
* [fix] TBD [pydrake] Bind CameraConfig.MakeCameras ([#19184][_#19184])
* [feature] TBD Provide automatic sanitization of field names in `namedview` ([#19196][_#19196])  # Related to #19164 -- MbP uses names which are not immediately useable as `namedview` fields. After this PR (and now that #19174 has landed), we can do e.g. ``` PositionView = namedview("PositionView", plant.GetPositionNames()) StateView = namedview("StateView", plant.GetStateNames()) ``` and all of the MbP introspection variants. Co-Authored-By: Jeremy Nimmer <jeremy.nimmer@tri.global>
...
* [fix] TBD [workspace,doc] [workspace] Upgrade buildifier to latest release 6.1.0 ([#19189][_#19189])
* [fix] TBD Fix documentation in new_release.py ([#19185][_#19185])  # Update the documentation in new_release.py to use `bazel run`. This was done previously for the workspace/README.md, but the documentation in the script itself got missed.
* [fix] TBD [workspace] Upgrade abseil_cpp_internal to latest commit ([#19185][_#19185])
* [fix] TBD [workspace] Upgrade curl_internal to latest release curl-8_0_1 ([#19185][_#19185])
* [fix] TBD [workspace] Upgrade dm_control_internal to latest commit ([#19185][_#19185])
* [fix] TBD [workspace] Upgrade fcl_internal to latest commit ([#19185][_#19185])
* [fix] TBD [workspace] Upgrade lcm to latest commit ([#19185][_#19185])
* [fix] TBD [workspace] Upgrade msgpack_internal to latest release cpp-6.0.0 ([#19185][_#19185])
* [fix] TBD [workspace] Upgrade mypy_internal to latest release v1.2.0 ([#19185][_#19185])
* [fix] TBD [workspace] Upgrade rules_python to latest release 0.20.0 ([#19185][_#19185])
* [fix] TBD [workspace] Upgrade scs_internal to latest release 3.2.3 ([#19185][_#19185])
* [fix] TBD [workspace] Upgrade sdformat_internal to latest release sdformat13_13.4.1 ([#19185][_#19185])
* [fix] TBD [workspace] Upgrade statsjs to latest commit ([#19185][_#19185])
* [fix] TBD [workspace] Upgrade tinyobjloader to latest commit ([#19185][_#19185])
