...
* [fix] Upgrade buildifier to latest release 6.1.0 ([#19189][_#19189])
* [fix] Fix documentation in new_release.py ([#19185][_#19185])
* [fix] Upgrade abseil_cpp_internal to latest commit ([#19185][_#19185])
* [fix] Upgrade curl_internal to latest release curl-8_0_1 ([#19185][_#19185])
* [fix] Upgrade dm_control_internal to latest commit ([#19185][_#19185])
* [fix] Upgrade fcl_internal to latest commit ([#19185][_#19185])
* [fix] Upgrade lcm to latest commit ([#19185][_#19185])
* [fix] Upgrade msgpack_internal to latest release cpp-6.0.0 ([#19185][_#19185])
* [fix] Upgrade mypy_internal to latest release v1.2.0 ([#19185][_#19185])
* [fix] Upgrade rules_python to latest release 0.20.0 ([#19185][_#19185])
* [fix] Upgrade scs_internal to latest release 3.2.3 ([#19185][_#19185])
* [fix] Upgrade sdformat_internal to latest release sdformat13_13.4.1 ([#19185][_#19185])
* [fix] Upgrade statsjs to latest commit ([#19185][_#19185])
* [fix] Upgrade tinyobjloader to latest commit ([#19185][_#19185])
