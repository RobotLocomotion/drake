...
* TBD [doc] Add release notes v0.38.0 ([#16356][_#16356])
* TBD [tools,doc] [tools] Deprecate drake-visualizer on macOS ([#16386][_#16386])
* TBD [workspace] Upgrade stduuid to latest commit ([#16387][_#16387])
...
* TBD [workspace] Add libcmaes as a testonly dependency ([#16441][_#16441])  # In the future, we might use this in production, but for getting started we only need it in the sample test.
* TBD [doc] Add full website DDG search to pydrake search panel ([#16473][_#16473])
* TBD [workspace] Upgrade common_robotics_utilities to latest commit ([#16484][_#16484])
* TBD [workspace] Upgrade dm_control to latest commit ([#16484][_#16484])
* TBD [workspace] Upgrade googlebenchmark to latest release v1.6.1 ([#16484][_#16484])
* TBD [workspace] Upgrade ignition_math to latest release ignition-math6_6.10.0 ([#16484][_#16484])
* TBD [workspace] Upgrade ros_xacro to latest release 1.13.16 ([#16484][_#16484])
* TBD [workspace] Upgrade voxelized_geometry_tools to latest commit ([#16484][_#16484])
* TBD [workspace] Upgrade buildifier to latest release 4.2.5 ([#16484][_#16484])
* TBD [workspace] Add upgrade comment to uwebsockets ([#16484][_#16484])
* TBD [doc] Add DDG searches to our Doxygen header ([#16491][_#16491])
* TBD [workspace] Upgrade rules_pkg to latest release 0.6.0 ([#16485][_#16485])
* TBD [workspace] Upgrade meshcat_python to latest commit ([#16505][_#16505])
...
* TBD Enable CLP in pip build ([#16521][_#16521])  # Add necessary logic to build clp (and its dependency coinutils) in the pip build. Enable CLP in Drake for the pip build.
* TBD [doc,setup,tools] setup: Upgrade recommended Bazel version to 5.0 ([#16523][_#16523])
* TBD
