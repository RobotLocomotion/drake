...
* TBD [primitives] Implement LeCun initialization for MultilayerPerceptron ([#16529][_#16529])  # These are the defaults used in PyTorch, and I find that they make a huge difference in practice compared to the random small numbers I had before.
New features
...
* TBD Mosek also print solution summary ([#16528][_#16528])  # This feature is enabled when we set kPrintToConsole or kPrintFileName in CommonSolverOptions.
New features
...
* TBD Enable ipopt in pip build ([#16532][_#16532])  # Add necessary logic to build ipopt in the pip build, and enable it in Drake for the pip build.
