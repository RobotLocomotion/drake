...
* TBD [primitives] Add MultilayerPerceptron::GetMutableParameters() ([#16542][_#16542])
New features
...
* TBD [common,math,tools,lcm] [test_utilities] Deprecate checking the specific exception subtype ([#16514][_#16514])  # Offering a subtype is just asking for trouble, when our GSG says not to.
...
<!--
  ...
  Current newest_commit 655088538b21644845f766c670e2151f3845a080 (inclusive).
-->
