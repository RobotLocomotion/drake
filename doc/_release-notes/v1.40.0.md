...
* [feature] TBD [systems,geometry] Compare RenderEngineParams with existing RenderEngine instances ([#22871][_#22871])  # This provides the ability to ask a RenderEngine instance if a set of parameters describes the engine. We apply this new ability when processing CameraConfig instances. It makes the process more forgiving as multiple CameraConfig can reference otherwise equal RenderEngine instances (whereas before, it was more brittle and inclined to throw).
New features
...
* [fix] TBD [common,workspace,examples] [workspace] Upgrade styleguide to latest commit ([#22878][_#22878])  # This incorporates changes to cpplint. There are no docs (style guide) changes.
...
* [fix] TBD [pydrake] Add some missing SceneGraph/Inspector bindings ([#22879][_#22879])
* [fix] TBD [pydrake] Fix DiagramBuilder.AddSystem return value policy ([#22884][_#22884])
New features
...
<!--
  ...
  Current newest_commit b9c0be0f483f7e3704efb0457a378a73b31d2366 (inclusive).
-->
