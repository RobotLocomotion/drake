...
* [newly deprecated] TBD [systems] Move DiscreteTimeApproximation into analysis ([#22867][_#22867])  # The functions declarations in systems/primitives are deprecated and will be removed on or after 2025-08-01. Co-authored-by: Wei-Chen Li <williamrob104@gmail.com> Co-Authored-By: Wei-Chen Li <williamrob104@gmail.com>
New features
...
* [fix] TBD [workspace] Upgrade vtk_internal to latest commit ([#22857][_#22857])  # Co-Authored-By: Aiden McCormack <aiden.mccormack@tri-workstation.khq.kitware.com>
* [fix] TBD [workspace] Upgrade googlebenchmark to latest release v1.9.2 ([#22854][_#22854])  # Co-authored-by: Rick Poyner <rick.poyner@tri.global>
* [fix] TBD Suppress benign eXIf warnings from libpng 1.6.47 ([#22861][_#22861])  # * [workspace] Upgrade libpng_internal to latest release v1.6.47 * Suppress benign eXIf warnings from libpng 1.6.47
