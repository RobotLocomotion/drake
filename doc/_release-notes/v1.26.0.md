...
* Add `EigenMapView` to aid inerop with C++ containers ([#20906][_#20906])
* Change the default Meshcat's recording framerate to 64 fps ([#20926][_#20926])
...
* Add bindings for `ConvexSet::CalcVolumeViaSampling` ([#20843][_#20843])
* Add support for `Union[List[T], ...]` ([#20919][_#20919])
...
* Upgrade meshcat to latest commit ([#20805][_#20805]) ([#20876][_#20876]) ([#20904][_#20904])
