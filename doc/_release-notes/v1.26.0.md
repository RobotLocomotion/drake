...
* [fix] TBD [framework] Fix broken Graphviz on systems with <,>,& characters ([#20915][_#20915])  # The Graphviz was broken when a system used an HTML special character as part of its class name, system name, or port name.
...
* [fix] TBD Fix QHull error when transforming between HPolyhedron and VPolytope with ambient dimension 1 ([#20893][_#20893])
* [fix] TBD Normalize rows of the matrix [A,b] in HPolyhedron::MaximumVolumeInscribedEllipsoid to prevent numerical issues ([#20849][_#20849])
...
* [feature] TBD [multibody,common,geometry,examples] Add EigenMapView to aid inerop with C++ containers ([#20906][_#20906])  # This helps remove lots of boilerplate.
* [fix] TBD [meshcat] Change the default recording framerate to 64 fps ([#20926][_#20926])  # The default framerate for StartRecording should match the default publish period of MeshcatVisualizer. Mismatches can lead to unexpected behavior: https://stackoverflow.com/questions/77916511/meshcat-not-visualizing-initial-conditions-correctly-drake/77979312#77979312
New features
...
* [fix] TBD [manipulation,multibody] Adjust iiwa 7 velocity and effort limits ([#20917][_#20917])
...
* [fix] TBD Add bindings for ConvexSet::CalcVolumeViaSampling ([#20843][_#20843])
* [fix] TBD [py yaml] Add support for Union[List[T], ...] ([#20919][_#20919])
* [feature] TBD [py yaml] yaml_load_typed uses schema=type(defaults) by default ([#20922][_#20922])
...
* [fix] TBD [workspace] Upgrade rules_rust, rust_toolchain to latest ([#20901][_#20901])  # - Upgrade rules_rust to latest release 0.38.0 - Upgrade rust_toolchain to latest Additionally, add repository metadata for rust_toolchain, make rules_rust and rust_toolchain cohorts, and remove no-longer-needed upgrade advice from rules_rust.
* [fix] TBD [workspace] Upgrade abseil_cpp_internal to latest commit ([#20900][_#20900])
* [fix] TBD [workspace] Upgrade crate_universe to latest ([#20900][_#20900])
* [fix] TBD [workspace] Upgrade curl_internal to latest release curl-8_6_0 ([#20900][_#20900])
* [fix] TBD [workspace,tools] [workspace] Upgrade ipopt_internal_fromsource to latest release releases/3.14.14 ([#20900][_#20900])
* [fix] TBD [workspace] Upgrade libpng_internal to latest release v1.6.42 ([#20900][_#20900])
* [fix] TBD [workspace] Upgrade nanoflann_internal to latest release v1.5.4 ([#20900][_#20900])
* [fix] TBD [workspace] Upgrade ros_xacro_internal to latest release 1.14.17 ([#20900][_#20900])
* [fix] TBD [workspace] Upgrade rules_license to latest release 0.0.8 ([#20900][_#20900])
* [fix] TBD [workspace] Upgrade suitesparse_internal to latest release v7.6.0 ([#20900][_#20900])
* [fix] TBD [workspace] Upgrade tinyobjloader_internal to latest commit ([#20900][_#20900])
* [fix] TBD [workspace] Upgrade vtk_internal to latest commit ([#20900][_#20900])
* [fix] TBD [workspace] Upgrade meshcat to latest commit ([#20904][_#20904])
...
* Upgrade crate_universe to latest versions ([#20814][_#20814])
...
* Upgrade vtk_internal to latest commit ([#20765][_#20765]) ([#20867][_#20867])
...
<!--
  ...
  Current newest_commit e6384996ffc44f8d0866a5308c1da660f042237e (inclusive).
-->
