...
* TBD [multibody] By default, use hydroelastic contact with fallback ([#16569][_#16569])  # - Switch the default contact model from point contact to hydroelastic with fallback. - The fallback to point contact happens between two rigid-hydroelastic collision geometries. It also happens when one or both of the two contacting geometries is non-hydroelastic. - Update Hydroelastic Contact User Guide.
New features
...
* TBD [tools,third_party,setup] [workspace] Use libjchart2d-java from apt on Ubuntu ([#16185][_#16185])  # Co-authored-by: Betsy McPhail <betsy.mcphail@kitware.com>
...
<!--
  ...
  Current newest_commit 6d84ab8750984163e74c89ad990c701a295fee5a (inclusive).
-->
