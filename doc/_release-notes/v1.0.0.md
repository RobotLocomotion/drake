...
* TBD [doc,tools] [pydrake] Deprecate tkinter-using classes ([#16656][_#16656])  # Also remove then from pydrake.all. Therefore, pydrake no longer depends on python3-tk.
