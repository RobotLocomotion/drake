...
* TBD [analysis] Don't Initialize during MakeSimulatorFromGflags ([#16657][_#16657])  # The user may want to alter the context before starting the simulation.
New features
...
* TBD [geometry] Add host name option to MeshcatParams ([#16654][_#16654])  # The default remains to bind to "*". Update meldis to only serve on localhost by default.
New features
...
* Add URL customization to Meshcat constructor ([#16638][_#16638])
...
* TBD [examples: hydroelastic] A compliant ball on a rigid plate mesh from SDF file ([#15804][_#15804])  # * [examples: hydroelastic] Compliant ball on rigid dinner plate and compliant floor - It shows both rigid-compliant and compliant-compliant hydroelastic contacts. - It uses a non-convex dinner plate from SDFormat file. * Reviewable. * Reviewable.
...
[_#16657]: https://github.com/RobotLocomotion/drake/pull/16657
<!-- <end issue links> -->

<!--
  Current oldest_commit c95ac12807375c61d9426802570a9fc635e377c1 (exclusive).
  Current newest_commit 26145a5f837179e2f8d2ebcaf93327f9ca7cb639 (inclusive).
-->
