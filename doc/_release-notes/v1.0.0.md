...
* Reinder: The use of ``drake-visualizer`` on macOS is deprecated and will be
...
* TBD [examples,manipulation] Remove unused model.config files ([#16696][_#16696])  # This also allows us to remove a confusing LICENSE statement for the wsg_50_description gripper model.
...
* Allow CMake builds to customize fmt and spdlog ([#16652][_#16652])
...
<!--
  ...
  Current newest_commit b3eb496eec2c1b8abc03d40d6f62466c75450e63 (inclusive).
-->
