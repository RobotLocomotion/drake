...
* TBD Remove tkinter-using classes from pydrake.all; pydrake no longer depends on python3-tk ([#16656][_#16656])
...
* TBD [workspace] Upgrade bazel_skylib to latest release 1.2.0 ([#16685][_#16685])
* TBD [workspace] Upgrade buildifier to latest release 5.0.1 ([#16685][_#16685])
* TBD [workspace] Upgrade dm_control to latest commit ([#16685][_#16685])
* TBD [workspace] Upgrade github3_py to latest release 3.1.2 ([#16685][_#16685])
* TBD [workspace] Upgrade petsc to latest release 3.16.4 ([#16685][_#16685])  # One of our bugfix patches has been upstreamed.
* TBD [workspace] Upgrade ros_xacro to latest release 1.13.17 ([#16685][_#16685])
...
* TBD [doc] Improve SpatialVelocity documentation ([#16350][_#16350])  # Partially address issue #16189 (unnecessary confusion with the SpatialVelocity::operator+ and SpatialVelocity::operator-. This PR is a template for rewriting C++ method and function parameters for ease-of-use with Python.
* TBD [doc,tools] [pydrake] Deprecate tkinter-using classes ([#16656][_#16656])

## Removal of deprecated items

* TBD [yaml] Remove deprecated functions ([#16673][_#16673])
* TBD [manipulation,multibody,examples] Remove deprecated package.xml files 2022-03 ([#16674][_#16674])
