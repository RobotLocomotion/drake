...
* TBD [tutorials,tools,doc] [doc] Withdraw tutorials from Colab ([#16568][_#16568])  # Colab is not a suitable host for our beginner tutorials. Is stuck on Python 3.7, but Drake will no longer support 3.7 as of April 2022.
* TBD [tutorials,tools,doc] [tutorials] Install tutorials in binary releases ([#16644][_#16644])
* None
...
<!--
  ...
  Current newest_commit 6bde59a013717015c81a1339fa653a736f3d8c2f (inclusive).
-->
