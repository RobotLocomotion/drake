...
* TBD [geometry/optimization] Add optional solver and solver options to SolveShortestPath ([#16616][_#16616])
New features
...
* TBD [common,math,systems] [common] Add if_then_else overload for Eigen::Vector ([#16621][_#16621])
...
<!--
  ...
  Current newest_commit a74319818ddafd68c13d40d0bf688c807db08478 (inclusive).
-->
