...
* TBD [multibody,solvers] PositionConstraint can update lower and upper bounds ([#16631][_#16631])
New features
...
* TBD [common] Give RandomGenerator efficient default and move constructors ([#16633][_#16633])  # Copying 5000 bytes of storage during a move is wasteful; better to just swap a heap pointer. Calculating 624 random integers in the default constructor is wasteful, if we're only trying to allocate a storage for generator that will be moved into later (e.g., when resizing a collection of generators). While we're here, tidy up some of its API documentation for completeness.
...
<!--
  ...
  Current newest_commit 23d921162f9e56f3973f635137b40d9506df9954 (inclusive).
-->
