...
* TBD [primitives] Support sin/cos input features in MultilayerPerceptron ([#16605][_#16605])
New features
...
* TBD Add general transformed version of AddPointInNonnegativeScalingConstraints to ConvexSet ([#16397][_#16397])
* TBD Add two-cycle constraint to Shortest Path formulation ([#16397][_#16397])
New features
...
<!--
  ...
  Current newest_commit c966e648e66b094b2fceef2d05ff7a448525ca30 (inclusive).
-->
