...
* TBD [multibody] Add plant getter to Parser ([#16655][_#16655])  # This might be convenient when re-using the same Parser across an entire simulation setup, even when adding models by hand.
New features
...
<!--
  ...
  Current newest_commit 3dce536c65e39309ab07a3dc99d79a7356b92312 (inclusive).
-->
