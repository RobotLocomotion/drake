...
* TBD [examples,tools] [examples: hydroelastic] Adds Spatula Slip Example ([#16668][_#16668])  # Adds spatula slip example to examples/hydroelastic Co-authored-by: Jeremy Nimmer <jeremy.nimmer@tri.global>
...
* TBD [pydrake/trajectories] Add Trajectory trampoline for inheritance ([#16684][_#16684])
New features
...
* TBD [tools,cmake] Allow external fmt, spdlog ([#16652][_#16652])  # Add logic (only when using the CMake wrapper) to allow the user to select and use external version(s) of fmt and/or spdlog.
...
<!--
  ...
  Current newest_commit 13be9359ec081f2109401327d9f8fac3ea9a5899 (inclusive).
-->
