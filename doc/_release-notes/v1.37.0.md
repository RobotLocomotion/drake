...
* [fix] TBD [solvers] Change solver names to upstream's preferred case ([#22407][_#22407])  # Clp prefers camel. Ipopt prefers camel. MOSEK prefers scream.
New features
...
* [fix] TBD [tools,solvers,workspace,doc] [build] Use modern spelling for Bazel config options ([#22393][_#22393])
...
<!--
  ...
  Current newest_commit 2fd667315f5d295cde5fc1e723a3c96d45c52379 (inclusive).
-->
