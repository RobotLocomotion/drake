...
* [feature] TBD Implements MultibodyPlants methods to retrieve joint actuators and actuated joints per model istance ([#18959][_#18959])
New features
...
* [fix] TBD [pydrake] Use nice names for default template classes ([#18972][_#18972])  # When a template class has a default type parameter, name the default instantiation directly using the default name, instead of via an alias. This makes IDE auto-complete and type annotations more natural.
