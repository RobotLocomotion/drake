...
* TBD [multibody,common,solvers] Adapt uses of TypeSafeIndex vs Eigen 3.4 prerelease ([#15335][_#15335])  # In Eigen 3.4, implicit conversion from TypeSafeIndex to int may fail. When needed, use the int constructor explicitly. Co-authored-by: Jeremy Nimmer <jeremy.nimmer@tri.global>
...
* TBD [common] Make reset_after_move be conditionally noexcept ([#15362][_#15362])
...
* TBD Add shoe to gallery ([#15044][_#15044])  # Add an example of robot hands tying shoe laces to the gallery. This includes a video as well as an interactive sim visualization.
...
[_#15382]: https://github.com/RobotLocomotion/drake/pull/15382
[_#15384]: https://github.com/RobotLocomotion/drake/pull/15384
[_#15388]: https://github.com/RobotLocomotion/drake/pull/15388
<!-- <end issue links> -->

<!--
  Current oldest_commit 248db432faa66d19e0bb24c2fe539ec5bf58ea7f (exclusive).
  Current newest_commit 2ce5d6209268a987c267064e22fc062d84ec65fd (inclusive).
-->
