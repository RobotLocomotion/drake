...
* [fix] TBD Implements fail fast heuristic in DoPointInSet for VPolytopes ([#21988][_#21988])
New features
...
* [feature] TBD [geometry,lcmtypes,examples] Illustration supports in-memory meshes ([#21952][_#21952])  # - Meshcat operates on MeshSource - DrakeVisualizer serializes a FileSource into javascript that subsequently gets decoded by meldis (and then passed to its own Meshcat as in-memory Mesh). - To evaluate the result: - meshcat_manual_test has been updated to include both on-disk and in-memory representations. (Doesn't support meldis.) - The solar system example has been updated to perform a similar role and now supports both meshcat and meldis.
New features
...
* [feature] TBD [workspace] Upgrade curl_internal to latest release 8.10.1 ([#21993][_#21993])  # Co-authored-by: Rick Poyner <rick.poyner@tri.global>
...
<!--
  ...
  Current newest_commit 8bcd04a1e488dcd8d493387cb5a85fdbf6373d8d (inclusive).
-->
