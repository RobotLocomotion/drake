...
* [feature] TBD Added method to set x(n) in the context for vector-valued ZeroOrderHold ([#22005][_#22005])
New features
...
* [fix] TBD [solvers] Remove inline destructors ([#22018][_#22018])
New features
...
* [newly deprecated feature] TBD [geometry,multibody] Deprecate Mesh/Convex::filename() ([#21881][_#21881])  # Use source().path() instead.
New features
...
* Add out-of-line destructors for common/trajectories classes ([#22010][_#22010])

## Build dependencies

<!-- <relnotes for workspace go here> -->

* [fix] TBD [cmake] Use new mode to find python for pybind11 ([#22012][_#22012])  # Update pybind11-config.cmake to follow the same logic as upstream pybind11Common so that the new (not deprecated) method of finding Python is used.
...
<!--
  ...
  Current newest_commit 2662e2bb7546d73c303d6f4b149f947c3ced159e (inclusive).
-->
