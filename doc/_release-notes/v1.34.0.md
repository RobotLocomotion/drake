...
* SceneGraph now supports in-memory meshfiles.
  ...
  * A single shape can heterogeneously mix in-memory and disk files (e.g.,
    on-disk for the geometry, in-memory for the texture).
...
* [fix] TBD [common,solvers,geometry] [common,geometry] Remove inline destructors ([#22030][_#22030])
...
* [fix] TBD Do not convert an int to a bool in Python binding of Meshcat::SetProperty ([#22021][_#22021])
New features
...
* Add out-of-line destructors for common/trajectories and solvers classes ([#22010][_#22010], [#22018][_#22018])

## Build dependencies

<!-- <relnotes for workspace go here> -->

* [fix] TBD [workspace,geometry,tools] [workspace] Upgrade vtk_internal to latest commit ([#21894][_#21894])  # Co-authored-by: Sankhesh Jhaveri <sankhesh.jhaveri@kitware.com> Co-authored-by: Betsy McPhail <betsy.mcphail@kitware.com> Co-authored-by: Jeremy Nimmer <jeremy.nimmer@tri.global>
...
<!--
  ...
  Current newest_commit 1771dbfb36636e7c37b021f0da0506cb4ccd4199 (inclusive).
-->
