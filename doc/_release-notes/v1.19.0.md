...
* [feature] TBD [geometry,examples,solvers,multibody,tools] Handle geometry::Mesh("foo.gltf", 1) throughout Drake ([#19739][_#19739])
...
* Fix incorrect type casting in `SortedPair<T>`; add test ([#19753][_#19753])
...
<!--
  ...
  Current newest_commit 728a0a42268e04c44396c32389b9e4dbe6bdc727 (inclusive).
-->
