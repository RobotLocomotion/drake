...
* [#19198][_#19198]: `RgbdSensorDiscrete` now has a zero-order hold on its pose output. ([#19696][_#19696])
...
* [#19752][_#19752] `GetDowncastSubsystemByName()` works with a non-templatized `System` ([#19755][_#19755])
...
* Additional `SpatialInertia::[Object]WithMass()` functions (solid capsule, solid cylinder, solid ellipsoid). ([#19737][_#19737])
...
* Improvements to handling of glTF in `geometry` and `visualization`:
...
* `CollisionChecker` validates distance and interpolation functions using the plant's default configuration rather than its zero configuration. ([#19736][_#19736])
...
<!--
  ...
  Current newest_commit 8b25bb8cd378802e1b819d66b4fba724d4b2fcc9 (inclusive).
-->
