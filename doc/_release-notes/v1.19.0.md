...
* Add `solvers::MakeSemidefiniteRelaxation` to construct a new `MathematicalProgram` which implements the SDP relaxation of the original program. ([#19632][_#19632])
