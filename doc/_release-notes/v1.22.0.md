...
* Drake now provides a pip-compatible index for installing the nightly build
  ...
  * Refer to [Installation via Pip](/pip.html#nightly-releases) for
    instructions.
* Drake's support for macOS Monterey (i.e., macOS 12) as reached end of life,
...
* [feature] TBD SceneGraph modifies/access renderer in the context ([#20355][_#20355])  # Previously we only provide API to modify/query the renderer in the SceneGraph model. Now we provide API to modify/query the renderer in the context.
New features
...
* [feature] TBD Add python binding for AffineSubspace::OrthogonalComplementBasis ([#20341][_#20341])
New features
...
* [fix] TBD [tools,setup] [setup] Remove dependency on bzip2 ([#20352][_#20352])  # We added this in e3bc3d04 to work around an Ubuntu 16.04 bug in its pkg-config files. That's no longer necessary.
...
* [fix] TBD [workspace,tools] [workspace] Use hidden symbols for tinyobjloader ([#20357][_#20357])
* [fix] TBD [workspace,tools] [workspace] Cull some unwanted ClpSolver code ([#20358][_#20358])
* [fix] TBD [workspace,tools] [workspace] Fix leaky symbol in abseill_cpp ([#20359][_#20359])
...
* Improve symbol hiding in VTK's third-party code ([#20346][_#20346])
...
<!--
  ...
  Current newest_commit 2f8f941a72f6ad09b7825864e567ec6e4e8966d2 (inclusive).
-->
