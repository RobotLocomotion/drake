...
* [feature] TBD [systems,geometry,manipulation] [systems/lcm] Indicate LCM connections in System graphviz output ([#20310][_#20310])  # Now that the lcm_url appears in the Graphviz details, we can remove that detail from the System name for simplicity.
New features
...
<!--
  ...
  Current newest_commit eb4a10b89e501da7aa17f173cc01c6b6feed46cc (inclusive).
-->
