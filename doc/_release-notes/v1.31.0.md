...
* Relax `solvers::UnrevisedLemkeSolver::ComputeZerTolerance()` internal tolerance for ARM ([#21713][_#21713])
* Throw instead of asserting (debug-only) for `solvers::QuadraticCost` size check ([#21583][_#21583])
* Fix parsing bugs in `solvers::OsqpSolver` and `solvers::MosekSolver` ([#21579][_#21579])
