...
* MultibodyPlant::CalcReactionForces() has been fixed and now gives correct results in discrete mode for both TAMSI and SAP, including contributions from constraints.
