...
* Drake Gym is now available, to simplify combining Drake simulations with reinforcement learning toolkits. See [the example here](https://github.com/RobotLocomotion/drake/tree/v1.20.0/bindings/pydrake/examples/gym). ([#19831][_#19831])
* The new `DRAKE_PYTHON_LOGGING` environment variable offers more control over logging when using `pydrake`. See [the documentation here](https://drake.mit.edu/doxygen_cxx/group__environment__variables.html). ([#19703][_#19703])
* Drake now includes a fix_inertia tool, to compute inertia tensors from masses and geometries in models. It works on both URDF and SDFormat models, and outputs a complete updated model file. [the documentation here](https://drake.mit.edu/pydrake/pydrake.multibody.fix_inertia.html). ([#19731][_#19731])
...
* Add new DistanceAndInterpolationProvider API. ([#19105][_#19105])

Fixes

* Cleanup `GcsTrajectoryOptimization` Subgraph costs and constraints. ([#19873][_#19873])
...
* Fix round-trip bugs with `variant<string,...>`. ([#19954][_#19954])
...
* Added visualization triads in meldis ([#19848][_#19848])
...
* `manipulation.kuka_iiwa` ([#19869][_#19869])
* `manipulation.schunk_wsg` ([#19869][_#19869])
* `manipulation.util` ([#19869][_#19869])
* `geometry::RenderEngineGlParams::default_label` ([#19912][_#19912])
* `geometry::RenderEngineGltfClientParams::default_label` ([#19906][_#19906])
* `geometry::RenderEngineVtkParams::default_label` ([#19911][_#19911])
* `multibody::tree:UnitInertia::SolidCylinderAboutEnd` two-argument overload ([#19803][_#19803])
...
* `geometry.render` ([#19868][_#19868])
* `geometry.GeometryInstance.release_shape` ([#19868][_#19868])
...
<!--
  ...
  Current newest_commit 8a430607943f6a39adf5f8c8167c4390bf5240d2 (inclusive).
-->
