...
* (feature) TBD Add more shapes to SpatialInertia factories ([#18483][_#18483])  # Add spatial inertia factory methods for solid box, capsule, cylinder, ellipsoid, sphere.  Add optional unit_vector argument to UnitInertia::SolidCapsule().
...
* (feature) TBD Add tetrahedron to SpatialInertia and UnitInertia ([#18618][_#18618])
...
* (fix) TBD [meshcat] Check whether browser supports gamepads ([#18720][_#18720])
...
* (feature) TBD Add CollisionChecker files copied from Anzu ([#18558][_#18558])
...
* (feature) TBD [planning] Copy SceneGraphCollisionChecker files from Anzu ([#18629][_#18629])
