...
* TBD Moving traj opt files to new destinations ([#18697][_#18697])  # - systems/trajectory_optimization to planning/trajectory_optimization - direct_collocation - direct_transcription - integration_constraint - kinematic_trajectory_optimization - multiple_shooting - sequential_expression_manager Moving includes updating all references, namespaces, and bindings.
* TBD Moving files to new destinations ([#18664][_#18664])  # - manipulation/planner to multibody/inverse_kinematics - constraint_relaxing_ik - manipulation/planner to manipulation/util - robot_plan_interpolator Moving includes updating all references (and namespaces as appropriate).
