...
* TBDTBD Moving traj opt files to new destinations ([#18697][_#18697])  # - systems/trajectory_optimization to planning/trajectory_optimization - direct_collocation - direct_transcription - integration_constraint - kinematic_trajectory_optimization - multiple_shooting - sequential_expression_manager Moving includes updating all references, namespaces, and bindings.
* TBDTBD Moving files to new destinations ([#18664][_#18664])  # - manipulation/planner to multibody/inverse_kinematics - constraint_relaxing_ik - manipulation/planner to manipulation/util - robot_plan_interpolator Moving includes updating all references (and namespaces as appropriate).
...
* TBDTBD artifacts for system/trajectory_optimization ([#18697][_#18697])
* TBDTBD Rename RobotDiagram::BuildDiagram() => Build() ([#18770][_#18770])
* TBDTBD Simplify RobotDiagramBuilder function names ([#18772][_#18772]) 
* TBDTBD Deprecate the pydrake.solvers.* submodules ([#18683][_#18683])
* TBDTBD Deprecate the pydrake.examples.* submodules ([#18685][_#18685])
* TBDTBD (manipulation,multibody,examples) Moving files to new destinations ([#18664][_#18664])  # - manipulation/planner to multibody/inverse_kinematics - constraint_relaxing_ik - manipulation/planner to manipulation/util - robot_plan_interpolator Moving includes updating all references (and namespaces as appropriate).
* TBDTBD Deprecation artifacts for manipulation/planner ([#18715][_#18715])

## Removal of deprecated items

* TBDTBD Remove deprecated code 2023-02 ([#18689][_#18689])
* TBDTBD Remove deprecated code 2023-02 ([#18716][_#18716])
* TBDTBD Remove deprecated externals 2023-02 ([#18686][_#18686])
