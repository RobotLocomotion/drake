...
* TBD [systems,geometry,examples] Remove 2021-12 geometry deprecation ([#16156][_#16156])
* TBD [systems,manipulation,examples] [systems] Remove deprecated code 2021-12 ([#16158][_#16158])
New features
...
* TBD [common,math] [common,math] Remove deprecated code 2021-12 ([#16157][_#16157])
...
* TBD [tools,setup] [workspace] Remove deprecated externals ([#16155][_#16155])  # Remove the ignition_math shared library (now it's static-only). Remove jsoncpp entirely.
