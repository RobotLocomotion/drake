...
* Enable reading of more primitive scalar types from yaml files ([#16096][_#16096])
...
* Replace colab installer script with an error stub to give a clearer error for older colab notebooks ([#16073][_#16073])
* Add `:drake_shared_library` target to `drake-bazel-installed` ([#16072][_#16072])
...
<!--
  ...
  Current newest_commit f5d887681b4b54a2b431ab1c69d45654b0e95011 (inclusive).
-->
