...
* Return `const VectorX&` rather than `VectorBlock` where possible from `port.Eval()` and similar methods. ([#16031][_#16031])
...
<!--
  ...
  Current newest_commit 1fe51826673ee24feea1b80baf1b950cc577bfe5 (inclusive).
-->
