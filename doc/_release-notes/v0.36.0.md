...
* TBD [meshcat] Add `SetObject(TriangleSurfaceMesh)` and `SetTriangleMesh(...)` ([#16077][_#16077])  # Adds support for sending triangle meshes directly to Meshcat (e.g. without having to write them to an .obj file on disk).
...
* TBD [lcm,geometry,systems] [lcm] Deprecate DrakeMockLcm ([#16078][_#16078])
* Add sugar to read and write yaml-serialized files ([#15902][_#15902], [#16000][_#16000])
...
* TBD [install] Remove LICENSE files from drake-bazel-installed runfiles ([#16070][_#16070])  # This improves compatibility with 'apt install drake-dev'.
* TBD [tools] Allow macOS 12 Monterey ([#16068][_#16068])
* TBD [setup] Display a disclaimer when 'apt-get update' is broken ([#16086][_#16086])
...
* Deprecate the direct use of YAML::Node by users ([#16057][_#16057])
...
<!--
  ...
  Current newest_commit 99e87e7a94158a591c9b1cdd6255109f3dd3a723 (inclusive).
-->
