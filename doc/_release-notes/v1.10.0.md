...
* dd more by-name sugar to Diagram and DiagramBuilder ([#18078][_#18078])
...
* Replace quadratic cost with affine cone constraint and linear cost ([#18185][_#18185])
...
* Improve documentation of MeshCat::SetTriangleColorMesh ([#18100][_#18100])
...
* Modernize parser.AddAllModelsFromFile ([#18208][_#18208])
* Add capsule support for MeshCat ([#17319][_#17319])
* Parse screw joints from URDF ([#18191][_#18191])

Fixes

* Fix multiple Vertex costs bug ([#18043][_#18043])
* Correct calculations of spatial velocity across ScrewJoint ([#18019][_#18019])
* Adds hydroelastic forces to continuous mode reaction forces computation ([#18057][_#18057])
...
<!-- Does this imply all of the nested things that were mechanically deprecated as well? -->
