...
* Add ExternallyAppliedSpatialForceMultiplexer ([#18171][_#18171])  # py plant: - Remove unneeded qualifier for ExternallyAppliedSpatialForce - test_propeller: Use body name rather than magic number adder_test: - Add check for discrete number of states - Use std::make_unique instead of .reset()
