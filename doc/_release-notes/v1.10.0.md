...
* Parallelize point cloud operations with OpenMP and use `common_robotics_utilities`'s DSHVG for voxel filter ([#18216][_#18216])
...
* drake::multibody::MultibodyPlant::GetOutputPort("continuous_state")  ([#18274][_#18274])
