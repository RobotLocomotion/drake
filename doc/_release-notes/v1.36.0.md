...
* Add `MathematicalProgram::AddLinearMatrixInequalityConstraint()` for a matrix of symbolic Expressions ([#22211][_#22211])
...
* Parallelize the Rounding Stage of GCS ([#22222][_#22222])
* Reproduce the SCS program with python code ([#22223][_#22223])

Fixes

* Drop unnecessary convex quadratic constraints in semdefinite relaxation programs ([#22123][_#22123])
