...
* TBD drake_visualizer: Factor out package.BUILD.bazel file ([#14976][_#14976])
* TBD drake_visualizer: Use Drake's native lcmtypes for builtin_scripts ([#14981][_#14981])
* Disable voxelized_geometry_tools unit test ([#15005][_#15005])  # It no longer passes on macOS after the latest Apple upgrade.
