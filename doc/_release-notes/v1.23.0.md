...
* [feature] TBD [multibody] Support .vtk meshes in CalcSpatialInertia() ([#20539][_#20539])
* [feature] TBD Implement per model instance net actuation output port ([#20549][_#20549])
* [fix] TBD [multibody,common] [parsing] Fix urdf mimic parsing of same joint names in different model instances ([#20551][_#20551])
New features
...
* [feature] TBD [planning,workspace] [planning] Switch CollisionChecker and VisibilityGraph to use CRU parfor API ([#20528][_#20528])  # - Switch CollisionChecker and VisibilityGraph to use CRU parallel-for API to support non-OpenMP parallel operations - Upgrade common_robotics_utilities to latest commit. - Upgrade voxelized_geometry_tools to latest commit.
New features
...
<!--
  ...
  Current newest_commit 0f0f7cc82ee1a6edd8653693a87e44dee8ed54b5 (inclusive).
-->
