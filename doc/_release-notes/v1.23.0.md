...
* Add conversion to/from SymPy ([#20117][_#20117])  # This provides most of the basic conversions users might need. We invite users of Drake+SymPy to contribute further improvements.
* Spport SymPy conversion for integers ([#20415][_#20415])
* Bind all image types, ImageFileFormat, and PixelScalar ([#20502][_#20502], [#20508][_#20508])

Fixes

* Ensure DrakeGym documentation has the right arguments for the reward callback ([#20529][_#20529])
* CompositeTrajectory binding isa PiecewiseTrajectory ([#20407][_#20407])
