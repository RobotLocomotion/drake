...
* [feature] TBD Enable deformable body collision filtering via MbP and parsing ([#23237][_#23237])
* [feature] TBD Improve introspection in DifferentialInverseKinematicsSystem API ([#23279][_#23279])  # This provides introspection on _all_ of the construction parameters.
New features
...
* [fix] TBD [pydrake] Add binding for Diagram.AreConnected ([#23277][_#23277])
New features
...
* [fix] TBD [setup,workspace,third_party] [workspace] Upgrade bazelisk to latest release v1.27.0 ([#23281][_#23281])
...
[_#23237]: https://github.com/RobotLocomotion/drake/pull/23237
...
<!--
  ...
  Current newest_commit 094b3cefc9eda540663e6984154fadaa6460efb7 (inclusive).
-->
