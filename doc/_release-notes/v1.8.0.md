...
* TBD [geometry/optimization] Enable rounding of GCS solution when solving convex relaxation of ShortestPath ([#17796][_#17796])
* TBD [multibody] Add CalcJacobianPositionVector ([#17920][_#17920])
New features
...
* Upgrade usockets to latest commit ([#17926][_#17926])
* Upgrade uwebsockets to latest release v20.16.0 ([#17926][_#17926])
...
<!--
  ...
  Current newest_commit e977f9d6023046b705ab63a4bca0543f9f78079d (inclusive).
-->
