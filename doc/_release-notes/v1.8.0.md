...
* TBD Spin perspective costs and constraints into separate functions ([#17844][_#17844])
* TBD Enable adding costs to vertices in GraphOfConvexSets ([#17844][_#17844])
New features
...
* TBD [trajectories] Add PathParameterizedTrajectory ([#17816][_#17816])
...
* TBD [meldis] Support deformable geometries ([#17848][_#17848])  # - Subscribe to DRAKE_VIEWER_DEFORMABLE lcm channel - Convert lcmt_viewer_link_data and lcmt_viewer_geometry_data to meshcat's triangle meshes.
New features
