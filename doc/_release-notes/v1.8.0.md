...
* TBD [perception] Normalize normals in PointCloud::VoxelizedDownSample ([#17945][_#17945])  # The average of normals is not in general unit length. This fix adds the extra normalization.
* TBD [perception] Fix PointCloud::Concatenate for XYZs only ([#17948][_#17948])  # I had a bad typo in the code which only populated xyzs if has_normals() was true.  This fixes it and adds more test coverage.
* Add PathParameterizedTrajectory ([#17816][_#17816])
* Add PointCloud::Crop and Concatenate ([#17829][_#17829])
* Add PointCloud::EstimateNormals ([#17914][_#17914])
...
* TBD [tools] Teach clang-format about C++20 and C++23 headers ([#17944][_#17944])
...
``drake-20220918-{focal|mac}.tar.gz``. See [Stable Releases](/from_binary.html#stable-releases) for instructions on how to use them.
