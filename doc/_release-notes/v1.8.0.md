...
* TBD [pydrake] Enable return-None cases for System event handlers ([#17859][_#17859])
New features
...
* TBD [workspace] Upgrade abseil_cpp_internal to latest commit ([#17872][_#17872])
* TBD [workspace] Upgrade bazel_skylib to latest release 1.3.0 ([#17872][_#17872])
* TBD [workspace] Upgrade dm_control_internal to latest commit ([#17872][_#17872])
* TBD [workspace] Upgrade lcm to latest commit ([#17872][_#17872])
* TBD [workspace] Upgrade optitrack_driver to latest commit ([#17872][_#17872])
* TBD [workspace] Upgrade picosha2 to latest commit ([#17872][_#17872])
* TBD [workspace] Upgrade pycodestyle to latest release 2.9.1 ([#17872][_#17872])
* TBD [workspace] Upgrade rules_python to latest release 0.12.0 ([#17872][_#17872])
