...
* TBD Add LinearConstraint::RemoveTinyCoefficient ([#17182][_#17182])
...
* TBD [geometry/optimization] Fix GetSolution for x_v in GraphOfConvexSets ([#17199][_#17199])  # Resolves #17167
* TBD [parsing] Add warnings for unsupported joint actuators ([#17178][_#17178])  # Change some related exceptions into diagnostic errors.
* TBD [plant] Improve error message in case of algebraic loop ([#17168][_#17168])  # Currently non-contact forces' calculation depends on input ports but is not marked so. As a result, algebraic loops may go undetected. This patch throws an exception at runtime when the algebraic loop is triggered instead of going into an infinite recursion.
New features
...
* TBD [pydrake] Deprecate old Python-based meshcat implementation ([#17194][_#17194])
* TBD Deprecate Polynomial::EqualToAfterExpansion ([#17202][_#17202])
* TBD [common] Monomial.ToExpression.is_expanded is true ([#17201][_#17201])  # This makes almost no difference in the benchmarks, but could turn out to be important later. In any case, it offends my sensibilities for a Monomial to claim to be un-expanded.
* None
