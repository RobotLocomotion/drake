...
* TBD [geometry,examples] [geometry] Move RenderEngineVtk into its own directory ([#17169][_#17169])  # Deprecate the older paths, and non-factory access to VtkRenderEngine.
New features
...
* TBD Remove support for Binder ([#17158][_#17158])
