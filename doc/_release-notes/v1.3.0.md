...
* Add missing `py::return_value_policy::copy` on a various bound attributes ([#17126][_#17126])
...
* Add Python binding for Parser::SetStrictParsing ([#17181][_#17181])
...
* Add Python binding for Polynomial::EqualToAfterExpansion ([#17128][_#17128])
* Add Python bindings for implicit dynamics ([#17032][_#17032])
* Add Python bindings for MultibodyPlant::GetRigidBodyByName() ([#17042][_#17042])
* Add Python bindings for MathematicalProgram variable scaling ([#17200][_#17200])
...
* drake::symbolic::Polynomial::EqualToAfterExpansion ([#17202][_#17202])
  * Use `Polynomial(...).Expand().EqualTo(other_polynomial.Expand())` instead.
