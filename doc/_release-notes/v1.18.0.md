...
* [feature] TBD [sensors] Add RgbdSensorAsync ([#19553][_#19553])
New features
...
* [feature] TBD Adds SaveIrisRegionsYamlFile and LoadIrisRegionsYamlFile to pydrake ([#19612][_#19612])  # In order to serialize a dictionary of Iris regions in both C++ and Python, this PR defines the type and adds the bespoke serialization wrapper for pydrake.
New features
