...
* TBD [solvers] Manually propagate exceptions within SNOPT ([#17272][_#17272])  # Without this, the macOS EH ABI cannot cross a C++/C boundary and would otherwise abort.
New features
...
* TBD [multibody,systems] [plant] Move scalar conversion constructor to cc file ([#17354][_#17354])  # This is a breaking change in the sense that anyone who has accidentally called this internal-use only constructor might now receive a linker error. C++ users should call, e.g., System::ToAutoDiffXd instead of this constructor. Python users are unaffected.
New features
...
* TBD Add [[nodiscard]] to symbolic::Polynomial functions ([#17330][_#17330])
...
* TBD [workspace] Upgrade abseil_cpp_internal to latest commit ([#17352][_#17352])
* TBD Bump CRU and VGT to address Clang warnings ([#17359][_#17359])
...
<!--
  ...
  Current newest_commit 9a9c2f4574a3331ca2b22d359695aaff0e3420e3 (inclusive).
-->
