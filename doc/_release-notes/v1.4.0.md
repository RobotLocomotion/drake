...
* TBD Check if influence_value_offset is strictly positive and finite in MinimumValueConstraint ([#17404][_#17404])
New features
...
* TBD expose parameters in QuadrotorPlant ([#17402][_#17402])
...
* TBD Set joint velocity limits for iiwa and jaco arms ([#17407][_#17407])  # * The existing limits were placeholder values. * For the iiwa, we have empirical limits for FRI control. * For the jaco, we have documented limits from the manual.
...
* TBD [workspace] Remove macOS python-tk dependency ([#17389][_#17389])  # Tkinter is no longer used directly by drake, and on macOS the plotting backend default uses Cocoa.  Therefore tkinter is no longer needed.  See also: #14702.
* TBD Remove more data from wheels ([#17401][_#17401])  # Tweak wheel generation to remove additional data files. This is necessary as recent changes have caused us to exceed the PyPI size limit. Co-authored-by: Jeremy Nimmer <jeremy.nimmer@tri.global>
...
<!--
  ...
  Current newest_commit ac6cc076133d4b317642b400cb3ae40cec288470 (inclusive).
-->
