...
* TBD [solvers] Deprecate fbstab ([#17416][_#17416])  # It is unused within Drake and has forked into a different upstream.
New features
...
* TBD [workspace] Upgrade gz_utils to latest release 1.4.0 ([#17417][_#17417])  # Fix release heuristics to locate new releases.
...
<!--
  ...
  Current newest_commit ba97b0f407049ff4afd8463db9f7ba68e55af19f (inclusive).
-->
