...
* TBD [geometry,examples,systems,multibody] [geometry] Rename frame_kinematics_vector.* ([#17329][_#17329])
* TBD [geometry] Add stub for frame_kinematics_vector.h ([#17329][_#17329])
* TBD [geometry,examples,systems] [geometry] Generalize FrameKinematicsVector ([#17329][_#17329])  # Change FrameKinematicsVector to KinematicsVector and allow it to key on more than FrameId. Add a new alias GeometryConfigurationVector which instantiates KinematicsVector<GeometryId, VectorX<T>>. Deprecate KinematicsVector::frame_ids().
New features
...
<!--
  ...
  Current newest_commit 528afeec451d873c966d19d77088d1d4076e150f (inclusive).
-->
