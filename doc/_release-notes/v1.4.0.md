...
* TBD [solvers,systems] add [[nodiscard]] to solvers folder ([#17380][_#17380])
New features
...
* TBD [multibody] Add support for MJCF to Parser ([#17358][_#17358])  # This adds the plumbing to parse into the MuJoCo format (MJCF) from the main Parser class. Resolves #16369.
New features
...
* TBD Evaluate polynomial (with affine coefficients) on a batch of indeterminates ([#17357][_#17357])  # .
* TBD [common,solvers] DecomposeAffineExpression passes coeffs as a pointer ([#17348][_#17348])  # Previously we pass coeffs as a const reference, and use const_cast to modify the value of coeffs. This violates GSG.
* TBD [lcm,systems,examples] [lcm] Add option for a channel name suffix ([#17337][_#17337])  # * [lcm] Add params struct and option for a channel suffix Deprecate the two-argument constructor.
...
<!--
  ...
  Current newest_commit a3a2ae53129794e0e7ccfe64c663b8d76a50e6ce (inclusive).
-->
