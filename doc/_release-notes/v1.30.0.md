...
* [fix] TBD Bind the tolerance argument when constructing a VPolytope from an HPolyhedron ([#21536][_#21536])
New features
...
* [feature] TBD Add tutorial on specifying custom gradients ([#21502][_#21502])  # * PR comments and more text and illustrations * Fix math * Another math fix * update to 3 constr; use chain rule (#1) * Tweak circle poses to have less ambiguous minimum, apply text suggestions * Fix typo * PR comments * Fix variable names and indexing * Fix preamble * Wow it even wants a newline * Move intro to preamble --------- Co-authored-by: Eric Cousineau <eric.cousineau@tri.global>
* None
...
* [fix] TBD [workspace] Upgrade curl_internal to latest release 8.8.0 ([#21544][_#21544])  # Co-authored-by: Jeremy Nimmer <jeremy.nimmer@tri.global>
* [fix] TBD [workspace,solvers] [workspace] Upgrade crate_universe to latest ([#21543][_#21543])  # [workspace] Upgrade clarabel_cpp_internal to latest release 0.9.0 Co-authored-by: Jeremy Nimmer <jeremy.nimmer@tri.global>
...
<!--
  ...
  Current newest_commit 32c907745ab91f04e8923e639994382143f88d5e (inclusive).
-->
