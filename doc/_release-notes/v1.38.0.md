...
* [breaking change] TBD [planning] Deprecate MaxCliqueSolverBase::Clone ([#22425][_#22425])  # Remove MaxCliqueSolverBase::DoClone overriding in pydrake (breaking change). Also clean up a few GSG inline dtor violations.
...
* [feature] TBD [sensors] Add parameters to RgbdSensorAsync ([#22427][_#22427])  # This patch is roughly the parallel of recent parameterization upgrades for RgbdSensor. It adds context parameters for much of the configuration of RgbdSensorAsync, and deprecates some of the old accessor methods.
