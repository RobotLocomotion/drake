...
* Build changes
  ...
  * When building from source, Drake can optionally build blas and lapack from
    ...
    For CMake users, set WITH_USER_BLAS and/or WITH_USER_LAPACK to OFF to have
    Drake build them from source.
...
* Drake's generated C++ LCM message headers now use std::array ([#20761][_#20761]). The class drake::EigenMapView might help with porting.
