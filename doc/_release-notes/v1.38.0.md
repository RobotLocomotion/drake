...
* [newly deprecated] TBD [systems,examples] [estimators] Deprecate one overload of SteadyStateKalmanFilter ([#22563][_#22563])
New features
...
* [fix] TBD [geometry,workspace] [workspace] Upgrade tinyobjloader_internal to latest commit ([#22564][_#22564])  # Remove upstreamed patch and unnecessary regression test. Co-authored-by: Sean Curtis <sean.curtis@tri.global>
New features
...
* [feature] TBD [common,workspace] [common] Enable serialization for MemoryFile ([#22560][_#22560])  # Co-authored-by: Sean Curtis <sean.curtis@tri.global>
...
* [fix] TBD [tools,setup] [build] macOS binary packages no longer use brew eigen/fmt/spdlog ([#22519][_#22519])  # When making a *.tar.gz binary release, don't use Homebrew for C++ dependencies (eigen, fmt, spdlog), because it offers absolutely no version stability. Instead, our packages will incorporate fmt and spdlog inside libdrake.so and provide the eigen, fmt, spdlog headers alongside Drake's headers. Also demote pkg-config to source_distribution; it hasn't been needed in binary_distribution since 78eaea83.
...
* [fix] TBD [workspace] Upgrade spral_internal to latest release v2025.01.08 ([#22567][_#22567])  # Co-authored-by: Jeremy Nimmer <jeremy.nimmer@tri.global>
* [fix] TBD [workspace] Upgrade stable_baselines3_internal to latest release v2.5.0 ([#22566][_#22566])  # Co-Authored-By: Jeremy Nimmer <jeremy.nimmer@tri.global>
* [fix] TBD [workspace] Upgrade openusd_internal to latest release v25.02 ([#22568][_#22568])  # Co-authored-by: Rick Poyner <rick.poyner@tri.global>
...
<!--
  ...
  Current newest_commit 73c9b1061301b723481c6798ffc5c389aa1c3965 (inclusive).
-->
