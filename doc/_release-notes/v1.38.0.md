...
* [feature] TBD Implement continuous- to discrete-time conversion for affine systems ([#22601][_#22601])
New features
...
* [fix] TBD MultibodyPlant hinders writing user non-finite values to context ([#22594][_#22594])  # MultibodyPlant::SetFoo(context, vector): when writing user-provided configuration values (qs and vs) into the context, we throw if the input has non-finite values. Includes the following APIs: - SetPositions() - 3 overloads - SetPositionsAndVelocities() - 2 overloads - SetDefaultPositions() - 2 overloads - SetVelocities() - 3 overloads - SetVelocitiesInArray()
New features
...
* [feature] TBD KinematicTrajectoryOptimization adds velocity linear constraint ([#22599][_#22599])  # Use the placeholder variable in the constraint binding. Adds a linear constraint on the decision variable when the user wants lb <= A * qdot(s * T) <= ub.
* [feature] TBD Growing IRIS-ZO Regions Along a Parametrized Subspace ([#22558][_#22558])
New features
...
<!--
  ...
  Current newest_commit ea20a5d7cba0dbfe801f898fb5885c5ad77b5ae9 (inclusive).
-->
