...
* [fix] TBD [ik] Allow non-world floating joints without crashing ([#22578][_#22578])  # Also set initial guess for non-quaternion dofs, as a convenience.
New features
...
* [fix] TBD [workspace] Remove unused and bitrotted gurobi_cxx target ([#22571][_#22571])
...
<!--
  ...
  Current newest_commit bd6ada0e60e8d2dbabd1a8d17e33027d1a7714d4 (inclusive).
-->
