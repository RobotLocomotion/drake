...
* [breaking change newly deprecated] TBD Nuke JointImplementation & JointImplementationBuilder ([#22620][_#22620])  # Also relaxed Joint protected API stability policy, see PR description.
* [feature] TBD Generalize mujoco defaults parsing ([#22625][_#22625])  # This adds immediate support for defaults in actuators and contact pairs and makes it easier to support defaults for future parsing features.
New features
...
* [fix] TBD Collision checker protects itself from user-provided NaN ([#22593][_#22593])  # When users provide the configuration vector, we immediately test for NaNs. Some context-variants of the public APIs are implicitly tested (as they were in the tests before this change).
New features
