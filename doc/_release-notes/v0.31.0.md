...
* Add bindings for SolverInterface::enabled ([#15107][_#15107])
* Remove deprecated code 2021-06 ([#15108][_#15108])
...
* Make `setup_drake_colab(*, build)` required; add more documentation about using releases ([#14482][_#14482])
...
* Stop installing `geometry` headers that dependend on non-installed third-party header files (`fcl`) ([#15070][_#15070])
