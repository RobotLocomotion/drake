...
Drake will eventually have a wide suite of simulated sensors. As these tools
expand, we'll include video highlighting their functionality.

This video is asneak preview of an RGB sensor model using an advanced
illumination model provided by `OSPray <https://www.ospray.org/>`_. This video was
created inserting a virtual RGB camera into the simulation of the controlled
