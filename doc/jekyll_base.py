...
def _minify(input_dir):
    # installed plugins
    bounce_js = "/usr/share/javascript/jquery-throttle-debounce/jquery.ba-throttle-debounce.js"  # noqa
    images_loaded_js = "/usr/share/javascript/imagesloaded/imagesloaded.pkgd.js"  # noqa
    # third party plugins
    ...
    plugins = [bounce_js, images_loaded_js, history_adapter_js,
               history_js, waypoint_js]
