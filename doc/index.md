    ...
    <div class="grid grid-3col">
      <div class="core-el">
        ...
        <div class="core-el-buttons">
          <a class="button--text" href="/doxygen_cxx/group__systems.html" target="_blank">API</a><a class="button--text" href="/tutorials/dynamical_systems.html" target="_blank">TUTORIAL</a>
        </div>
      </div>
      <div class="core-el">
        <h4>Solving Mathematical<br> Programs</h4>
        <div class="core-el-buttons">
          <a class="button--text" href="/doxygen_cxx/group__solvers.html" target="_blank">API</a><a class="button--text" href="/tutorials/mathematical_program.html" target="_blank">TUTORIAL</a>
        </div>
      </div>
      <div class="core-el">
        <h4>Multibody Kinematics<br> and Dynamics</h4>
        <div class="core-el-buttons">
          <a class="button--text" href="/doxygen_cxx/group__multibody.html" target="_blank">API</a><a class="button--text" href="/tutorials/authoring_multibody_simulation.html" target="_blank">TUTORIAL</a>
        </div>
      </div>
    </div>
  </div>
...
you start by
[browsing the tutorials online](/tutorials/index.html).
For a more interactive experience after that, you may run the tutorials locally
via `pip`; refer to
