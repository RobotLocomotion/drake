...
\newcommand{\doxygen}{https://groups.csail.mit.edu/locomotion/private/robotlibdoc/DoxygenMatlab/html}

\usepackage{xcolor}
% switch to other comment command to remove all comments.
\newcommand{\todo}[1]{\marginpar{\tiny\color{blue}#1\raggedright}}

\title{{\Huge MIT \robotlib}\\ {\huge A Nonlinear Dynamics and Control Toolbox}}
