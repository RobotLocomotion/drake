...
9. Find a plausible build to use
   ...
   c. Open the latest builds from the following builds:
      ...
      0) https://drake-jenkins.csail.mit.edu/view/Packaging/job/mac-catalina-unprovisioned-clang-bazel-nightly-snopt-packaging/
      1) https://drake-jenkins.csail.mit.edu/view/Packaging/job/linux-bionic-unprovisioned-gcc-bazel-nightly-snopt-packaging/
   ...
   4. Check the logs for those packaging builds and find the URLs they posted
      ...
      with today's date (they kick off after midnight).  All of the builds should have the same date. If not, wait until the following night.
