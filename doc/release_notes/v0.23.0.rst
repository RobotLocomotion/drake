...
* TBD py sensors: Ensure keep_alive for Image[].data is honored (`#14015`_)  # Test does not indicate a difference in Drake, but avoids a segfault in Anzu
* TBD jupyter: more robust fail fast when running as non-interactive kernel (`#14025`_)  # my bazel test script on travis ubuntu has been failing because get_ipython() returns an object, but not one that has a usable kernel. https://github.com/RussTedrake/manipulation/runs/1077702318?check_suite_focus=true This makes it more robust.
* TBD Add jupyter widget version of JointSliders (`#14017`_)  # Co-authored-by: Russ Tedrake <russt@mit.edu>
* TBD jupyter_widgets: Make testing instructions more explicit (`#14027`_)
...
.. _#14027: https://github.com/RobotLocomotion/drake/pull/14027
...
..
  ...
  Current newest_commit 8581223802b7790504529b9d66f1f1aab6eaaee9 (inclusive).
