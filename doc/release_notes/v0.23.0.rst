...
* The drake/common/symbolic.h headers now ``#error`` when included incorrectly (`#14003`_).
...
* TBD Add a construtor to allow IDC to own the input plant (`#14037`_)
...
* TBD Add .png schematic and improved documentation to show Parent/Child bodies and joint M/F frames (aka Jp/Jc frames) (`#13961`_)
...
* TBD AutoDiffScalar: move-aware rewrites of more math (`#14045`_)  # Relevant to: #13985, #14039 Rewrite various global-scope math functions on AutoDiffScalars to exploit pass-by-value optimizations; demonstrate resulting improvements via lowered allocation counts in the heap test. The issues noted above give more context.
...
* TBD pydrake: Add {start,end}_time() to Trajectory (`#14049`_)
...
* TBD Revert "workspace: Update pybind11 fork to latest commit" (`#14046`_)  # We believe the PR #14028 "workspace: Update pybind11 fork to latest commit" caused a failure in drake-external-examples:macos catalina 10.15. This reverts commit 21035a5554457737ae5707ba964472f3a3cb7765.
* TBD Restore "workspace: Update pybind11 fork to latest commit" (`#14048`_)  # This reverts commit 690a7eacd136c842d2a7aeda7a5228cfa9d7af95.
...
* Upgrade pybind11 fork to latest commit (`#14028`_)
...
.. _#13961: https://github.com/RobotLocomotion/drake/pull/13961
