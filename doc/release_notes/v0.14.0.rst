...
..
  ...
  Changelog newest_commit 456e8917892ae7c718c83667e1785986fd4265ea (inclusive).
...
* Deprecate iiwa_wsg_simulation (`#12581`_)  # It was built on a lot of RBT infrastructure.  manipulation_station is a more modern example of the same idea.
* py deprecation: Remove "Please see ..." addendum (`#12578`_)
