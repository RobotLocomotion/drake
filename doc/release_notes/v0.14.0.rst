...
* Error out on now-unsupported --config=snopt_fortran (`#12549`_)
* Update recommended Bazel version to 2.0 (`#12526`_)
* Remove stale TODOs in common (`#12540`_)
* Deprecate common/drake_nodiscard.h (`#12539`_)
...
* Move GitHub token filename for relnotes to command line, not environ
  (`#12518`_)
...
This release provides `pre-compiled binaries <https://github.com/RobotLocomotion/drake/releases/tag/v0.14.0>`__ named ``drake-20120113-{bionic|mac}.tar.gz``. See https://drake.mit.edu/from_binary.html#nightly-releases for instructions on how to use them
