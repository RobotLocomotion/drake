...
* First implementation of general region of attraction code (`#12827`_)  # Implements the convex formulation of searching for a maximal level set of a Lyapunov candidate. Working towards #10863
* [geometry] Add half space-BVH collision support (`#12840`_)  # A BVH can now be collided against a half space.
* doc: Note that GCC 7.5 is now Ubuntu's default compiler (`#12845`_)
