...
* Added ability to generate pybind coverage stats (`#12040`_)
* Removed dead code from mkdoc.py (`#12818`_)
...
* add pybind11/eigen.h to pydrake/solvers (`#12737`_)  # Co-Authored-By: Eric Cousineau <eric.cousineau@tri.global>
