...
New hydroelastic contact model in progress (`#12455`_, `#12358`_, `#12348`_, `#12333`_, `#12323`_, `#12378`_, `#12417`_, `#12311`_, `#12347`_)

* Still only experimental.
* Increased the number and types of shapes supported in the prototype.
* Added more visualization infrastructure.
