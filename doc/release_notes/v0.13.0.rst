...
* Added Ellipsoid parsing from SDF (`#12324`_)
* Extend shape support in hydroleastic contact model

  * Rigid Meshes supported (`#12455`_)
  * Fully support soft and rigid for Sphere, Box, Cylinder, and Ellipsoid (`#12358`_, `#12348`_, `#12333`_, `#12323`_)

* Extend Capsule Shape support for proximity queries (`#12343`_, `#12332`_)
* Ability to export surface and volume mesh fields for VTK (Paraview) visualization (`#12311`_)
* Initial implementation of Bounding Volume Hierarchy (BVH) to accelerate mesh-mesh hydroelastic contact -- not complete yet (`#12347`_)
* Added new generalized acceleration ports to MultibodyPlant (`#12354`_)
...
* Clarify and unify definition of surface normal direction for ContactSurface (`#12432`_, `#12463`_)
* Removed expensive and unused "referring triangles" from SurfaceMesh (`#12438`_)
* Update instructions for tasks related to adding new Shape sub-classes (`#12372`_)
* Update documentation of QueryObject::ComputeContactSurfaces() to reflect the current state of hydroelastic contact support (`#12413`_)
...
* Feature: Hydroelastic spatial force visualization adds spatial forces (`#12378`_, `#12417`_)
...
..
  ...
  Current newest_commit e7f352d26827b37d63d8f609ee0a4d5195ccf9b3 (inclusive).
