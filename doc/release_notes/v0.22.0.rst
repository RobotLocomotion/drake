...
* .bazelignore,doc: Ignore debian directory during bazel build and doxygen doc generation (`#13766`_)
* CPPLINT.cfg: cpplint: Disable whitespace/todo (`#13763`_)  # In preparation for enabling C-style comment linting, we disable the whitespace rules for TODOs.  They go beyond what GSG demands, and it is unclear how to apply them to C-style comments.
* attic,common,examples,geometry,math,multibody,solvers,systems: Fix line length and whitespace nits throughout (`#13762`_)  # Remove commented-out attic code that defeats the new cpplint. These problems were highlighted by forthcoming changes to cpplint.
* attic,doc,examples,manipulation,multibody,systems,tools: Mow over all XML files with xmllint (`#13768`_)
...
* doc,setup: setup: Update recommended Bazel version to 3.4 (`#13743`_)
* doc,tools: doc: Update code style guide for Python 3 and docstrings (`#12236`_)  # workspace: Bump styleguide fork to latest
* doc: doc: Add release notes v0.21.0 (`#13724`_)
...
* geometry,systems: Add NOLINT markers to overly-wide non-markdown tables (`#13805`_)
