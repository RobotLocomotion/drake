...
* common,geometry,multibody,systems,tools: Prefer triple-quote for C++ multi-line string literals (`#13811`_)  # To help naive readers better understand this unusual construction, we'll use a marker similar to Python's multi-line literal and apply the style uniformly across the codebase.
...
* bindings: py tree: Improve testing for random distributions and accessors (`#13817`_)
