...
* YamlReadArchive now offers strictness options (`#13532`_).
...
* Remove attic symbols from pydrake.all (`#13315`_).
...
* Make DiagramContext use the DiagramDiscreteValues type (`#13536`_)
...
* yaml: Add configurable policies for missing items (`#13537`_, `#13532`_)
...
* manipulation: Use latching input (not parameter) for no-op IIWA command (`#13340`_, `#13540`_)
...
* manipulation: Fix collision geometries of the panda arm URDF (`#13550`_)
...
* pydrake.solvers.csdp.CsdpSolver (`#13544`_)
* pydrake.solvers.csdp.CsdpSolverDetails (`#13544`_)
* pydrake.solvers.sdpa_free_format.GenerateSDPA (`#13546`_)
...
* Add support for Ubuntu 20.04 Focal Fossa (`#13266`_, `#13283`_, `#13306`_,
  ...
  `#13486`_, `#13487`_, `#13502`_, `#13508`_, `#13553`_)
...
* On macOS, pin Sphinx to versions below 3.1 (`#13535`_)
...
``drake-20200615-{bionic|focal|mac}.tar.gz``. See :ref:`Nightly Releases
