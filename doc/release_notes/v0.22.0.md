...
* Add Depth16U and Grey8U support to ImageWriter (`#13871`_)
...
* Add PoseSliders system for Jupyter widgets integration (`#13849`_)
* Deprecation annotations may pass a date=YYYY-MM-DD kwarg (`#13730`_)

Fixes

* Fix ConnectDrakeVisualizer keep-alive behavior (`#13868`_)

Newly bound

* pydrake.common.eigen_geometry.Quaternion.slerp (`#13810`_)
* pydrake.systems.framework.LeafOutputPort.disable_caching_by_default (`#13881`_)
...
``drake-20200817-{bionic|focal|mac}.tar.gz``. See :ref:`Nightly Releases
