...
* Update to Gurobi 9.0.2 and use GUROBI_HOME instead of GUROBI_PATH (`#13049`_)  # * Update to gurobi9. * Use gurobi 9.0.2 instead of 9.0.0 * Use GUROBI_HOME instead of GUROBI_PATH environment variable.
* Add module for "accuracy" and "tolerance" conventions (`#13267`_)
* Update FCL to latest commit (`#13274`_)  # Fixes seg-fault for contact between convex and half space
