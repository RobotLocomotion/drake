...
simulator to the newer ``MultibodyPlant``, including every example used by our
MIT users.
...
* The upgrade of spdlog to its latest release 1.5.0 (`#12669`_, below) fixes a
...
* Upgrade fcl to latest commit (`#12694`_)
...
* Upgrade styleguide to latest commit (includes cpplint changes) (`#12687`_)
