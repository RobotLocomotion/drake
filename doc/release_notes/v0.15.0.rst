...
This release includes major ports of consumers of the legacy ``RigidBodyTree``
simulator to the newer ``MultibodyTree``, including every example used by our
MIT users.

A number of subsitutes for what are now C++ standard library mechanisms have
...
* Update pybind11 fork to latest commit (`#12641`_)
  ...
  * This fixes a bug that caused false cache hits for overloads (`#12589`_)
