...
* Move remaining acrobot monte carlo material out of dev (`#14541`_)
* Fix ``acrobot`` Spong controller LCM communication to actually work
  (`#14525`_)
...
* Allow ``yaml`` to operate on non-default MaxRows or MaxCols storage
  (`#14618`_)
...
* Bind ``MathematicalProgram::NewNonnegativePolynomial`` (`#14627`_)
...
* Add support for macOS Big Sur 11.x (`#14632`_, `#14608`_, `#14608`_,
  `#14608`_)
* Update ``voxelized_geometry_tools`` for new device voxelizer interface
  (`#14600`_)
* Upgrade fcl to latest commit (`#14620`_)
* Fix ``pathutils.bzl`` globbing vs double-star matching (`#14564`_)
* Add retry to apt-get/brew update calls and add flag to skip update altogether
  (`#14492`_)

.. Not installed:
     * Start gathering sharable performance benchmarking infrastructure
       (`#14505`_)
...
* ``drake::multibody::MultibodyPlant::CalcCenterOfMassPosition`` (`#14538`_)

Python

* ``pydrake.multibody.plant.MultibodyPlant.CalcCenterOfMassPosition``
  (`#14538`_)
* ``pydrake.common.ToleranceType.absolute`` (`#14592`_)
* ``pydrake.common.ToleranceType.relative`` (`#14592`_)
