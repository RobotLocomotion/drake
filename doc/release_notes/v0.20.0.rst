...
Newly bound
* TBD Add bindings for SceneGraphInspector and Shapes (`#13559`_)
* TBD Add python binding for MPResult.set_x_val (`#13577`_)
* TBD Added binding for MBP.CalcCenterOfMassPosition (`#13594`_)
* TBD Add bindings for AcrobotPlant (`#13556`_)
