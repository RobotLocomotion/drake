...
4. Download ``gurobi10.0.2_linux64.tar.gz`` from [DOWNLOADS](https://packages.gurobi.com/10.0/gurobi10.0.2_linux64.tar.gz). You may need to manually edit the URL to get the correct version.
...
2. Set up your Gurobi license file in accordance with Gurobi documentation.
3. ``export GRB_LICENSE_FILE=/path/to/gurobi.lic``
4. Download and install ``gurobi10.0.2_mac64.pkg`` from [DOWNLOADS](https://packages.gurobi.com/10.0/gurobi10.0.2_macos_universal2.pkg).
