...
bazel test --config=dbg common:polynomial_test       # Run one test in debug mode.
...
bazel build --config=dbg common:polynomial_test && \
  gdb bazel-bin/common/polynomial_test               # Run one test under gdb.

bazel test --config=dbg --config=clang --config=asan common:polynomial_test  # Run one test under AddressSanitizer.
