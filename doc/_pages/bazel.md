...
Drake supports any patch version of Gurobi 9.5. At time of writing, the most recent available version was 9.5.2; if using a newer patch version, the paths and file names above should be adjusted accordingly.
