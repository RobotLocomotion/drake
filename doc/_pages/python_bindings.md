...
location under `/opt/...` mentioned in Gurobi 12.0, or you must ensure that you
define the `${GUROBI_HOME}` environment variable, or specify
...
Program patterns that may create a lot of memory use include:
