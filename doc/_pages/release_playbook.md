...
1. Nagivate to the web page for the two Jenkins wheel builds you launched
   above, under the "Launch the wheel staging builds ..." paragraph.
2. Open the "Console Output" and scroll to the bottom to
...
3. Download the wheels built on Jenkins:
   - One wheel file for macOS.
   - Three wheel files for Ubuntu (3.8, 3.9, 3.10).
4. Run ``twine upload a.whl b.whl c.whl (etc)``, replacing the ``a.whl``
   placeholders with the paths to all of the files you downloaded.
