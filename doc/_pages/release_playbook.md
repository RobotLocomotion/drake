...
1. Choose the git sha that will be tagged as the release:
   ...
   2. Make sure <https://drake-jenkins.csail.mit.edu/view/Nightly%20Production/>
      ...
      ignore).
   3. Using <https://github.com/RobotLocomotion/drake/commits/master/> as a
      reference, find a git sha to use for the release. Typically it will be the
      last commit from the prior day.
