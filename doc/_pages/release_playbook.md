...
4. Change "sha1" to the **git sha** corresponding to ``v1.N.0`` and
   "release_version" to ``1.N.0``.
5. Click "Build"; the build will finish after approximately 75 minutes.
6. After it's finished, open the "Console Output" and find the URL of the built
   wheel, which will be something like
