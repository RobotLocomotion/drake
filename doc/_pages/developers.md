...
introduced with the Haswell architecture in 2013. You can easily build Drake
from source for an older machine if necessary; please use Stackoverflow to get
instructions.
