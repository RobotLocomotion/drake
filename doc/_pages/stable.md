...
be controlled at compile time via `-Werror=deprecated-declarations` and
`DRAKE_DEPRECATION_IS_SILENT`, and at runtime via
`DRAKE_DEPRECATION_RUNTIME_SEVERITY`; see the
