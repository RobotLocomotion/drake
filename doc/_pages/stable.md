...
Deprecation announcements appear in the [release notes](/release_notes/release_notes.html)
...
Refer to [Installation and Quickstart](/installation.html) for the current details.
