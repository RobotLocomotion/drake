...
interpreter. Otherwise, it uses `find_package(Python)` to try and find the Python
version supported by Drake on the host platform (falling back to finding any Python
version at all if needed). See
