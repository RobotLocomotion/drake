...
The error message will include one of the following:
  ...
  - `Context was not created for the FooSystem system '::_::foo'; it was created
    for the root diagram.`
  - `Context was not created for the root diagram; it was created for the system
    '::_::foo'.`
  - `Context was not created for BarSystem system '::_::bar'; it was created for
    the system '::_::foo'`
