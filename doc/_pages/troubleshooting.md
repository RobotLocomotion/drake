...
```bash
pip install manipulation[mesh] --extra-index-url https://drake-packages.csail.mit.edu/whl/nightly/
python -m manipulation.make_drake_compatible_model {input_file} {output_file}
```
