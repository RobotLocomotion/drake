...
* [https://github.com/RobotLocomotion/drake/releases/download/v1.57.0/drake-1.57.0-noble.tar.gz](https://github.com/RobotLocomotion/drake/releases/download/v1.57.0/drake-1.57.0-noble.tar.gz)
* [https://github.com/RobotLocomotion/drake/releases/download/v1.57.0/drake-1.57.0-noble-arm64.tar.gz](https://github.com/RobotLocomotion/drake/releases/download/v1.57.0/drake-1.57.0-noble-arm64.tar.gz)
* [https://github.com/RobotLocomotion/drake/releases/download/v1.57.0/drake-1.57.0-resolute-amd64.tar.gz](https://github.com/RobotLocomotion/drake/releases/download/v1.57.0/drake-1.57.0-resolute-amd64.tar.gz)
* [https://github.com/RobotLocomotion/drake/releases/download/v1.57.0/drake-1.57.0-resolute-amd64v3.tar.gz](https://github.com/RobotLocomotion/drake/releases/download/v1.57.0/drake-1.57.0-resolute-amd64v3.tar.gz)
* [https://github.com/RobotLocomotion/drake/releases/download/v1.57.0/drake-1.57.0-resolute-arm64.tar.gz](https://github.com/RobotLocomotion/drake/releases/download/v1.57.0/drake-1.57.0-resolute-arm64.tar.gz)
* https://github.com/RobotLocomotion/drake/releases/download/v1.57.0/drake-1.57.0-mac-arm64.tar.gz
...
```
curl -fsSLO https://github.com/RobotLocomotion/drake/releases/download/v1.57.0/drake-1.57.0-mac-arm64.tar.gz
```
...
```
wget -O drake.tar.gz https://github.com/RobotLocomotion/drake/releases/download/v1.57.0/drake-1.57.0-$(. /etc/os-release && echo $VERSION_CODENAME)-$(dpkg-query --show '--showformat=${Architecture-Variant}\n${Architecture}\n' libc6 | grep -m 1 .).tar.gz
```
