...
* `Modeling Dynamical Systems <http://drake.mit.edu/doxygen_cxx/group__systems.html>`_
	...
	* `Rigid-body kinematics and dynamics <http://drake.mit.edu/doxygen_cxx/group__rigid__body__systems.html>`_
		...
		* `Contact/collisions modeled with compliant contact <http://drake.mit.edu/doxygen_cxx/group__drake__contacts.html>`_ using continuous (differential equation) and discrete (difference equation, i.e., time stepping) models; **Coming soon**: hybrid models for rigid contact
