...
We have Python tutorials that can previewed and executed as Jupyter
notebooks online, with no need for local setup:
...
You may also find more information about running these locally
`in the source tree <https://github.com/RobotLocomotion/drake/tree/master/>`_.
