...
Building the Python bindings using CMake is the suggested way of consuming the Python bindings from Drake externally. To do so:
...
With your ``PYTHONPATH`` configured appropriately, you should be able to import pydrake. From the example above::
