...
.. note::
    ...
    If you are using Homebrew Python on Mac, you must ensure that you are using
    ``python2`` to execute these scripts.
    You may do this by either explicitly using ``python2`` on the command
    line, or follow the instructions from ``brew info python``::
