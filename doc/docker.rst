...
.. _ubuntu_1804_bionic_beaver_with_proprietary_nvidia_driver_390_and_cuda_90_support:

Ubuntu 18.04 (Bionic Beaver) with Proprietary NVIDIA Driver 390 and CUDA 9.0 Support
------------------------------------------------------------------------------------
...
Install the proprietary NVIDIA driver 390 and CUDA toolkit 9.0 from the Ubuntu
package archive:
...
::
  ...
  cd drake
  docker build \
    --file setup/ubuntu/docker/bionic/Dockerfile.nvidia-cuda-9.0-devel-ubuntu18.04 \
    --tag drake .
  docker run --interactive --runtime=nvidia --tty drake bash
