...
def _build(*, out_dir, temp_dir, modules, quick):
    ...
    # Fix the formatting of deprecation text.
    regexs = [
        # Remove quotes around the removal date.
        r's#(removed from Drake on or after) "(....-..-..)" *\.#\1 \2.#g;',
        # Remove quotes in the explanation.
