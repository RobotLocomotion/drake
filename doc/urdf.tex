...
\begin{itemize}
  \item \mcode{<collision_filter_group>}
    \begin{itemize}
      ...
      \item Elements
        \begin{itemize}
          \item \mcode{<member>} 
            ...
            \begin{itemize}
              \item Attributes: \mcode{link} (required) String naming that link. 
            \end{itemize}

          \item \mcode{<ignored_collision_filter_group>}
            ...
            \begin{itemize}
              \item Attributes: \mcode{collision_filter_group} (required)
