...
use Clang 4.0 on Ubuntu Xenial, set the ``CC`` environment variable before
running **bazel build**, **bazel test**, or any other **bazel** commands.
...
Cheat sheet for operating on the entire project::
  ...
  CC=clang-4.0 bazel build //...    # Build using Clang 4.0 on Xenial.
  CC=clang-4.0 bazel test //...     # Build and test using Clang 4.0 on Xenial.
