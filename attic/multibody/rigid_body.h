...
class RigidBody {
 public:
  ...
  /**
   * (Internal) Removes collision element group, but does NOT make the
   * necessary calls to `collision::Model::RemoveElement`. Because of this,
   * do NOT use this directly, but instead use
