...
class RigidTransform {
 public:
  ...
  // Isometry3 are discouraged. We promise that these methods will continue to
  // exist (though possibly marked as deprecated) until at least 2019-12-01.
  // N.B. Keep the deprecation date here in sync with the deprecation comment
  // inside drake/bindings/pydrake/math_py.cc.
