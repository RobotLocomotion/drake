...
void LoadMatrix3Inv(const double* R_BA, Vec4* adg_, Vec4* beh_, Vec4* cfi_) {
  ...
  //     The upper half of the result comes from the Foo part of `hi`.
  //     The lower half of the result comes from the Bar half of `lo`.
  ...
  //   Or with concrete examples:
  //     ConcatLowerLower(0123, 4567) => 4501
  //     ConcatUpperUpper(0123, 4567) => 6723
  //     ConcatLowerUpper(0123, 4567) => 6701
  //     ConcatUpperLower(0123, 4567) => 4523
  //
