...
/* Loads R_BA, transposed. Imagine R_BA in as doubles named 'abcdefghi'. Upon
return, the output arguments adg_, beh_, and cfi_ are filled with the like-
named elements of R_BA. (As usual, underscore means undefined / don't care.) */
