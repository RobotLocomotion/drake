...
GTEST_TEST(AdditionalAutodiffTest, InitializeAutoDiffTuple) {
  ...
  // FAIL(sherm1): this next line causes a compilation failure in Release
  // builds with this not-very-helpful message:
  // common/autodiffxd.h:123:26: error: '<anonymous>' may be used
  // uninitialized in this function [-Werror=maybe-uninitialized]
  //     m_value = other.value();
  //               ~~~~~~~~~~~^~
  // That line is in our AutoDiffXd assignment operator. Not clear whether
  // the warning is correct -- the tests all pass if I suppress the warning
  // or compile in Debug. Any ideas?
