...
GTEST_TEST(RotationMatrix, SymbolicProjectionTest) {
  ...
  // Even inputs that are far from orthonormal do not throw.  (This helps us to
  // cover more code within Eigen's SVD implementation.  The test case above
  // using an Identity has an early-return, skipping some of the code.)
  Matrix3d m;
  m << 1, 2,  3,
       4, 5,  6,
       7, 8, -10;
