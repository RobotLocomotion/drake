...
/// that takes an Isometry3d for the camera_pose.  If this port is
/// connected, then the point cloud is converted to the parent frame (e.g.
...
/// the camera_pose input is not connected, then the point_cloud output will
/// contain a PointCloud in the camera frame.
///
