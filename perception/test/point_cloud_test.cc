...
GTEST_TEST(PointCloudTest, VoxelizedDownSample) {
  ...
  auto CheckHasPointAveragedFrom =
      [](const PointCloud& cloud, const PointCloud& down_sampled,
  ...
  CheckHasPointAveragedFrom(cloud, down_sampled, {0});
  CheckHasPointAveragedFrom(cloud, down_sampled, {1, 2});
  CheckHasPointAveragedFrom(cloud, down_sampled, {3, 4, 5});
  ...
  EXPECT_EQ(down_sampled.size(), 3);
  CheckHasPointAveragedFrom(cloud, down_sampled, {5});
}
