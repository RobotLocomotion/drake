...
% Set up the model
load(fullfile(getDrakePath, '+examples', '+Atlas', 'data', 'atlas_fp.mat'), 'xstar');
r = examples.Atlas.Atlas(fullfile(getDrakePath, '+examples', '+Atlas', 'urdf', 'atlas_minimal_contact.urdf'));
