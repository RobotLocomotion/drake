function [xtraj,utraj,ltraj,v,p,info,trans_info]=runDirtran_Gcs(xtraj_init, utraj_init, ltraj_init, trans_info)
clear mex
% p = AcrobotPlant();
p = Gripper2D_gcs;
N = 30;
...
xf = [0;.6;0;2.25;-2;-.3;-.4;.5;zeros(8,1)];
...
xmax = [.1;inf;inf; pi; inf; pi/4; pi/4;pi/4;2*ones(8,1)];
...
% con.clambdai.ub.clambdai = repmat([repmat([inf;1],3,1); inf(8,1)],1,N);
...
options.IterationsLimit = 300000;
