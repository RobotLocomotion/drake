...
class Pool {
 ...
 private:
  ...
  static constexpr int kBurned = kOffset + 1;
};
...
class PoolVectorXd {
 public:
  ...
  PoolVectorXd& SetFromData(const double* data, int64_t dsize) {
    DRAKE_ASSERT(data == nullptr || data != data_);
