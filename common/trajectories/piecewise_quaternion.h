...
class PiecewiseQuaternionSlerp final : public PiecewiseTrajectory<T> {
 public:
   ...
   * @throws exception if breaks and quaternions have different length,
  ...
  /**
   * Builds a PiecewiseQuaternionSlerp.
   * @throws exception if breaks and rot_matrices have different length,
   * or breaks have length < 2.
   */
  PiecewiseQuaternionSlerp(
      const std::vector<double>& breaks,
  ...
  /**
   * Builds a PiecewiseQuaternionSlerp.
   * @throws exception if breaks and ang_axes have different length,
   * or breaks have length < 2.
   */
  PiecewiseQuaternionSlerp(
      const std::vector<double>& breaks,
