...
GTEST_TEST(StackedTrajectoryTest, StackTwoDiscreteColumnVectors) {
  const double t0 = 0.2;
  const double tf = 0.8;
  const Vector2d value_start_top(1, 2);
  const Vector2d value_start_bot(3, 4);
  const Vector2d value_end_top(11, 12);
  const Vector2d value_end_bot(13, 14);
...
GTEST_TEST(StackedTrajectoryTest, StackTwoDiscreteRowVectors) {
  const double t0 = 0.2;
  const double tf = 0.8;
  const RowVector2d value_start_top(1, 2);
  const RowVector2d value_start_bot(3, 4);
  const RowVector2d value_end_top(11, 12);
  const RowVector2d value_end_bot(13, 14);
