...
class Trajectory {
  ...
  */
  ...
  /**
   * Returns true iff the Trajectory provides an implementation for
   * EvalDerivative().  The derivative need not be continuous, but should return
   * a result for all t for which value(t) returns a result.
   */
