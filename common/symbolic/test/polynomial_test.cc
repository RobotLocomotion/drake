...
TEST_F(SymbolicPolynomialTest, CalcPolynomialWGramLower) {
  ...
  const auto poly1 = CalcPolynomialWGramLower(monomial_basis1, Q1_lower);
  EXPECT_PRED2(
  ...
  const auto poly2 = CalcPolynomialWGramLower(monomial_basis2, Q2_lower);
  ...
  const auto poly3 = CalcPolynomialWGramLower(monomial_basis2, Q3_lower);
