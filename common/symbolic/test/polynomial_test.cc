...
TEST_F(SymbolicPolynomialTest, CalcPolynomialWLowerTriangular) {
  ...
  const auto poly1 = CalcPolynomialWLowerTriangular(monomial_basis1, Q1_lower);
  EXPECT_PRED2(
  ...
  const auto poly2 = CalcPolynomialWLowerTriangular(monomial_basis2, Q2_lower);
  ...
  const auto poly3 = CalcPolynomialWLowerTriangular(monomial_basis2, Q3_lower);
