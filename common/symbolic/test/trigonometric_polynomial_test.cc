...
TEST_F(SubstituteStereographicProjectionTest, Test1) {
  // test cos(theta(0))
...
TEST_F(SubstituteStereographicProjectionTest, Test2) {
  // test 1.
...
TEST_F(SubstituteStereographicProjectionTest, Test3) {
  // test a + b
  CheckSubstituteStereographicProjection(
...
TEST_F(SubstituteStereographicProjectionTest, Test4) {
  // test 1 + cos(theta(0))
  CheckSubstituteStereographicProjection(
...
TEST_F(SubstituteStereographicProjectionTest, Test5) {
...
TEST_F(SubstituteStereographicProjectionTest, Test6) {
...
TEST_F(SubstituteStereographicProjectionTest, Test7) {
...
TEST_F(SubstituteStereographicProjectionTest, Test8) {
  // test t_angle(0)
  CheckSubstituteStereographicProjection(
...
TEST_F(SubstituteStereographicProjectionTest, Test9) {
...
TEST_F(SubstituteStereographicProjectionTest, Test10) {
...
TEST_F(SubstituteStereographicProjectionTest, Test11) {
...
TEST_F(SubstituteStereographicProjectionTest, Test12) {
  CheckSubstituteStereographicProjection(
...
TEST_F(SubstituteStereographicProjectionTest, Test13) {
...
TEST_F(SubstituteStereographicProjectionTest, Test14) {
  // (sin(theta(0)))²
  CheckSubstituteStereographicProjection(
...
TEST_F(SubstituteStereographicProjectionTest, Test15) {
...
TEST_F(SubstituteStereographicProjectionTest, Test16) {
  // a * x * t0 * cos(theta1)
  CheckSubstituteStereographicProjection(
