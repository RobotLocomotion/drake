...
// NOLINTNEXTLINE(build/include): Our header file is included by algebra.h.
#include "drake/common/symbolic/algebra/all.h"
/* clang-format on */
...
#include "drake/common/symbolic/algebra/formula_cell.h"
