...
Formula make_conjunction(const set<Formula, Formula::CompareLess>& formulas) {
  set<Formula, Formula::CompareLess> operands;
...
Formula make_disjunction(const set<Formula, Formula::CompareLess>& formulas) {
  set<Formula, Formula::CompareLess> operands;
  for (const Formula& f : formulas) {
    if (is_true(f)) {
...
const set<Formula, Formula::CompareLess>& get_operands(const Formula& f) {
