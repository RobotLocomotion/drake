...
TEST_F(SymbolicExpressionTest, Clamp2) {
  ...
  // The contract of std::clamp is very particular. When we have the absurd
  // case of lo > hi, the lo needs to win.
  EXPECT_EQ(e.Evaluate({{var_x_, 0}, {var_lo, 10}, {var_hi, 3}}), 10);
}
