...
class UnificationVisitor {
 ...
 private:
  ...
  // ExpressionLess>. For example, `3 + 2x + 3x²` is represented as
  //
  //     constant coefficient: 3
  //     ordered map: {x ↦ 2, x² ↦ 3}.
  //
  // Note that keys in std::map<Expression, double, ExpressionLess> is compared
  // by Expression::Less.
  //
  ...
  bool VisitAdditionAligned(
      const double c0_p, const map<Expression, double, ExpressionLess>& map_p,
      const double c0_e, const map<Expression, double, ExpressionLess>& map_e,
      Substitution* const subst) const {
  ...
  bool VisitAdditionSkewed(const map<Expression, double, ExpressionLess>& map_p,
                           const double c0_e,
                           const map<Expression, double, ExpressionLess>& map_e,
                           Substitution* const subst) const {
  ...
  bool VisitAdditionCheckPairs(
      map<Expression, double, ExpressionLess>::const_iterator it_p,
      map<Expression, double, ExpressionLess>::const_iterator it_e, const int n,
  ...
  // ExpressionLess> which maps a base expression to its exponent. For example,
  // `3 * pow(x, 2) * pow(y, 3)` is represented as
  //
  //     constant factor: 3
  //     ordered map: {x ↦ 2, y ↦ 3}.
  //
  ...
  bool VisitMultiplicationAligned(
      const double c_p,
      const map<Expression, Expression, ExpressionLess>& map_p,
      const double c_e,
      const map<Expression, Expression, ExpressionLess>& map_e,
      Substitution* const subst) const {
  ...
  bool VisitMultiplicationCheckPairs(
      map<Expression, Expression, ExpressionLess>::const_iterator it_p,
      map<Expression, Expression, ExpressionLess>::const_iterator it_e,
