...
symbolic::RationalFunction SubstituteStereographicProjectionImpl(
  ...
  if (non_sin_cos_vars.empty()) {
    ...
    // I first store the other indeterminates to set non_sin_cos_vars, and parse
    // e_poly as a polynomial of only sin_cos_vars. Convert this new polynomial
    // to rational function, and then reparse this new rational function with
    // indeterminates t + non_sin_cos_vars.
