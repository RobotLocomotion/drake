...
class PolynomialBasisElement {
 public:
  ...
  [[nodiscard]] const std::map<Variable, int, VariableLess>& var_to_degree_map()
      const {
   ...
   */
  [[nodiscard]] const std::map<Variable, int, VariableLess>& get_powers()
      const {
    return var_to_degree_map_;
  }
 ...
 protected:
  ...
  std::map<Variable, int, VariableLess>* get_mutable_var_to_degree_map() {
    return &var_to_degree_map_;
  }
 ...
 private:
  ...
  std::map<Variable, int, VariableLess> var_to_degree_map_;
  int total_degree_{};
};
