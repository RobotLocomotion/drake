...
#define DRAKE_SPECIALIZE_LDLT(SomeMatrix)                       \
template <>                                                     \
template <>                                                     \
...
DRAKE_SPECIALIZE_LDLT(drake::MatrixX<drake::symbolic::Expression>)
DRAKE_SPECIALIZE_LDLT(drake::MatrixUpTo6<drake::symbolic::Expression>)

#undef DRAKE_SPECIALIZE_LDLT
