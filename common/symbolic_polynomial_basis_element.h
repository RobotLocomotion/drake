 ...
 * a tie, then we use the lexicographical order as the tie breaker, but a
 * PolynomialBasisElement with higher order in lexicographical order is
 * considered lower order in graded reverse lexicographical order.
 *
 ...
 * order. The lexicographical order compares two monomials by first comparing
 * the exponent of the largest variable, if there is a tie then go forth to the
 * second largest variable. Thus z² > zy >zx > y² > yx > x². Finally reverse
 * the order as x² > xy > y² > xz > yz > z².
 *
