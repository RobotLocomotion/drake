...
struct SortedPair {
  ...
  // N.B. We leave all of the copy/move/assign operations defaulted, so that
  // iff T provides it, we also provide it.  Do not declare a destructor here,
  // or else those defaults will be nixed.
