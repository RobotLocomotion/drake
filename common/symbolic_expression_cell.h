...
class ExpressionAddFactory {
 public:
  ...
  explicit ExpressionAddFactory(const std::shared_ptr<ExpressionAdd>& ptr);

  /** Adds @p e to this factory. */
  void AddExpression(const Expression& e);
  /** Adds ExpressionAdd pointed by @p ptr to this factory. */
  void Add(const std::shared_ptr<ExpressionAdd>& ptr);
...
class ExpressionMulFactory {
 public:
  ...
  explicit ExpressionMulFactory(const std::shared_ptr<ExpressionMul>& ptr);

  /** Adds @p e to this factory. */
  void AddExpression(const Expression& e);
  /** Adds ExpressionMul pointed by @p ptr to this factory. */
  void Add(const std::shared_ptr<ExpressionMul>& ptr);
