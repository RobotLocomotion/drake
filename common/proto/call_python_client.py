...
def default_globals():
    ...
    if plt is None:
        raise NotImplementedError(
            "On Ubuntu when using the default pyplot configuration of"
            " MPLBACKEND=TkAgg you must 'sudo apt install python3-tk'"
            " to obtain the interative Tk backend. Alternatively, you"
            " may set MPLBACKEND to something else (e.g., Qt5Agg).")
