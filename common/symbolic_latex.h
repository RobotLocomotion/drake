...
// Generates a Latex string representation of `val` displayed as an integer
// the floating point values are zero, or with `precision`.
std::string ToLatex(double val, int precision);
