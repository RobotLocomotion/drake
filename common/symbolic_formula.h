...
/// Specialization of ExtractBoolOrThrow for `bool_t<symbolic::Expression>`
/// which includes `symbolic::Formula`. It calls `Evaluate` with an empty
/// environment.
template <>
inline bool ExtractBoolOrThrow(const bool_t<symbolic::Expression>& b) {
