...
class DecomposePolynomialVisitor {
 public:
  GenericPolynomial<MonomialBasisElement>::MapType Decompose(
 ...
 private:
  GenericPolynomial<MonomialBasisElement>::MapType Visit(
      const Expression& e, const Variables& indeterminates) const {
    return VisitExpression<GenericPolynomial<MonomialBasisElement>::MapType>(
        this, e, indeterminates);
  }

  GenericPolynomial<MonomialBasisElement>::MapType VisitVariable(
      const Expression& e, const Variables& indeterminates) const {
    const Variable& var{get_variable(e)};
    if (indeterminates.include(var)) {
      // Monomial : var, coefficient : 1
      return GenericPolynomial<MonomialBasisElement>::MapType{
          {{MonomialBasisElement{var}, 1}}};
    } else {
      // Monomial : 1, coefficient : var
      return GenericPolynomial<MonomialBasisElement>::MapType{
          {{MonomialBasisElement{}, var}}};
    }
  }

  GenericPolynomial<MonomialBasisElement>::MapType VisitConstant(
      const Expression& e, const Variables&) const {
    const double v{get_constant_value(e)};
    if (v != 0) {
      return GenericPolynomial<MonomialBasisElement>::MapType{
          {{MonomialBasisElement(), v}}};  // = v.
    }
    return GenericPolynomial<MonomialBasisElement>::MapType{};  // = 0.
  }

  GenericPolynomial<MonomialBasisElement>::MapType VisitAddition(
      const Expression& e, const Variables& indeterminates) const {
    // e = c₀ + ∑ᵢ (cᵢ * eᵢ)
    GenericPolynomial<MonomialBasisElement>::MapType new_map;
    ...
    for (const pair<const Expression, double>& p :
      ...
      const GenericPolynomial<MonomialBasisElement>::MapType map_i =
          Visit(e_i, indeterminates);
      for (const pair<const MonomialBasisElement, Expression>& term : map_i) {
        const MonomialBasisElement& m_j{term.first};
  ...
  GenericPolynomial<MonomialBasisElement>::MapType VisitMultiplication(
      const Expression& e, const Variables& indeterminates) const {
    ...
    for (const pair<const Expression, Expression>& p :
      ...
      const pair<MonomialBasisElement, Expression> result_i{
          VisitPow(base_i, exponent_i, indeterminates)};
      const MonomialBasisElement& m_i{result_i.first};
      const Expression& coeff_i{result_i.second};
      m.MergeBasisElementInPlace(m_i);
      coeff *= coeff_i;
    }
    return GenericPolynomial<MonomialBasisElement>::MapType{{m, coeff}};
  }
  ...
  pair<MonomialBasisElement, Expression> VisitPow(
    ...
    if (intersect(base.GetVariables(), indeterminates).empty()) {
      ...
      for (const Variable& var : base.GetVariables()) {
        if (indeterminates.include(var)) {
          m.MergeBasisElementInPlace(MonomialBasisElement(var, n));
        } else {
  ...
  GenericPolynomial<MonomialBasisElement>::MapType VisitPow(
      const Expression& e, const Variables& indeterminates) const {
  ...
  GenericPolynomial<MonomialBasisElement>::MapType VisitDivision(
      const Expression& e, const Variables& indeterminates) const {
    // e = e₁ / e₂
    ...
    // variables).
    GenericPolynomial<MonomialBasisElement>::MapType map{
        Visit(e1, indeterminates)};
    for (auto& item : map) {
      item.second /= e2;
    }
    return map;
  ...
  // indeterminate `x`.
  GenericPolynomial<MonomialBasisElement>::MapType VisitNonPolynomialTerm(
      const Expression& e, const Variables& indeterminates) const {
    // vars(e) ∩ indeterminates = ∅.
  ...
  GenericPolynomial<MonomialBasisElement>::MapType VisitAbs(
      const Expression& e, const Variables& indeterminates) const {
    return VisitNonPolynomialTerm(e, indeterminates);
  }

  GenericPolynomial<MonomialBasisElement>::MapType VisitLog(
      const Expression& e, const Variables& indeterminates) const {
    return VisitNonPolynomialTerm(e, indeterminates);
  }
  GenericPolynomial<MonomialBasisElement>::MapType VisitExp(
      const Expression& e, const Variables& indeterminates) const {
    return VisitNonPolynomialTerm(e, indeterminates);
  }
  GenericPolynomial<MonomialBasisElement>::MapType VisitSqrt(
      const Expression& e, const Variables& indeterminates) const {
    return VisitNonPolynomialTerm(e, indeterminates);
  }
  GenericPolynomial<MonomialBasisElement>::MapType VisitSin(
      const Expression& e, const Variables& indeterminates) const {
    return VisitNonPolynomialTerm(e, indeterminates);
  }
  GenericPolynomial<MonomialBasisElement>::MapType VisitCos(
      const Expression& e, const Variables& indeterminates) const {
    return VisitNonPolynomialTerm(e, indeterminates);
  }
  GenericPolynomial<MonomialBasisElement>::MapType VisitTan(
      const Expression& e, const Variables& indeterminates) const {
    return VisitNonPolynomialTerm(e, indeterminates);
  }
  GenericPolynomial<MonomialBasisElement>::MapType VisitAsin(
      const Expression& e, const Variables& indeterminates) const {
    return VisitNonPolynomialTerm(e, indeterminates);
  }
  GenericPolynomial<MonomialBasisElement>::MapType VisitAcos(
      const Expression& e, const Variables& indeterminates) const {
    return VisitNonPolynomialTerm(e, indeterminates);
  }
  GenericPolynomial<MonomialBasisElement>::MapType VisitAtan(
      const Expression& e, const Variables& indeterminates) const {
    return VisitNonPolynomialTerm(e, indeterminates);
  }
  GenericPolynomial<MonomialBasisElement>::MapType VisitAtan2(
      const Expression& e, const Variables& indeterminates) const {
    return VisitNonPolynomialTerm(e, indeterminates);
  }
  GenericPolynomial<MonomialBasisElement>::MapType VisitSinh(
      const Expression& e, const Variables& indeterminates) const {
    return VisitNonPolynomialTerm(e, indeterminates);
  }
  GenericPolynomial<MonomialBasisElement>::MapType VisitCosh(
      const Expression& e, const Variables& indeterminates) const {
    return VisitNonPolynomialTerm(e, indeterminates);
  }
  GenericPolynomial<MonomialBasisElement>::MapType VisitTanh(
      const Expression& e, const Variables& indeterminates) const {
    return VisitNonPolynomialTerm(e, indeterminates);
  }
  GenericPolynomial<MonomialBasisElement>::MapType VisitMin(
      const Expression& e, const Variables& indeterminates) const {
    return VisitNonPolynomialTerm(e, indeterminates);
  }
  GenericPolynomial<MonomialBasisElement>::MapType VisitMax(
      const Expression& e, const Variables& indeterminates) const {
    return VisitNonPolynomialTerm(e, indeterminates);
  }
  GenericPolynomial<MonomialBasisElement>::MapType VisitCeil(
      const Expression& e, const Variables& indeterminates) const {
    return VisitNonPolynomialTerm(e, indeterminates);
  }
  GenericPolynomial<MonomialBasisElement>::MapType VisitFloor(
      const Expression& e, const Variables& indeterminates) const {
    return VisitNonPolynomialTerm(e, indeterminates);
  }
  GenericPolynomial<MonomialBasisElement>::MapType VisitIfThenElse(
      const Expression& e, const Variables& indeterminates) const {
    return VisitNonPolynomialTerm(e, indeterminates);
  }
  GenericPolynomial<MonomialBasisElement>::MapType VisitUninterpretedFunction(
      const Expression& e, const Variables& indeterminates) const {
    return VisitNonPolynomialTerm(e, indeterminates);
  }
  ...
  // methods.
  friend GenericPolynomial<MonomialBasisElement>::MapType drake::symbolic::
      VisitExpression<GenericPolynomial<MonomialBasisElement>::MapType>(
          const DecomposePolynomialVisitor*, const Expression&,
          const Variables&);
};
...
GenericPolynomial<BasisElement>::GenericPolynomial(const Expression& e,
  ...
  if constexpr (std::is_same_v<BasisElement, MonomialBasisElement>) {
    ...
    const std::map<MonomialBasisElement, Expression>
