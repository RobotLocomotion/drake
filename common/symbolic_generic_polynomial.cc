...
GenericPolynomial<BasisElement>& GenericPolynomial<BasisElement>::operator+=(
  ...
  // this->AddProduct(1.0, m);
  // return *this;
  // I cannot do return AddProduct(1.0, m);
...
bool GenericPolynomial<BasisElement>::CoefficientsAlmostEqual(
  ...
  return GenericPolynomialEqual(
      (*this - p).RemoveTermsWithSmallCoefficients(tol),
      GenericPolynomial<BasisElement>(0), true);
}
