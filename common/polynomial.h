...
class Polynomial {
 ...
 public:
   ...
   * the polynomial with respect to @p x, evaluated at @p x.  @p
   * derivative_order = 0 (the default) returns the polynomial value without
   * differentiation.  @p derivative_order = 1 returns the first derivative,
   * etc.
   *
