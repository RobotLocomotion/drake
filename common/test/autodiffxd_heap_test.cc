...
// evidence that the technique is strictly necessary. However, all of the
// tested functions are marked `inline`, so future implementations may be
// vulnerable to dead-code elimination.
