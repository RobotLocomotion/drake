...
void CheckSubstituteStereographicProjection(
  ...
  const symbolic::RationalFunction e_rational2 =
      SubstituteStereographicProjection(e_poly, cos_vars, sin_vars, t_angle);
...
GTEST_TEST(RationalForwardKinematics, ReplaceCosAndSinWithRationalFunction) {
  ...
  CheckSubstituteStereographicProjection(
      cos(theta(0)), subs, symbolic::Polynomial(cos_vars(0)), cos_vars,
      sin_vars, t_angle,
  ...
  // test sin(theta(0))
  CheckSubstituteStereographicProjection(
      sin(theta(0)), subs, symbolic::Polynomial(sin_vars(0)), cos_vars,
      sin_vars, t_angle,
      symbolic::RationalFunction(
  ...
  // test 1 + cos(theta(0))
  CheckSubstituteStereographicProjection(
      1 + cos(theta(0)), subs, symbolic::Polynomial(1 + cos_vars(0)), cos_vars,
      sin_vars, t_angle,
      symbolic::RationalFunction(
  ...
  CheckSubstituteStereographicProjection(
      t_angle(0), subs,
      symbolic::Polynomial({{symbolic::Monomial(), t_angle(0)}}), cos_vars,
      sin_vars, t_angle,
  ...
  CheckSubstituteStereographicProjection(
      ...
      symbolic::Polynomial(t_angle(0) * cos_vars(0), cos_sin_vars), cos_vars,
      sin_vars, t_angle,
      symbolic::RationalFunction(
          symbolic::Polynomial(
  ...
  CheckSubstituteStereographicProjection(
      ...
      symbolic::Polynomial(t_angle(0) * sin_vars(0), cos_sin_vars), cos_vars,
      sin_vars, t_angle,
      symbolic::RationalFunction(
