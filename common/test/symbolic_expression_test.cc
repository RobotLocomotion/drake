...
TEST_F(SymbolicExpressionTest, UniformRealDistribution) {
  ...
  {
    EXPECT_THROW(uniform_real_distribution<Expression>(x_, y_), runtime_error);
    EXPECT_THROW(uniform_real_distribution<Expression>(x_, 1.0), runtime_error);
    EXPECT_THROW(uniform_real_distribution<Expression>(0.0, y_), runtime_error);
...
TEST_F(SymbolicExpressionTest, NormalDistribution) {
  ...
  // Exceptions at construction.
  {
    EXPECT_THROW(normal_distribution<Expression>(x_, y_), runtime_error);
    EXPECT_THROW(normal_distribution<Expression>(x_, 1.0), runtime_error);
    EXPECT_THROW(normal_distribution<Expression>(0.0, y_), runtime_error);
...
TEST_F(SymbolicExpressionTest, ExponentialDistribution) {
  ...
  // Exceptions at construction.
  {
    EXPECT_THROW(exponential_distribution<Expression>(+x_), runtime_error);
