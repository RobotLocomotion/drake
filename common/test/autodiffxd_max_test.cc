...
TEST_F(AutoDiffXdTest, TieBreakingCheck) {
  ...
  // and our overload return the first argument `v1`. In Drake, we rely on this
  // implementation-detail (i.e. Maliput Dragway's Lane::ImplDoToLanePositionT
  // method). This test checks if the property holds so that we can detect a
