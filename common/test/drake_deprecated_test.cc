...
GTEST_TEST(DrakeDeprecatedTest, WarnOnceTest) {
  static const drake::internal::WarnDeprecated warn_once(
      "2038-01-19", "The method {} has been renamed to {}.", "OldCalc()",
      "NewCalc()");
}
...
GTEST_TEST(DrakeDeprecatedTest, WarnThrowsTest) {
  ...
  DRAKE_EXPECT_THROWS_MESSAGE(
      drake::internal::WarnDeprecated("2038-01-19", "Hello {}", "World"),
      "DRAKE DEPRECATED: Hello World. The deprecated code will be removed "
