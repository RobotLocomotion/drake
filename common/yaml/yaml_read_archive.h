...
class YamlReadArchive final {
 public:
  ...
  struct Options {
    ...
    /// data into the destination, instead of replacing the map data.  In other
    /// words, the maps can have default values that are left intact unless the
    /// YAML data provides a value *for that specific key*.
