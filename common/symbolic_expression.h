...
class uniform_real_distribution<drake::symbolic::Expression> {
 public:
  ...
  /// maximum value @p b.
  ///
  /// @throw std::runtime_error if a or b is not a constant expression.
  /// @throw std::runtime_error if a > b.
...
class normal_distribution<drake::symbolic::Expression> {
 public:
  ...
  ///
  /// @throw std::runtime_error if mean or stddev is not a constant expression.
  /// @throw std::runtime_error if stddev <= 0.
...
class exponential_distribution<drake::symbolic::Expression> {
 public:
  ...
  ///
  /// @throw std::runtime_error if lambda is not a constant expression.
  /// @throw std::runtime_error if lambda <= 0.
