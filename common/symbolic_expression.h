...
class normal_distribution<drake::symbolic::Expression> {
 public:
  ...
  // Note that in libstdc++ std::normal_distribution<> defines min() and max()
  // to return -DBL_MAX and DBL_MAX while the one in libc++ returns -INFINITY
  // and INFINITY. We follows libc++ and return -INFINITY and INFINITY.
