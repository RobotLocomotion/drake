...
/// `Eigen::DenseBase::all()`, except this function does not explicitly
/// short-circuit, so works even when scalar_predicate<>::is_bool does not
...
/// `Eigen::DenseBase::any()`, except this function does not explicitly
/// short-circuit, so works even when scalar_predicate::is_bool does not hold.
