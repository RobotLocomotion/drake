...
///
/// Many users will only need to use the "drake/common/symbolic/algebra.h" file
/// instead of this one.
///
...
/// example, example is addition (+) over Monomial gives a Polynomial.
/// If a user does not include the necessary set of header files,
