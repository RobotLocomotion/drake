...
DRAKE_DEPRECATED("The drake/common/text_logging_gflags.h convenience header is being removed from Drake.  Downstream projects should maintain their own implementation of this feature.  See drake/common/add_text_logging_gflags.cc for an example.", "2020-02-01")  // NOLINT(whitespace/line_length)
