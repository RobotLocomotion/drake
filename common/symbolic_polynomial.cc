...
void Polynomial::EvaluateWAffineCoefficients(
    const Eigen::Ref<const VectorX<symbolic::Variable>>& indeterminates,
  ...
  // monomial and c is the coefficient of the monomial. For each coefficient
  // c, write it as c=a_coeff * decision_variables + b_coeff, hence this
