...
class DiagnosticPolicy {
 public:
  ...
  /* (Advanced.) Process a warning using default behavior. */
  void WarningDefaultAction(const DiagnosticDetail& detail) const;

  /* (Advanced.) Process an error using default behavior. */
  void ErrorDefaultAction(const DiagnosticDetail& detail) const;
