...
thread_local drake::internal::pool_ladder_allocator::Ladder*
DenseStoragePools::s_ladder{};

// Initialize the ladder function to the once-only init thunk, which will
// replace itself with a cheap accessor when it is executed.
thread_local DenseStoragePools::LadderFn
DenseStoragePools::s_ladder_fn{DenseStoragePools::ladder_init_thunk};

thread_local DenseStoragePools::Reaper DenseStoragePools::s_reaper;
