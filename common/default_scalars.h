...
/// functions to instantiate (provided as as function pointers), *including*
...
// N.B. Below we use "Make_Function_Pointers" (etc.) as a function name, which
// violates our function name style guide by mixing inner capitalization with
// underscores.  However, we've done this on purpose, to avoid conflicts with
// user-provided code in the same translation unit.  We can't use a namespace
// because we need to allow for easy friendship in case a member function does
