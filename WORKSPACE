...
# to actually be defined. The minimum_bazel_version value should usually match
# the version passed to the find_package(Bazel) call in the root
# CMakeLists.txt.
versions.check(minimum_bazel_version = "0.14.1")
