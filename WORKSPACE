...
local_repository(
    ...
    # Since the only use of kythe tooling is for pkg_config_package, and we
    # plan to implement our own version of that soon anyway, we'll leave this
    # alone for now, rather than diagnosing the errors.
