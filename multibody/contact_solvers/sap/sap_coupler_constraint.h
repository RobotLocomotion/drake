...
/* Implements a SAP (compliant) coupler constraint between two dofs.
 ...
 More precisely, given g = q₀ - ρ⋅q₁ - Δq, this constraint models the constraint
 the impulse γ ∈ ℝ as:
   γ = -(k⋅g + d⋅ġ)
 where k is the stiffness and d the dissipation.

 The generalized force on dof 0 is:
   τ₀ = γ
 And the generalized force on dof 1 is:
   τ₁ = −ργ
