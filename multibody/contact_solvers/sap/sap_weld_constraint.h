...
/* Implements a SAP (compliant) weld constraint between two bodies.
 ...
 constraint lacks frame-invariance. This leads to a small artifact discussed
 below where angular momentum is not conserved. It is unclear at this time if
 choosing a particular frame leads to a better approximation, conditioning, etc.
 We choose the world frame for convenience. See
 MakeSapHolonomicConstraintKinematics() for a derivation of this constraint
 velocity.
