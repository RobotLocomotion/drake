...
class SapModel {
 ...
 private:
  ...
  /* Computes a diagonal approximation of the Delassus operator used for
   regularization or the contact problem leading to better numerical
   conditioning.
   ...
   in cluster order as specified by the contact problem's graph, see
   SapContactProblem::graph().
