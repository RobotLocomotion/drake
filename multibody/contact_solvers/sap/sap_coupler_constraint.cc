...
std::unique_ptr<SapConstraint<double>> SapCouplerConstraint<T>::DoToDouble()
  ...
  SapCouplerConstraint<double>::Kinematics k(
      kinematics_.clique0, kinematics_.clique_dof0, kinematics_.clique_nv0,
      ExtractDoubleOrThrow(kinematics_.q0), kinematics_.clique1,
      kinematics_.clique_dof1, kinematics_.clique_nv1,
