...
class SapConstraint {
 ...
 protected:
  // Not moveable though copyable so that derived classes can implement
  // DoClone().
  SapConstraint(SapConstraint&& other) = delete;
  SapConstraint& operator=(SapConstraint&& other) = delete;
  SapConstraint(const SapConstraint&) = default;
  SapConstraint& operator=(const SapConstraint&) = default;
