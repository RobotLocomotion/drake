...
class SapLimitConstraintTest
 ...
 public:
  // Makes a SapLimitConstraint with from this->GetParam() and an arbitrary
  // clique, clique_dof and clique_nv.
  void SetUp() override {
...
// Bare minimum sanity chekcs on a newly constructed limit constraint.
