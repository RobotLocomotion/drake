...
TEST_P(SapHuntCrossleyConstraintTest, RegionI) {
  ...
  {
    const Vector3d vc(slip_within_stiction, -slip_within_stiction, -0.1);
    ValidateGradients(p, vc);
  }
  {
    const Vector3d vc(-slip_within_stiction, slip_within_stiction, -0.05);
    ValidateGradients(p, vc);
  }
}
...
TEST_P(SapHuntCrossleyConstraintTest, RegionIII) {
  ...
  // In particular, the normal velocity is large enough to break contact.
  {
    const Vector3d vc(0.1, 0, 0.1);
    ValidateGradients(p, vc);
  }
  {
    const Vector3d vc(1.0e-3, -2.0e-3, 0.01);
    ValidateGradients(p, vc);
  }
  {
...
TEST_P(SapHuntCrossleyConstraintTest, RegionIZeroStiffnessAndZeroDissipation) {
  ...
  {
    const Vector3d vc(slip_within_stiction, 0.0, -0.1);
    ValidateGradients(p, vc);
  }
  {
    const Vector3d vc(slip_within_stiction, -slip_within_stiction, -0.1);
