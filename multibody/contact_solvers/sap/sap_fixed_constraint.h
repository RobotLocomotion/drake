...
/* Implements a SAP fixed constraint between two objects.
 ...
 point Qᵢ on object B, for i = 0, 1, ..., n-1.
 For each i =  0, 1, ..., n-1, consider a frame Nᵢ with origin Nᵢo such that

    p_WNᵢo = (p_WPᵢ + p_WQᵢ) / 2

 and identity rotation

    R_WNᵢ = I.

 For each i = 0, 1, ..., n-1, the constraint penalizes non-coincident Pᵢ and Qᵢ
 ...
 particular frame leads to a better approximation, conditioning, etc.
