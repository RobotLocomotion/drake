...
BlockSparseCholeskySolver<BlockType>::CalcSchurComplementAndFactor(
  ...
  /* The block elimination ordering implies a permutation of the remaining
   ...
   remaining indices in `global_to_remaining`. */
  /* A value of -1 indicates that the element is eliminated. */
