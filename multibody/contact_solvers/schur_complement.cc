...
/* TODO(xuchenhan-tri): In the following implementation, we constructs `a`, the
 ...
 profiling shows that the current implementation is not a performance issue, so
 we have opted for simplicity in the implementation. */
