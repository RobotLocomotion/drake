...
GTEST_TEST(Block3x3SparseMatrixTest, SetFromTriplets) {
  ...
  expected_matrix.topLeftCorner<3, 3>() = MakeMatrix(1.0);
  expected_matrix.block<3, 3>(6, 3) = MakeMatrix(2.0);
  expected_matrix.bottomRightCorner<3, 3>() = MakeMatrix(3.0);
