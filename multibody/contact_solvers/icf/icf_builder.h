...
Context, and information about external and actuation forces. It is the only
class in ICF that depends on MultibodyPlant information.
*/
template <typename T>
class IcfBuilder {
 public:
 ...
 private:
  ...
  // Mass is a function of the plant Context. TODO(rpoyner-tri): fix the logic
  // for updating and using masses.
