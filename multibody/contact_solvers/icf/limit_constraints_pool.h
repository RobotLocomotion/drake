...
disabled (infinite). This allows us to handle the fairly common case where some
joints in a clique have limits while others do not.
...
By convention, we define velocities and impulses as positive when they move the
constraint away from the limit. Putting together both lower and upper limits,
this produces the the Jacobian J = [Iₙ;-Iₙ], where Iₙ is the identity matrix of
size n, the number of DoFs in the clique.
