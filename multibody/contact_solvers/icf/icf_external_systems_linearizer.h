...
TODO(#23918) For the moment, this class only implements actuation linearization
τᵤ(v), not external forces τₑ(v). If the plant has external force inputs
connected, we will throw an exception.
