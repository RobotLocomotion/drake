...
/* Stores per-iteration solver data for a pool of holonomic constraints, each
with N constraint equations: the constraint impulse γ ∈ ℝᴺ and the total cost.
This is the data companion to HolonomicConstraintsPool<T, N>, updated at each
solver iteration.
