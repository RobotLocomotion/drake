...
class Joint : public MultibodyTreeElement<Joint<T>, JointIndex>  {
 public:
  ...
  /// instance from @p frame_on_child (this is typically what is desired for
  /// joints between the world and a model, or between two models (e.g. an arm
  /// to a gripper).  See this class's documentation for further details.
  ///
  /// @param[in] name
