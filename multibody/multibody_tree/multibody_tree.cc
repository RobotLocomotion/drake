...
void MultibodyTree<T>::CreateModelInstances() {
  ...
  // Add all of our bodies and joint actuators to the appropriate
  // instance.  The order of the mobilizers should match the order in
  // which the bodies were added to the tree, which may not be the
  // order in which the mobilizers were added, so we get the mobilizer
  // through the BodyNode.
