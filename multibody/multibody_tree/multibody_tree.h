...
class MultibodyTree {
 public:
  ...
  const BodyType<T>& AddBody(std::unique_ptr<BodyType<T>> body) {
    ...
    DRAKE_ASSERT(body->model_instance().is_valid());
  ...
  const FrameType<T>& AddFrame(std::unique_ptr<FrameType<T>> frame) {
    ...
    DRAKE_ASSERT(frame->model_instance().is_valid());
  ...
  const ForceElementType<T>& AddForceElement(
    ...
    DRAKE_ASSERT(force_element->model_instance().is_valid());
  ...
  /// @param[in] model_instance
  ////  The model instance containing this joint.
  /// @param[in] parent
  ...
  /// Returns the number of generalized positions a specific model instance.
  ...
  /// Returns the number of generalized velocities a specific model instance.
