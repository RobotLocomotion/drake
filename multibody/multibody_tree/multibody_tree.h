...
class MultibodyTree {
 ...
 private:
  ...
  // Currently, MultibodyTree treats damping forces separately from other
  // ForceElement forces for a quick simple solution. This right now allows
  // clients of MBT (namely MBP) to implement their own customized (implicit)
