...
/// loaded from different formats.  The tests are do not expend on the which
/// parser is used, as different parsers should create the same plant from a
/// correct model in the appropriate format (URDF/SDF).
