...
namespace multibody {
/**
 * If we have a body with orietation quaternion z₁ at time t₁, and a quaternion
 * z₂ at time t₂ = t₁ + h, with the average angular velocity ω (expressed in the
 ...
 * z₂, Δz = [cos(|ω|h/2), ω/(|ω|+ε)sin(|ω|h/2)].
 ...
 *
 * The decision variables of this constraint is [z₁, z₂, ω, h]
 *
