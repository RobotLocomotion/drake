...
class SpatialVelocityConstraint final : public solvers::Constraint {
 public:
  ...
  struct AngularVelocityBounds {
     ...
     * non-negative. The actual constraint will be implemented as a constraints
     ...
     * norm of w_AQ is very close to zero, we add a small random number to the
     * norm to avoid numerical difficulties. */
