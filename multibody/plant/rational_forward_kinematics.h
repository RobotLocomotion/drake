...
namespace multibody {
/**
 * For certain robots (whose joints transform are algebraic function of joint
...
class RationalForwardKinematics {
 ...
 private:
   ...
   * from that in MultibodyTreeTopology. If we designate certain link as the
   ...
   * MultibodyTreeTopology usually designate the world as the root link, but we
