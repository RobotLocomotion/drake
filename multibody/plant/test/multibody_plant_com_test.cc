...
TEST_F(MultibodyPlantCenterOfMassTest, CenterOfMassPosition) {
  ...
  Eigen::Vector3d result =
      (p_SScm_S_ * mass_S_ + p_TTcm_T_ * mass_T_) / (mass_S_ + mass_T_);
  ...
  math::RigidTransformd X_WT1(
      math::RotationMatrixd(Eigen::MatrixXd::Identity(3, 3)), p_WTo_W);
  ...
  math::RigidTransformd X_WS(math::RollPitchYawd(0.3, -1.5, 0.7),
                             Eigen::Vector3d(5.2, -3.1, 10.9));
  math::RigidTransformd X_WT(math::RollPitchYawd(-2.3, -3.5, 1.2),
