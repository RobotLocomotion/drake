...
/* Popualtess the given diagram builder for the ConnectionError test based on
...
/* For a given public API, this captures the "key phrase" we expect to see in
 the exception (under throwing conditions). It also carries a function that will
 allow us to exercise the API in question. */
