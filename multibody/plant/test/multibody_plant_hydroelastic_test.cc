...
class ContactModelTest : public ::testing::Test {
 protected:
  void Configure(
      ContactModel model, bool connect_scene_graph = true,
      double time_step = 0.0,
      ContactSurfaceChoice choice = ContactSurfaceChoice::kContinuous,
...
TEST_F(CalcContactSurfacesTest, ContinuousSystemContinuousSurface) {
  const double time_step = 0.0;  // Zero to select continuous system.
  this->Configure(time_step, ContactSurfaceChoice::kContinuous);
...
TEST_F(CalcContactSurfacesTest, ContinuousSystemDiscreteSurface) {
  const double time_step = 0.0;  // Zero to select continuous system.
  this->Configure(time_step, ContactSurfaceChoice::kDiscrete);
...
TEST_F(CalcContactSurfacesTest, DiscreteSystemContinuousSurface) {
...
TEST_F(CalcContactSurfacesTest, DiscreteSystemDiscreteSurface) {
  const double time_step = 5.0e-3;  // Non-zero to select discrete system.
  this->Configure(time_step, ContactSurfaceChoice::kDiscrete);
...
TEST_F(CalcHydroelasticWithFallbackTest, ContinuousSystemContinuousSurface) {
  const double time_step = 0.0;  // Zero to select continuous system.
  this->Configure(time_step, ContactSurfaceChoice::kContinuous);
...
TEST_F(CalcHydroelasticWithFallbackTest, ContinuousSystemDiscreteSurface) {
  const double time_step = 0.0;  // Zero to select continuous system.
  this->Configure(time_step, ContactSurfaceChoice::kDiscrete);
...
TEST_F(CalcHydroelasticWithFallbackTest, DiscreteSystemConinuousSurface) {
  const double time_step = 5.0e-3;  // Non-zero to select discrete system.
  this->Configure(time_step, ContactSurfaceChoice::kContinuous);
...
TEST_F(CalcHydroelasticWithFallbackTest, DiscreteSystemDiscreteSurface) {
  const double time_step = 5.0e-3;  // Non-zero to select discrete system.
  this->Configure(time_step, ContactSurfaceChoice::kDiscrete);
