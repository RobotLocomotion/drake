...
// enough to reach steady a steady state in which the hydroelastic forces
// balance the weight of the sphere.
// The purpose of this test is to verify the results of a simulation using the
// discrete approximation of hydroelastics.
TEST_F(HydroelasticModelTests, DiscreteTamsiSolver) {
  ...
  // We use a tolerance value based on previos runs of this test.
