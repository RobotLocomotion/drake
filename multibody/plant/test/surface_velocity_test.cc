...
// R_z(90°)). Contact pairs pass the outward normal to each body: +Wz to A
// (ground), −Wz to B (box):
//
// ground (A): axis_ss_B=(1,0,0): R_WB*(1,0,0)=(0,1,0); (0,1,0)×(+Wz)=(1,0,0)
// box    (B): axis_ss_B=(0,-1,0): R_WB*(0,-1,0)=(1,0,0); (1,0,0)×(-Wz)=(0,1,0)
//
...
// frictional force on box ∝ (kGroundSpeed, -kBoxSpeed, 0)
//
...
class OrthogonalSurfaceVelocityTest
 ...
 protected:
  ...
  // Returns the centroid of the contacting body.
