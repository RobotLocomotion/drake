...
// axis_ss_B = (1,0,0), n_W = (0,0,1) (R_WB = I, so n_B = n_W).
...
// (ground), −Ẑ to B (box):
//
//   ground (A): axis_ss_B=(1,0,0): R_WB*(1,0,0)=(0,1,0); (0,1,0)×(+Ẑ)=(1,0,0)
//   box    (B): axis_ss_B=(0,-1,0): R_WB*(0,-1,0)=(1,0,0); (1,0,0)×(-Ẑ)=(0,1,0)
//
