...
TEST_F(ActuatedIiwaArmTest, AssembleDesiredStateInput_DisarmedModel) {
  ...
  EXPECT_EQ(ssize(input.instance_is_armed), plant_->num_model_instances());
  EXPECT_FALSE(input.instance_is_armed[acrobot_model_]);
  EXPECT_FALSE(input.instance_is_armed[arm_model_]);
  EXPECT_FALSE(input.instance_is_armed[gripper_model_]);
  EXPECT_FALSE(input.instance_is_armed[box_model_]);
}
...
TEST_F(ActuatedIiwaArmTest,
  ...
  EXPECT_FALSE(input.instance_is_armed[acrobot_model_]);
  EXPECT_FALSE(input.instance_is_armed[arm_model_]);
  EXPECT_TRUE(input.instance_is_armed[gripper_model_]);
  EXPECT_FALSE(input.instance_is_armed[box_model_]);
  ...
  EXPECT_EQ(input.xd, expected_xd);
}
...
TEST_F(ActuatedIiwaArmTest,
  ...
  EXPECT_EQ(ssize(input.instance_is_armed), plant_->num_model_instances());
  EXPECT_FALSE(input.instance_is_armed[acrobot_model_]);
  EXPECT_TRUE(input.instance_is_armed[arm_model_]);
  EXPECT_TRUE(input.instance_is_armed[gripper_model_]);
  EXPECT_FALSE(input.instance_is_armed[box_model_]);
