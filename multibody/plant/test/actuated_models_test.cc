...
// presence of removed actuators. We saturate the feed forward actuation of the
// gripper and arm so that the generalized forces reported by the constraints
// are clamped to the known effort limits.
