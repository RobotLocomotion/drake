...
This test shows both, dynamically: the solver actually holds the loop closed
while the constraint is active, and the mechanism comes apart at the split link
when it isn't.
