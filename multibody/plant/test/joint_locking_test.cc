...
std::vector<JointLockingSapTestConfig> MakeJointLockingSapTestCases() {
...
INSTANTIATE_TEST_SUITE_P(
    JointLockingTests, JointLockingSapTest,
    testing::ValuesIn(MakeTestMakeJointLockingSapTestCasesCases()),
    testing::PrintToStringParamName());
