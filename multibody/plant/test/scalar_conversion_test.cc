...
// We test we can scalar convert a plant containing a revolute joint and spring.
// In particular, we verify that the spring element correctly references the
// joint both before and after scalar conversion.
