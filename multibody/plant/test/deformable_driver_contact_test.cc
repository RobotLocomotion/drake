...
TEST_F(DeformableDriverContactTest, EvalDeforambleContact) {
...
TEST_F(DeformableDriverContactTest, EvalParticipatingVelocities) {
  ...
  const auto q = model_->GetReferencePositions(body_id0_);
  ...
  /* Verify that the participating velocities are muxed correctly. */
