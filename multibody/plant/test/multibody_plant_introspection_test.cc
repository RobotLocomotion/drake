...
GTEST_TEST(MultibodyPlantIntrospection, FloatingBodies) {
  ...
  // mobilities assigned in the order bodies were added to the model. This
  // assumption implies that DOFs for the first tree are first, followed by DOFs
  // for the second tree, etc.
