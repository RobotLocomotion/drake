...
INSTANTIATE_TEST_SUITE_P(
    SupportMatrixTests, DiscretePlantTestDouble,
    ::testing::Combine(
...
INSTANTIATE_TEST_SUITE_P(
    SupportMatrixTests, DiscretePlantTestAutoDiff,
    ::testing::Combine(
        ::testing::Values(DiscreteContactApproximation::kSimilar,
                          DiscreteContactApproximation::kTamsi),
        ::testing::Values(ContactModel::kPoint,
...
INSTANTIATE_TEST_SUITE_P(
    SupportMatrixTests, DiscretePlantTestExpression,
    ::testing::Combine(
        ::testing::Values(DiscreteContactApproximation::kSimilar,
                          DiscreteContactApproximation::kTamsi),
        ::testing::Values(ContactModel::kPoint,
