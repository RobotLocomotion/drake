...
class AcrobotPlantTests : public ::testing::Test {
 public:
  ...
  void VerifyDoCalcDiscreteVariableUpdates(double theta1, double theta2,
    ...
    // solver only, currently SAP. Therefore we first this to be true.
    ...
    // "continous" and "discrete" accelerations will differ by:
    //   a_sap = a0 - M₀⁻¹⋅D⋅(v−v₀)
    // we take this term into account below.
    const VectorXd D = VectorXd::Constant(2, 0.1);
