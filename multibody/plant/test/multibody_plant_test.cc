...
GTEST_TEST(MultibodyPlantTest, LinearizePendulum) {
  ...
  A << 0.0, 1.0, parameters.g() / parameters.l(), domegadot_domega;
...
GTEST_TEST(MultibodyPlantTest, AutoDiffAcrobotParameters) {
  ...
  // clang-format off
  analytic_mass_matrix << I1 + I2 + m2 * l1 * l1 + 2 * m2 * l1 * lc2, I2 + m2 * l1 * lc2, // NOLINT
                                                  I2 + m2 * l1 * lc2,                 I2; // NOLINT
  // clang-format on
  ...
  analytic_mass_matrix_partial_m2
      << (1.0 / 3.0) * l2 * l2 + l1 * l1 + 2 * l1 * lc2, (1.0 / 3.0) * l2 * l2 + l1 * lc2, // NOLINT
                       (1.0 / 3.0) * l2 * l2 + l1 * lc2,            (1.0 / 3.0) * l2 * l2; // NOLINT
  // clang-format on
  ...
  analytic_mass_matrix_partial_l2 <<
            (2.0 / 3.0) * m2 * l2 + m2 * l1, (2.0 / 3.0) * m2 * l2 + 0.5 * m2 * l1, // NOLINT
      (2.0 / 3.0) * m2 * l2 + 0.5 * m2 * l1,                 (2.0 / 3.0) * m2 * l2; // NOLINT
  // clang-format on
