...
TEST_F(AcrobotPlantTests, SetPositionWithNans) {
...
TEST_F(AcrobotPlantTests, SetDefaultPositionWithNans) {
  VectorX<double> p = VectorX<double>::Zero(plant_->num_positions());
  ASSERT_GT(p.rows(), 0);
...
TEST_F(AcrobotPlantTests, SetVelocitiesWithNans) {
...
TEST_F(AcrobotPlantTests, SetVelocitiesInArrayWithNans) {
...
TEST_F(AcrobotPlantTests, SetPositionAndVelocitiesWithNans) {
