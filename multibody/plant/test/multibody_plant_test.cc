...
GTEST_TEST(MultibodyPlantTest, GetBodiesAffectedBy) {
  ...
  std::set<BodyIndex> expected_bodies1;
  expected_bodies1.insert(lower.index());
  const std::vector<JointIndex> joints2{shoulder, elbow};
  std::set<BodyIndex> expected_bodies2;
  expected_bodies2.insert(lower.index());
  expected_bodies2.insert(upper.index());
