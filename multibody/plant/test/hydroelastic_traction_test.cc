...
GTEST_TEST(HydroelasticTractionCalculatorTest,
  ...
  // traction_Aq_W. In this case, the zeros should win out. If, on the other
  // hand, we fail to use a *soft* norm to determine the relative speed of the
  // bodies, we'll get NaNs.
  ...
  EXPECT_TRUE(CompareMatrices(grad_traction_Aq_W, zeros, 1e-15));
}
