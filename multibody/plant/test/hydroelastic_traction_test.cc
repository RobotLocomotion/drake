...
GTEST_TEST(HydroelasticTractionCalculatorTest,
  ...
  // simply a polynomial of degree six. Although our implementation uses
  // Horner's method to minimize round-off errors, AutoDiffXd applied to that
  // expression still leads to a suboptimal computation that looses precision.
  // We obtained the numbers below using Matlab variable precision arithmetic.
