...
TEST_F(ContactPropertiesTest, GetCombinedCoulombFriction) {
  EXPECT_EQ(GetCombinedCoulombFriction(g_A_, g_D_, inspector()),
            CalcContactFrictionFromSurfaceProperties(kMuA, kMuD));
}
