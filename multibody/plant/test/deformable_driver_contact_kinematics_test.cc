 ...
 protected:
  ...
  void MakeScene(bool dynamic_rigid_body) {
    ...
    /* Set up the deformable body velocity and the rigid body velocity so that
     the contact velocities in the contact frame are (0, 0, 1). Recall that the
     contact frame C is defined such that Cz is aligned with the contact normal
     and Cx and Cy are arbitrarily defined. */
    if (dynamic_rigid_body) {
