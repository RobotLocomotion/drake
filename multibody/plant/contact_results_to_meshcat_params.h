...
/** The set of parameters for configuring ContactResultsToMeshcatSystem. */
struct ContactResultsToMeshcatParams {
  ...
  /** A prefix to add to the path for all objects and transforms curated by the
   ContactResultsToMeshcatSystem. It can be an absolute path or relative path.
  ...
  /** The threshold below which forces will no longer be drawn.  The
   ContactResultsToMeshcatSystem constructor enforces that this must be strictly
