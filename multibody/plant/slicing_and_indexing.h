...
// MatrixBlock variant of the above function. If M.is_dense() == true, returns a
// new possibly smaller matrix from M, by selecting the columns indexed by @p
// indices. Does not handle non-dense MatrixBlock.
