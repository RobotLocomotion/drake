...
struct MultibodyPlantConfig {
  ...
  /// of 1.0 is a conservative choice to avoid numerical ill-conditioning.
  /// However, this might introduce artificial softening of the contact
  /// constraints. If this is your case try:
