...
void MultibodyPlant<T>::DeclareStateCacheAndPorts() {
  ...
  for (ModelInstanceIndex i(0); i < num_model_instances(); ++i) {
    ...
    instance_net_actuation_ports_[i] =
  ...
  for (ModelInstanceIndex i(0); i < num_model_instances(); ++i) {
    const std::string& model_instance_name = GetModelInstanceName(i);
    instance_state_output_ports_[i] =
        this->DeclareVectorOutputPort(
  ...
  for (ModelInstanceIndex i(0); i < num_model_instances(); ++i) {
    const std::string& model_instance_name = GetModelInstanceName(i);
    instance_generalized_acceleration_output_ports_[i] =
        this->DeclareVectorOutputPort(
  ...
  for (ModelInstanceIndex i(0); i < num_model_instances(); ++i) {
    ...
    instance_generalized_contact_forces_output_ports_[i] =
        this->DeclareVectorOutputPort(
