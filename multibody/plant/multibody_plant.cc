...
void MultibodyPlant<T>::DeclareStateCacheAndPorts() {
  ...
  // For discrete plant, delegate the caching of the actual computation of net
  // actuation to DiscreteUpdateManager while always copying the result from the
  // DiscreteUpdateManager. Copying should be cheap.
