...
using systems::ValueCalcFunction;
...
void MultibodyPlant<T>::DeclareCacheEntries() {
  ...
  auto& point_pairs_cache_entry = this->DeclareCacheEntry(
      ...
      ValueCalcFunction(this, &MultibodyPlant<T>::CalcPointPairPenetrations),
      {this->configuration_ticket()});
  ...
  auto& contact_surfaces_cache_entry = this->DeclareCacheEntry(
      ...
      ValueCalcFunction(this, &MultibodyPlant<T>::CalcContactSurfaces),
      {this->configuration_ticket()});
  ...
  auto& tamsi_solver_cache_entry = this->DeclareCacheEntry(
      ...
      ValueCalcFunction(this, &MultibodyPlant<T>::CalcContactSolverResults),
