...
failure. This tradeoff underscores the importance of carefully selecting contact
...
|:---------------------------------|:------:|:-------------:|
|Point stiffness                   |   N/m  |      10⁶      |
|Hydroelastic modulus              |   Pa   |      10⁷      |
|Hunt & Crossley dissipation       |   s/m  |      50       |
|Friction                          |    -   |      0.5      |
|Stiction tolerance                |   m/s  |      10⁻⁴     |
|Margin                            |   m    |      10⁻⁴     |
...
costume values for your application.
...
selecting stiffness to approximate rigid objects involves balancing accuracy
...
were g is the acceleration of gravity.

As examples, we consider an object of radius 5 cm, a typical household object of
about a pound, and an object of radius 30 cm, say a humanoid robot of about 250
pounds.
