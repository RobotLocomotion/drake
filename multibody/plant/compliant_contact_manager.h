...
// introducing additional states. Dissipation is modeled using a linear model.
// For point contact, given the penetration distance x and its time derivative
// ẋ, the normal contact force (in Newtons) is modeled as:
//   fₙ = k⋅(x + τ⋅ẋ)₊
