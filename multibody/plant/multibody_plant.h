...
class MultibodyPlant : public internal::MultibodyTreeSystem<T> {
 public:
  ...
  /// called to add another `UniformGravityFieldElement`.  As there was not
  /// always a default gravity field element, for compatibility purposes
  /// calling this function to add a `UniformGravityFieldElement` which is
  /// identical to `gravity_field` is not an error.
  ...
  /// A mutable accessor to the current gravity field.  May be nullptr if no
  /// gravity field is specified.
