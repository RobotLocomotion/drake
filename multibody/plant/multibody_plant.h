...
/// contact) is detected. As a consequence, one can only run purely kinematic
/// simulations under the combination of SAP and `AutoDiffXd`. The SAP solver
/// does not support symbolic calculations.
///
/// <h2>References</h2>
///
