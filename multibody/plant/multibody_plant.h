...
class MultibodyPlant final : public internal::MultibodyTreeSystem<T> {
 public:
  ...
  /// automatically-added floating joint, or continue to use the APIs in this
  /// group. To access the added floating joint, use GetJointByName() with the
  /// name of the floating base body (see RigidBody::name()). In the rare case
  /// that there is already some unrelated joint with that name, we prepend
  ...
  /// floating base bodies (those have "Free" in their names rather than
  ...
  /// Sets the default pose X_WB of a floating base body B in World. This may be
  ...
  /// If there is a unique base body in the model given by `model_instance`,
  ...
  /// Returns true if there is a unique base body in the model given by
