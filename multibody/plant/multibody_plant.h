...
- declare collision filters to ignore collisions:
  ...
  - between bodies welded to the world.
...
class MultibodyPlant : public internal::MultibodyTreeSystem<T> {
 public:
  ...
  ///
  /// If `this` plant registered geometry with a SceneGraph:
  /// - input and output ports to enable communication with that SceneGraph are
  ///   declared,
  /// - collision filters based on model topology are declared.
  ///
