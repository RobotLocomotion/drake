...
class MultibodyPlant final : public internal::MultibodyTreeSystem<T> {
 public:
  ...
  /// vector of Joints. This is a _kinematic_ relationtionship rather than a
  ...
  ///
  /// The affected bodies are returned in increasing order of body indexes. A
  /// body is included in the output if that body's spatial velocity is
  /// affected by the velocity of one of the indicated joints.
  ///
