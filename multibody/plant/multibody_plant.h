...
class MultibodyPlant : public internal::MultibodyTreeSystem<T> {
 public:
  ...
  // the low-resolution hydroelastic contact surfaces. This configuration
  // defaults to `false`. When false, MBP will use the high-resolution
  // hydroelastic contact surfaces for the discrete system.
  //
  // For a continuous system, this setting has no effect because MBP will always
  // use the high-resolution contact surfaces.
  //
  // The low-resolution contact surfaces lead to a smaller contact problems with
  ...
  // TODO(DamrongGuoy): Consider an alternative name of the above function,
  //  perhaps set_polygonal_representation(bool use_polygonal_representation),
  //  `false` by default, as we improve the code and visualization.
