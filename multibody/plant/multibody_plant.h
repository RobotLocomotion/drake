...
class MultibodyPlant final : public internal::MultibodyTreeSystem<T> {
 ...
 private:
  ...
  // Returns the total number of miscellaneous continuous state variables needed
  // by MultibodyPlant-owned features.
  int CalcNumRequiredMiscContinuousStates() const;
