...
² This port is always declared, though it will be zero sized for model instances
  ...
  #### Combined actuation and actuation output
...
the actuation output port (get_actuation_output_port()). That is, the actuation
output port reports the total actuation applied by a given actuator.
