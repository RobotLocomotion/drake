...
class MultibodyPlant : public internal::MultibodyTreeSystem<T> {
 public:
  ...
  /// JointActuatorIndex. Values in this port for actuators without PD control
  /// will be ignored. In general, NumPdControlledActuators(model_instance) is
  /// lower or equal than num_actuators(model_instance), and thus PD control on
  /// just a subset of actuators is allowed.
  ///
