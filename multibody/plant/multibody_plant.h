...
class MultibodyPlant : public internal::MultibodyTreeSystem<T> {
 public:
  ...
  ///
  /// We use a dissipation model parameterized by a dissipation constant with
  /// units of inverse of velocity, i.e. `s/m`. See
  ...
  ///
  /// <!-- TODO(rpoyner-tri): insert ref to "modeling dissipation" section -->
