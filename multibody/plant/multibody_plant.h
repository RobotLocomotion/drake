...
class MultibodyPlant : public internal::MultibodyTreeSystem<T> {
 public:
  ...
  // set_contact_solver() should only be called by advanced developers wanting
  // to try out their custom contact solvers. We choose not to show it in
  // public documentations rather than making it private with friends.
