...
class MultibodyPlant : public MultibodyTreeSystem<T> {
 public:
  ...
  /// Returns a vector containing the lower position limits for all joints.
  /// Any unbounded or unspecified limits will be -inf.
  ...
  /// Returns a vector containing the upper position limits for all joints.
  /// Any unbounded or unspecified limits will be +inf.
  /// @returns concatenation of each joint's limit vector. This concatentation
  /// is ordered by `JointIndex`.
  /// @throws std::logic_error if called pre-finalize.
