...
class MultibodyPlant final : public internal::MultibodyTreeSystem<T> {
 public:
  ...
  /// generated model than in the user's specification. Results for the
  /// original RigidBody elements can still be obtained by name or BodyIndex,
  /// but no results (in particular, no reaction forces) are available for
  /// the unmodeled Weld joints.
  ///
