...
class MultibodyPlant : public internal::MultibodyTreeSystem<T> {
 public:
  ...
  /// al., 2021]. A value of 1.0 is a conservative choice to avoid
  /// ill-conditioning that might lead to softer than expected contact. If this
  /// is your case, consider turning off this approximation by setting this
  /// parameter to zero. For difficult cases where ill-conditioning is a
  /// problem, a small but non-zero number can be used, e.g. 1.0e-3.
