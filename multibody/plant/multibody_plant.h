...
class MultibodyPlant : public internal::MultibodyTreeSystem<T> {
 public:
  ...
  /// without specifying a joint become "floating base bodies" bodies after
  ...
  /// base body" because its parent is not the world. The effect of the various
  ...
  /// ubiquitously through the APIs of the Joint class. For that reason the
  ...
  /// upstream joints at the time of Finalize(). Using Joint APIs to affect a
