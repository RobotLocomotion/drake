...
class MultibodyPlant : public internal::MultibodyTreeSystem<T> {
 public:
  ...
  /// vector of joints.
  /// @note Since Drake doesn't support floating joints and kinematic loops,
  /// this function effectively returns all bodies that are outboard of the
  /// given vector of joints.
