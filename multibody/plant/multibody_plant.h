...
class MultibodyPlant final : public internal::MultibodyTreeSystem<T> {
 public:
  ...
  /// not necessarily unit length. We use that length to scale further scale
  /// `speed`. This gives us the effect of reducing the surface velocity as the
  /// contact normal aligns with the axis of rotation.
  ///
  ...
  ///    a visualization affordance; there is no value in setting it to a
