...
void CompliantContactManager<T>::DeclareCacheEntries() {
  ...
  auto& non_contact_forces_accelerations_cache_entry = this->DeclareCacheEntry(
              ...
              [this](const systems::Context<T>& context,
                ...
                systems::CacheEntryValue& value =
                    plant()
                        .get_cache_entry(
                            cache_indexes_
                                .non_contact_forces_evaluation_in_progress)
                        .get_mutable_cache_entry_value(context);
                bool& evaluation_in_progress =
                    value.GetMutableValueOrThrow<bool>();
      ...
      // inputs. We use CacheIndexes::non_contact_forces_evaluation_in_progress to
