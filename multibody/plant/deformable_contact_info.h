...
/** A class containing information regarding contact and contact response
 between two geometries belonging to a pair of bodies with at least one of which
...
class DeformableContactInfo {
 public:
  ...
  /** Constructs a %DeformableContactInfo.
   @param[in] id_A The geometry id of the geometry A.
   @param[in] id_B The geometry id of the geometry B.
  ...
  /** Gets the contact point data, including tractions and slip velocities, at
   each contact point. Ordered the same way as the faces of contact_mesh()`. */
