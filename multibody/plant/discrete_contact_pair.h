...
/** A characterization of the intersection of two penetrating geometries with
 the discrete information a discrete solver cares about. Encapsulated in this
 manner the solver is agnostic to whether these pairs are penetration pairs for
 a point contact model or quadrature point pairs for a compliant surface model such a hydroelastics.
...
struct DiscreteContactPair {
  ...
  T stiffness{0.0};
  /** The damping of the contact pair. **/
  T damping{0.0};
};
