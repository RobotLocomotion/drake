...
@section multibody_simulation Simulation of Multibody Systems
...
thus the interested is referred to the documentation for
...
Today SAP is our preffered discrete solver for its robustness, speed, and rich
feature set of constraints. A novel extension to SAP presented in @ref
Castro2023 "[Castro et al., 2023]", still convex, allows to introduce complex
models of compliant contact, such as
...
friction, but only dynamic friction can be resolved. Therefore the static
