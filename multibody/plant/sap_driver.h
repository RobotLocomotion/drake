...
// Mutable access to the manger is provided during DeclareCacheEntries() to
...
class SapDriver {
 public:
  ...
  // services perform solver-agnostic multibody computations, e.g. contact
  ...
  // With this function the manger provided at construction gives `this` driver
