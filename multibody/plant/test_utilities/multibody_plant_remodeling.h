...
class MultibodyPlantRemodelingBase {
 ...
 protected:
  ...
  double time_step_{};  // time step of plant_
};

class MultibodyPlantRemodeling : public MultibodyPlantRemodelingBase,
                                 public ::testing::Test {
 public:
  MultibodyPlantRemodeling() : MultibodyPlantRemodelingBase(0.1) {}
};
...
class MultibodyPlantRemodelingParam : public MultibodyPlantRemodelingBase,
 ...
 public:
  MultibodyPlantRemodelingParam() : MultibodyPlantRemodelingBase(GetParam()) {}
};
