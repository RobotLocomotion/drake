...
/* The visual properties implied by the <visual> tag. If geometry is populated,
 then at least one (possibly both) of the properties is populated. Otherwise,
 all fields are empty.*/
struct UrdfVisualProperties {
