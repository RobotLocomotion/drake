...
input formats. Some formats come from practice elsewhere in the robotics
community: URDF, SDFormat, MJCF (Mujoco XML). In these formats, there are
Drake-specific extensions and Drake-specific limitations.
...
`multibody/parsing/README_model_directives.md` for more info.
