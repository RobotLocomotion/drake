...
parameters, and adds it to either the visual or collision geometry of the
model.
...
<!-- TODO(rpoyner-tri): Find a home for @amcastro's theory documentation, discussed in #16444. -->
