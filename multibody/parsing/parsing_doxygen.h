...
- SDF location: `/sdf/model/link/visual/drake:accepting_renderer`
- URDF location: `/robot/link/visual/drake:accepting_renderer/@name`
- Syntax: String.
...
- SDF location: `/sdf/model/drake:linear_bushing_rpy/drake:bushing_force_damping`
- URDF location: `/robot/drake:linear_bushing_rpy/drake:bushing_force_damping/@value`
- Syntax: Three flooating point values.
