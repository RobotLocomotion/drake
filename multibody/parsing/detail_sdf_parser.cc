...
void AddPrismaticSpringFromSpecification(
    const sdf::Joint &joint_spec, const PrismaticJoint<double>& joint,
    MultibodyPlant<double>* plant) {
  DRAKE_THROW_UNLESS(plant != nullptr);
  ...
  // If a negative value is passed in, PrismaticSpring will
  // throw an error.
...
void AddJointFromSpecification(
  ...
  switch (joint_spec.Type()) {
    ...
    case sdf::JointType::PRISMATIC: {
      ...
      AddPrismaticSpringFromSpecification(joint_spec, joint, plant);
      break;
    }
