...
class NeedsFetch {
 public:
  ...
  operator bool() const { return value_.load(); }

  /* Sets this to a new value. */
  void store(bool value) { value_ = value; }
...
class PackageData {
 ...
 private:
  ...
  /* Directory in which the manifest resides. When needs_fetch_ is true, it is
