...
/** Parses the drake-relevant collision properties from a <collision> element.
 ...
 | drake:rigid_hydroelastic         | hydroelastic | compliance                | Requests a rigid hydroelastic representation. Cannot be combined *with* soft_hydroelastic.                                       |
 | drake:soft_hydroelastic          | hydroelastic | compliance                | Requests a soft hydroelastic representation. Cannot be combined *with* rigid_hydroelastic. Requires a value for elastic_modulus. |
