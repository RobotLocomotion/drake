 ...
 public:
  ...
  DiagnosticDetail MakeDetail(const XMLNode* location,
    ...
    if (data_source_.file_name) {
      ...
      // Be consistent with fake filename used in parser.cc.
      detail.filename = "<literal-string>.urdf";
    }
...
ModelInstanceIndex AddModelFromUrdf(
  ...
  UrdfDiagnostic diag(workspace.diagnostic, data_source);
