...
std::optional<ModelInstanceIndex> AddModelFromMesh(
  ...
  // the file contents provided. It would be nice if, at the very least, users
  // had to report the extension (and it were preserved in DataSource).
