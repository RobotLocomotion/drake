...
class Parser final {
 public:
  ...
  /// Get a mutable reference to the accumulated set of collision filter
  /// definitions seen by this parser. Collision filter group data is only ever
  /// an output of parsing, not an input.
  CollisionFilterGroups& collision_filter_groups() {
