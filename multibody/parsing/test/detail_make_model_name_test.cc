...
TEST_F(MakeModelNameTest, AutoRename) {
  ...
  EXPECT_EQ("robot_0", MakeModelName("robot", {}, workspace_));
  plant_.AddModelInstance("robot_0");
  ...
  EXPECT_EQ("thing_0", MakeModelName("thing", {}, workspace_));
  plant_.AddModelInstance("thing_0");
...
TEST_F(MakeModelNameTest, PrefixAndAutoRename) {
  ...
  EXPECT_EQ("prefix::robot_0", MakeModelName("robot", "prefix", workspace_));
}
