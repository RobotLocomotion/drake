...
GTEST_TEST(FileParserTest, InterleavedRenaming) {
  ...
  for (int k = 0; k < kNumLoads; ++k) {
    ...
    model_instance_name << model_name << k;
    parser.SetAutoRenaming(true);
  ...
  expected.AddGroup("kuka_iiwa0::iiwa_wrist",
                    {"kuka_iiwa0::iiwa_link_5",
                     "kuka_iiwa0::iiwa_link_6",
                     "kuka_iiwa0::iiwa_link_7"});
  expected.AddGroup("kuka_iiwa1::iiwa_wrist",
                    {"kuka_iiwa1::iiwa_link_5",
                     "kuka_iiwa1::iiwa_link_6",
                     "kuka_iiwa1::iiwa_link_7"});
  expected.AddExclusionPair(
      {"kuka_iiwa0::iiwa_wrist", "kuka_iiwa0::iiwa_wrist"});
  expected.AddExclusionPair(
      {"kuka_iiwa1::iiwa_wrist", "kuka_iiwa1::iiwa_wrist"});
