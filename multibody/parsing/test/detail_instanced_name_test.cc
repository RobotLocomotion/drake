...
// TODO(rpoyner-tri): replace explicit implementation with compiler default
// once macOS Ventura support ends. Once it is gone, this test (and perhaps
// this whole file) can go too.
