...
<drake:drake>
  <drake:mesh_resolution_hint value="2.5"/>
    ...
    verify_single_property(properties, geometry::kHydroGroup,
  ...
  <drake:drake>
    ...
    ASSERT_NE(instance.proximity_properties(), nullptr);
    const ProximityProperties& properties = *instance.proximity_properties();
    verify_single_property(properties, geometry::kMaterialGroup,
  ...
  // Case: has no drake:drake coefficients, only drake_compliance coeffs.
  {
    unique_ptr<XMLDocument> doc = MakeCollisionDocFromString(R"_(
  <drake_compliance>
  ...
  // Case: has both drake_compliance and drake:drake; drake:drake wins.
  unique_ptr<XMLDocument> doc = MakeCollisionDocFromString(R"_(
  <drake_compliance>
    <static_friction>3.5</static_friction>
    <dynamic_friction>2.5</dynamic_friction>
