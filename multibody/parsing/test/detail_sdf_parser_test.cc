...
GTEST_TEST(SdfParser, MergeIncludeInterfaceAPI) {
  ...
  EXPECT_FALSE(plant.HasModelInstanceNamed("top::arm_urdf::test_arm_urdf_name"));

  EXPECT_TRUE(
      plant.HasModelInstanceNamed("top::arm_sdf_no_merge::test_arm_sdf_name"));
  EXPECT_TRUE(plant.HasModelInstanceNamed(
      "top::arm_urdf_no_merge::test_arm_urdf_name"));
  ...
  //   const RigidTransformd X_WL2_expected(RollPitchYawd(0.1, 0.2, 0.3),
  //                                       Vector3d(2, 4, 3));
  //   const auto& arm_L2 = plant.GetFrameByName("L2",
  //   extra_arm_model_instance);
  //   const RigidTransformd X_WL2 = arm_L2.CalcPoseInWorld(*context);
  //   EXPECT_TRUE(CompareMatrices(X_WL2_expected.GetAsMatrix4(),
  //                               X_WL2.GetAsMatrix4(), kEps));
  // }
  ...
  //   const auto& gripper_mount_frame =
  //       plant.GetFrameByName("gripper_mount", flange_model_instance);
  //   const RigidTransformd X_WM = gripper_mount_frame
