...
// found.
//
// Emits an error on @p policy if the attribute doesn't contain exactly one
// numeric value. If the error policy does not throw, then the function will
// return true and set @p val to the first value obtained, if present.
//
