...
// indicated plant and resolver objects will still be mutable; only the pointer
// values within the struct are const.
struct ParsingWorkspace {
  ...
  // this struct.
  ParsingWorkspace(const PackageMap& package_map_in,
