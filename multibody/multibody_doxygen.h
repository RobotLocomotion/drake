...
-----------------------------|:----:|:------------------------:|:----------:|----------------------------
Generic vector v             |  v   |@f$[v]_E@f$               |`v_E`       |Vector v expresed in frame E.
...
Ez measure of vector v       |  v   |@f$[v]_{Ez}@f$            |`v_Ez`      |Ez scalar component of vector v, i.e., 𝐯 • 𝐄𝐳, where Ez is a unit vector of frame E.
