...
class FixedSizeLinearConstitutiveModelCacheEntryTest : public ::testing::Test {
 protected:
  void SetUp() {
  ...
  FixedSizeLinearConstitutiveModelCacheEntry<double, kNumQuads>
...
TEST_F(FixedSizeLinearConstitutiveModelCacheEntryTest,
...
TEST_F(FixedSizeLinearConstitutiveModelCacheEntryTest, UpdateCacheEntry) {
