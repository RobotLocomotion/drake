...
class FixedSizeSimplexGaussianQuadratureTest : public ::testing::Test {
  void SetUp() override {}

 protected:
  template <int NaturalDim, int NumQuadratureLocations>
  double Integrate(const FixedSizeQuadrature<
                       double, NaturalDim, NumQuadratureLocations>& quadrature,
  ...
  FixedSizeSimplexGaussianQuadrature<double, 2, 1> linear_2d_quadrature_;
  FixedSizeSimplexGaussianQuadrature<double, 2, 2> quadratic_2d_quadrature_;
  FixedSizeSimplexGaussianQuadrature<double, 3, 1> linear_3d_quadrature_;
  FixedSizeSimplexGaussianQuadrature<double, 3, 2> quadratic_3d_quadrature_;
};
