...
pair<typename FixedSizeSimplexGaussianQuadrature<T, NaturalDimension,
                                                 Order>::LocationsType,
     typename FixedSizeSimplexGaussianQuadrature<T, NaturalDimension,
                                                 Order>::WeightsType>
FixedSizeSimplexGaussianQuadrature<T, NaturalDimension,
                                   Order>::ComputePointsAndWeights() const {
