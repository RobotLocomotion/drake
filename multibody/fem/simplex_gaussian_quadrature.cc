...
SimplexGaussianQuadrature<2, 1>::ComputePointsAndWeights() const {
  using LocationsType = SimplexGaussianQuadrature<2, 1>::LocationsType;
  using WeightsType = SimplexGaussianQuadrature<2, 1>::WeightsType;
...
SimplexGaussianQuadrature<2, 2>::ComputePointsAndWeights() const {
  using LocationsType = SimplexGaussianQuadrature<2, 2>::LocationsType;
  using WeightsType = SimplexGaussianQuadrature<2, 2>::WeightsType;
  /* quadrature point location,  weight/area
       (1/6, 1/6)                     1/3
       (2/3, 1/6)                     1/3
       (1/6, 2/3)                     1/3
...
SimplexGaussianQuadrature<2, 3>::ComputePointsAndWeights() const {
  /* quadrature point location,  weight/area
      (1/3, 1/3)                     -9/16
      (3/5, 1/5)                     25/48
      (1/5, 3/5)                     25/48
...
SimplexGaussianQuadrature<3, 1>::ComputePointsAndWeights() const {
  /* quadrature point location,  weight/area
      (1/4, 1/4, 1/4)                1.0              */
...
SimplexGaussianQuadrature<3, 2>::ComputePointsAndWeights() const {
  /* quadrature point location,  weight/area
      (a, b, b)                      1/4
      (b, a, b)                      1/4
      (b, b, a)                      1/4
...
SimplexGaussianQuadrature<3, 3>::ComputePointsAndWeights() const {
  /* quadrature point location,  weight/area
      (1/4, 1/4, 1/4)               -4/5
      (a, b, b)                      9/20
      (b, a, b)                      9/20
