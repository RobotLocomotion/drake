...
class DirichletBoundaryCondition {
  ...
  */
  ...
  /* Modifies the given `fem_state` to comply with this boundary condition.
   ...
   conditioner is greater than or equal to the `fem_state->num_dofs()`. */
  ...
  /* Modifies the given tangent matrix that arises from an FEM model into the
   ...
   @throw std::exception if any dof index specified by `this` boundary
   conditioner is greater than or equal to the `tangent_matrix->cols()`. */
  ...
  /* Modifies the given residual that arises from an FEM model without BC into
   ...
   @throw std::exception if any dof index specified by `this` boundary
   conditioner is greater than or equal to the `residual->size()`. */
