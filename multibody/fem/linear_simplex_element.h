...
class LinearSimplexElement
 ...
 public:
  ...
  using Locations = typename Base::Locations;
  ...
  template <typename U>
  using Samples = typename Base::template Samples<U>;
  ...
  explicit LinearSimplexElement(Locations locations)
  ...
  const Samples<ShapeFunctions>& GetShapeFunctions() const { return S_; }
