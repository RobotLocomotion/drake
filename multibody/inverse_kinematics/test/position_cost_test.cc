...
template <typename T>
auto ConstructTwoFreeBodiesConstraint(
...
GTEST_TEST(PositionCostTest, TwoFreeBodies) {
  ...
  auto [plant, context, body1, body2, cost] =
      ConstructTwoFreeBodiesConstraint<double>(p_AP, p_BQ, C);
  auto [plant_ad, context_ad, body1_ad, body2_ad, cost_ad] =
      ConstructTwoFreeBodiesConstraint<AutoDiffXd>(p_AP, p_BQ, C);
