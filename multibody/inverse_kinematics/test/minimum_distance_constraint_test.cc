...
TEST_F(SpheresAndWallsTest, TestWithCollisionChecker) {
  ...
  auto check_constraint = [&dut, &collision_checker](
  ...
  check_constraint(Eigen::Vector3d(0, 0, 0), Eigen::Vector3d(1E-4, 0, 0),
                   false);
  ...
  // The distance between the two spheres is between minimum_distance_lower and
