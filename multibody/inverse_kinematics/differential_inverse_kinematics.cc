...
// Makes the matrix N(q) by calling MakeVelocityToQDotMap repeatedly.
...
// API.
SparseMatrix<double> MakeVelocityToQDotMap(
    const MultibodyPlant<double>& plant,
    const systems::Context<double>& context) {
  SparseMatrix<double> N(plant.num_positions(), plant.num_velocities());
