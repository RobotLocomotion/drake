...
class MinimumDistanceConstraint final : public solvers::Constraint {
 public:
  ...
  considered in each constraint evaluation. @default 1 meter. The
  influence_distance_offset can have a big effect on the performance of the
  nonlinear optimizer with this constraint. In one of our robot experiment (with
  Franka Panda arms), we chose influence_distance_offset to be 1e-6 and it works
  a lot better than the default 1 meter.
