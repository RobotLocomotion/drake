...
namespace multibody {
/**
 * Impose the constraint f(q) - r = 0, where f(q) computes the center-of-mass
 * (COM) position from robot generalized position q. r is the variable
 * representing robot CoM position.
 * The evaluated variables are [q;r]
 */
