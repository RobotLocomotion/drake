...
are not shown, nor is the contact between the ball and the floor.) Notice that
only approximately half of the bottom of the plate makes contact with the floor.
...
When viewing collisions, note that red contact arrows indicate a hydroelastic
collision, with an associated collision patch. Green contact arrows indicate
point contact collision, which does not have any contact patch.
