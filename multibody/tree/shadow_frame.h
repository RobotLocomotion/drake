...
automatically, and the two frames cannot drift apart. This mirrors the way a
shadow link's mass properties are sourced from its primary link rather than
being independently settable.
