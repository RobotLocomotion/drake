...
class Joint : public MultibodyElement<Joint, T, JointIndex> {
 public:
  ...
  /// unlocked. Locking is not supported for continuous-mode systems.
  /// @throws std::exception if the parent tree uses continuous state.
  ...
  /// Unlock the joint.  Locking is not supported for continuous-mode systems.
  /// @throws std::exception if the parent tree uses continuous state.
