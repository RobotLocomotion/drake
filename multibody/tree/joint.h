...
class Joint : public MultibodyElement<T> {
 ...
 private:
  ...
  // private method MakeJointImplementation().
  friend class internal::JointImplementationBuilder<T>;

  // This method must be implemented by derived classes in
  // order to provide JointImplementationBuilder a Mobilizer as the Joint's
  // internal representation.
  virtual std::unique_ptr<internal::Mobilizer<T>> MakeJointImplementation(
