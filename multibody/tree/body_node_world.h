...
#define DEFINE_DUMMY_HELPER(Rnv)                                            \
  ...
  DEFINE_DUMMY_HELPER(1)
  DEFINE_DUMMY_HELPER(2)
  DEFINE_DUMMY_HELPER(3)
  DEFINE_DUMMY_HELPER(4)
  DEFINE_DUMMY_HELPER(5)
  DEFINE_DUMMY_HELPER(6)

#undef DEFINE_DUMMY_HELPER
