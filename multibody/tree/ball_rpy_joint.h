...
class BallRpyJoint final : public Joint<T> {
 public:
  ...
  /// for an explanation of the generalized velocity.
  ...
  /// angular velocity for `this` joint (see get_angular_velocity()).
  ...
  /// angles). That is, the angles θ₁, θ₂, θ₃, correspond to a sequence of
  /// rotations about the x̂, ŷ, ẑ axes of parent frame F, respectively.
  /// Mathematically, rotation `R_FM` is given in terms of angles θ₁, θ₂, θ₃
  /// by: <pre>
  ...
  /// Zero θ₁, θ₂, θ₃ angles corresponds to frames F and M being coincident.
  ...
  /// angles (intrinsic).
  ///
  /// @note This particular choice of angles θ₁, θ₂, θ₃ for this joint are
