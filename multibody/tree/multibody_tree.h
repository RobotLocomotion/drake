...
class MultibodyTree {
 ...
 private:
  ...
  // default positions. These associated joints are guaranteed to be
  // QuaternionFloatingJoints. The poses are stored as a quaternion-translation
  // pair to match the default positions stored in the quaternion floating
  // joints without any numerical conversions and thereby avoiding roundoff
  // errors and surprising discrepancies pre and post finalize.
  std::unordered_map<
