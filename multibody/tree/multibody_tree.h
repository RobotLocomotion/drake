...
class MultibodyTree {
 public:
  ...
  // SpanningForestModel also if it has been built.
  [[nodiscard]] const LinkJointGraph& link_joint_graph() const {
 ...
 private:
  ...
  // multibody plant, and containing the chosen SpanningForestModel we use
  // for computation.
