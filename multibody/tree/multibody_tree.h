...
class MultibodyTree {
 public:
  ...
  JointType<T>& GetMutableJointByName(
    ...
    // Note: This shortcut avoids duplicating or factoriing out the code from
    // GetJointByName, and because this method is not marked as const, it
    // does not permit any new access.
