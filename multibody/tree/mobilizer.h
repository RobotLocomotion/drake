...
class Mobilizer : public MultibodyElement<Mobilizer, T, MobilizerIndex> {
 public:
  ...
  // for the `k`th position in this mobilizer. Mobilizers with more than one
  // position must override this method.
  ...
  // for the `k`th velocity in this mobilizer. Mobilizers with more than one
  // velocity must override this method.
