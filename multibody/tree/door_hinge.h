...
/// The curve `doublet(t, x)` is the second derivative of `s` scaled by `t²`,
...
/// <pre>
///  τ = τ_ts
///      `-` τ_c * doublet(q `-` qc₀/2, qc₀/2)
///      `-` τ_df * s(q̇, t)
///      `-` τ_sf * doublet(q̇, t)
///      `-` τ_vf * q̇.
/// </pre>
/// where τ_ts = ks * (q `-` qs₀) with ks the `spring_constant` and `qs₀`
/// the `spring_zero_angle_rad`. `qc₀` is the catch width angle and
/// `t` is `motion_threshold`.
...
/// of these different elements to obtain different characteristics for the
