...
class MultibodyTreeTopology {
 public:
  ...
  // We refer to as "tree" to a subgraph in the topology having a tree structure
  ...
  // For the t-th tree, this method returns the index to the first generalized
  ...
  // tree are contiguos in the vector of generalized velocities for the full
  // model.
