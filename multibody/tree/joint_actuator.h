...
class JointActuator final
 ...
 public:
  ...
  /// Typically, ρ >> 1. For the gear-motor here, reflected inertia Iᵣᵢ = ρ² ⋅
  /// Iᵣ. ratio is defined as the ratio of the rotor angular velocity to the
  /// joint's shaft angular velocity, typically ≫ 1 for robotic systems. For
  /// this case the reflected inertia will be: Iᵣᵢ = ρ²⋅Iᵣ.
  ///
