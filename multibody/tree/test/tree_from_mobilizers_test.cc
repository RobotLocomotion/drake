      ...
      for (double iq_shoulder = 0; iq_shoulder < num_angles; ++iq_shoulder) {
        ...
        for (double iq_elbow = 0; iq_elbow < num_angles; ++iq_elbow) {
          ...
          Eigen::MatrixXd X_WU_value =
              math::ExtractValueMatrixFromAutoDiff(X_WU.GetAsMatrix4());
          Eigen::MatrixXd X_WL_value =
              math::ExtractValueMatrixFromAutoDiff(X_WL.GetAsMatrix4());
          ...
          Eigen::MatrixXd X_WU_dot =
              math::ExtractGradientMatrixFromAutoDiff(X_WU.GetAsMatrix4());
          X_WU_dot.resize(4, 4);
          Eigen::MatrixXd X_WL_dot =
              math::ExtractGradientMatrixFromAutoDiff(X_WL.GetAsMatrix4());
          X_WL_dot.resize(4, 4);
