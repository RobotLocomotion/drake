...
GTEST_TEST(ModelInstance, ModelInstanceTest) {
  ...
  // bodies are added. Since internally we use a depth-first-ordering of bodies
  // in the tree, this implies that DOFs for the first tree are first, followed
  // by DOFs of the second tree, etc.
