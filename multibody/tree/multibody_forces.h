...
class MultibodyForces {
 public:
  ...
  /// MultibodyForces structure before a MultibodyPlant has been constructed.
  /// However, this must be used cautiously since the number of mobilized
  /// bodies and their mobilities are not known until after Finalize().
