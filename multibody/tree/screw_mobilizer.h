...
/* This mobilizer models a screw joint between an inboard frame F and an
 ...
 Zero θ define the "zero configuration" which corresponds to frame F and
 M being coincident and aligned, see set_zero_state(). The translation (z)
 depends on and proportional to the rotation θ. Their relation is defined by
...
template <typename T>
inline T get_screw_translation_from_rotation(const T& theta, const double& screw_pitch) {
