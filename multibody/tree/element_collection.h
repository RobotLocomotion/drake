...
This is helper class is used by MultibodyTree to maintain its collections of
elements that match the above description. (See the `@tparam` below for the full
