...
class ElementCollection final {
 public:
  ...
  /* Accesses an element via its index, without validity checking.
 ...
 private:
  /* Throws an error for access to a removed element. */
  ...
  // Map used to find element indexes by their actuator name. The same name
