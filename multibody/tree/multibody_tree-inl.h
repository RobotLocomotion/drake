...
MultibodyTree<T>::get_mutable_positions_and_velocities(
  ...
  // Not using ValidateCreatedForThisSystem() since we don't need all it does,
  // can't produce a more helpful message so far from the MultibodyPlant API,
  // and hope for this test to be inlined.
