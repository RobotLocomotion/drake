...
class RpyFloatingJoint final : public Joint<T> {
 public:
  ...
  @warning See class documentation for discussion of singular configurations.
  @returns a constant reference to this joint. */
  const RpyFloatingJoint<T>& SetFromRotationMatrix(
  ...
  @returns a constant reference to this joint. */
  const RpyFloatingJoint<T>& set_position(systems::Context<T>* context,
  ...
  @warning See class documentation for discussion of singular configurations.
  @returns a constant reference to `this` joint. */
  const RpyFloatingJoint<T>& set_pose(
  ...
  These functions can only be called after Finalize(). */
  /**@{*/

  /** Sets the random distribution from which the roll-pitch-yaw orientation
  angles of his joint will be randomly sampled. See the %RpyFloatingJoint class
  documentation for details on the orientation representation. If no position
  distribution has been set, translations will default to a delta centered at
  zero translation.
  ...
  for details on the position representation. If no angle distribution has been
  set, angles will default to a delta centered at zero.*/
  ...
  @returns The default angles (roll,pitch,yaw) as a Vector3. */
  ...
  @param[in] angles he desired default angles of the joint
  @warning See class documentation for discussion of singular configurations. */
  ...
  /** Gets the default position (translation vector) `p_FM` for this joint.
  @returns The default translation vector `p_FM` of this joint. */
  Vector3<double> get_default_position() const {
    return this->default_positions().template tail<3>();
  }

  /** Sets the default position (translation vector) `p_FM` of this joint.
  @param[in] p_FM
  ...
  @retval X_FM The default pose of this joint. */
  math::RigidTransform<double> get_default_pose() const {
    return math::RigidTransform(
        math::RollPitchYaw<double>(get_default_angles()),
 ...
 private:
  ...
  std::pair<Eigen::Quaternion<double>, Vector3<double>> DoGetDefaultPose()
      const final {
