...
/** Computes the SpatialInertia of a body made up of a homogeneous material
 ...
 A final note on the geometry::Convex type. The mesh referenced by the
 geometry::Convex specification may not actually be convex. In collision
 checking, the convex hull of the mesh is used. For this function, the *actual*
 mesh is used. So, the mass properties may not reflect the mass properties of
