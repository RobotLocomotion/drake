...
class FixedOffsetFrame final : public Frame<T> {
 public:
  ...
  /// @param[in,out] context contains the parameters of this frame's
  //    multibody plant.
  ...
  /// @param[in] context contains the parameters of this frame's multibody
  ///   plant.
  ...
  /// Returns the rigid transform X_PF that characterizes `this` frame F's pose
  /// in its parent frame P.
  /// @param[in] parameters contains the parameters of this frame's multibody
  ///   plant.
  math::RigidTransform<T> GetPoseInParentFrame(
