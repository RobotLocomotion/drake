...
MatrixX<double> MultibodyTree<T>::MakeActuatorSelectorMatrix(
  ...
  // Map of joint index to actuator index for all actuators.
  std::unordered_map<JointIndex, JointActuatorIndex> joint_to_actuator_index;
