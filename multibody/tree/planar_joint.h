...
class PlanarJoint final : public Joint<T> {
 public:
  ...
  /// body B expresed in frame F as τ_B_F = τ⋅Fz_F.
  ...
  /// the translations of `this` joint equals `p_FoMo_F`.
  /// @param[in] context The context of the model this joint belongs to.
  /// @param[in] p_FoMo_F The desired translations in meters to be stored in
  ...
  /// translations (see class documentation) to `v_FoMo_F`. The new
  /// rates of change get stored in `context`.
  /// @param[in] context The context of the model this joint belongs to.
  /// @param[in] v_FoMo_F The desired rates of change of `this` joint's
  ...
  Vector3<double> get_default_positions() const {
  ...
  void set_random_positions_distribution(
