...
/// joint allows frame M to translate with respect to frame F along the x- and
...
class PlanarJoint final : public Joint<T> {
 public:
  ...
  static const char kTypeName[]  = "planar";
  ...
  /// body B expressed in frame F as t_B_F = τ⋅Fz_F.
  Vector3<double> damping() const { return damping_; }

  /// @name Context-dependent value access
  /// @{

  /// Gets the generalized coordinates corresponding to the position of `this`
  /// joint from `context`.
  ///
  /// @param[in] context The context of the model this joint belongs to.
  /// @retval p_FoMo_F The position of `this` joint stored in the `context` ordered
  ...
  /// Gets the generalized coordinate corresponding to the angle θ of `this`
  /// joint from `context`.
  ///
  /// @param[in] context The context of the model this joint belongs to.
  /// @retval angle The angle θ of `this` joint stored in the `context`. See
  ...
  /// Sets the generalized coordinates in the `context` so that the position of
  /// `this` joint equals `p_FoMo_F` and its orientation equals `angle`.
  ///
  /// @param[in] context The context of the model this joint belongs to.
  /// @param[in] p_FoMo_F The desired position in meters to be stored in
  ///                     `context` ordered as (x, y). See class documentation
  ...
  /// @param[in] context The context of the model this joint belongs to.
  /// @retval v_FoMo_F The velocity of `this` joint as stored in the `context`.
  ...
  ///
  /// @param[in] context The context of the model this joint belongs to.
  /// @retval theta_dot The rate of change of `this` joint's angle θ as stored
  ///                   in the `context`.
  ...
  ///
  /// @param[in] context The context of the model this joint belongs to.
  /// @param[in] theta_dot The desired rates of change of `this` joint's angle
  ...
  /// @retval angle The default angle of `this` joint.
