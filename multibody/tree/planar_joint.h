...
class PlanarJoint final : public Joint<T> {
 public:
  ...
  /// `this` joint from `context`.
  ///
  /// @param[in] context The context of the model this joint belongs to.
  /// @retval p_FoMo_F The translation of `this` joint stored in the `context`
  ...
  /// the translation of `this` joint equals `p_FoMo_F`.
  ///
  /// @param[in] context The context of the model this joint belongs to.
  /// @param[in] p_FoMo_F The desired translation in meters to be stored in
  ...
  ///
  /// @param[in] context The context of the model this joint belongs to.
  /// @retval theta The rotation of `this` joint stored in the `context`. See
  ...
  /// the rotation θ of `this` joint equals `theta`.
  ///
  /// @param[in] context The context of the model this joint belongs to.
  /// @param[in] theta The desired rotation in radians to be stored in
  ///                  `context`. See class documentation for details.
  /// @returns a constant reference to `this` joint.
  ...
  // of `this` joint equals `p_FoMo_F` and its rotation equals `theta`.
  ///
  /// @param[in] context The context of the model this joint belongs to.
  /// @param[in] p_FoMo_F The desired translation in meters to be stored in
  ///                     `context` ordered as (x, y). See class documentation
  ...
  /// Gets the rate of change, in radians per second, of `this` joint's rotation
  /// θ from `context`.  See class documentation for the definition of this
  /// rotation.
  ///
  /// @param[in] context The context of the model this joint belongs to.
  /// @retval theta_dot The rate of change of `this` joint's rotation θ as
  ///                   stored in the `context`.
  const T& get_angular_velocity(const systems::Context<T>& context) const {
    return get_mobilizer()->get_angular_rate(context);
  }

  /// Sets the rate of change, in radians per second, of `this` joint's rotation
  ...
  /// Gets the default translation for `this` joint.
  /// @retval p_FoMo_F The default translation of `this` joint.
  ...
  /// @param[in] p_FoMo_F The desired default translation of the joint
  ...
  /// Gets the default rotation for `this` joint.
  /// @retval theta The default rotation of `this` joint.
  double get_default_rotation() const { return this->default_positions()[2]; }

  /// Sets the default rotation of this joint.
  /// @param[in] theta The desired default rotation of the joint
  ...
  /// Sets the default translation and rotation of this joint.
  /// @param[in] p_FoMo_F The desired default translation of the joint
  /// @param[in] theta The desired default rotation of the joint
  ...
  /// Sets the random distribution that the translation and rotation of this
  /// joint will be randomly sampled from. See class documentation for details
  /// on the definition of the translation and rotation.
