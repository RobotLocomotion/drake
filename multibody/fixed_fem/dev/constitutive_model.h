...
class ConstitutiveModel {
 public:
  ...
  /* Creates a DeformationGradientData that is compatible
   with this ConstitutiveModel. */
  typename DerivedTraits::DeformationGradientDataType
  MakeDeformationGradientData(ElementIndex element_index) const {
    return typename DerivedTraits::DeformationGradientDataType(element_index);
  }
