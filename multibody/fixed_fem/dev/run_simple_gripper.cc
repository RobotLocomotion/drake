...
A demo to showcase integration of deformable solver and the contact solver. This
demo can only be run in discrete mode.
...
int DoMain() {
  ...
  /* Set a pre-computed initial position of the box so that the box fits snuggly
   in the gripper. */
