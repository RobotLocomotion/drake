...
class LinearSimplexElement
 ...
 public:
  ...
  using ShapeFunctions = typename Base::ShapeFunctions;
  ...
  template <typename U>
  using ArrayOfSamples = typename Base::template ArrayOfSamples<U>;
  ...
  explicit LinearSimplexElement(
      const ArrayOfSamples<Vector<double, natural_dimension>>& locations)
      : Base(locations, GetShapeFunctionsHelper(locations),
 ...
 private:
  ...
  ArrayOfSamples<ShapeFunctions> GetShapeFunctionsHelper(
  ...
  static const ArrayOfSamples<GradientInParentCoordinates>
  GetGradientInParentCoordinatesHelper();
};
