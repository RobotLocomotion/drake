...
/* Implements the interface StateUpdater with Newmark-beta time integration
 scheme with velocity being the known variable. Given the value for the current
 time step velocity `v`, the states are calculated from states from the previous
 time step according to the following equations:
