...
namespace multibody {
namespace fixed_fem {
/** %ElementCacheEntry provides basic caching capabilities for the per-element,
 state-dependent quantities used in an FEM simulation that are not states
 themselves. These quantities are stored in `ElementData`.
 ...
 `FooElement`, the element that this %ElementCacheEntry is holding data for, is
 a most derived class from FemElement. */
