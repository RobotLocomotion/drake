...
class LinearOperator {
 public:
  ...
  /// DoMultiply().
  /// @pre y is not nullptr.
  /// @pre x.size() equals this->cols() and y->size() equals this->rows().
  ...
  /// @pre y is not nullptr.
  /// @pre x.size() equals this->rows() and y->size() equals this->cols().
  ...
  /// @pre A is not nullptr.
  /// @pre A->rows() equals this->rows() and A->cols() equals this->cols().
