...
/// This method creates geometry for a block and an inclined plane (World).
/// It creates the surface friction properties of the block and inclined plane
/// and the mass/inertia properties of a uniform-density block.
///
