...
using Offset = SpGrid<GridData, kMaxGridSize>::Offset;
...
GTEST_TEST(SpGridTest, Constructor) {
  ...
  SpGrid<GridData, kMaxGridSize> grid;
}
...
GTEST_TEST(SpGridTest, IterateGridWithOffset) {
  ...
  grid.IterateGridWithOffset(
      [](SpGrid<GridData, kMaxGridSize>::Offset offset, GridData* node_data) {
        node_data->data =
  ...
  grid.IterateConstGridWithOffset(
      [](SpGrid<GridData, kMaxGridSize>::Offset offset,
...
GTEST_TEST(SpGridTest, SetFrom) {
  SpGrid<GridData, kMaxGridSize> grid1;
  SpGrid<GridData, kMaxGridSize> grid2;
