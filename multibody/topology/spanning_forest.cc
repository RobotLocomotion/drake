...
/* Add a new mobilized body outboard of the given inboard body:
   ...
   - if joint type is Weld, we are creating or joining a composite mobilized
     body; if that is the World composite then the Mobod is "anchored". */
...
void SpanningForest::AssignCoordinates() {
  ...
  // O(n) inward pass counts outboard bodies and coordinates for each
  // Mobod.
