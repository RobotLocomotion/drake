...
one or more _fused_ (composite) Mobods.
...
class SpanningForest {
 public:
  ...
  that if you have chosen the modeling option to fuse welded-together Links into
  fused (composite) bodies, then each WeldedLinksAssembly gets only a single
 ...
 private:
  ...
  // the "next level" outboard of this optimized WeldedLinksAssembly.
