...
modeled by a mobilizer but welds may be eliminated by creating Link Composites
that require only a single mobilizer for a group of Links.
...
class SpanningForest {
 ...
 private:
  ...
  // Determines proposed depth-first reordering.
  // @retval old_to_new
