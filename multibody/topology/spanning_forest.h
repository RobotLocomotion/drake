...
class SpanningForest {
 ...
 private:
  ...
  bool model_instance_is_static(ModelInstanceIndex index) const {
    return static_cast<bool>(options(index) & ModelingOptions::kStatic);
  }

  bool use_fixed_base(ModelInstanceIndex index) const {
    return static_cast<bool>(options(index) & ModelingOptions::kUseFixedBase);
  }
  ...
  struct Data {
    ...
    ModelingOptions global_modeling_options{ModelingOptions::kDefault};
