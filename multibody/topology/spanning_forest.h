...
class SpanningForest {
 public:
  ...
  /** Returns the sequence of mobilized bodies from World to the given body B,
  ...
  of the Composite Mobod. The remaining Mobods are in no particular order.

  Except for World, Mobods that are not welded to any other Mobods do not appear
  here.
  @see mobod_to_links() */
  ...
  "active" Link, that is, the one whose mobilizer is used for the whole
  Composite. Cost is O(1) and very fast. */
  inline LinkIndex mobod_to_link(
