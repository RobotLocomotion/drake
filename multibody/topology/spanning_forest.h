...
composite of Links in a WeldedLinksAssembly. A mobilizer connects each Mobod to
an inboard Mobod (except for World). An additional "shadow" Link and its Mobod
is created whenever a loop is broken by cutting a Link, and a LoopConstraint is
added to reconnect the primary Link to its shadow. Every moving Joint will map
to a Mobod and there will be additional floating or weld joints added as needed
to connect tree root nodes (a.k.a. "base bodies") to World.
