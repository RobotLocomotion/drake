...
std::ostream& operator<<(std::ostream& o, ModelingOptions options) {
  if (options == ModelingOptions::kDefault) {
    o << "Default";
  } else {
    if ((options & ModelingOptions::kStatic) == ModelingOptions::kStatic)
      o << " Static";
    if ((options & ModelingOptions::kUseRpyFloatingJoints) ==
        ModelingOptions::kUseRpyFloatingJoints)
      o << " UseRpy";
    if ((options & ModelingOptions::kCombineLinkComposites) ==
        ModelingOptions::kCombineLinkComposites)
      o << " CombineComposites";
    if ((options & ModelingOptions::kUseFixedBase) ==
