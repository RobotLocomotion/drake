...
class LinkJointGraph::Link {
 public:
  ...
  a fused-link mobod of some or all of the links in the assembly (including this
  one of course). If you ask this Mobod what Joint it represents, it will report
  the Joint that was used to mobilize that fused mobod; that won't necessarily
  be a Joint connected to this %Link. See inboard_joint_index() to find the
  Joint that connected this %Link to its WeldedLinksAssembly. */
