...
class SpanningForest::Mobod {
 public:
  ...
  /** A %Mobod is a "base body" if its inboard mobilizer connects it to
  ...
  modesl a LinkComposite (collection of welded-together Links), this is the
  ...
  /** Returns all the Links of a LinkComposite that are mobilized by this
  ...
  part, if any. If there are no %Mobods welded to this one, then the returned
  index is invalid. */
