...
class SpanningForest::Mobod {
 public:
  ...
  invalid only if this is the World %Mobod. The inboard %Mobod's level()
  ...
  is the "active" Joint that connects the LinkComposite's active Link to its
  inboard %Mobod.
  @see link() */
