...
template VectorX<AutoDiffUpTo73d> RigidBodyTree<double>::DoTransformPointsJacobianDotTimesV<AutoDiffUpTo73d>(const KinematicsCache<AutoDiffUpTo73d>&, const Eigen::Ref<const Matrix3Xd>&, int, int) const;  // NOLINT
