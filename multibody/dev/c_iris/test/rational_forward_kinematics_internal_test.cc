...
TEST_F(FinalizedIiwaTest, TestReshuffleKinematicTreeWithWorldAsRoot) {
  ReshuffledBody reshuffled_world(world_, nullptr, nullptr);
  ReshuffleKinematicTree(*iiwa_, &reshuffled_world);
...
TEST_F(FinalizedIiwaTest, TestReshuffleKinematicTreeWithLink3AsRoot) {
  ReshuffledBody reshuffled_link_3(iiwa_link_[3], nullptr, nullptr);
  ReshuffleKinematicTree(*iiwa_, &reshuffled_link_3);
