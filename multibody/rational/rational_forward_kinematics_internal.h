...
struct ChangedRootBody {
  ChangedRootBody(BodyIndex m_body_index, const ChangedRootBody* const m_parent,
                  const internal::Mobilizer<double>* const m_mobilizer)
  ...
  const internal::Mobilizer<double>* const mobilizer;
};
