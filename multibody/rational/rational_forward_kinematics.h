...
/** For certain robots (whose joint transforms are algebraic functions of joint
 ...
 joint, and d* is the displacement of that joint in q*.
...
class RationalForwardKinematics {
  ...
  */
  ...
  // prismatic joint. The displacement of the prismatic joint is d_star + d
  // along `axis_F`.
  template <typename T>
  ...
  symbolic::Variables s_angles_variables_;
};
}  // namespace multibody
}  // namespace drake
