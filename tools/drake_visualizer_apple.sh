...
export DYLD_LIBRARY_PATH="external/drake_visualizer/lib${DYLD_LIBRARY_PATH:+:$DYLD_LIBRARY_PATH}"

# TODO(jamiesnape): Do not hard code absolute path to vtk@8.0.
export PYTHONPATH="drake/bindings/python:drake/lcmtypes:external:external/drake_visualizer/lib/python2.7/dist-packages:external/lcmtypes_bot2_core/lcmtypes:external/lcmtypes_robotlocomotion/lcmtypes:/usr/local/opt/vtk@8.0/lib/python2.7/site-packages${PYTHONPATH:+:$PYTHONPATH}"
