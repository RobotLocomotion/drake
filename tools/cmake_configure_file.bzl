...
def cmake_configure_file(
    ...
    configure_file substitution semanatics.  This implementation is incomplete,
    ...
    Definitions optionally can be read from simple CMake listfiles that contain
    statements of the form "set(FOO_MAJOR_VERISON 1)" and similar.

    See //tools/cmake_configure_file.py for our implementation of the
    substitution rules.
