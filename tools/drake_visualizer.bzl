...
def _impl(repository_ctx):
    if repository_ctx.os.name == "mac os x":
        archive = "dv-0.1.0-173-g6e492205-qt-5.9.1-vtk-8.0.1-mac.tar.gz"
        ...
        if distro == "Ubuntu 14.04":
            ...
            sha256 = "95c2fd4c516b3a63918816ad54e2b5ab986700fa84c68dcf24e1d4b32cfa5b0e"  # noqa
        elif distro == "Ubuntu 16.04":
            archive = "dv-0.1.0-173-g6e49220-qt-5.5.1-vtk-8.0.1-xenial-x86_64.tar.gz"  # noqa
            sha256 = "023f983fbbe57a005a6e7f19e9b7659a002db6f6ae2a0539808039e1e1ba9d0a"  # noqa
        else:
