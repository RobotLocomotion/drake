...
cc_library(
    ...
    srcs = [
        ...
        # The following need to be in both src and hdrs because include_prefix
        # is being used.
        "bot2-param/src/param_client/param_client.h",
        "bot2-param/src/param_client/param_util.h",
    ],
...
cc_library(
    name = "bot2_frames",
    srcs = [
        "bot2-frames/src/bot_frames.c",
        # The following needs to be in both src and hdrs because include_prefix
        # is being used.
        "bot2-frames/src/bot_frames.h",
    ],
