...
class InstallTest(unittest.TestCase):
    ...
    def _run_one_command(self, test_command):
        ...
        # so that necessary libraries are availble. On Ubuntu, the libraries
        ...
        test_command = os.path.join(os.getcwd(), test_command)
        subprocess.check_call([python, test_command], cwd="/", env=env)
