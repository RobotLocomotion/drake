"""Support for installation scripts generated from a Bazel `install` target.
"""
import argparse
import collections
import filecmp
...
def execute_installation(args, actions_fn):
    """This is the installation "main" function.

    args (list) -- command line arguments
    actions_fn (callable) -- function that performs install actions

    The actions function takes no arguments and returns nothing; in actual
    bazel `install` rule usage, its body will be generated.
    """
    global color
    global list_only
    global prefix
