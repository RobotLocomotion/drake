...
build, downstream code can use this macro to detect that case and decide how to
treat it, e.g., to opt into assuming an unstamped build is new enough:

@code{.cpp}
#if DRAKE_VERSION_IS_UNSTAMPED || DRAKE_VERSION_AT_LEAST(1, 51, 1, 20260311)
// ... use a newer Drake API ...
#endif
@endcode
