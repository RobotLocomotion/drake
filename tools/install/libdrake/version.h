...
// caller's arguments followed by the five-argument macro, then the
// four-argument macro. Because of this, the sixth slot will be the
// five-argument macro for a five-argument call and the four-argument macro
// for a four-argument call; the trailing (__VA_ARGS__) in
// DRAKE_VERSION_AT_LEAST then calls the selected macro, which the chooser
// returns as `chosen`.
