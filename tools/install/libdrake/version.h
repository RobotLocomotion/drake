...
// Returns its sixth argument. DRAKE_VERSION_AT_LEAST invokes this with the
// caller's arguments followed by the 5 argument macro, then the 4 argument
// macro. Because of this, the sixth slot will the 5 argument macro for a
// five-argument call and the 4 argument macro for a four-argument call; the
// trailing (__VA_ARGS__) in DRAKE_VERSION_AT_LEAST then calls the selected
// macro, which the chooser returns as `chosen`.
