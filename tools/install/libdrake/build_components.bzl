...
LIBDRAKE_COMPONENTS = [
    ...
    "//common/proto:protobuf_ubsan_fixup",
    ...
    "//tools/install/libdrake:gurobi_deps",
    "//tools/install/libdrake:mosek_deps",
    "//tools/install/libdrake:vtk_deps",
    "//util:lcm_util",
    "//util:util",
]
