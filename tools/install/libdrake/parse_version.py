...
def _split_version(version_full):
    ...
    parts, padding if necessary. Any pre-release, 'dev', 'post', and/or local
    identifier (i.e., the portion following a '+') is discarded. Raises
...
def main():
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Path to a source archive's PACKAGE_VERSION.TXT, used if "
