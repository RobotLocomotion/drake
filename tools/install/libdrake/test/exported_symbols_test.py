...
class ExportedSymbolsTest(unittest.TestCase):
    ...
    def _find_cxa_atexit_callers(binary):
        """Returns a list of (demangled) function names that have a relocation
        pointing to __cxa_atexit, except for those _is_known_bad_ctor_or_dtor
        already knows are bad.
        """
        ...
        atexit_call_vmas = []
        # The loop variable "i" an index into text_bytes.
