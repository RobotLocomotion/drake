...
To run:
    ...
    bazel-bin/tools/release_engineering/mirror_to_s3 [--dry-run]
"""
...
def main(args: list[str]) -> None:
    parser = argparse.ArgumentParser(prog="mirror_to_s3", description=__doc__)
    parser.add_argument(
        "-n",
        "--dry-run",
        default=False,
    ...
    token_file = "~/.config/readonly_github_api_token.txt"
