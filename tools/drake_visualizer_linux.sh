...
export PYTHONPATH="drake/bindings/python:drake/lcmtypes:external/drake_visualizer/lib/python2.7/dist-packages:external/vtk/lib/python2.7/site-packages:external/lcmtypes_bot2_core/lcmtypes:external/lcmtypes_robotlocomotion/lcmtypes:external${PYTHONPATH:+:$PYTHONPATH}"
