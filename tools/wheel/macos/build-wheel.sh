...
# TODO(matthew.woehlke) If/when we fix the builds to get their dependencies
# some other way, note that, as of writing, building the actual wheel has
# additional dependencies; this logic may need to lower rather than being
# deleted outright. See (and consider partly reverting) the commit that added
# this comment.
