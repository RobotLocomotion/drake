...
def drake_cc_googletest(
    ...
    # As a courtesy to lower layers, don't insert the "no_kcov" tag if it is
    # already present.
    kcov_already_off = (new_tags != None and "no_kcov" in new_tags)
    if not kcov_already_off and not is_small:
