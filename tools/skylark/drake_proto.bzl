...
def drake_cc_proto_library(
    ...
    native.genrule(
        ...
        cmd = "for src in $(SRCS) ; do sed -e '/#include <google\/protobuf\/generated_message_reflection.h>/ a #include \"protobuf-ubsan-fixup.h\"' $$src > $${src::-6}_ubsan_fixup.pb.cc ; done",  # noqa
    )
