...
condition. When used with drake_cc_googletest or drake_cc_googletest, the test
is still compiled. When used with drake_cc_optional_googletest, the test is not
even compiled.
