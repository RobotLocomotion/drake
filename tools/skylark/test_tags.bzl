...
def no_valgrind_tools_test_tags():
    """Returns the test tags necessary to exclude tests that exceed their
    timeout or fail when running under Valgrind tools such as DRD, Helgrind,
    and Memcheck.
    """
    return [
        "no_drd",
