...
valgrind \
    ...
    --tool=drd \
    --trace-children=yes \
    --trace-children-skip=/bin/cat,/bin/cp,/bin/mkdir,/bin/sed,/usr/bin/clang,/usr/bin/clang-6.0,/usr/bin/clang-format-6.0,/usr/bin/dot,/usr/bin/fc-list,/usr/bin/find,/usr/bin/gcc,\*/external/buildifier/buildifier \
