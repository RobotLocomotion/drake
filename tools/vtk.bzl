...
def _impl(repository_ctx):
    if repository_ctx.os.name == "mac os x":
        ...
        if distro == "Ubuntu 14.04":
            archive = "vtk-v8.0.1-qt-4.8.6-trusty-x86_64.tar.gz"
            sha256 = "fd18ecd9efdef74e6a2a113b75b512e9a733253b2c02c1a1a4b78b7bdbd15c16"  # noqa
        elif distro == "Ubuntu 16.04":
            archive = "vtk-v8.0.1-qt-5.5.1-xenial-x86_64.tar.gz"
            sha256 = "5e5623729c3e345e0a4cfc8cbdac0bb83971d50964277a6add02ea768cb8a0cb"  # noqa
        else:
