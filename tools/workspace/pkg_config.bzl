...
def setup_pkg_config_repository(repository_ctx):
    ...
    build_file_deprecation = getattr(
        repository_ctx.attr,
        "build_file_deprecation",
        "",
    )
    if build_file_deprecation == "":
        build_file_deprecation = None
    ...
    substitutions = {
        ...
        "%{build_file_deprecation}": repr(build_file_deprecation),
    }
    template = getattr(
        repository_ctx.attr,
        "build_file_template",
