...
def _impl(repo_ctx):
    # Only available on macOS. On Ubuntu, no targets should depend on @net_sf_jchart2d.
    ...
    if os_result.is_ubuntu:
        repo_ctx.symlink(
            Label("@drake//tools/workspace/net_sf_jchart2d:package-ubuntu.BUILD.bazel"),
            "BUILD.bazel",
        )
        repo_ctx.symlink(
      ...
      repo_ctx.symlink(
            Label("@drake//tools/workspace/net_sf_jchart2d:package-macos.BUILD.bazel"),
            "BUILD.bazel",
        )
