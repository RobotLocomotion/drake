...
def _compose_cmake_prelude():
    ...
    stubs = "\n\n".join([_stub_expand(function) for function in functions])
...
def _extract(prelude: str, subdir: str) -> dict[str, str | list[str]]:
    ...
    result = _interpret(prelude, cmake)
...
def _generate() -> str:
    ...
    for subdir in SUBDIRS:
        ...
        extracted = _extract(prelude, subdir)
