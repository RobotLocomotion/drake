...
def _impl(repository_ctx):
    ...
    if os_result.is_ubuntu and os_result.ubuntu_release == "18.04":
        result = setup_pypi_wheel(
            ...
            pypi_wheel_mirrors = repository_ctx.attr.mirrors["pypi_wheel"],
    ...
    # offer the @pygame repostory.  Either way, there's noting more to do.
    repository_ctx.file("BUILD.bazel", "# Empty pygame_py BUILD file.")
