...
def github_archive(
    ...
    Args:
        ...
        include_tags_pattern: optional string specifies a regex describing the
            ...
            `include_tags_pattern = r"^(\\d+\\.)"` is specified, all newer
...
def github_download_and_extract(
    ...
    Args:
        ...
        include_tags_pattern: regex describing the portion of the current tag
    ...
    # TODO(tyler-yankee): We should support include_tags_pattern for releases,
    # too.
    if upgrade_type != "tag" and include_tags_pattern:
        fail("include_tags_pattern can only be used for tags")
