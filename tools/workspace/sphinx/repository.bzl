...
load("@drake//tools/workspace:http_archive_python.bzl", "http_archive_python")
...
def sphinx_repository(name, mirrors = None):
    github_archive(
        ...
        # TODO(eric.cousineau): Use latest version possible.
        ...
        # Use this since Sphinx has non-ASCII filenames.
        http_archive = http_archive_python,
    )

    # TODO(eric.cousineau): Use a PyPI archive.
    pypi_archive(
        name = name + "_typing",
        package = "typing",
        version = "3.6.6",
