...
MODULE_SETTINGS = {
    "ABI": {
        "cmake_defines": [
            # TODO(jwnimmer-tri) XXX Use hidden attribute.
            "VTK_ABI_NAMESPACE_BEGIN=inline namespace drake_vendor {",
    ...
    "VTK::vtksys": {
        ...
        "cmake_defines": [
            ...
            # TODO(jwnimmer-tri) XXX Does this matter on macOS?
        ...
        "copts_extra": [
            ...
            # TODO(jwnimmer-tri) XXX Do we need sub-second timestamps?
            # KWSYS_CXX_STAT_HAS_ST_MTIM (linux) vs _MTIMESPEC (apple)
        ],
    },
    "VTK::CommonCore": {
        "visibility": ["//visibility:public"],
        "hdrs_extra": [
            # TODO(jwnimmer-tri) XXX Add a filegroup() name for these, for
            #   improved DRY on the exact filenames vs the macro.
        ...
        "cmake_defines": [
            # Version number(s).
            # TODO(jwnimmer-tri) XXX How to we keep these up to date?
            "VTK_VERSION=9.2.20220921",
            "VTK_VERSION_FULL=9.2.20220921+drake",
            "VTK_MAJOR_VERSION=9",
            "VTK_MINOR_VERSION=2",
            "VTK_BUILD_VERSION=20220921",
            # Features that are available on the host platform.
            "VTK_HAS_ISFINITE=1",
            "VTK_HAS_ISINF=1",
            "VTK_HAS_ISNAN=1",
    ...
    "VTK::FiltersGeneral": {
        ...
        "srcs_glob_exclude": [
            ...
            # TODO(jwnimmer-tri) File an issue with VTK upstream.
    ...
    "VTK::IOImport": {
        "visibility": ["//visibility:public"],
        # This module has a lot of importer classes that we don't need, which
        # themselves have a lot of wide dependencies. We'll opt-out of the
        # default srcs glob, and instead just specify the one class we need.
        "srcs_glob_exclude": ["**"],
        "srcs_extra": [
    ...
    "VTK::RenderingOpenGL2": {
        ...
        "cmake_undefines": [
            ...
            # XXX
            "VTK_USE_X",
            # "VTK_USE_OPENGL_LIBRARY",
        ],
        "hdrs_extra": [
            ":generated_rendering_opengl2_sources",
        ],
        "srcs_extra": [
            # XXX vtkObjectFactory.cmake
