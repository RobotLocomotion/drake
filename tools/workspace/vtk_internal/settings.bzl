...
MODULE_SETTINGS = {
    ...
    "VTK::pegtl": {
        # TODO(jwnimmer-tri) Used primarily by vtkCellAttribute (there's an
        # additional use in IO/MotionFx but we can ignore that).The only user of pugixml is vtkDataAssembly.
