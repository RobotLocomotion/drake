...
def create_modules_bzl(repo_ctx):
    ...
    This is necessary because BUILD files can't parse external metdaata as part
...
vtk_internal_repository = repository_rule(
    attrs = {
        ...
        "commit": attr.string(
            # TODO(jwnimmer-tri) We should be using a version numbered release,
            # shouldn't we? Maybe 9.2.3?
        ...
        "patches": attr.label_list(
            default = [
                ...
                "@drake//tools/workspace/vtk_internal:patches/doubleconversion.patch",  # noqa
                "@drake//tools/workspace/vtk_internal:patches/metaio.patch",
                "@drake//tools/workspace/vtk_internal:patches/pugixml.patch",
            ],
        ),
