...
filegroup(
    ...
    srcs = glob([
        "lib/libPythonQt.*",
        "lib/libddApp.*",
        PYTHON_SITE_PACKAGES_RELPATH + "/bot_lcmgl/**/*.py",
        PYTHON_SITE_PACKAGES_RELPATH + "/director/**/*.py",
        PYTHON_SITE_PACKAGES_RELPATH + "/director/**/*.so",
        PYTHON_SITE_PACKAGES_RELPATH + "/urdf_parser_py/**/*.py",
    ]) + [
