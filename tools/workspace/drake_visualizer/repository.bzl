...
def _impl(repository_ctx):
    ...
    if os_result.is_macos:
        archive = "dv-0.1.0-406-g4c3e570a-python-3.9.0-qt-5.15.1-vtk-8.2.0-mac-x86_64.tar.gz"  # noqa
        sha256 = "57b14c25a7fe1dde5afbf96eb39ef3f69e661ca5a40dfa1bda616d8f73d549ae"  # noqa
