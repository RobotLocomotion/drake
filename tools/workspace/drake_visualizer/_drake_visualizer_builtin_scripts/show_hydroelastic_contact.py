...
class VisualModel:
    ...
    tracks them unique per geometry-geometry contact and allows the visualizer
    ...
    class _Contact:
        ...
        def set_mesh_data(self, mesh_data: vtk.vtkPolyData, item_name: str,
            ...
            """Implements ViewMode.set_contact_mesh_data."""
        ...
        def set_debug_data(self, item_data: DebugData, item_name: str, view):
            """Implements ViewMode.set_contact_debug_data."""
...
class HydroelasticContactVisualizer:
    ...
    def update_uv_transform(self, xform):
        ...
        #     target amount d, we must put the origin at -d.
        #
        # Finally, We rely on the texture map *clamping* its values for pressure
    ...
    def update_pressure_mesh_cb(self, vis_item: VisualItem,
                                mesh_data: vtk.vtkPolyData):
        """The callback supplied to the VisualModel for when updating a pressure
        mesh."""
