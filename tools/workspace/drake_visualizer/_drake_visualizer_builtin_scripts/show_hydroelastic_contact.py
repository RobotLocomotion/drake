...
class _BodyContact:
    ...
    def __init__(self,
        ...
        self._folder = om.getOrCreateContainer(
            self._folder_name(self.key), root_folder)
    ...
    def _folder_name(key):
        ...
        name1 = _BodyContact._body_name_from_key(key, 0)
        name2 = _BodyContact._body_name_from_key(key, 1)
    ...
    @staticmethod
    def _body_name_from_key(key, body_index: int):
    ...
    def body_name(surface: lcmt_hydroelastic_contact_surface_for_viz,
        ...
        return _BodyContact._body_name_from_key(key, body_index)
