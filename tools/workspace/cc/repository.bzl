...
"""
    ...
    # CMakeLists.txt and doc/_pages/from_source.md. We know from experience
    # that compilation of Drake will certainly fail with versions lower than
    # these, even if they happen to support the necessary compiler flags.
