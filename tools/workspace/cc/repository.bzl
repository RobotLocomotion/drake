...
"""
    ...
    # We do not fail outright here since even those we do not officially
    ...
    # CMakeLists.txt. We know from experience that compilation of Drake will
    # certainly fail with versions lower than these, even if they happen to
    # support the necessary compiler flags.
