...
"""A python library (with command-line previewer) that reports summary data
related to Drake's repository rules.  This library uses bazel command-line
actions so is suitable only for manual use, not any build rules or test
automation.
"""
