...
# Ubuntu only: GUROBI_PATH should be the linux64 directory in the Gurobi 8.1.1
# release.
#
# TODO(jwnimmer-tri) The Gurobi docs use /opt/gurobi811/linux64, so we should
...
def _gurobi_impl(repo_ctx):
    ...
    if os_result.is_macos:
        ...
        gurobi_path = "/Library/gurobi811/mac64"
