...
vivamus at augue eget arcu dictum varius.)""";
    ...
    struct /* mkdoc_test */ {
      ...
      struct /* AnonymousConstant */ {
        // Source: drake/tools/workspace/pybind11/test/sample_header.h:300
...
* Begin third unordered list element. Hac habitasse platea dictumst quisque
  sagittis purus sit. End third unordered list element.)""";
        ...
        struct /* ctor */ {
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:108
          const char* doc_0args = R"""(Custom constructor 1.)""";
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:116
...
phasellus egestas tellus rutrum tellus pellentesque eu.)""";
        ...
        struct /* PublicMethod */ {
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:130
          const char* doc = R"""()""";
        } PublicMethod;
...
Postcondition:
    ...
    condimentum id. End postcondition.)""";
        ...
        struct /* TypedefAlias */ {
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:99
          const char* doc =
...
R"""(Using alias. Sit amet nisl purus in mollis nunc sed id semper.)""";
        ...
        struct /* do_stuff */ {
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:183
          const char* doc_stuff_1 = R"""(Docstring 1.)""";
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:189
          const char* doc_stuff_2 = R"""(Docstring 2.)""";
        } do_stuff;
        // Symbol: drake::mkdoc_test::Class::get_foo
        struct /* get_foo */ {
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:174
          const char* doc_0args_nonconst = R"""(Overloaded only by its const-ness.)""";
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:178
        ...
        struct /* overloaded_method */ {
          ...
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:154
          const char* doc_2args_charlie_delta = R"""(This one takes an int and a double.)""";
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:158
          const char* doc_2args_double_int = R"""(This one takes the road less traveled.)""";
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:162
        ...
        struct /* overloaded_with_same_doc */ {
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:166
...
Deprecated:
    ...
    after 2038-01-19.)""";
        ...
        struct /* a */ {
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:319
          const char* doc_deprecated =
R"""((Deprecated.)
...
Deprecated:
    ...
    2038-01-19.)""";
      ...
      struct /* Enum */ {
        // Source: drake/tools/workspace/pybind11/test/sample_header.h:283
        const char* doc =
...
fringilla est ullamcorper eget nulla facilisi.)""";
      ...
      struct /* EnumClass */ {
        // Source: drake/tools/workspace/pybind11/test/sample_header.h:291
        const char* doc =
...
Deprecated:
    ...
    tincidunt lobortis. End deprecated.)""";
        ...
        struct /* Serialize */ {
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:225
          const char* doc =
...
nisi.)""";
      ...
      struct /* TemplateClass */ {
        // Source: drake/tools/workspace/pybind11/test/sample_header.h:240
...
id. Nisl rhoncus mattis rhoncus urna neque.)""";
      ...
      struct /* func */ {
        // Source: drake/tools/workspace/pybind11/test/sample_header.h:64
        const char* doc_0args =
R"""(Function. Mi sit amet mauris commodo quis.)""";
        // Source: drake/tools/workspace/pybind11/test/sample_header.h:68
...
egestas egestas fringilla phasellus faucibus.)""";
  ...
  struct /* namespace_1 */ {
    ...
    struct /* MySimpleSystem */ {
      // Source: drake/tools/workspace/pybind11/test/sample_header.h:432
      const char* doc =
R"""(My simple system.
...
R"""(Ligula. Nunc turpis. Mauris vitae sapien. Nunc.)""";
        ...
        struct /* ctor */ {
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:383
          const char* doc = R"""()""";
        } ctor;
        // Symbol: namespace_1::namespace_2::DummyClass::static_function_1
        struct /* static_function_1 */ {
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:395
          const char* doc = R"""()""";
        } static_function_1;
      ...
      struct /* Struct1 */ {
        // Source: drake/tools/workspace/pybind11/test/sample_header.h:348
        const char* doc =
R"""(Quam odio at est.
...
R"""(Et, ornare sagittis, tellus. Fusce felis.)""";
        ...
        struct /* var_2 */ {
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:354
...
R"""(Tempor lobortis turpis. Sed tellus velit, ullamcorper.)""";
        ...
        struct /* var_5 */ {
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:363
          const char* doc =
...
R"""(Fames ac turpis egestas. Sed vitae eros. Nulla.)""";
        ...
        struct /* var_7 */ {
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:369
          const char* doc =
...
R"""(Volutpat. Donec non tortor. Vivamus posuere nisi mollis.)""";
      ...
      struct /* Struct5 */ {
        // Source: drake/tools/workspace/pybind11/test/sample_header.h:378
        const char* doc = R"""()""";
      } Struct5;
