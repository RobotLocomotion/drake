...
Deprecated:
    ...
    after 2038-01-19.)""";
      ...
      struct /* DrakeDeprecatedTemplateClass */ {
        // Source: drake/tools/workspace/pybind11/test/sample_header.h:329
        const char* doc_deprecated =
...
R"""(Ligula. Nunc turpis. Mauris vitae sapien. Nunc.)""";
        ...
        struct /* static_function_2 */ {
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:399
          const char* doc = R"""()""";
        } static_function_2;
        // Symbol: namespace_1::namespace_2::DummyClass::struct_2
        struct /* struct_2 */ {
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:397
          const char* doc = R"""()""";
        } struct_2;
      } DummyClass;
...
R"""(Volutpat. Donec non tortor. Vivamus posuere nisi mollis.)""";
      ...
      struct /* Struct4 */ {
        // Source: drake/tools/workspace/pybind11/test/sample_header.h:380
        const char* doc = R"""()""";
      } Struct4;
