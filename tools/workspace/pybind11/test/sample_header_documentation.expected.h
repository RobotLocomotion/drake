...
constexpr struct /* sample_header_doc */ {
  ...
  struct /* RootLevelSymbol */ {
    // Source: drake/tools/workspace/pybind11/test/sample_header.h:15
    const char* doc =
...
Version:
    ...
    struct /* mkdoc_test */ {
      ...
      struct /* AnonymousConstant */ {
        // Source: drake/tools/workspace/pybind11/test/sample_header.h:222
...
Parameter ``param2``:
    ...
    malesuada fames ac turpis. End second input parameter.)""";
        ...
        struct /* Nested */ {
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:147
          const char* doc =
...
Bug report:
    ...
    Eget est lorem ipsum dolor sit amet consectetur. End bug report.)""";
        ...
        struct /* ProtectedMethod */ {
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:139
          const char* doc =
...
condimentum vitae sapien pellentesque habitant morbi.)""";
        ...
        struct /* PublicStatic */ {
          ...
          const char* doc =
R"""(Static method. ``Typewriter``. Regular.
...
Postcondition:
    ...
    condimentum id. End postcondition.)""";
        ...
        struct /* PublicTemplateMethod */ {
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:124
          const char* doc =
...
semper.)""";
        ...
        struct /* protected_member_ */ {
          ...
          const char* doc =
R"""(Protected member. Porttitor eget dolor morbi non arcu risus quis
varius quam.)""";
        } protected_member_;
      } Class;
      // Symbol: drake::mkdoc_test::Enum
      struct /* Enum */ {
        // Source: drake/tools/workspace/pybind11/test/sample_header.h:206
        const char* doc =
...
fringilla est ullamcorper eget nulla facilisi.)""";
        ...
        struct /* EnumConstant */ {
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:208
...
Attention:
    ...
    risus feugiat. End attention.)""";
        ...
        struct /* field_2 */ {
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:179
          const char* doc =
...
Since:
    ...
    faucibus. End since.)""";
        ...
        struct /* ctor */ {
          // Source: drake/tools/workspace/pybind11/test/sample_header.h:193
          const char* doc =
...
Remark:
    ...
    fermentum posuere urna nec. End remarks.)""";
      ...
      struct /* func */ {
        // Source: drake/tools/workspace/pybind11/test/sample_header.h:39
        const char* doc =
R"""(Function. Mi sit amet mauris commodo quis.)""";
        // Source: drake/tools/workspace/pybind11/test/sample_header.h:45
        const char* doc_2 =
