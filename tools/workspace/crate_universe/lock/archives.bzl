...
ARCHIVES = [
    ...
    dict(
        name = "crate__proc-macro2-1.0.80",
        ...
        build_file = Label("@drake//tools/workspace/crate_universe/lock/details:BUILD.proc-macro2-1.0.80.bazel"),
    ),
    dict(
    ...
    dict(
        ...
        build_file = Label("@drake//tools/workspace/crate_universe/lock/details:BUILD.syn-2.0.59.bazel"),
    ),
    dict(
