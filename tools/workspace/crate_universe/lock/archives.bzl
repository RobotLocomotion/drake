...
ARCHIVES = [
    ...
    dict(
        name = "crate__clarabel-0.7.0",
        patches = [
            "@drake//tools/workspace/crate_universe:patches/clarabel_blas.patch",
        ],
        sha256 = "910ba9e23a61c253f83b2b550fae76abd220509509ae82c161ca673c4ad443cf",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/clarabel/0.7.0/download"],
        strip_prefix = "clarabel-0.7.0",
        build_file = Label("@drake//tools/workspace/crate_universe/lock/details:BUILD.clarabel-0.7.0.bazel"),
    ),
    dict(
    ...
    dict(
        ...
        build_file = Label("@drake//tools/workspace/crate_universe/lock/details:BUILD.either-1.10.0.bazel"),
    ),
    dict(
    ...
    dict(
        ...
        build_file = Label("@drake//tools/workspace/crate_universe/lock/details:BUILD.syn-2.0.51.bazel"),
    ),
    dict(
        name = "crate__thiserror-1.0.57",
        ...
        build_file = Label("@drake//tools/workspace/crate_universe/lock/details:BUILD.thiserror-1.0.57.bazel"),
    ),
    dict(
        name = "crate__thiserror-impl-1.0.57",
        ...
        build_file = Label("@drake//tools/workspace/crate_universe/lock/details:BUILD.thiserror-impl-1.0.57.bazel"),
    ),
    dict(
