...
ARCHIVES = [,
    ...
    dict(
        ...
        build_file = Label("@drake//tools/workspace/crate_universe/lock/details:BUILD.libc-0.2.152.bazel"),
    ),
    dict(
    ...
    return [
        struct(repo = "crate__clarabel-0.6.0", is_dev_dep = False),
    ]
]
