...
ARCHIVES = [
    ...
    dict(
        ...
        build_file = Label("//tools/workspace/crate_universe/lock/details:BUILD.indexmap-2.7.0.bazel"),
    ),
    dict(
    ...
    dict(
        name = "crate__proc-macro2-1.0.92",
        ...
        build_file = Label("//tools/workspace/crate_universe/lock/details:BUILD.proc-macro2-1.0.92.bazel"),
    ),
    dict(
    ...
    dict(
        ...
        build_file = Label("//tools/workspace/crate_universe/lock/details:BUILD.ryu-1.0.18.bazel"),
    ),
    dict(
    ...
    dict(
        name = "crate__serde_json-1.0.134",
        ...
        build_file = Label("//tools/workspace/crate_universe/lock/details:BUILD.serde_json-1.0.134.bazel"),
    ),
    dict(
    ...
    dict(
        ...
        build_file = Label("//tools/workspace/crate_universe/lock/details:BUILD.syn-2.0.94.bazel"),
    ),
    dict(
    ...
    dict(
        name = "crate__unicode-ident-1.0.14",
        ...
        build_file = Label("//tools/workspace/crate_universe/lock/details:BUILD.unicode-ident-1.0.14.bazel"),
    ),
]
