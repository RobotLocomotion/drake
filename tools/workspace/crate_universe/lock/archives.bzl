...
ARCHIVES = [
    ...
    dict(
        ...
        build_file = Label("@drake//tools/workspace/crate_universe/lock/details:BUILD.hashbrown-0.15.2.bazel"),
    ),
    dict(
    ...
    dict(
        ...
        build_file = Label("@drake//tools/workspace/crate_universe/lock/details:BUILD.indexmap-2.7.0.bazel"),
    ),
    dict(
    ...
    dict(
        ...
        build_file = Label("@drake//tools/workspace/crate_universe/lock/details:BUILD.itoa-1.0.14.bazel"),
    ),
    dict(
    ...
    dict(
        ...
        build_file = Label("@drake//tools/workspace/crate_universe/lock/details:BUILD.libc-0.2.167.bazel"),
    ),
    dict(
    ...
    dict(
        ...
        build_file = Label("@drake//tools/workspace/crate_universe/lock/details:BUILD.proc-macro2-1.0.92.bazel"),
    ),
    dict(
    ...
    dict(
        ...
        build_file = Label("@drake//tools/workspace/crate_universe/lock/details:BUILD.serde-1.0.215.bazel"),
    ),
    dict(
        name = "crate__serde_derive-1.0.215",
        ...
        build_file = Label("@drake//tools/workspace/crate_universe/lock/details:BUILD.serde_derive-1.0.215.bazel"),
    ),
    dict(
        name = "crate__serde_json-1.0.133",
        ...
        build_file = Label("@drake//tools/workspace/crate_universe/lock/details:BUILD.serde_json-1.0.133.bazel"),
    ),
    dict(
    ...
    dict(
        ...
        build_file = Label("@drake//tools/workspace/crate_universe/lock/details:BUILD.syn-2.0.90.bazel"),
    ),
    dict(
        ...
        build_file = Label("@drake//tools/workspace/crate_universe/lock/details:BUILD.thiserror-1.0.69.bazel"),
    ),
    dict(
        ...
        build_file = Label("@drake//tools/workspace/crate_universe/lock/details:BUILD.thiserror-impl-1.0.69.bazel"),
    ),
    dict(
        ...
        build_file = Label("@drake//tools/workspace/crate_universe/lock/details:BUILD.unicode-ident-1.0.14.bazel"),
    ),
]
