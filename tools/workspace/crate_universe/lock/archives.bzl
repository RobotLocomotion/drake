...
ARCHIVES = [
    ...
    dict(
        ...
        build_file = Label("@drake//tools/workspace/crate_universe/lock/details:BUILD.indexmap-2.3.0.bazel"),
    ),
    dict(
    ...
    dict(
        ...
        build_file = Label("@drake//tools/workspace/crate_universe/lock/details:BUILD.serde-1.0.204.bazel"),
    ),
    dict(
        name = "crate__serde_derive-1.0.204",
        ...
        build_file = Label("@drake//tools/workspace/crate_universe/lock/details:BUILD.serde_derive-1.0.204.bazel"),
    ),
    dict(
        name = "crate__serde_json-1.0.121",
        ...
        build_file = Label("@drake//tools/workspace/crate_universe/lock/details:BUILD.serde_json-1.0.121.bazel"),
    ),
    dict(
    ...
    dict(
        ...
        build_file = Label("@drake//tools/workspace/crate_universe/lock/details:BUILD.syn-2.0.72.bazel"),
    ),
    dict(
