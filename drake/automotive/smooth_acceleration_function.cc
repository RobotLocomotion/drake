...
void calc_smooth_acceleration(const T& desired_acceleration,
  ...
  *result = damped_acceleration * smoothing_factor;
}

// These instantiations must match the API documentation in
// smooth_acceleration_function.h.
template void calc_smooth_acceleration<double>(
...
template void calc_smooth_acceleration<AutoDiffXd>(
    ...
    AutoDiffXd* result);
#endif
template void calc_smooth_acceleration<Expression>(
