...
gen_vector_proto "bicycle car parameters" $mydir/bicycle_car_parameters.named_vector
gen_lcm_and_vector_from_proto "bicycle car state" $mydir/bicycle_car_state.named_vector
gen_lcm_and_vector_from_proto "driving command" $mydir/driving_command.named_vector
...
gen_vector_proto "maliput railcar params" $mydir/maliput_railcar_params.named_vector
...
gen_vector_proto "simple car params" $mydir/simple_car_params.named_vector
