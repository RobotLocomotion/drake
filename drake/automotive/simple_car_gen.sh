...
gen_lcm_and_vector_from_proto $mydir/bicycle_car_parameters.named_vector
...
gen_lcm_and_vector_from_proto $mydir/maliput_railcar_params.named_vector
...
gen_lcm_and_vector_from_proto $mydir/simple_car_params.named_vector
