...
class Lane final : public api::Lane {
 ...
 private:
  ...
  // Note: Due to the discontinuity in `distance` at lane boundaries, a
  // `geo_pos` point located exactly on the boundary will (not unsurprisingly)
  // have undefined partial derivatives (NAN).
