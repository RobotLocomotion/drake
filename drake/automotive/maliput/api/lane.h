...
class Lane {
 public:
  ...
  //
  // TODO(jadecastro): Consider having client enforce the geo_pos AutoDiffXd
  // coherency contract.  Reevaluate this once an AutoDiff consumer for
 ...
 private:
  ...
  DoToLanePosition(const GeoPositionT<AutoDiffXd>&,
