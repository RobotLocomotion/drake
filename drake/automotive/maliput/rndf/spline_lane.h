...
class SplineLane : public Lane {
 public:
  ...
  /// points. The tuple will be interpreted as with the first value as the knot
  /// and the second as the tangent.
  ///
 ...
 private:
  ...
  // Provides a rotation vector in terms of Euler angles, with only
