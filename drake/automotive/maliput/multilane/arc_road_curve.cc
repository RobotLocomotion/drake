...
bool ArcRoadCurve::IsValid(
  ...
  // TODO(...)            Include height_bounds in checking against the
  //                      singularity at the arc center.
  // TODO(...)            Check against singularities in curvature of elevation.
  // TODO(...)            Check for self-intersecting volumes (e.g., when arc
  //                      angle >= 2π).
