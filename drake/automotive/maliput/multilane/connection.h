...
class Connection {
 public:
  ...
  ///
  /// It begins at `start` and extends on the plane z=0 `line_length` distance
  /// with `start.xy().heading()` heading angle. `end_z` will be used to build
  /// elevation and superelevation information of the road.
  ///
  ...
  ///
  /// It begins at `start` and extends on the plane z=0 with
  /// `arc_offset.radius()` an angle span of `arc_offset.d_theta()`. `end_z`
  /// will be used to build elevation and superelevation information of the
  /// road.
  ///
  ...
  /// creating an Endpoint with that information.
