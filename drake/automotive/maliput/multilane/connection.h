...
class EndpointZ {
 public:
  ...
  ///
  /// As theta and theta_dot are part of the superelevation of the road, when
  /// going in the opposite direction there is a flip of the axis. Consequently,
  /// z_dot, theta and theta_dot must be negative.
