...
TEST_F(MultilaneArcRoadCurveTest, WorldFunctionDerivative) {
  ...
  const double kQuiteExact = 1e-9;
  const double kDifferential = 1e-5;
...
// values being used below, the same curve functions were composed and numerically
// evaluated using Octave.
