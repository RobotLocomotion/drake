...
class IdmPlannerParameters : public systems::BasicVector<T> {
 public:
  ...
  /// @arg @c v_ref defaults to 10.0 in m/s.
  /// @arg @c a defaults to 1.0 in m/s^2.
  /// @arg @c b defaults to 3.0 in m/s^2.
  /// @arg @c s_0 defaults to 1.0 in m.
  /// @arg @c time_headway defaults to 0.1 in s.
  /// @arg @c delta defaults to 4.0 in dimensionless.
  /// @arg @c bloat_diameter defaults to 4.5 in m.
  /// @arg @c distance_lower_limit defaults to 1e-2 in m.
  /// @arg @c scan_ahead_distance defaults to 100.0 in m.
