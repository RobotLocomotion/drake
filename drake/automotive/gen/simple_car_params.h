...
class SimpleCarParams : public systems::BasicVector<T> {
 public:
  ...
  /// @arg @c max_velocity defaults to 45.0 in units of m.
  ...
  /// The limit on the car's forward speed, in meters per second.
  /// @note @c max_velocity is expressed in units of m.
