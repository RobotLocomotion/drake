...
#include "drake/lcmt_railcar_command_t.hpp"
 ...
 * RailcarCommand type.
 */
class RailcarCommandTranslator
    : public systems::lcm::LcmAndVectorBaseTranslator {
 public:
  RailcarCommandTranslator()
      : LcmAndVectorBaseTranslator(RailcarCommandIndices::kNumCoordinates) {}
