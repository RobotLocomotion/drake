...
class BicycleCarParameters : public systems::BasicVector<T> {
 public:
  ...
  /// @arg @c mass defaults to 2278.0 in kg.
  /// @arg @c lf defaults to 1.292 in m.
  /// @arg @c lr defaults to 1.515 in m.
  /// @arg @c Iz defaults to 3210.0 in kg m^2.
  /// @arg @c Cf defaults to 10.8e4 in N / rad.
  /// @arg @c Cr defaults to 10.8e4 in N / rad.
