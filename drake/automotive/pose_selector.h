...
class PoseSelector {
 public:
  ...
  ///
  /// If the first argument is a RoadPosition object (@p road), then poses in
  /// lanes that eventually merge (converge to the same branch point) are
  /// considered in addition to those along the ego car's path.  Otherwise, if
