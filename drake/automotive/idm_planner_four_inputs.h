...
/// IdmPlannerFourInputs -- an IDM (Intelligent Driver
/// Modal)[1]. Four-input version.
///
...
template <typename T>
class IdmPlannerFourInputs : public systems::LeafSystem<T> {
 public:
  IdmPlannerFourInputs(const T& v_0);
  ~IdmPlannerFourInputs() override;
