...
// The number of dragway lanes is by default zero to disable the dragway. A
// dragway road network is only enabled when the user specifies a number of
// lanes greater than zero. For more details, see DetermineRoadNetworkType().
