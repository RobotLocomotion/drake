...
DEFINE_int32(num_simple_car, 0, "Number of SimpleCar vehicles. This option can "
             "be overriden by --simple_car_names. If this option is used, the "
             "cars are named \"0\", \"1\", \"2\", etc.");
