...
class PurePursuit {
 public:
  ...
  /// @lane_direction is the LaneDirection with the current lane upon whose
  /// centerline the path is defined, and the direction of travel.
  /// @param road is the RoadGeometry.
  /// @param ego_pose is the PoseVector for the ego vehicle.
