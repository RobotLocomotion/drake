...
class AutomotiveSimulator {
 public:
  ...
  /// @pre Start() has NOT been called.
  void AddPublisher(const SimpleCar<double>& system, int vehicle_number);

  /// Adds an LCM publisher for the given @p system.
  /// @pre Start() has NOT been called.
  void AddPublisher(const SimpleCarToEulerFloatingJoint<double>& system,
                    int vehicle_number);
  ...
  /// such system has been added, or multiple such systems have been added.
  ///
  /// This is the diagram variant of the of the method, which can only be used
  /// after Start().
  ///
  ...
  /// Advance simulated time by the given @p seconds increment.
