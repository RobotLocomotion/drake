...
class AutomotiveSimulator {
 public:
  ...
  ///
  /// @param id The ID of the MaliputRailcar. This is the value that was
  /// returned by the method that added the MaliputRailcar was added to the
  /// simulation. If no MaliputRailcar with such an ID exists, a
