...
class AutomotiveSimulator {
 public:
  ...
  /// The default constructor that configures this object with a nullptr
  /// DrakeLcm instance and hence does NOT perform any visualization.
  AutomotiveSimulator();

  /// A constructor that configures this object to use a _real_ DrakeLcm
  /// instance only if the argument is non-null.  Otherwise, no visualization is
  /// produced.
