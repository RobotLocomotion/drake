...
/// Models an idealized response to driving commands, neglecting all physics.
/// Note that the SimpleCar can move forward, stop, turn left, and turn right
/// but *cannot* travel in reverse.
///
/// configuration:
