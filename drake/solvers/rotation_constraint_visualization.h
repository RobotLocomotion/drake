...
/**
 * Draw a unit sphere
 * @param color The rgb color of the surface to be plotted. @default is [0, 0.5, 0.5]
 */
 ...
 * @param color The rgb color of the surface to be plotted. @default is [0.5, 0.2, 0.3]
