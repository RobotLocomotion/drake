...
class SixHumpCamelObjective
    : public TemplatedDifferentiableFunction<SixHumpCamelObjective> {
 public:
  SixHumpCamelObjective()
      : TemplatedDifferentiableFunction<SixHumpCamelObjective>(*this){};

  template <typename ScalarType>
  void evalImpl(const Ref<const Matrix<ScalarType, Dynamic, 1>>& x,
                Matrix<ScalarType, Dynamic, 1>& y) {
    y.resize(1);
    y(0) =
...
class GloptipolyConstrainedExampleObjective
    : public TemplatedDifferentiableFunction<
          GloptipolyConstrainedExampleObjective> {
 public:
  GloptipolyConstrainedExampleObjective()
      : TemplatedDifferentiableFunction<GloptipolyConstrainedExampleObjective>(
            *this){};
