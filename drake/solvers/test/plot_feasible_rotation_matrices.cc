...
/// It then evaluates this program over a large number of samples plots the
...
// Use this method to change the feasibility envelop for all of the plotting
// tools.
...
void AddTestConstraints(MathematicalProgram* prog,
  ...
  AddRotationMatrixMcCormickEnvelopeMilpConstraints(
      prog, R, 1);  // kPitch_NegPI_2_to_PI_2 | kYaw_0_to_PI_2);
}
...
void plotColumnVectorXYSlice(int column = 0,
  ...
  // Set add feasibility constraint
