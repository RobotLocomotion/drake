...
CE_xy << 0.3147,    0.1324,    0.4575,    0.4572,
0.4058,   -0.4025,    0.4649,   -0.0146;
...
G <<
0.6472,   -0.1517,   -0.1019,   -0.4394,    0.1772,    0.1697,
-0.1517,    0.3755,    0.0967,    0.3431,    0.2979,    0.1124,
-0.1019,    0.0967,    0.1902,    0.0987,    0.2064,   -0.0820,
-0.4394,    0.3431,    0.0987,    0.6460,    0.1524,    0.0546,
0.1772,    0.2979,    0.2064,    0.1524,    1.0408,    0.2175,
0.1697,    0.1124,   -0.0820,    0.0546,    0.2175,    0.5526;
...
EXPECT_TRUE(
    CompareMatrices
    (gurobi_solution, snopt_solution, 1e-4, MatrixCompareType::absolute));
}
} // namespace
} // namespace solvers
} // namespace drake