...
GTEST_TEST(DecomposeNonConvexQuadraticForm, Test0) {
  // Decomposes a psd matrix Q, then Q1 = Q and Q2 = 0
  Eigen::Matrix3d Q1, Q2;
  Eigen::Matrix3d Q = Eigen::Matrix3d::Identity();
  std::tie(Q1, Q2) = ConvexDecompositionNonConvexQuadraticForm(Q);
...
GTEST_TEST(DecomposeNonConvexQuadraticForm, Test1) {
  // Decomposes a negative definite matrix Q, then Q1 = 0, and Q2 = -Q.
  Eigen::Matrix3d Q1, Q2;
  Eigen::Matrix3d Q = -Eigen::Matrix3d::Identity();
  std::tie(Q1, Q2) = ConvexDecompositionNonConvexQuadraticForm(Q);
...
GTEST_TEST(DecomposeNonConvexQuadraticForm, Test3) {
  ...
  // Q1 = [1.5 1.5; 1.5 1.5], Q2 = [0.5 -0.5; -0.5 0.5]
  Eigen::Matrix2d Q1, Q2;
  Eigen::Matrix2d Q;
  Q << 1, 3, 1, 1;
  std::tie(Q1, Q2) = ConvexDecompositionNonConvexQuadraticForm(Q);
