...
class MathematicalProgram {
 ...
 public:
  ...
  /**
   * Add a linear constraint represented by a symbolic array of formulas to the
   * program. A formula in @p formulas can be of the following forms:
   *
   *  1. e1  <=  e2 , which is 0 <= e2 - e1 <= ∞
   *  2. e1  >=  e2 , which is 0 <= e1 - e2 <= ∞
   *  3. e1  ==  e2
  ...
  AddLinearConstraint(const Derived& formulas) {
    ...
    drake::VectorX<symbolic::Expression> v{n};
    Eigen::VectorXd lb{n};
    Eigen::VectorXd ub{n};
