...
class SnoptSolverResult : public MathematicalProgramSolverResult {
 public:
  SnoptSolverResult(SolutionSummary summary, int snopt_info, double objective_value) :
      MathematicalProgramSolverResult(summary), snopt_info_(snopt_info), objective_value_(objective_value) {}

  /** Getter for snopt info. Refer to Section 8.6 (EXIT conditions) of SNOPT manual
