...
const DecisionVariableMatrixX MathematicalProgram::NewContinuousVariables(
...
MathematicalProgram::VarType MathematicalProgram::DecisionVariableType(const symbolic::Variable &var) const {
