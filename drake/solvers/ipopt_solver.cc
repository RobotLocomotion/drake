...
class IpoptSolver_NLP : public Ipopt::TNLP {
 public:
  ...
  virtual bool get_nlp_info(
    ...
    // ouputing a single Number for the result, and the size of the
  ...
  virtual void finalize_solution(SolverReturn status, Index n, const Number* x,
    ...
    switch (status) {
      ...
      case Ipopt::MAXITER_EXCEEDED: {
        ...
        std::cout << "Hint: Remember that IPOPT is an interior-point method and performs badly if any variables are unbounded." << std::endl;
        break;
      }
      default: {
