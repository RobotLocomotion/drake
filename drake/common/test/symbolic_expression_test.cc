...
TEST_F(MonomialTest, MonomialBasis_x_0) {
  ...
  const drake::Vector1<Expression> basis2{MonomialBasis<1, 0>({var_x_})};
...
TEST_F(MonomialTest, MonomialBasis_x_2) {
  ...
  const drake::Vector3<Expression> basis2{MonomialBasis<1, 2>({var_x_})};
...
TEST_F(MonomialTest, MonomialBasis_x_y_0) {
  ...
  const drake::Vector1<Expression> basis2{
      MonomialBasis<2, 0>({var_x_, var_y_})};
  drake::Vector1<Expression> expected;
...
TEST_F(MonomialTest, MonomialBasis_x_y_1) {
  ...
  const drake::Vector3<Expression> basis2{
      MonomialBasis<2, 1>({var_x_, var_y_})};
  drake::Vector3<Expression> expected;
...
TEST_F(MonomialTest, MonomialBasis_x_y_2) {
  ...
  const drake::Vector6<Expression> basis2{
      MonomialBasis<2, 2>({var_x_, var_y_})};
...
TEST_F(MonomialTest, MonomialBasis_x_y_3) {
  ...
  const Eigen::Matrix<Expression, 10, 1> basis2{
      MonomialBasis<2, 3>({var_x_, var_y_})};
...
TEST_F(MonomialTest, MonomialBasis_x_y_z_2) {
  ...
  const Eigen::Matrix<Expression, 10, 1> basis2{
      MonomialBasis<3, 2>({var_x_, var_y_, var_z_})};
...
TEST_F(MonomialTest, MonomialBasis_x_y_z_3) {
  ...
  const Eigen::Matrix<Expression, 20, 1> basis2{
      MonomialBasis<3, 3>({var_x_, var_y_, var_z_})};
...
TEST_F(MonomialTest, MonomialBasis_x_y_z_w_3) {
  ...
  const Eigen::Matrix<Expression, 35, 1> basis2{
      MonomialBasis<4, 3>({var_x_, var_y_, var_z_, var_w_})};
