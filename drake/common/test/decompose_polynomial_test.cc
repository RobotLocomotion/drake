...
void DecomposePolynomialTest::CheckDecomposePolynomial6(
  ...
  CheckMonomialToCoeffMap(e, {var_x_, var_y_}, map_expected4,
  ...
  CheckMonomialToCoeffMap(e, {var_x_, var_y_, var_z_}, map_expected7,
                          check_expression_equal);
}
...
void DecomposePolynomialTest::CheckDecomposePolynomial7(const Expression& e) {
  ...
  CheckMonomialToCoeffMap(e, {var_x_, var_y_}, map_expected3);
}
