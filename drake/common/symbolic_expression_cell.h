...
class ExpressionCeil : public UnaryExpressionCell {
 public:
  explicit ExpressionCeil(const Expression& e);
  Polynomial<double> ToPolynomial() const override;
  Expression Expand() const override;
  Expression Substitute(const Substitution& s) const override;
  Expression Differentiate(const Variable& x) const override;
...
/** Casts @p expr_ptr to @c shared_ptr<ExpressionCeil>.
 *  @pre @c *expr_ptr is of @c ExpressionCeil.
 */
std::shared_ptr<ExpressionCeil> to_ceil(
    const std::shared_ptr<ExpressionCell>& expr_ptr);
/** Casts @p e to @c shared_ptr<ExpressionCeil>.
 *  @pre @c *(e.ptr_) is of @c ExpressionCeil.
 */
std::shared_ptr<ExpressionCeil> to_ceil(const Expression& e);
