...
typename std::enable_if<
    std::is_base_of<Eigen::MatrixBase<MatrixL>, MatrixL>::value &&
        ...
        // Exclude Polynomial x Polynomial case.
        !(std::is_same<typename MatrixL::Scalar, Polynomial>::value &&
          std::is_same<typename MatrixR::Scalar, Polynomial>::value) &&
...
// Informs Eigen that LhsType + RhsType gets ResultType.
#define DRAKE_SYMBOLIC_SCALAR_SUM_OP_TRAITS(LhsType, RhsType, ResultType) \
  DRAKE_SYMBOLIC_SCALAR_BINARY_OP_TRAITS(LhsType, RhsType,                \
                                         internal::scalar_sum_op, ResultType)

// Informs Eigen that LhsType - RhsType gets ResultType.
#define DRAKE_SYMBOLIC_SCALAR_DIFFERENCE_OP_TRAITS(LhsType, RhsType, \
                                                   ResultType)       \
  DRAKE_SYMBOLIC_SCALAR_BINARY_OP_TRAITS(                            \
      LhsType, RhsType, internal::scalar_difference_op, ResultType)

// Informs Eigen that LhsType * RhsType gets ResultType.
#define DRAKE_SYMBOLIC_SCALAR_PRODUCT_OP_TRAITS(LhsType, RhsType, ResultType) \
  DRAKE_SYMBOLIC_SCALAR_BINARY_OP_TRAITS(                                     \
      LhsType, RhsType, internal::scalar_product_op, ResultType)

// Informs Eigen that conj_product(pLhsType, RhsType) gets ResultType.
#define DRAKE_SYMBOLIC_SCALAR_CONJ_PRODUCT_OP_TRAITS(LhsType, RhsType, \
                                                     ResultType)       \
  DRAKE_SYMBOLIC_SCALAR_BINARY_OP_TRAITS(                              \
...
DRAKE_SYMBOLIC_SCALAR_SUM_OP_TRAITS(drake::symbolic::Polynomial,
                                    drake::symbolic::Monomial,
                                    drake::symbolic::Polynomial)
DRAKE_SYMBOLIC_SCALAR_DIFFERENCE_OP_TRAITS(drake::symbolic::Polynomial,
                                           drake::symbolic::Monomial,
                                           drake::symbolic::Polynomial)
DRAKE_SYMBOLIC_SCALAR_PRODUCT_OP_TRAITS(drake::symbolic::Polynomial,
                                        drake::symbolic::Monomial,
                                        drake::symbolic::Polynomial)
DRAKE_SYMBOLIC_SCALAR_CONJ_PRODUCT_OP_TRAITS(drake::symbolic::Polynomial,
                                             drake::symbolic::Monomial,
                                             drake::symbolic::Polynomial)

// Informs Eigen that Polynomial op double gets Polynomial
// where op ∈ {+, -, *, conj_product}.
DRAKE_SYMBOLIC_SCALAR_SUM_OP_TRAITS(drake::symbolic::Polynomial, double,
                                    drake::symbolic::Polynomial)
DRAKE_SYMBOLIC_SCALAR_DIFFERENCE_OP_TRAITS(drake::symbolic::Polynomial, double,
                                           drake::symbolic::Polynomial)
DRAKE_SYMBOLIC_SCALAR_PRODUCT_OP_TRAITS(drake::symbolic::Polynomial, double,
                                        drake::symbolic::Polynomial)
DRAKE_SYMBOLIC_SCALAR_CONJ_PRODUCT_OP_TRAITS(drake::symbolic::Polynomial,
                                             double,
                                             drake::symbolic::Polynomial)
...
// where op ∈ {+, -, *, conj_product}.
DRAKE_SYMBOLIC_SCALAR_SUM_OP_TRAITS(drake::symbolic::Monomial,
                                    drake::symbolic::Polynomial,
                                    drake::symbolic::Polynomial)
DRAKE_SYMBOLIC_SCALAR_DIFFERENCE_OP_TRAITS(drake::symbolic::Monomial,
                                           drake::symbolic::Polynomial,
                                           drake::symbolic::Polynomial)
DRAKE_SYMBOLIC_SCALAR_PRODUCT_OP_TRAITS(drake::symbolic::Monomial,
                                        drake::symbolic::Polynomial,
                                        drake::symbolic::Polynomial)
DRAKE_SYMBOLIC_SCALAR_CONJ_PRODUCT_OP_TRAITS(drake::symbolic::Monomial,
                                             drake::symbolic::Polynomial,
                                             drake::symbolic::Polynomial)
...
// where op ∈ {+, -, *, conj_product}.
DRAKE_SYMBOLIC_SCALAR_SUM_OP_TRAITS(drake::symbolic::Monomial, double,
                                    drake::symbolic::Polynomial)
DRAKE_SYMBOLIC_SCALAR_DIFFERENCE_OP_TRAITS(drake::symbolic::Monomial, double,
                                           drake::symbolic::Polynomial)
DRAKE_SYMBOLIC_SCALAR_PRODUCT_OP_TRAITS(drake::symbolic::Monomial, double,
                                        drake::symbolic::Polynomial)
DRAKE_SYMBOLIC_SCALAR_CONJ_PRODUCT_OP_TRAITS(drake::symbolic::Monomial, double,
                                             drake::symbolic::Polynomial)

// Informs Eigen that double op Polynomial gets Polynomial
// where op ∈ {+, -, *, conj_product}.
DRAKE_SYMBOLIC_SCALAR_SUM_OP_TRAITS(double, drake::symbolic::Polynomial,
                                    drake::symbolic::Polynomial)
DRAKE_SYMBOLIC_SCALAR_DIFFERENCE_OP_TRAITS(double, drake::symbolic::Polynomial,
                                           drake::symbolic::Polynomial)
DRAKE_SYMBOLIC_SCALAR_PRODUCT_OP_TRAITS(double, drake::symbolic::Polynomial,
                                        drake::symbolic::Polynomial)
DRAKE_SYMBOLIC_SCALAR_CONJ_PRODUCT_OP_TRAITS(double,
                                             drake::symbolic::Polynomial,
                                             drake::symbolic::Polynomial)

// Informs Eigen that double op Monomial gets Polynomial
// where op ∈ {+, -, *, conj_product}.
DRAKE_SYMBOLIC_SCALAR_SUM_OP_TRAITS(double, drake::symbolic::Monomial,
                                    drake::symbolic::Polynomial)
DRAKE_SYMBOLIC_SCALAR_DIFFERENCE_OP_TRAITS(double, drake::symbolic::Monomial,
                                           drake::symbolic::Polynomial)
DRAKE_SYMBOLIC_SCALAR_PRODUCT_OP_TRAITS(double, drake::symbolic::Monomial,
                                        drake::symbolic::Polynomial)
DRAKE_SYMBOLIC_SCALAR_CONJ_PRODUCT_OP_TRAITS(double, drake::symbolic::Monomial,
                                             drake::symbolic::Polynomial)

#undef DRAKE_SYMBOLIC_SCALAR_CONJ_PRODUCT_OP_TRAITS
#undef DRAKE_SYMBOLIC_SCALAR_PRODUCT_OP_TRAITS
#undef DRAKE_SYMBOLIC_SCALAR_DIFFERENCE_OP_TRAITS
#undef DRAKE_SYMBOLIC_SCALAR_SUM_OP_TRAITS
