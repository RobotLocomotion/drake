...
template <typename DerType>
Eigen::AutoDiffScalar<typename DerType::PlainObject>
saturate(const Eigen::AutoDiffScalar<DerType>& value, const double& low,
         const double& high) {
  ...
  return cond(
      value < low, low_scalar,
      value > high, high_scalar,
      value);
}
