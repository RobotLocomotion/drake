...
/// because of the "static initialization fiasco" as mentioned in cppguide, but
/// other solutions to this problem place the objects on the heap through an
/// indirection.  This mechanism is probably slightly faster.
template <typename T>
