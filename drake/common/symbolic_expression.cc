...
class Monomial {
 public:
  ...
  explicit Monomial(const vector<pair<Variable::IdType, int>>& powers)
...
// the order as x^2 > xy > y^2 > xz > yz > z^2. There is an introduction to
// monomial order in https://en.wikipedia.org/wiki/Monomial_order, and an
// introduction to graded reverse lexicographical order in
