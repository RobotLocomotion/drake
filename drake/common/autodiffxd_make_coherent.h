...
/// the donor, variables pass through unchanged.
inline static void autodiffxd_make_coherent(const AutoDiffXd& donor,
...
inline static void autodiffxd_make_coherent(const double&, double*) {}

inline static void autodiffxd_make_coherent(const symbolic::Expression&,
                                            symbolic::Expression*) {}
