...
class RigidBodyTreeTest : public ::testing::Test {
 protected:
  virtual void SetUp() {
    ...
    r1b1 = make_unique_ref<RigidBody>();
    r1b1->model_name_ = "robot1";
    r1b1->name_ = "body1";

    r2b1 = make_unique_ref<RigidBody>();
    r2b1->model_name_ = "robot2";
    r2b1->name_ = "body1";

    r3b1 = make_unique_ref<RigidBody>();
    r3b1->model_name_ = "robot3";
    r3b1->name_ = "body1";

    r4b1 = make_unique_ref<RigidBody>();
 ...
 public:
  ...
  unique_ptr_ref<RigidBody> r1b1;
  unique_ptr_ref<RigidBody> r2b1;
  unique_ptr_ref<RigidBody> r3b1;
  unique_ptr_ref<RigidBody> r4b1;
};
...
TEST_F(RigidBodyTreeTest, TestAddFloatingJointNoOffset) {
  ...
  tree->add_rigid_body(r1b1.move());
  tree->add_rigid_body(r2b1.move());
...
TEST_F(RigidBodyTreeTest, TestAddFloatingJointWeldToLink) {
  ...
  // TODO(amcastro-tri): these pointers will be replaced by Sherm's
  // unique_ptr_reference's
  tree->add_rigid_body(r3b1.move());
  tree->add_rigid_body(r4b1.move());
