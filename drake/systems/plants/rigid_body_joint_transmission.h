...
public:
	/**
   * Constructs a joint transmission by specifying the position numbers of the two joints, together with the multiplier
   *
   ...
   * @param[in] offset  A double, offset = joint1_value-joint2_value*multiplier
	 */
	RigidBodyJointTransmission(const std::string& joint1_name, const std::string& joint2_name, double multiplier, double offset):
  joint1_name_(joint1_name), joint2_name_(joint2_name), multiplier_(multiplier), offset_(offset) {
