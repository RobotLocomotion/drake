...
template DLLEXPORT_RBM MatrixXd RigidBodyManipulator::forwardKin<Matrix3Xd >(const KinematicsCache<double>&, const MatrixBase<Matrix3Xd> &, int, int, int) const;
template DLLEXPORT_RBM MatrixXd RigidBodyManipulator::forwardKin<Eigen::MatrixXd >(const KinematicsCache<double>&, Eigen::MatrixBase<Eigen::MatrixXd> const &, int, int, int) const;
template DLLEXPORT_RBM VectorXd RigidBodyManipulator::forwardKin<Vector3d>(const KinematicsCache<double>&, const MatrixBase<Vector3d> &, int, int, int) const;
...
template DLLEXPORT_RBM GradientVar<Eigen::Matrix<Eigen::AutoDiffScalar<Eigen::Matrix<double, -1, 1, 0, 73, 1> >, 3, -1, 0, 3, -1>::Scalar, -1, -1, -1, -1> RigidBodyManipulator::forwardKinJacobian<Eigen::Matrix<Eigen::AutoDiffScalar<Eigen::Matrix<double, -1, 1, 0, 73, 1> >, 3, -1, 0, 3, -1> >(KinematicsCache<Eigen::Matrix<Eigen::AutoDiffScalar<Eigen::Matrix<double, -1, 1, 0, 73, 1> >, 3, -1, 0, 3, -1>::Scalar> const&, Eigen::MatrixBase<Eigen::Matrix<Eigen::AutoDiffScalar<Eigen::Matrix<double, -1, 1, 0, 73, 1> >, 3, -1, 0, 3, -1> > const&, int, int, int, bool, int) const;
template DLLEXPORT_RBM GradientVar<Eigen::Matrix<Eigen::AutoDiffScalar<Eigen::Matrix<double, -1, 1, 0, 73, 1> >, 3, -1, 0, 3, -1>::Scalar, -1, 1, -1, 1> RigidBodyManipulator::forwardJacDotTimesV<Eigen::Matrix<Eigen::AutoDiffScalar<Eigen::Matrix<double, -1, 1, 0, 73, 1> >, 3, -1, 0, 3, -1> >(KinematicsCache<Eigen::Matrix<Eigen::AutoDiffScalar<Eigen::Matrix<double, -1, 1, 0, 73, 1> >, 3, -1, 0, 3, -1>::Scalar> const&, Eigen::MatrixBase<Eigen::Matrix<Eigen::AutoDiffScalar<Eigen::Matrix<double, -1, 1, 0, 73, 1> >, 3, -1, 0, 3, -1> > const&, int, int, int, int) const;
