...
template DLLEXPORT_RBM GradientVar<Eigen::VectorXd::Scalar, Eigen::Dynamic, Eigen::VectorXd::ColsAtCompileTime, Eigen::Dynamic, Eigen::VectorXd::ColsAtCompileTime> RigidBodyManipulator::forwardKin<Eigen::VectorXd >(KinematicsCache<Eigen::VectorXd::Scalar> const&, Eigen::MatrixBase<Eigen::VectorXd > const&, int, int, int, int) const;
