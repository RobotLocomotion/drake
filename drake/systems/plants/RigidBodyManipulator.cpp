...
template DLLEXPORT_RBM GradientVar<Eigen::AutoDiffScalar<Eigen::Matrix<double, -1, 1, 0, -1, 1> >, -1, 1, -1, 1> RigidBodyManipulator::dynamicsBiasTerm<Eigen::AutoDiffScalar<Eigen::Matrix<double, -1, 1, 0, -1, 1> > >(KinematicsCache<Eigen::AutoDiffScalar<Eigen::Matrix<double, -1, 1, 0, -1, 1> > >&, std::unordered_map<RigidBody const*, GradientVar<Eigen::AutoDiffScalar<Eigen::Matrix<double, -1, 1, 0, -1, 1> >, 6, 1, 6, 1>, std::hash<RigidBody const*>, std::equal_to<RigidBody const*>, std::allocator<std::pair<RigidBody const* const, GradientVar<Eigen::AutoDiffScalar<Eigen::Matrix<double, -1, 1, 0, -1, 1> >, 6, 1, 6, 1> > > > const&, int) const;
