...
Matrix<Scalar, Eigen::Dynamic, Eigen::Dynamic> RigidBodyManipulator::positionConstraintsJacobian(const KinematicsCache<Scalar> &cache) const {
  ...
  for (size_t i = 0; i < loops.size(); i++) {
    // position constraint
    ret.template middleRows<3>(6 * i) = forwardKinJacobian(cache, Vector3d::Zero(), loops[i].frameA->frame_index, loops[i].frameB->frame_index, 0, true);
    // second position constraint (to constrain orientation)
    ret.template middleRows<3>(6 * i + 3) = forwardKinJacobian(cache, loops[i].axis, loops[i].frameA->frame_index, loops[i].frameB->frame_index, 0, true);
  }
  return ret;
}
...
template DLLEXPORT_RBM Eigen::Matrix<double, 6, -1, 0, 6, -1> RigidBodyManipulator::worldMomentumMatrix<double>(KinematicsCache<double>&, std::__1::set<int, std::__1::less<int>, std::__1::allocator<int> > const&, bool) const;
...
template DLLEXPORT_RBM Eigen::Matrix<double, 6, 1, 0, 6, 1> RigidBodyManipulator::worldMomentumMatrixDotTimesV<double>(KinematicsCache<double>&, std::__1::set<int, std::__1::less<int>, std::__1::allocator<int> > const&) const;
template DLLEXPORT_RBM Eigen::Matrix<double, -1, -1, 0, -1, -1> RigidBodyManipulator::forwardKinJacobian<double, Eigen::Matrix<double, 3, 1, 0, 3, 1> >(KinematicsCache<double> const&, Eigen::MatrixBase<Eigen::Matrix<double, 3, 1, 0, 3, 1> > const&, int, int, int, bool) const;
template DLLEXPORT_RBM Eigen::Matrix<double, -1, 1, 0, -1, 1> RigidBodyManipulator::forwardJacDotTimesV<double, Eigen::Matrix<double, 3, 1, 0, 3, 1> >(KinematicsCache<double> const&, Eigen::MatrixBase<Eigen::Matrix<double, 3, 1, 0, 3, 1> > const&, int, int, int) const;
template DLLEXPORT_RBM Eigen::Matrix<double, -1, 1, 0, -1, 1> RigidBodyManipulator::inverseDynamics<double>(KinematicsCache<double>&, std::__1::unordered_map<RigidBody const*, Eigen::Matrix<double, 6, 1, 0, 6, 1>, std::__1::hash<RigidBody const*>, std::__1::equal_to<RigidBody const*>, Eigen::aligned_allocator<std::__1::pair<RigidBody const* const, Eigen::Matrix<double, 6, 1, 0, 6, 1> > > > const&, Eigen::Matrix<double, -1, 1, 0, -1, 1> const&) const;
...
template DLLEXPORT_RBM std::__1::pair<Eigen::Matrix<double, 3, 1, 0, 3, 1>, double> RigidBodyManipulator::resolveCenterOfPressure<Eigen::Matrix<double, 3, 1, 0, 3, 1>, Eigen::Matrix<double, 3, 1, 0, 3, 1> >(KinematicsCache<double> const&, std::__1::vector<ForceTorqueMeasurement, std::__1::allocator<ForceTorqueMeasurement> > const&, Eigen::MatrixBase<Eigen::Matrix<double, 3, 1, 0, 3, 1> > const&, Eigen::MatrixBase<Eigen::Matrix<double, 3, 1, 0, 3, 1> > const&) const;
