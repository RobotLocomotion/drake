...
void mexFunction(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[]) {
  ...
  if (nrhs < 2) {
    mexErrMsgIdAndTxt("Drake:IKoptionsmex:BadInputs",
                      "See IKoptionsmex.cpp for usage");
  }
  ...
  switch (COMMAND) {
    ...
    case 3: {
      ...
      if (field_str == "Q") {
        if (!mxIsNumeric(prhs[3]) || mxGetM(prhs[3]) != nq ||
            mxGetN(prhs[3]) != nq) {
          mexErrMsgIdAndTxt("Drake:updatePtrIKoptionsmex:BadInputs",
                            "Q must be nq x nq double matrix");
        }
        MatrixXd Q(nq, nq);
        ...
        if (!mxIsNumeric(prhs[3]) || mxGetM(prhs[3]) != nq ||
            mxGetN(prhs[3]) != nq) {
          mexErrMsgIdAndTxt("Drake:updatePtrIKoptionsmex:BadInputs",
                            "Qa must be nq x nq double matrix");
        }
        MatrixXd Qa(nq, nq);
        ...
        if (!mxIsNumeric(prhs[3]) || mxGetM(prhs[3]) != nq ||
            mxGetN(prhs[3]) != nq) {
          mexErrMsgIdAndTxt("Drake:updatePtrIKoptionsmex:BadInputs",
                            "Qv must be nq x nq double matrix");
        }
        MatrixXd Qv(nq, nq);
        ...
        if (!mxIsLogicalScalar(prhs[3])) {
          mexErrMsgIdAndTxt("Drake:updatePtrIKoptionsmex:BadInputs",
                            "debug must be a single boolean");
        }
        ...
        if (!mxIsLogicalScalar(prhs[3])) {
          mexErrMsgIdAndTxt("Drake:updatePtrIKoptionsmex:BadInputs",
                            "sequentialSeedFlag must be a boolean scalar");
        }
        bool flag = *mxGetLogicals(prhs[3]);
        ...
        if (!mxIsNumeric(prhs[3]) || mxGetNumberOfElements(prhs[3]) != 1) {
          mexErrMsgIdAndTxt("Drake:updatePtrIKoptionsmex:BadInputs",
                            "MajorOptimalityTolerance must be a double scalar");
        }
        double tol = mxGetScalar(prhs[3]);
        if (tol <= 0) {
          mexErrMsgIdAndTxt("Drake:updatePtrIKoptionsmex:BadInputs",
                            "MajorOptimalityTolerance must be positive");
        }
        ...
        if (!mxIsNumeric(prhs[3]) || mxGetNumberOfElements(prhs[3]) != 1) {
          mexErrMsgIdAndTxt(
              ...
              "MajorFeasibilityTolerance must be a double scalar");
        }
        double tol = mxGetScalar(prhs[3]);
        if (tol <= 0) {
          mexErrMsgIdAndTxt("Drake:updatePtrIKoptionsmex:BadInputs",
                            "MajorFeasibilityTolerance must be positive");
        }
        ikoptions_new->setMajorFeasibilityTolerance(tol);
      } else if (field_str == "superbasicsLimit") {
        if (!mxIsNumeric(prhs[3]) || mxGetNumberOfElements(prhs[3]) != 1) {
          mexErrMsgIdAndTxt("Drake:updatePtrIKoptionsmex:BadInputs",
                            "SuperbasicsLimit must be an integer scalar");
        }
        int limit = (int)mxGetScalar(prhs[3]);
        if (limit <= 0) {
          mexErrMsgIdAndTxt("Drake:updatePtrIKoptionsmex:BadInputs",
                            "SuperbasicsLimit must be positive");
        }
        ikoptions_new->setSuperbasicsLimit(limit);
      } else if (field_str == "majorIterationsLimit") {
        if (!mxIsNumeric(prhs[3]) || mxGetNumberOfElements(prhs[3]) != 1) {
          mexErrMsgIdAndTxt("Drake:updatePtrIKoptionsmex:BadInputs",
                            "MajorIterationsLimit must be an integer scalar");
        }
        int limit = (int)mxGetScalar(prhs[3]);
        if (limit <= 0) {
          mexErrMsgIdAndTxt("Drake:updatePtrIKoptionsmex:BadInputs",
                            "MajorIterationsLimit must be positive");
        }
        ikoptions_new->setMajorIterationsLimit(limit);
      } else if (field_str == "iterationsLimit") {
        if (!mxIsNumeric(prhs[3]) || mxGetNumberOfElements(prhs[3]) != 1) {
          mexErrMsgIdAndTxt("Drake:updatePtrIKoptionsmex:BadInputs",
                            "IterationsLimit must be an integer scalar");
        }
        int limit = (int)mxGetScalar(prhs[3]);
        if (limit <= 0) {
          mexErrMsgIdAndTxt("Drake:updatePtrIKoptionsmex:BadInputs",
                            "IterationsLimit must be positive");
        }
        ikoptions_new->setIterationsLimit(limit);
      } else if (field_str == "fixInitialState") {
        if (!mxIsLogicalScalar(prhs[3])) {
          mexErrMsgIdAndTxt("Drake:updatePtrIKoptionsmex:BadInputs",
                            "fixInitialState must be a boolean scalar");
        }
        bool flag = *mxGetLogicals(prhs[3]);
        ...
        if (mxGetNumberOfElements(prhs[3]) == 0) {
          ...
          if (!mxIsNumeric(prhs[3]) || mxGetM(prhs[3]) != 1) {
            mexErrMsgIdAndTxt(
                "Drake:updatePtrIKoptionsmex:BadInputs",
                "additional_tSamples must be a row double vector");
          }
          t_samples.resize(mxGetN(prhs[3]));
          memcpy(t_samples.data(), mxGetPrSafe(prhs[3]),
                 sizeof(double) * mxGetN(prhs[3]));
        }
      ...
      mxArray* additional_argument = mxCreateDoubleScalar(2);
      plhs[0] = createDrakeMexPointer((void*)ikoptions_new, "IKoptions", -1, 1,
                                      &additional_argument);
      delete[] field;
    } break;
    default:
