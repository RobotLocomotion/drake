...
using drake::AutoDiffVector73d;
using drake::AutoDiffVectorXd;
...
template DRAKERBM_EXPORT MatrixX<AutoDiffVector73d> RigidBodyTree::massMatrix<
    AutoDiffVector73d>(KinematicsCache<AutoDiffVector73d>&) const;
template DRAKERBM_EXPORT MatrixX<AutoDiffVectorXd> RigidBodyTree::massMatrix<
    AutoDiffVectorXd>(KinematicsCache<AutoDiffVectorXd>&) const;
...
template DRAKERBM_EXPORT Vector3<AutoDiffVector73d> RigidBodyTree::centerOfMass<
    AutoDiffVector73d>(KinematicsCache<AutoDiffVector73d>&,
                       set<int, less<int>, allocator<int>> const&) const;
template DRAKERBM_EXPORT Vector3<AutoDiffVectorXd> RigidBodyTree::centerOfMass<
    AutoDiffVectorXd>(KinematicsCache<AutoDiffVectorXd>&,
                      set<int, less<int>, allocator<int>> const&) const;
...
template DRAKERBM_EXPORT VectorX<AutoDiffVector73d>
RigidBodyTree::dynamicsBiasTerm<AutoDiffVector73d>(
    KinematicsCache<AutoDiffVector73d>&,
    unordered_map<
        RigidBody const*, TwistVector<AutoDiffVector73d>,
        hash<RigidBody const*>, equal_to<RigidBody const*>,
        Eigen::aligned_allocator<pair<RigidBody const* const,
                                      TwistVector<AutoDiffVector73d>>>> const&,
    bool) const;
template DRAKERBM_EXPORT VectorX<AutoDiffVectorXd>
RigidBodyTree::dynamicsBiasTerm<AutoDiffVectorXd>(
    KinematicsCache<AutoDiffVectorXd>&,
    unordered_map<
        RigidBody const*, TwistVector<AutoDiffVectorXd>, hash<RigidBody const*>,
        equal_to<RigidBody const*>,
        Eigen::aligned_allocator<pair<RigidBody const* const,
                                      TwistVector<AutoDiffVectorXd>>>> const&,
    bool) const;
...
template DRAKERBM_EXPORT TwistMatrix<AutoDiffVector73d>
RigidBodyTree::geometricJacobian<AutoDiffVector73d>(
    KinematicsCache<AutoDiffVector73d> const&, int, int, int, bool,
    vector<int, allocator<int>>*) const;
template DRAKERBM_EXPORT TwistMatrix<AutoDiffVectorXd>
RigidBodyTree::geometricJacobian<AutoDiffVectorXd>(
    KinematicsCache<AutoDiffVectorXd> const&, int, int, int, bool,
    vector<int, allocator<int>>*) const;
...
template DRAKERBM_EXPORT Eigen::Transform<AutoDiffVector73d, 3, 1, 0>
RigidBodyTree::relativeTransform<AutoDiffVector73d>(
    KinematicsCache<AutoDiffVector73d> const&, int, int) const;
template DRAKERBM_EXPORT Eigen::Transform<AutoDiffVectorXd, 3, 1, 0>
RigidBodyTree::relativeTransform<AutoDiffVectorXd>(
    KinematicsCache<AutoDiffVectorXd> const&, int, int) const;
...
template DRAKERBM_EXPORT Matrix3X<AutoDiffVector73d>
RigidBodyTree::centerOfMassJacobian<AutoDiffVector73d>(
    KinematicsCache<AutoDiffVector73d>&,
    set<int, less<int>, allocator<int>> const&, bool) const;
template DRAKERBM_EXPORT Matrix3X<AutoDiffVectorXd>
RigidBodyTree::centerOfMassJacobian<AutoDiffVectorXd>(
    KinematicsCache<AutoDiffVectorXd>&,
    set<int, less<int>, allocator<int>> const&, bool) const;
...
template DRAKERBM_EXPORT TwistMatrix<AutoDiffVector73d>
RigidBodyTree::centroidalMomentumMatrix<AutoDiffVector73d>(
    KinematicsCache<AutoDiffVector73d>&,
    set<int, less<int>, allocator<int>> const&, bool) const;
template DRAKERBM_EXPORT TwistMatrix<AutoDiffVectorXd>
RigidBodyTree::centroidalMomentumMatrix<AutoDiffVectorXd>(
    KinematicsCache<AutoDiffVectorXd>&,
    set<int, less<int>, allocator<int>> const&, bool) const;
template DRAKERBM_EXPORT TwistMatrix<double>
...
template DRAKERBM_EXPORT MatrixX<AutoDiffVector73d>
RigidBodyTree::forwardKinPositionGradient<AutoDiffVector73d>(
    KinematicsCache<AutoDiffVector73d> const&, int, int, int) const;
template DRAKERBM_EXPORT MatrixX<AutoDiffVectorXd>
RigidBodyTree::forwardKinPositionGradient<AutoDiffVectorXd>(
    KinematicsCache<AutoDiffVectorXd> const&, int, int, int) const;
template DRAKERBM_EXPORT MatrixXd
...
template DRAKERBM_EXPORT TwistVector<AutoDiffVector73d>
RigidBodyTree::geometricJacobianDotTimesV<AutoDiffVector73d>(
    KinematicsCache<AutoDiffVector73d> const&, int, int, int) const;
template DRAKERBM_EXPORT TwistVector<AutoDiffVectorXd>
RigidBodyTree::geometricJacobianDotTimesV<AutoDiffVectorXd>(
    KinematicsCache<AutoDiffVectorXd> const&, int, int, int) const;
...
template DRAKERBM_EXPORT Vector3<AutoDiffVector73d>
RigidBodyTree::centerOfMassJacobianDotTimesV<AutoDiffVector73d>(
    KinematicsCache<AutoDiffVector73d>&,
    set<int, less<int>, allocator<int>> const&) const;
template DRAKERBM_EXPORT Vector3<AutoDiffVectorXd>
RigidBodyTree::centerOfMassJacobianDotTimesV<AutoDiffVectorXd>(
    KinematicsCache<AutoDiffVectorXd>&,
    set<int, less<int>, allocator<int>> const&) const;
...
template DRAKERBM_EXPORT TwistVector<AutoDiffVector73d>
RigidBodyTree::centroidalMomentumMatrixDotTimesV<AutoDiffVector73d>(
    KinematicsCache<AutoDiffVector73d>&,
    set<int, less<int>, allocator<int>> const&) const;
template DRAKERBM_EXPORT TwistVector<AutoDiffVectorXd>
RigidBodyTree::centroidalMomentumMatrixDotTimesV<AutoDiffVectorXd>(
    KinematicsCache<AutoDiffVectorXd>&,
    set<int, less<int>, allocator<int>> const&) const;
template DRAKERBM_EXPORT TwistVector<double>
...
template DRAKERBM_EXPORT MatrixX<AutoDiffVector73d>
RigidBodyTree::transformPointsJacobian<AutoDiffVector73d, Matrix3Xd>(
    KinematicsCache<AutoDiffVector73d> const&,
    Eigen::MatrixBase<Matrix3Xd> const&, int, int, bool) const;
template DRAKERBM_EXPORT MatrixX<AutoDiffVectorXd>
RigidBodyTree::transformPointsJacobian<AutoDiffVectorXd, Matrix3Xd>(
    KinematicsCache<AutoDiffVectorXd> const&,
    Eigen::MatrixBase<Matrix3Xd> const&, int, int, bool) const;
template DRAKERBM_EXPORT MatrixXd
...
template DRAKERBM_EXPORT MatrixXd RigidBodyTree::transformPointsJacobian<
    ...
    bool) const;
template DRAKERBM_EXPORT MatrixX<AutoDiffVector73d>
RigidBodyTree::transformPointsJacobian<AutoDiffVector73d,
                                       Eigen::Map<Matrix3Xd const>>(
    KinematicsCache<AutoDiffVector73d> const&,
    Eigen::MatrixBase<Eigen::Map<Matrix3Xd const>> const&, int, int,
    bool) const;
template DRAKERBM_EXPORT MatrixX<AutoDiffVectorXd>
RigidBodyTree::transformPointsJacobian<AutoDiffVectorXd,
                                       Eigen::Map<Matrix3Xd const>>(
    KinematicsCache<AutoDiffVectorXd> const&,
    Eigen::MatrixBase<Eigen::Map<Matrix3Xd const>> const&, int, int,
    bool) const;
...
RigidBodyTree::transformPointsJacobianDotTimesV<double, Vector3d>(
    ...
    int) const;
template DRAKERBM_EXPORT VectorX<AutoDiffVector73d>
RigidBodyTree::transformPointsJacobianDotTimesV<AutoDiffVector73d,
                                                Eigen::Map<Matrix3Xd const>>(
    KinematicsCache<AutoDiffVector73d> const&,
    Eigen::MatrixBase<Eigen::Map<Matrix3Xd const>> const&, int, int) const;
template DRAKERBM_EXPORT VectorX<AutoDiffVectorXd>
RigidBodyTree::transformPointsJacobianDotTimesV<AutoDiffVectorXd,
                                                Eigen::Map<Matrix3Xd const>>(
    KinematicsCache<AutoDiffVectorXd> const&,
    Eigen::MatrixBase<Eigen::Map<Matrix3Xd const>> const&, int, int) const;
template DRAKERBM_EXPORT VectorXd
...
template DRAKERBM_EXPORT Matrix4X<AutoDiffVector73d>
RigidBodyTree::relativeQuaternionJacobian<AutoDiffVector73d>(
    KinematicsCache<AutoDiffVector73d> const&, int, int, bool) const;
template DRAKERBM_EXPORT Matrix4X<AutoDiffVectorXd>
RigidBodyTree::relativeQuaternionJacobian<AutoDiffVectorXd>(
    KinematicsCache<AutoDiffVectorXd> const&, int, int, bool) const;
...
RigidBodyTree::relativeRollPitchYawJacobian<double>(
    KinematicsCache<double> const&, int, int, bool) const;
template DRAKERBM_EXPORT Matrix3X<AutoDiffVector73d>
RigidBodyTree::relativeRollPitchYawJacobian<AutoDiffVector73d>(
    KinematicsCache<AutoDiffVector73d> const&, int, int, bool) const;
template DRAKERBM_EXPORT Matrix3X<AutoDiffVectorXd>
RigidBodyTree::relativeRollPitchYawJacobian<AutoDiffVectorXd>(
    KinematicsCache<AutoDiffVectorXd> const&, int, int, bool) const;
...
template DRAKERBM_EXPORT VectorX<AutoDiffVectorXd>
RigidBodyTree::relativeRollPitchYawJacobianDotTimesV<AutoDiffVectorXd>(
    KinematicsCache<AutoDiffVectorXd> const&, int, int) const;
template DRAKERBM_EXPORT VectorX<AutoDiffVector73d>
RigidBodyTree::relativeRollPitchYawJacobianDotTimesV<AutoDiffVector73d>(
    KinematicsCache<AutoDiffVector73d> const&, int, int) const;
...
RigidBodyTree::relativeQuaternionJacobianDotTimesV<double>(
    KinematicsCache<double> const&, int, int) const;
template DRAKERBM_EXPORT VectorX<AutoDiffVector73d>
RigidBodyTree::relativeQuaternionJacobianDotTimesV<AutoDiffVector73d>(
    KinematicsCache<AutoDiffVector73d> const&, int, int) const;
template DRAKERBM_EXPORT VectorX<AutoDiffVectorXd>
RigidBodyTree::relativeQuaternionJacobianDotTimesV<AutoDiffVectorXd>(
    KinematicsCache<AutoDiffVectorXd> const&, int, int) const;
