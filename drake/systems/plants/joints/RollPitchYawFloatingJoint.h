...
class DRAKEJOINTS_EXPORT RollPitchYawFloatingJoint
 ...
 public:
  ...
  jointTransform(const Eigen::MatrixBase<DerivedQ>& q) const {
    ...
    auto rpy =
        q.template middleRows<drake::kSpaceDimension>(drake::kSpaceDimension);
  ...
  void motionSubspace(
    ...
    auto rpy =
        q.template middleRows<drake::kSpaceDimension>(drake::kSpaceDimension);
    Eigen::Matrix<Scalar, drake::kSpaceDimension, drake::kSpaceDimension> E;
  ...
  void motionSubspaceDotTimesV(
    ...
    auto rpyd =
        v.template middleRows<drake::kSpaceDimension>(drake::kSpaceDimension);
    Scalar rolld = rpyd(0);
