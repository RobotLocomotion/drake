...
DRAKEIK_EXPORT void inverseKinTraj(
    ...
    RigidBodyConstraint **const constraint_array, MatrixBase<DerivedD> &q_sol,
    MatrixBase<DerivedE> &qdot_sol, MatrixBase<DerivedF> &qddot_sol, int &INFO,
    vector<string> &infeasible_constraint, IKoptions ikoptions) {
...
template DRAKEIK_EXPORT void inverseKinTraj(
    ...
    RigidBodyConstraint **const constraint_array, MatrixBase<MatrixXd> &q_sol,
    MatrixBase<MatrixXd> &qdot_sol, MatrixBase<MatrixXd> &qddot_sol, int &INFO,
    vector<string> &infeasible_constraint, IKoptions ikoptions);
