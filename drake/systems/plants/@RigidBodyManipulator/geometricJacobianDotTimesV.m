...
if kinsol.mex
  ...
  if compute_gradient
    [Jdot_times_v, dJdot_times_v] = geometricJacobianDotTimesVmex(obj.mex_model_ptr, kinsol.mex_model_ptr, base, end_effector, expressed_in);
  else
    Jdot_times_v = geometricJacobianDotTimesVmex(obj.mex_model_ptr, kinsol.mex_model_ptr, base, end_effector_expressed_in);
  end
else
