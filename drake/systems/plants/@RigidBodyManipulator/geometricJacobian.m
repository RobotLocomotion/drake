...
if (kinsol.mex)
  ...
  if nargout > 2
    [J, v_or_qdot_indices, dJ] = geometricJacobianmex(obj.mex_model_ptr, kinsol.mex_model_ptr, base, end_effector, expressed_in, in_terms_of_qdot);
  else
    [J, v_or_qdot_indices] = geometricJacobianmex(obj.mex_model_ptr, kinsol.mex_model_ptr, base, end_effector, expressed_in, in_terms_of_qdot);
  end
else
  if nargout > 2
