...
if kinsol.mex
  if compute_gradients
    [A, dA] = centroidalMomentumMatrixmex(robot.mex_model_ptr, kinsol.mex_model_ptr, robotnum, in_terms_of_qdot);
  else
    A = centroidalMomentumMatrixmex(robot.mex_model_ptr, kinsol.mex_model_ptr, robotnum, in_terms_of_qdot);
  end
else
  if compute_gradients
