...
if kinsol.mex
  ...
  if compute_gradient
    [Jdot_times_v, dJdot_times_v] = forwardJacDotTimesVmex(obj.mex_model_ptr, kinsol.mex_model_ptr, body_or_frame_id, points, rotation_type, base_or_frame_id);
  else
    Jdot_times_v = forwardJacDotTimesVmex(obj.mex_model_ptr, kinsol.mex_model_ptr, body_or_frame_id, points, rotation_type, base_or_frame_id);
  end
else
