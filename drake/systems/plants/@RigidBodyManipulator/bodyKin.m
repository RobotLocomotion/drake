...
if (kinsol.mex)
  ...
  if compute_dP
    [P, dP] = forwardKinPositionGradientmex(obj.mex_model_ptr, kinsol.mex_model_ptr, m, body_or_frame_ind, 1);
  elseif compute_P
    P = forwardKinPositionGradientmex(obj.mex_model_ptr, kinsol.mex_model_ptr, m, body_or_frame_ind, 1);
  end
else
  if compute_P
    if compute_dP
