...
CONSTRUCT_CONSTRAINT_DLLEXPORT void rigidBodyConstraintParseTspan(
    const mxArray* pm, Eigen::Vector2d& tspan);
CONSTRUCT_CONSTRAINT_DLLEXPORT void rigidBodyConstraintParse3dUnitVector(
    const mxArray* pm, Eigen::Vector3d& unit_vec);
CONSTRUCT_CONSTRAINT_DLLEXPORT void rigidBodyConstraintParseQuat(
    const mxArray* pm, Eigen::Vector4d& quat);
CONSTRUCT_CONSTRAINT_DLLEXPORT double rigidBodyConstraintParseGazeConethreshold(
    const mxArray* pm);
