...
/// can be used to call functions that that look like:
///
/// @code
...
///
/// int main() {
///    std::cout << get_name(SystemTypeTag<MySystem>{});
/// }
/// @endcode
///
/// In this case, we could directly called get_name<MySystem>() by specifying
/// the template argument, but that is not always possible.  In particular, tag
