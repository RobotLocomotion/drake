 ...
 * these
 * CompositeEventCollection objects need to be merged to generate a complete
 ...
 */
template <typename T>
class LeafCompositeEventCollection : public CompositeEventCollection<T> {
 public:
 ...
 */
template <typename T>
class DiagramCompositeEventCollection : public CompositeEventCollection<T> {
 public:
