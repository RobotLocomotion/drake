...
bool IsControllable(const LinearSystem<double>& sys, double threshold = Eigen::Default);
...
bool IsObservable(const LinearSystem<double>& sys, double threshold = Eigen::Default);
