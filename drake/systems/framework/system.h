...
class System {
 public:
  ...
  /// EventCollection will be passed to all the event handling mechanism.
  ///
  ...
  /// the simulator will merge @p event_info with the other EventCollection
  /// instances generated by other types of event triggering mechanism (e.g.
  /// CalcNextUpdateTime()), and the merged EventCollection will be passed to
  /// the appropriate handlers before taking a step.
  ///
  /// @p event_info cannot be null. @p event_info will be cleared on entry.
