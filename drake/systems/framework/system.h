...
class System {
 public:
  ...
  const SystemConstraint<T>& get_constraint(int constraint_index) const {
 ...
 protected:
  ...
  /// System.  Ownership of the SystemConstraint is tranferred to this system.
  void CreateConstraint(std::unique_ptr<SystemConstraint<T>> constraint) {
