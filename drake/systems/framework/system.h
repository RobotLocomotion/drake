 ...
 * @brief Drake uses a Simulink-inspired description of dynamical systems.
   ...
   physics models of mechanical systems, and a growing list of sensors, actuators, controllers, planners, estimators.

   @nbsp
   All dynamical systems derive from the System base class, and must explicitly declare all State, parameters, and
   noise/disturbances inputs.  The Diagram class permits modeling complex systems from libraries of parts.
 * @}
 */
