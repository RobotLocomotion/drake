...
class System {
 public:
  ...
  /// Returns the SystemScalarConverter for this object.  This is an expert-
  /// level API intended for framework authors.  Most users should prefer the
  /// convenience helpers such as System::ToAutoDiffXd.
