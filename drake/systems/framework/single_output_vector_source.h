...
class SingleOutputVectorSource : public LeafSystem<T> {
 ...
 protected:
  ...
  /// but this overload takes VectorBlock that has been consistency-checked
  /// with the output size declared at construction-time.  Subclasses should
