...
class Diagram : public System<T>,
 ...
 public:
  ...
  /// because it does not actually inspect the fine-grained sparsity of
  /// subsystems.
  /// TODO(david-german-tri): Improve the implementation.
  ...
  /// quite conservative, because it does not actually inspect the fine-grained
  /// sparsity of subsystems.
  /// TODO(david-german-tri): Improve the implementation.
