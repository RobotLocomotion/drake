...
class LeafSystem : public System<T> {
 ...
 protected:
  ...
  void DeclarePeriodicAction(const double period_sec, const double offset_sec,
  ...
  /// the discrete state.
  void DeclareDiscreteUpdatePeriodSec(const double period_sec) {
  ...
  /// discrete state.
  void DeclarePeriodicDiscreteUpdate(const double period_sec,
  ...
  void DeclarePeriodicUnrestrictedUpdate(const double period_sec,
                                         const double offset_sec) {
    DeclarePeriodicAction(period_sec, offset_sec,
  ...
  /// period_sec thereafter. On the discrete tick, the system may update
  /// the discrete state.
  void DeclarePublishPeriodSec(const double period_sec) {
