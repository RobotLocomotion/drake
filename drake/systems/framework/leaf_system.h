...
class LeafSystem : public System<T> {
 ...
 protected:
  ...
  /// the given type of action. Clobbers any other periodic behaviors
  /// previously declared.
  void DeclarePeriodicEvent(const T& period_sec, const T& offset_sec,
  ...
  void DeclareUpdatePeriodSec(const T& period_sec) {
    DeclarePeriodicEvent(period_sec, 0.0,
  ...
  void DeclarePeriodicUpdate(const T& period_sec, const T& offset_sec) {
    DeclarePeriodicEvent(period_sec, offset_sec,
        DiscreteEvent<T>::kDiscreteUpdateAction);
  }
  ...
  void DeclarePublishPeriodSec(const T& period_sec) {
    DeclarePeriodicEvent(period_sec, 0, DiscreteEvent<T>::kPublishAction);
  }
