...
TEST_F(ParametersTest, Modal) {
  EXPECT_EQ(72, UnpackIntValue(params_->get_modal_parameter(0)));
  EXPECT_EQ(144, UnpackIntValue(params_->get_modal_parameter(1)));
  params_->get_mutable_modal_parameter(1).SetValue<int>(512);
  EXPECT_EQ(512, UnpackIntValue(params_->get_modal_parameter(1)));
}
...
TEST_F(ParametersTest, Clone) {
  ...
  EXPECT_EQ(72, UnpackIntValue(clone->get_modal_parameter(0)));
  EXPECT_EQ(144, UnpackIntValue(clone->get_modal_parameter(1)));
  ...
  EXPECT_EQ(6.0, params_->get_numeric_parameter(0)->GetAtIndex(1));
  // - modal
  clone->get_mutable_modal_parameter(0).SetValue<int>(256);
  EXPECT_EQ(72, UnpackIntValue(params_->get_modal_parameter(0)));
}
