...
GTEST_TEST(SecondOrderStateTest, MapVelocityToConfigurationDerivatives) {
  ...
  Context<double>* sys1_context =
      diagram.GetMutableSubsystemContext(context.get(), diagram.sys1());
  Context<double>* sys2_context =
      diagram.GetMutableSubsystemContext(context.get(), diagram.sys2());

  diagram.sys1()->x(sys1_context)->set_v(13);
  diagram.sys2()->x(sys2_context)->set_v(17);
