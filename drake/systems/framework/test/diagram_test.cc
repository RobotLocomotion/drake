...
TEST_F(NestedDiagramContextTest, GetSubsystemContext) {
  ...
  big_diagram_->GetMutableSubsystemContext(big_context_.get(), integrator3_)
      ->get_mutable_continuous_state_vector()->SetAtIndex(0, 4);
...
TEST_F(NestedDiagramContextTest, GetSubsystemState) {
  ...
  big_diagram_->GetMutableSubsystemState(big_state, integrator0_)
      ->get_mutable_continuous_state()
      ->get_mutable_vector()
      ->SetAtIndex(0, 1);
  big_diagram_->GetMutableSubsystemState(big_state, integrator1_)
      ->get_mutable_continuous_state()
      ->get_mutable_vector()
      ->SetAtIndex(0, 2);
  big_diagram_->GetMutableSubsystemState(big_state, integrator2_)
      ->get_mutable_continuous_state()
      ->get_mutable_vector()
      ->SetAtIndex(0, 3);
  big_diagram_->GetMutableSubsystemState(big_state, integrator3_)
      ->get_mutable_continuous_state()
      ->get_mutable_vector()
      ->SetAtIndex(0, 4);
