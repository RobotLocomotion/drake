...
class DiagramTest : public ::testing::Test {
 protected:
  void SetUp() override {
    ...
    auto integrator0_xc = GetContinuousState(integrator0_.get());
    ...
    auto integrator1_xc = GetContinuousState(integrator1_.get());
  ...
  ContinuousState<double>* GetContinuousState(const System<double>* system) {
