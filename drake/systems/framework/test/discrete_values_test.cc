...
TEST_F(DiscreteValuesTest, OwnedState) {
  ...
  EXPECT_EQ(1.0, xd.get_value(0)->GetAtIndex(0));
  EXPECT_EQ(1.0, xd.get_value(0)->GetAtIndex(1));
  EXPECT_EQ(2.0, xd.get_value(1)->GetAtIndex(0));
  EXPECT_EQ(3.0, xd.get_value(1)->GetAtIndex(1));
}
...
TEST_F(DiscreteValuesTest, Clone) {
  ...
  EXPECT_EQ(1.0, clone->get_value(0)->GetAtIndex(0));
  EXPECT_EQ(1.0, clone->get_value(0)->GetAtIndex(1));
  EXPECT_EQ(2.0, clone->get_value(1)->GetAtIndex(0));
  EXPECT_EQ(3.0, clone->get_value(1)->GetAtIndex(1));
}
...
TEST_F(DiscreteValuesTest, SetFrom) {
  ...
  const BasicVector<AutoDiffXd>& vec = *ad_xd.get_value(0);
