...
class DeclaredModelPortsSystem : public LeafSystem<double> {
 public:
  ...
  DeclaredModelPortsSystem() {
    ...
    this->DeclareVectorInputPort(MyVector2d(),
                                 RandomDistribution::kUniformRandom);
    this->DeclareVectorInputPort(MyVector2d(),
                                 RandomDistribution::kGaussianRandom);
...
GTEST_TEST(ModelLeafSystemTest, ModelPortsTopology) {
  ...
  EXPECT_EQ(in3.get_random_type(), RandomDistribution::kUniformRandom);
  EXPECT_EQ(in4.get_random_type(), RandomDistribution::kGaussianRandom);
}
