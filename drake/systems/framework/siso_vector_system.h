...
class SisoVectorSystem : public LeafSystem<T> {
 ...
 protected:
  ...
  /// this method provides VectorBlocks to represent the input, state, and
  /// output.  Subclasses should override this method, and not the base class
  ...
  /// System::DoCalcTimeDerivatives but this method provides VectorBlocks to
  /// represent the input, continuous state, and derivatives.  Subclasses
  ...
  /// Provides a convenience method for %SisoVectorSystem subclasses.  This
  /// method performs the same logical operation as
  /// System::DoCalcDiscreteVariableUpdates but this method provides
  /// VectorBlocks to represent the input, discrete state, and discrete
  /// updates.  Subclasses should override this method, and not the base class
  /// method (which is `final`).
  ///
