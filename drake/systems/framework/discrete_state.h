...
/// The DiscreteState is a container for all the State variables that are
/// updated discontinuously on time or state based triggers. The numeric part
/// of discrete state is the "difference state". The non-numeric part is the
/// "modal state".
///
/// DiscreteState owns its state, and is therefore suitable for leaf Systems
