...
/// algorithm construct decision variables for the particular mathematical
/// program that is being formulated, and must bind the system constraint to
/// those variables (e.g. by populating the Context with the decision variables
/// and calling Calc).
///
