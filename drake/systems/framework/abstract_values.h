...
class AbstractValues {
 public:
  ...
  /// Constructs a AbstractValues that owns the underlying data.
  explicit AbstractValues(std::vector<std::unique_ptr<AbstractValue>>&& data);

  /// Constructs a AbstractValues that does not own the underlying data.
  explicit AbstractValues(const std::vector<AbstractValue*>& data);

  /// Constructs a AbstractValues that owns a single @p datum.
