...
class DiagramBuilder {
 public:
  ...
  /// Cascades @p src and @p dest.  This is a synonym for `Connect`.  The sole
  /// input port on the @p dest system is connected to sole output port on the
  /// @p src system.  Throws an exception if the sole-port precondition is not
  /// met (i.e., if @p dest has no input ports, or @p dest has more than one
  /// input port, or @p src has no output ports, or @p src has more than one
  /// output port).
