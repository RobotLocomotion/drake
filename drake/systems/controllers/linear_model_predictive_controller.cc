...
LinearModelPredictiveController<T>::LinearModelPredictiveController(
  ...
  // definite, however it turns out that Eigen's algorithm for checking this is
  // incomplete: it only succeeds on *strictly* positive definite matrices. We
  // exploit the fact here to check for strict positive-definiteness of R.
