...
#include "drake/systems/controllers/gravity_compensation.h"
...
template <typename T>
GravityCompensation<T>::GravityCompensation(const T& k, int length) : gain_(k) {
...
template <typename T>
void GravityCompensation<T>::EvalOutput(const ContextBase<T>& context,
