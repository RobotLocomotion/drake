...
// * @brief Wraps an existing (RigidBody) system with a simple gravity
// * controller (the new system represents the closed-loop controller + system)
// * The controller generates the generalised forces to compensate for
// * Gravity at the current state of the plant.
// * @concept{system_concept}
// *
// *   ----->[ sys ]-------> yout
// *   |                 |
...
// */
//template <class System>
//class SimpleGravityCompensatedSystem {
// public:
//  template <typename ScalarType>
//  using StateVector = typename System::template StateVector<ScalarType>;
//  template <typename ScalarType>
