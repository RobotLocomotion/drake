...
/// shooting method, where we have decision variables representing every
/// timestep of the trajectory, and one-step of numerical integration
/// provides the dynamic constraints between those decision variables.
