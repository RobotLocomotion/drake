...
int main() {
  ...
  default_material.set_stiffness(10000);
  default_material.set_dissipation(1);
  default_material.set_friction(0.9, 0.5);
  plant->set_default_compliant_material(default_material);

  systems::CompliantContactParameters model_parameters;
  model_parameters.characteristic_area = 2;
  model_parameters.v_stiction_tolerance = 0.01;
