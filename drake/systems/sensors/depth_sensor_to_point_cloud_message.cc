...
DepthSensorToPointCloudMessage::DepthSensorToPointCloudMessage(
...
DepthSensorToPointCloudMessage::depth_readings_input_port() const {
  return this->get_input_port(input_port_index_);
}

const OutputPortDescriptor<double>&
DepthSensorToPointCloudMessage::pointcloud_message_output_port() const {
  return System<double>::get_output_port(output_port_index_);
}

void DepthSensorToPointCloudMessage::DoCalcOutput(
