...
const int GyroscopeOutputConstants::kWx;
const int GyroscopeOutputConstants::kWy;
const int GyroscopeOutputConstants::kWz;
...
Vector3<T> GyroscopeOutput<T>::get_rotational_velocities() const {
  ...
  Vector3<T> rotational_velocity(
      BasicVector<T>::GetAtIndex(GyroscopeOutputConstants::kWx),
      BasicVector<T>::GetAtIndex(GyroscopeOutputConstants::kWy),
      BasicVector<T>::GetAtIndex(GyroscopeOutputConstants::kWz));
