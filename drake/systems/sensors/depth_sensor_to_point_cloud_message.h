...
/// A DepthSensorToPointCloudMessage takes as input a DepthSensorOutput and
...
/// DepthSensorOutput.
class DepthSensorToPointCloudMessage : public systems::LeafSystem<double> {
 public:
  DRAKE_NO_COPY_NO_MOVE_NO_ASSIGN(DepthSensorToPointCloudMessage)

  /// A %DepthSensorToPointCloudMessage constructor.
  ///
  /// @param spec The specification of the depth sensor whose output is being
  /// visualized.
  explicit DepthSensorToPointCloudMessage(const DepthSensorSpecification& spec);
