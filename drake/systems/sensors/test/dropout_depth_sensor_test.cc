...
void DoEmptyWorldTest(const char* const name,
  ...
  DropoutDepthSensor<double> dut(name, tree, frame, specification, 1.0, 0.0);
...
GTEST_TEST(TestDropoutDepthSensor, XyEmptyWorldTest) {
  DepthSensorSpecification specification;
...
GTEST_TEST(TestDropoutDepthSensor, XzEmptyWorldTest) {
  DepthSensorSpecification specification;
...
GTEST_TEST(TestDropoutDepthSensor, XyzEmptyWorldTest) {
  DepthSensorSpecification specification;
...
GTEST_TEST(TestDropoutDepthSensor, XyBoxInWorldTest) {
  DepthSensorSpecification specification;
  DepthSensorSpecification::set_xy_planar_spec(&specification);
...
GTEST_TEST(TestDropoutDepthSensor, TestTooClose) {
  DepthSensorSpecification specification;
...
GTEST_TEST(TestDropoutDepthSensor, TestDropoutDepthSensorSpecIsCopyable) {
...
GTEST_TEST(TestDropoutDepthSensor, TestOutputIgnoresNaNs) {
...
GTEST_TEST(TestDropoutDepthSensor, TestOutputSemantics) {
