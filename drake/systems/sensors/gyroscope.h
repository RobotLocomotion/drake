...
/// A simulated ideal gyroscope that measures angular acceleration.
///
...
class Gyroscope : public systems::LeafSystem<double> {
 public:
  /// This gyroscope measures rotational acceleration around 3 axes within its
  /// frame: X, Y, and Z.
  static constexpr int kNumMeasurements{3};

  /// A constructor that initializes an Gyroscope.
  ///
