...
class TimeVaryingAffineSystem : public LeafSystem<T> {
 public:
  ...
  int num_states(void) const { return num_states_; }
  int num_inputs(void) const { return num_inputs_; }
  int num_outputs(void) const { return num_outputs_; }
...
class AffineSystem : public TimeVaryingAffineSystem<T> {
 public:
  ...
  // Implement the time-varying affine system interface
