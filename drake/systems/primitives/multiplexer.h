...
class Multiplexer : public LeafSystem<T> {
 public:
  ...
  /// Constructs a %Multiplexer with one vector-valued output port whose size
  /// equals the size of `model_vector`.  In addition, the output type derives
  /// from that of `model_vector`.
