...
* Always use `in-class member initialization
  ...
  requires that they be initialized in the constructor's initializer list. For
  more information, see
  `this Slack discussion <https://drakedevelopers.slack.com/archives/platform_review/p1489628407521372>`_.
