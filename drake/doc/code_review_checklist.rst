...
- Did you remember to add all new headers to the list of installed files?
...
- Do a self-review, before you ask anyone else to review.
  ...
  - As you update your PR based on review feedback, review your commit
    diffs before pushing them -- don’t leave it to the the reviewers
    discover your careless typos.

- Remove commented-out code.
- Remove code that isn’t part of the build, or doesn’t have unit tests.
- Don’t include files with only whitespace diffs in your PR.
...
- Bare pointers are a common source of mistakes; if you see one,
  consider if it is what you want (eg, this is a mutable
