...
A PR generally should not exceed 500 lines of code. Larger PRs are sometimes
allowed, for instance if the change is generated by an easily-reviewed script.
Before sending an oversize PR, check that your platform reviewer is willing to
accept it.
