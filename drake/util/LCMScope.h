...
/*Utility to automate the use of our matlab scope infrastructure with C++ programs.
This code wraps the lcmt_scope_data type so you don't have get so dirty with pointers
