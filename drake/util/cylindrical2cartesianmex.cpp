...
{
  if(nrhs != 5){
    mexErrMsgIdAndTxt("Drake:cylindrical2cartesianmex:IncorrectInputs", "Usage [x_cartesian,v_cartesian,J,Jdotv] = cylindrical2cartesian(cylinder_axis,cylinder_x_dir,cylinder_origin,x_cylinder,v_cylinder)");
  }
  if(!mxIsNumeric(prhs[0]) || mxGetNumberOfElements(prhs[0]) != 3)
  {
    mexErrMsgIdAndTxt("Drake:cylindrical2cartesianmex:InvalidInput","cylinder_axis should be a 3 x 1 vector");
  }
  ...
  {
    mexErrMsgIdAndTxt("Drake:cylindrical2cartesianmex:InvalidInput","cylinder_x_dir should be a 3 x 1 vector");
  }
  ...
  {
    mexErrMsgIdAndTxt("Drake:cylindrical2cartesianmex:InvalidInput","cylinder_origin should be a 3 x 1 vector");
  }
  ...
  {
    mexErrMsgIdAndTxt("Drake:cylindrical2cartesianmex:InvalidInput","x should be a 6 x 1 vector");
  }
  ...
  {
    mexErrMsgIdAndTxt("Drake:cylindrical2cartesianmex:InvalidInput","v should be a 6 x 1 vector");
  }
  ...
  cylindrical2cartesian(cylinder_axis,cylinder_x_dir,cylinder_origin,x_cylinder,v_cylinder,x_cartesian,v_cartesian,J,Jdotv);
