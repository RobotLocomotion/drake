...
void cylindrical2cartesian(const drake::Vector3<Scalar>& m_cylinder_axis,
                           const drake::Vector3<Scalar>& m_cylinder_x_dir,
                           const drake::Vector3<Scalar>& cylinder_origin,
                           const drake::Vector6<Scalar>& x_cylinder,
                           const drake::Vector6<Scalar>& v_cylinder,
                           drake::Vector6<Scalar>& x_cartesian,
                           drake::Vector6<Scalar>& v_cartesian,
                           Eigen::Matrix<Scalar, 6, 6>& J,
                           drake::Vector6<Scalar>& Jdotv) {
  drake::Vector3<Scalar> cylinder_axis =
      m_cylinder_axis / m_cylinder_axis.norm();
  drake::Vector3<Scalar> cylinder_x_dir =
  ...
  drake::Vector3<Scalar> x_rpy_cartesian = rotmat2rpy(R_cartesian);
...
template <typename Scalar>
void cartesian2cylindrical(const drake::Vector3<Scalar>& m_cylinder_axis,
                           const drake::Vector3<Scalar>& m_cylinder_x_dir,
                           const drake::Vector3<Scalar>& cylinder_origin,
                           const drake::Vector6<Scalar>& x_cartesian,
                           const drake::Vector6<Scalar>& v_cartesian,
                           drake::Vector6<Scalar>& x_cylinder,
                           drake::Vector6<Scalar>& v_cylinder,
                           Eigen::Matrix<Scalar, 6, 6>& J,
                           drake::Vector6<Scalar>& Jdotv) {
  drake::Vector3<Scalar> cylinder_axis =
      m_cylinder_axis / m_cylinder_axis.norm();
  ...
  drake::Vector3<Scalar> x_pos_cylinder =
      R_cartesian2cylinder * (x_cartesian.block(0, 0, 3, 1) - cylinder_origin);
  drake::Vector3<Scalar> v_pos_cylinder =
