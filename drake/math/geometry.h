...
*/
  ...
  dquat2rotmat(const Eigen::MatrixBase<Derived> &q) {
    ...
    ret
        << w, x, -y, -z, z, y, x, w, -y, z, -w, x, -z, y, x, -w, w, -x, y, -z, x,
  ...
  drotmat2rpy(const Eigen::MatrixBase<DerivedR> &R,
    ...
    auto dR11_dq =
        getSubMatrixGradient<DerivedDR::ColsAtCompileTime>(dR, 0, 0,
                                                           R.rows());
    auto dR21_dq =
        getSubMatrixGradient<DerivedDR::ColsAtCompileTime>(dR, 1, 0,
                                                           R.rows());
    auto dR31_dq =
        getSubMatrixGradient<DerivedDR::ColsAtCompileTime>(dR, 2, 0,
                                                           R.rows());
    auto dR32_dq =
        getSubMatrixGradient<DerivedDR::ColsAtCompileTime>(dR, 2, 1,
                                                           R.rows());
    auto dR33_dq =
        getSubMatrixGradient<DerivedDR::ColsAtCompileTime>(dR, 2, 2,
                                                           R.rows());
  ...
  drotmat2quat(const Eigen::MatrixBase<DerivedR> &R,
    ...
    auto dR11_dq =
        getSubMatrixGradient<DerivedDR::ColsAtCompileTime>(dR, 0, 0,
                                                           R.rows());
    auto dR12_dq =
        getSubMatrixGradient<DerivedDR::ColsAtCompileTime>(dR, 0, 1,
                                                           R.rows());
    auto dR13_dq =
        getSubMatrixGradient<DerivedDR::ColsAtCompileTime>(dR, 0, 2,
                                                           R.rows());
    auto dR21_dq =
        getSubMatrixGradient<DerivedDR::ColsAtCompileTime>(dR, 1, 0,
                                                           R.rows());
    auto dR22_dq =
        getSubMatrixGradient<DerivedDR::ColsAtCompileTime>(dR, 1, 1,
                                                           R.rows());
    auto dR23_dq =
        getSubMatrixGradient<DerivedDR::ColsAtCompileTime>(dR, 1, 2,
                                                           R.rows());
    auto dR31_dq =
        getSubMatrixGradient<DerivedDR::ColsAtCompileTime>(dR, 2, 0,
                                                           R.rows());
...
*/
  ...
  Eigen::Matrix<typename DerivedA::Scalar, 3, Eigen::Dynamic> dcrossProduct(
    ...
    Eigen::Matrix<typename DerivedA::Scalar, 3, Eigen::Dynamic> ret(3,
                                                                    da.cols());
...
*/
  ...
  void angularvel2quatdotMatrix(const Eigen::MatrixBase<DerivedQ> &q,
    ...
    if (dM) {
      (*dM) << Scalar(0), Scalar(-0.5), Scalar(0), Scalar(0), Scalar(0.5),
          ...
          Scalar(-0.5), Scalar(0), Scalar(0), Scalar(0.5), Scalar(0), Scalar(
          0),
          Scalar(0), Scalar(-0.5), Scalar(0), Scalar(0), Scalar(0), Scalar(0),
          Scalar(0.5), Scalar(0.5), Scalar(0), Scalar(0), Scalar(0), Scalar(
          0),
  ...
  void angularvel2rpydotMatrix(
    ...
    if (dphi) {
      ...
      Scalar sp2 = sp * sp;
      Scalar cp2 = cp * cp;
      (*dphi) << Scalar(0), (cy * sp) / cp2, -sy / cp, Scalar(0), Scalar(
          0), -cy,
          Scalar(0), cy + (cy * sp2) / cp2, -(sp * sy) / cp, Scalar(0),
          (sp * sy) / cp2, cy / cp, Scalar(0), Scalar(0), -sy, Scalar(0),
          sy + (sp2 * sy) / cp2, (cy * sp) / cp, Scalar(0), Scalar(0), Scalar(
          0),
          Scalar(0), Scalar(0), Scalar(0), Scalar(0), Scalar(0), Scalar(0);
      ...
      if (ddphi) {
        ...
        (*ddphi) << Scalar(0), Scalar(0), Scalar(0), Scalar(0), Scalar(0),
            ...
            cy / cp2, -(sp * sy) / cp, Scalar(0), Scalar(0), Scalar(
            0), Scalar(
            0),
            Scalar(0), Scalar(0), Scalar(0), Scalar(0), Scalar(0);
      }
  ...
  Eigen::Matrix<typename Derived::Scalar, 3, 4> quatdot2angularvelMatrix(
    ...
    ret << -qtilde(1), qtilde(0), -qtilde(3), qtilde(2), -qtilde(2), qtilde(
        3),
...
*/
  ...
  dTransformSpatialMotion(
    ...
    for (int col = 0; col < X.cols(); col++) {
      ...
      auto dXv_col =
          getSubMatrixGradient<Eigen::Dynamic>(dX, Xv_rows, col_array,
                                               X.rows());
      ...
      setSubMatrixGradient<Eigen::Dynamic>(ret, domega_part_col, Xomega_rows,
                                           col_array, X.rows());
      setSubMatrixGradient<Eigen::Dynamic>(ret, dv_part_col, Xv_rows,
                                           col_array,
                                           X.rows());
    }
    return ret;
  ...
  drake::SquareTwistMatrix<typename DerivedI::Scalar> transformSpatialInertia(
    ...
    if (isRegularInertiaMatrix(I)) {
      ...
      J_new.noalias() +=
          R * J.template selfadjointView<Lower>() * R.transpose();
  ...
  typename TransformSpatial<DerivedB>::type crossSpatialMotion(
      const Eigen::MatrixBase<DerivedA> &a,
      const Eigen::MatrixBase<DerivedB> &b) {
    typename TransformSpatial<DerivedB>::type ret(drake::kTwistSize,
                                                  b.cols());
    ret.template topRows<3>() =
  ...
  typename TransformSpatial<DerivedB>::type crossSpatialForce(
    ...
    ret.template topRows<3>() =
        -b.template topRows<3>().colwise().cross(a.template topRows<3>());
    ret.template topRows<3>() -=
        b.template bottomRows<3>().colwise().cross(
            a.template bottomRows<3>());
    ret.template bottomRows<3>() =
        -b.template bottomRows<3>().colwise().cross(a.template topRows<3>());
    return ret;
  }
  ...
  drake::TwistMatrix<typename DerivedA::Scalar> dCrossSpatialMotion(
    ...
    ret.row(0) = -da.row(2) * b[1] + da.row(1) * b[2] - a[2] * db.row(1) +
                 a[1] * db.row(2);
    ret.row(1) =
        da.row(2) * b[0] - da.row(0) * b[2] + a[2] * db.row(0) -
        a[0] * db.row(2);
  ...
  drake::TwistMatrix<typename DerivedA::Scalar> dCrossSpatialForce(
    ...
    ret.row(3) =
        da.row(2) * b[4] - da.row(1) * b[5] + a[2] * db.row(4) -
        a[1] * db.row(5);
    ret.row(4) = -da.row(2) * b[3] + da.row(0) * b[5] - a[2] * db.row(3) +
                 a[0] * db.row(5);
    ret.row(5) =
        da.row(1) * b[3] - da.row(0) * b[4] + a[1] * db.row(3) -
        a[0] * db.row(4);
    ret = -ret;
    return ret;
  }
...
*/
  ...
  typename DHomogTrans<DerivedQdotToV>::type dHomogTrans(
    ...
    ret.template middleRows<3>(0) =
        -Rz * qdot_to_omega_y + Ry * qdot_to_omega_z;
    ret.row(3).setZero();

    ret.template middleRows<3>(4) =
        Rz * qdot_to_omega_x - Rx * qdot_to_omega_z;
    ret.row(7).setZero();

    ret.template middleRows<3>(8) =
        -Ry * qdot_to_omega_x + Rx * qdot_to_omega_y;
    ret.row(11).setZero();
  ...
  Eigen::Matrix<typename Derived::Scalar, 3, 1> flipExpmap(
    ...
    bool is_degenerate = (expmap_norm <
