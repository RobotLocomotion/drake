...
function(matlab_add_unit_test)
  ...
  set(multiValueArgs UNITTEST_PRECOMMAND ADDITIONAL_PATH MATLAB_ADDITIONAL_STARTUP_OPTIONS TEST_ARGS CUSTOM_TEST_COMMAND)
  ...
  # We have to fanagle the form of the custom command because of the way CMake
  # processes strings with \ and ;. Semicolons are almost guaranteed to be
  # part of the custom MATLAB command, so we have to deal with that here
  # before it gets passed to add_test.
  ...
  add_test(NAME ${${prefix}_NAME}
	    ...
	    -DCUSTOM_TEST_COMMAND=${custom_test_cmd_clean}
