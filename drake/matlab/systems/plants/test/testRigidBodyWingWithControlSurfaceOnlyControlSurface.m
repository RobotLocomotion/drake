function xtraj = testRigidBodyWingWithControlSurfaceOnlyControlSurface()
  ...
  r = RigidBodyManipulator('testRigidBodyWingWithControlSurfaceOnlyControlSurface.urdf', options);
  ...
  constant_traj = ConstantTrajectory([0.8 100]);
