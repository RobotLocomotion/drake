  ...
  switch (constraint_type) {
      ...
      if (field_str == "active") {
        ...
        if (mxGetNumberOfElements(prhs[2]) != 1) {
          mexErrMsgIdAndTxt(
              ...
              "QuasiStaticConstraint:flag must be a single boolean");
        }
        ...
        if (mxGetNumberOfElements(prhs[2]) != 1) {
          mexErrMsgIdAndTxt(
              "Drake:updatePtrRigidBodyConstraintmex:BadInputs",
              "QuasiStaticConstraint:shrink factor must be a double scalar");
        }
        double factor = mxGetScalar(prhs[2]);
        if (factor <= 0.0) {
          mexErrMsgIdAndTxt("Drake:updatePtrRigidBodyConstraintmex:BadInputs",
                            "QuasiStaticConstraint:shrink factor should be a "
                            "positive scalar");
        }
        QuasiStaticConstraint* cnst_new = new QuasiStaticConstraint(*cnst);
        ...
        for (int idx = 0; idx < num_new_bodies; idx++) {
          ...
          memcpy(new_body_pts_tmp.data(), mxGetPrSafe(prhs[3 + idx * 2]),
    ...
    case RigidBodyConstraint::PostureConstraintType: {
      ...
      if (field_str == "bounds") {  // setJointLimits(pc, joint_idx, lb, ub)
        ...
        if (!mxIsNumeric(prhs[2]) || mxGetN(prhs[2]) != 1 ||
            ...
            mxGetM(prhs[4]) != num_idx || mxGetN(prhs[4]) != 1) {
          mexErrMsgIdAndTxt("Drake:updatePtrRigidBodyConstraintmex:BadInputs",
                            "PostureConstraint:joint_idx, lb and ub must be of "
                            "the same length numerical vector");
        }
        ...
        delete[] joint_idx;
        plhs[0] =
            createDrakeConstraintMexPointer((void*)pc_new, "PostureConstraint");
      } else {
        mexErrMsgIdAndTxt("Drake:updatePtrRigidBodyConstraintmex:BadInputs",
                          "PostureConstraint: argument 2 is not accepted");
      }
    } break;
    case RigidBodyConstraint::AllBodiesClosestDistanceConstraintType: {
      ...
      if (field_str == "robot") {
        ...
        plhs[0] = createDrakeConstraintMexPointer(
            (void*)cnst_new, "AllBodiesClosestDistanceConstraint");
      } else {
        mexErrMsgIdAndTxt(
            "Drake:updatePtrRigidBodyConstraintmex:BadInputs",
            "AllBodiesClosestDistanceConstraint:argument 2 is not accepted");
      }
    } break;
    case RigidBodyConstraint::WorldEulerConstraintType: {
      ...
      if (field_str == "robot") {
        ...
        mexErrMsgIdAndTxt("Drake:updatePtrRigidBodyConstraintmex:BadInputs",
                          "WorldEulerConstraint:argument 2 is not accepted");
      }
    } break;
    case RigidBodyConstraint::WorldGazeDirConstraintType: {
      ...
      if (field_str == "robot") {
        ...
        mexErrMsgIdAndTxt("Drake:updatePtrRigidBodyConstraintmex:BadInputs",
                          "WorldGazeDirConstraint:argument 2 is not accepted");
      }
    } break;
    case RigidBodyConstraint::WorldGazeOrientConstraintType: {
      ...
      if (field_str == "robot") {
        ...
        mexErrMsgIdAndTxt(
            "Drake:updatePtrRigidBodyConstraintmex:BadInputs",
            "WorldGazeOrientConstraint:argument 2 is not accepted");
      }
    } break;
    case RigidBodyConstraint::WorldGazeTargetConstraintType: {
      ...
      if (field_str == "robot") {
        ...
        mexErrMsgIdAndTxt(
            "Drake:updatePtrRigidBodyConstraintmex:BadInputs",
            "WorldGazeTargetConstraint:argument 2 is not accepted");
      }
    } break;
    case RigidBodyConstraint::RelativeGazeTargetConstraintType: {
      ...
      if (field_str == "robot") {
        ...
        cnst_new->updateRobot(robot);
        plhs[0] = createDrakeConstraintMexPointer(
            (void*)cnst_new, "RelativeGazeTargetConstraint");
      } else {
        mexErrMsgIdAndTxt(
            "Drake:updatePtrRigidBodyConstraintmex:BadInputs",
            "RelativeGazeTargetConstraint:argument 2 is not accepted");
      }
    } break;
    case RigidBodyConstraint::RelativeGazeDirConstraintType: {
      ...
      if (field_str == "robot") {
        ...
        mexErrMsgIdAndTxt(
            "Drake:updatePtrRigidBodyConstraintmex:BadInputs",
            "RelativeGazeDirConstraint:argument 2 is not accepted");
      }
    } break;
    ...
    case RigidBodyConstraint::WorldPositionConstraintType: {
      ...
      if (field_str == "robot") {
        ...
        mexErrMsgIdAndTxt("Drake:updatePtrRigidBodyConstraintmex:BadInputs",
                          "WorldPositionConstraint:argument 2 is not accepted");
      }
    } break;
    case RigidBodyConstraint::WorldPositionInFrameConstraintType: {
      ...
      if (field_str == "robot") {
        ...
        cnst_new->updateRobot(robot);
        plhs[0] = createDrakeConstraintMexPointer(
            (void*)cnst_new, "WorldPositionInFrameConstraint");
      } else {
        mexErrMsgIdAndTxt(
            "Drake:updatePtrRigidBodyConstraintmex:BadInputs",
            "WorldPositionInFrameConstraint:argument 2 is not accepted");
      }
    } break;
    case RigidBodyConstraint::WorldQuatConstraintType: {
      ...
      if (field_str == "robot") {
        ...
        mexErrMsgIdAndTxt("Drake:updatePtrRigidBodyConstraintmex:BadInputs",
                          "WorldQuatConstraint:argument 2 is not accepted");
      }
    } break;
    case RigidBodyConstraint::Point2PointDistanceConstraintType: {
      ...
      if (field_str == "robot") {
        ...
        cnst_new->updateRobot(robot);
        plhs[0] = createDrakeConstraintMexPointer(
            (void*)cnst_new, "Point2PointDistanceConstraint");
      } else {
        mexErrMsgIdAndTxt(
            "Drake:updatePtrRigidBodyConstraintmex:BadInputs",
            "Point2PointDistanceConstraint:argument 2 is not accepted");
      }
    } break;
    case RigidBodyConstraint::Point2LineSegDistConstraintType: {
      ...
      if (field_str == "robot") {
        ...
        cnst_new->updateRobot(robot);
        plhs[0] = createDrakeConstraintMexPointer(
            (void*)cnst_new, "Point2LineSegDistConstraint");
      } else {
        mexErrMsgIdAndTxt(
            "Drake:updatePtrRigidBodyConstraintmex:BadInputs",
            "Point2LineSegDistConstraint:argument 2 is not accepted");
      }
    } break;
    case RigidBodyConstraint::WorldFixedPositionConstraintType: {
      ...
      if (field_str == "robot") {
        ...
        cnst_new->updateRobot(robot);
        plhs[0] = createDrakeConstraintMexPointer(
            (void*)cnst_new, "WorldFixedPositionConstraint");
      } else {
        mexErrMsgIdAndTxt(
            "Drake:updatePtrRigidBodyConstraintmex:BadInputs",
            "WorldFixedPositionConstraint:argument 2 is not accepted");
      }
    } break;
    case RigidBodyConstraint::WorldFixedOrientConstraintType: {
      ...
      if (field_str == "robot") {
        ...
        mexErrMsgIdAndTxt(
            "Drake:updatePtrRigidBodyConstraintmex:BadInputs",
            "WorldFixedOrientConstraint:argument 2 is not accepted");
      }
    } break;
    case RigidBodyConstraint::WorldFixedBodyPoseConstraintType: {
      ...
      if (field_str == "robot") {
        ...
        cnst_new->updateRobot(robot);
        plhs[0] = createDrakeConstraintMexPointer(
            (void*)cnst_new, "WorldFixedBodyPoseConstraint");
      } else {
        mexErrMsgIdAndTxt(
            "Drake:updatePtrRigidBodyConstraintmex:BadInputs",
            "WorldFixedBodyPoseConstraint:argument 2 is not accepted");
      }
    } break;
    case RigidBodyConstraint::RelativePositionConstraintType: {
      ...
      if (field_str == "robot") {
        ...
        mexErrMsgIdAndTxt(
            "Drake:updatePtrRigidBodyConstraintmex:BadInputs",
            "RelativePositionConstraint:argument 2 is not accepted");
      }
    } break;
    case RigidBodyConstraint::RelativeQuatConstraintType: {
      ...
      if (field_str == "robot") {
        ...
        mexErrMsgIdAndTxt("Drake:updatePtrRigidBodyConstraintmex:BadInputs",
                          "RelativeQuatConstraint:argument 2 is not accepted");
      }
    } break;
    case RigidBodyConstraint::MinDistanceConstraintType: {
      ...
      if (field_str == "robot") {
        ...
        mexErrMsgIdAndTxt("Drake:updatePtrRigidBodyConstraintmex:BadInputs",
                          "MinDistanceConstraint:argument 2 is not accepted");
      }
    } break;
    case RigidBodyConstraint::GravityCompensationTorqueConstraintType: {
      ...
      if (field_str == "robot") {
        ...
        cnst_new->updateRobot(robot);
        plhs[0] = createDrakeConstraintMexPointer(
            (void*)cnst_new, "GravityCompensationTorqueConstraint");
      } else {
        mexErrMsgIdAndTxt(
            "Drake:updatePtrRigidBodyConstraintmex:BadInputs",
            "GravityCompensationTorqueConstraint:argument 2 is not accepted");
      }
    } break;
    default:
      mexErrMsgIdAndTxt("Drake:updatePtrRigidBodyConstraintmex:BadInputs",
