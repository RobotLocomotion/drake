 ...
 */
::testing::AssertionResult ExpectSO3(const Eigen::Matrix3d& R,
 ...
 * @param tolerance The tolerance for determining equivalence.
 */
::testing::AssertionResult CompareSO3WithoutAxisSign(
 ...
 * then rotations using CompareSO3WithoutAxisSign.
 * @param X_expected Expected SE(3) transform.
 * @param X_actual Actual SE(3) transform.
 * @param tolerance The tolerance for determining equivalence.
 */
