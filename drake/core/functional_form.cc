...
class FunctionalForm::Internal {
 public:
  ...
  static int constexpr kSize = static_cast<int>(Form::kUndefined) + 1;
...
FunctionalForm operator+(FunctionalForm const& l, FunctionalForm const& r) {
  FunctionalForm::Form f =
      FunctionalForm::Internal::kAdd[int(l.form_)][int(r.form_)];
...
FunctionalForm operator*(FunctionalForm const& l, FunctionalForm const& r) {
  FunctionalForm::Form f =
      FunctionalForm::Internal::kMul[int(l.form_)][int(r.form_)];
  FunctionalForm::Variables vars;
  if (FunctionalForm::Internal::need_vars(f)) {
    vars = FunctionalForm::Variables::Union(l.vars_, r.vars_);
  }
...
FunctionalForm operator/(FunctionalForm const& l, FunctionalForm const& r) {
  FunctionalForm::Form f =
      FunctionalForm::Internal::kDiv[int(l.form_)][int(r.form_)];
  FunctionalForm::Variables vars;
  if (FunctionalForm::Internal::need_vars(f)) {
    vars = FunctionalForm::Variables::Union(l.vars_, r.vars_);
  }
...
FunctionalForm abs(FunctionalForm const& x) {
  return FunctionalForm(FunctionalForm::Internal::kAbs[int(x.form_)],
                        FunctionalForm::Variables(x.vars_));
}

FunctionalForm cos(FunctionalForm const& x) {
  return FunctionalForm(FunctionalForm::Internal::kCos[int(x.form_)],
                        FunctionalForm::Variables(x.vars_));
}

FunctionalForm exp(FunctionalForm const& x) {
  return FunctionalForm(FunctionalForm::Internal::kExp[int(x.form_)],
                        FunctionalForm::Variables(x.vars_));
}

FunctionalForm log(FunctionalForm const& x) {
  return FunctionalForm(FunctionalForm::Internal::kLog[int(x.form_)],
                        FunctionalForm::Variables(x.vars_));
}

FunctionalForm sin(FunctionalForm const& x) {
  return FunctionalForm(FunctionalForm::Internal::kSin[int(x.form_)],
                        FunctionalForm::Variables(x.vars_));
}

FunctionalForm sqrt(FunctionalForm const& x) {
  return FunctionalForm(FunctionalForm::Internal::kSqrt[int(x.form_)],
                        FunctionalForm::Variables(x.vars_));
}
...
std::ostream& operator<<(std::ostream& os, FunctionalForm const& f) {
  os << kFunctionalFormNames[int(f.form_)];
  if (!f.vars_.empty()) {
    os << "(";
    const char* sep = "";
