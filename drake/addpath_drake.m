...
addpath(fullfile(root,'solvers_matlab'));
addpath(fullfile(root,'solvers_matlab','trajectoryOptimization'));
...
addpath(fullfile(root,'solvers_matlab','BMI'));
addpath(fullfile(root,'solvers_matlab','BMI','util'));
addpath(fullfile(root,'solvers_matlab','BMI','kinematics'));
addpath(fullfile(root,'solvers_matlab','qpSpline'));
