...
class IdealDepthSensor : public RigidBodyTreeSensor {
 public:
  ...
  /// A constructor that initializes an IdealDepthSensor by explicitly
  ...
  /// A constructor that initializes an IdealDepthSensor using an
  /// IdealDepthSensorSpecification.
  ///
  /// @param[in] tree The RigidBodyTree containing the geometric configuration
  /// of the world. This parameter is aliased by a class member variable. Thus,
  /// its lifespan must exceed that of this class' instance.
  ...
  /// @param[in] frame The frame to which this depth sensor is attached.
  ///
  /// @param[in] specs The specifications of this sensor.
  ///
  IdealDepthSensor(const RigidBodyTree<double>& tree,
                   const std::string& sensor_name,
                   const RigidBodyFrame<double>& frame,
                   const IdealDepthSensorSpecification& specs);
  ...
  const IdealDepthSensorSpecification& get_specification() {
 ...
 private:
  ...
  const IdealDepthSensorSpecification specification_;
