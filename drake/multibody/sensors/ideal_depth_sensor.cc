...
constexpr double IdealDepthSensor::kError;
constexpr double IdealDepthSensor::kTooFar;
constexpr double IdealDepthSensor::kTooClose;
...
IdealDepthSensor::IdealDepthSensor(const RigidBodyTree<double>& tree,
    ...
    : IdealDepthSensor(
          tree, sensor_name, frame,
          IdealDepthSensorSpecification(min_theta, max_theta, min_phi, max_phi,
                                        num_theta_values, num_phi_values,
                                        min_range, max_range)) {}

IdealDepthSensor::IdealDepthSensor(
    const RigidBodyTree<double>& tree, const std::string& sensor_name,
    const RigidBodyFrame<double>& frame,
...
std::ostream& operator<<(std::ostream& out, const IdealDepthSensor& sensor) {
  ...
  out << "IdealDepthSensor: Raycast endpoints:\n"
