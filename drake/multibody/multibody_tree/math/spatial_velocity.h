...
class SpatialVelocity : public SpatialVector<SpatialVelocity, T> {
 ...
 public:
  ...
  /// 6-dimensional dot product with the spatial force `F_Q_E` applied about the
  ...
  /// `F_Q_E` when applied about the origin of frame `Q` moving with `this`
  /// spatial velocity `V_IQ_E`.
