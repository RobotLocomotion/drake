...
class Model {
 ...
 protected:
  ...
  /** Allows sub-classes to do additional processing on when elements are
   removed from the collision model.  This is called each time
   Model::RemoveElement is called.
