...
TEST_P(CompliantParameterParseTest, SinglValueStiffness) {
  double value = 15;
...
// assigns parameter values that are default except for the specified value.
TEST_P(CompliantParameterParseTest, SinglValueDissipation) {
  double value = 15;
...
// parsing error.
TEST_P(CompliantParameterParseTest, SinglValueStaticFriction) {
  double value = 15;
