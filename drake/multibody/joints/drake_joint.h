...
class DrakeJoint {
 public:
  ...
  ///
  /// To clarify the sense of the returned transform `X_PF`, consider a
  /// point `x`. Let `x_P` be point `x` measured and expressed in frame `P`
  /// and `x_F` be point `x` measured and expressed in frame `F`. Then `x_P`
  /// is given by:
  ///
  /// <pre>
  /// x_P = X_PF * x_F
