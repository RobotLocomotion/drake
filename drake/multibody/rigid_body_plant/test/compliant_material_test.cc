...
GTEST_TEST(CompliantMaterialTest, ResetToDefault) {
  ...
  material.set_stiffness_to_default();
...
GTEST_TEST(CompliantMaterialTest, DefaultValues) {
  ...
  EXPECT_EQ(defaults.stiffness(), 1e8) << "Have you updated the doxygen?";
