...
/** The set of per-object compliant material properties. It attempts to model
 the material properties of a single object. The material properties include:
   - Young's modulus with units of pascals (i.e.,N/m²). This is a measure of the
     ...
     that of a medium rubber: 1e8 pascals.
 ...
 material.set_dissipation(10);  // stiffness is no longer default.
...
class CompliantMaterial {
 public:
  ...
  /** Extract the value for Young's modulus with an optional default value. The
   default value is tested in Debug build. */
  ...
  /** Extract the dissipation value with an optional default value. The default
   value is tested in Debug build.
  ...
  /** Extract the static friction coefficient with an optional default value.
   The default value is tested for non-negativity in Debug build.
