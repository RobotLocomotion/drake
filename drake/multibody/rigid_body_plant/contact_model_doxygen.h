...
/** @defgroup per_object_contact Per-object contact material
 ...
 - stiffness (k) with units of stiffness/area of force/volume -- this stiffness
   assumes a thin layer of compliance over a rigid core; fully compliant bodies
   require stiffness in units of stress/strain,
 ...
 - sᵢ is the "squish" factor of body I. The two penetrating geometries represent
   deforming bodies. Consider contact between a steel body and foam ball; the
   foam ball would eperience the entire deformation and the squish factors
   for the foam ball would be 1 and 0 for the steel plate. It is defined
 ...
 configured to use default parameter values will report different values as the
 default values change. This allows us to _not_ worry about the order of
