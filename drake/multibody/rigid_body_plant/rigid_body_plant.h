...
/// - Port 2: A ContactsResults class allowing access to the result
/// from contact computations.
/// - Port 2-N: Individual output ports containing the state
/// (positions + velocities) for each model instance id, accessed
