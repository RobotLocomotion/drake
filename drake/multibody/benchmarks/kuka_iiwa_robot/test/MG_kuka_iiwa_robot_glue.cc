...
MGKukaIIwaRobotGlue<T>::CalcEndEffectorKinematics(
  ...
  VectorX<double> joint_angles_etc(q.size() + qDt.size() + qDDt.size());
  joint_angles_etc << q, qDt, qDDt;
  ...
  MG_kuka_auto_generated.SetVariablesFromArray(joint_angles_etc.data());
