...
class MGKukaIIwaRobotAutoGenerated {
 public:
  MGKukaIIwaRobotAutoGenerated() { g = 0.0; }
  ...
  // Class data.
  double g, mA, mB, mC, mD, mE, mF, mG;
  double IAzz, IBxx, IByy, IBzz, ICxx, ICyy, ICzz, IDxx, IDyy, IDzz,
         IExx, IEyy, IEzz, IFxx, IFyy, IFzz, IGxx, IGyy, IGzz;
