...
/// gripper. It expose an output port for the state of each IIWA arm and WSG
...
class IiwaAndWsgPlantWithStateEstimator : public systems::Diagram<T> {
 public:
  ...
  /// @param combined_plant` a `RigidBodyPlant` that is assumed to be generated
  ///        containing a single Kuka IIWA arm, Schunk WSG gripper, and
  ///        one other object.
