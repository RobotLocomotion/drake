...
using manipulation::planner::RelaxingIkWrapper;
...
bool PlanStraightLineMotion(const VectorX<double>& q_current,
                            ...
                            RelaxingIkWrapper* planner, IKResults* ik_res,
  ...
  std::vector<
    RelaxingIkWrapper::IkCartesianWaypoint> waypoints(num_via_points + 1);
