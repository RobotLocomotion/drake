...
void IiwaCommandReceiver::DoCalcDiscreteVariableUpdates(
  ...
  if (command.num_joints != 0) {
    ...
    state_value.tail(kNumJoints) =
        (new_positions - state_value.head(kNumJoints)) / kIiwaLcmStatusInterval;
