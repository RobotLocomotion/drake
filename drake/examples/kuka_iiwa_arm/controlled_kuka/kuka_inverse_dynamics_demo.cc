...
#include "drake/examples/QPInverseDynamicsForHumanoids/system/kuka_inverse_dynamics_controller.h"
...
int DoMain() {
  ...
  model.SetDesiredTrajectory(MakePlan(), context);
...
int main(int argc, char* argv[]) {
  ...
  return drake::examples::qp_inverse_dynamics::DoMain();
}
