...
/// This class implements a source for joint positions/velocites for
/// an iiwa arm.  It has two input ports, one for robot_plan_t
/// messages containing a plan to follow, and another port for
/// lcmt_iiwa_status messages.
///
