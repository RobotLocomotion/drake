...
"""Launch the `uniformly_accelerated_particle` demo along with
the drake-visualizer to see things move
...
_epilog = """
All remaining arguments are passed to the underlying demo program:
---
"""
...
def main():
    demo_path = "drake/examples/uniformly_accelerated_particle/uniformly_accelerated_particle"
    ...
    parser.add_argument(
        "--no-visualizer", action='store_true', default=False,
