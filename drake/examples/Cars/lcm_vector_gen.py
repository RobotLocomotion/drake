...
class DRAKECARS_EXPORT %(camel)sTranslator
 ...
 public:
  ...
  std::unique_ptr<systems::VectorBase<double>> AllocateOutputVector()
      const override;
...
std::unique_ptr<systems::VectorBase<double>>
...
def generate_allocate_output_vector(context, fields):
    cc = context["cc"]
...
def generate_code(args):
    ...
    with open(os.path.join(cxx_dir, "%s_translator.cc" % snake), 'w') as cc:
        ...
        generate_allocate_output_vector(locals(), args.fields)
