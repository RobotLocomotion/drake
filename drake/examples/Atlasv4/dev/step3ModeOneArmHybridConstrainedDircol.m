function [p,v,xtraj,utraj,ltraj,z,F,info,traj_opt] = step3ModeOneArmHybridConstrainedDircol(z0,xtraj,utraj,ltraj)
step_height = .3;
...
% N = [6,6,5,5,6];
N = [5,4,5];
duration = {[.2 .7],[.1 1.5] [.1 ]};
modes = {[1;2],[2;3;4;5], [3;4]};
% 
% N = N(1:3);
...
to_options.mode_options{2}.active_inds = [1;2;3;4;6;7;8];
...
if length(N) > 1
  traj_opt = traj_opt.addConstraint(BoundingBoxConstraint(-.33,inf),traj_opt.mode_opt{2}.cstrval_inds(end) + traj_opt.var_offset(2));
end
