...
///
/// The system has three output ports (the third added by Tristan), one with the current desired
/// state (q,v) of the iiwa arm, another for the accelerations, and another for the plan status.
///
