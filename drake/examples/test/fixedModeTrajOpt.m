function [p,xtraj,utraj,ltraj,ljltraj,z,F,info,traj_opt] = fixedModeTrajOpt(xtraj,utraj,ltraj,ljltraj)
...
N_vec = [5;10;5];
N = sum(N_vec) + 1;
mode_seq = [true(2,1) false(2,1) true(2,1)];
...
traj_opt = FixedModeImplicitTrajectoryOptimization(p,N_vec,T_span,mode_seq,to_options);
