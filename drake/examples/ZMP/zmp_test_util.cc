...
std::vector<PiecewisePolynomial<double>> GenerateDesiredZMPTrajs(
  ...
  zmp_trajs.reserve(3);
  zmp_trajs.push_back(PiecewisePolynomial<double>::ZeroOrderHold(Ts, zmp_d));
  zmp_trajs.push_back(PiecewisePolynomial<double>::FirstOrderHold(Ts, zmp_d));
  zmp_trajs.push_back(PiecewisePolynomial<double>::Pchip(Ts, zmp_d));
