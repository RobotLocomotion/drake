...
extern const double kJacoLcmStatusPeriod;
...
/// Handles lcmt_jaco_status messages from a LcmSubscriberSystem.  Has
...
/// systems::Value object templated on type `lcmt_jaco_status`. For an example
/// of this, see jaco_wsg_simulation.cc.
