...
int main(int argc, char* argv[]) {
  ...
  const std::string kModelPath = "/manipulation/models/jaco_description/urdf/"
      "j2n6s300.urdf";
  {
  ...
  simulator.set_target_realtime_rate(0.35);
...
int main(int argc, char* argv[]) {
  return drake::examples::kinova_jaco_arm::main(argc, argv);
}
