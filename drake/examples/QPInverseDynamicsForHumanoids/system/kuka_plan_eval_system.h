...
class KukaPlanEvalSystem : public PlanEvalSystem {
 public:
  ...
  std::unique_ptr<systems::AbstractState> AllocateAbstractState() const override;

  void SetDesiredTrajectory(const PiecewisePolynomialTrajectory& traj, systems::State<double>* state);
