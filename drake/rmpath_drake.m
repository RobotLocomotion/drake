...
rmpath(fullfile(root,'solvers_matlab'));
rmpath(fullfile(root,'solvers_matlab','trajectoryOptimization'));
...
rmpath(fullfile(root,'solvers_matlab','BMI'));
rmpath(fullfile(root,'solvers_matlab','BMI','util'));
rmpath(fullfile(root,'solvers_matlab','BMI','kinematics'));
rmpath(fullfile(root,'solvers_matlab','qpSpline'));
