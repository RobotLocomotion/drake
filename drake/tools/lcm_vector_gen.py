...
INDICES_END = """
  ...
  /// vector. In other words, `%(indices)s::GetCoordinateNames()[i]`
  /// is the name for `BasicVector::GetAtIndex(i)`.
  static const std::vector<std::string>& GetCoordinateNames();
};
"""
INDICIES_NAMES_ACCESSOR_IMPL = """
