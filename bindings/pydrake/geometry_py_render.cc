...
void DoScalarIndependentDefinitions(py::module m) {
  ...
  constexpr auto& doc_vtk = pydrake_doc.drake.geometry.render_vtk;
  ...
  {
    using Class = render_vtk::RenderEngineVtkParams;
  ...
  m.def("MakeRenderEngineVtk", &render_vtk::MakeRenderEngineVtk,
      py::arg("params"), doc_vtk.MakeRenderEngineVtk.doc);
