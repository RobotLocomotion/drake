...
void BindMathematicalProgram(py::module m) {
  ...
  prog_cls  // BR
      ...
      .def("AddLogDeterminantLowerConstraint",
          &MathematicalProgram::AddLogDeterminantLowerConstraint, py::arg("X"),
          py::arg("lower"),
          doc.MathematicalProgram.AddLogDeterminantLowerConstraint.doc)
