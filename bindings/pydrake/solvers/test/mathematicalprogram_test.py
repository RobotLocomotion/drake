...
class TestMathematicalProgram(unittest.TestCase):
    ...
    def test_solver_options(self):
        ...
        self.assertEqual(
            prog.GetSolverOptionsDouble(SolverType.kGurobi)["double_key"], 1.0)
        self.assertEqual(len(prog.GetSolverOptionsDouble(SolverType.kOsqp)), 0)

        prog.SetSolverOption(SolverType.kGurobi, "int_key", 2)
        self.assertEqual(
            prog.GetSolverOptionsInt(SolverType.kGurobi)["int_key"], 2)
        self.assertEqual(len(prog.GetSolverOptionsInt(SolverType.kOsqp)), 0)

        prog.SetSolverOption(SolverType.kGurobi, "string_key", "3")
        self.assertEqual(
            prog.GetSolverOptionsStr(SolverType.kGurobi)["string_key"], "3")
        self.assertEqual(len(prog.GetSolverOptionsStr(SolverType.kOsqp)), 0)
