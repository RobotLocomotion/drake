...
class TestAutomotive(unittest.TestCase):
    def test_road_odometry(self):
        ...
        self.assertTrue(road_odom.lane.id().string() == lane_0.id().string())
        ...
        self.assertTrue(road_odom.lane.id().string() == lane_1.id().string())
    ...
    def test_closest_pose(self):
        ...
        self.assertTrue(closest_pose.odometry.lane.id().string() ==
                        lane_0.id().string())
