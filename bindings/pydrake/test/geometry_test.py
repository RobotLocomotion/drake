...
class TestGeometry(unittest.TestCase):
    ...
    def test_drake_visualizer(self):
        ...
        mut.DrakeVisualizer.BroadcastLoad(scene_graph, lcm, params)
        lcm.HandleSubscriptions(0)
        self.assertEqual(load_subscriber.count, 1)
        self.assertEqual(draw_subscriber.count, 0)
        load_subscriber.clear()
        ...
        context = scene_graph.CreateDefaultContext()
        mut.DrakeVisualizer.BroadcastLoad(context, scene_graph, lcm, params)
        lcm.HandleSubscriptions(0)
        self.assertEqual(load_subscriber.count, 1)
        self.assertEqual(draw_subscriber.count, 0)
        load_subscriber.clear()
        ...
        context = scene_graph.CreateDefaultContext()
        mut.DrakeVisualizer.BroadcastDraw(context, scene_graph, lcm, params)
        lcm.HandleSubscriptions(0)
        self.assertEqual(load_subscriber.count, 0)
        self.assertEqual(draw_subscriber.count, 1)
        load_subscriber.clear()
        draw_subscriber.clear()
