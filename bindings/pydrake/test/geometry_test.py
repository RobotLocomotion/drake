...
class TestGeometry(unittest.TestCase):
    ...
    def test_scene_graph_api(self, T):
        ...
        # iterables, as well as non-kwarg usages of functions. In other tests,
        # we will generally test `list` for iterables.
        # TODO(eric.cousineau): Simplify this testing if/when `iterable_t` is
        # separated out / upstreamed.
        frame_set_options = [
            # Frame scalar.
