...
PYBIND11_MODULE(_symbolic_py, m) {
  ...
  py::class_<Variables>(m, "Variables", doc.Variables.doc)
      .def(py::init<>(), doc.Variables.ctor.doc)
  ...
  py::class_<Expression>(m, "Expression")
      ...
      // methods.
      .def("log", &symbolic::log, doc.ExpressionLog.doc)
      .def("__abs__", &symbolic::abs)
      .def("exp", &symbolic::exp, doc.ExpressionExp.doc)
      .def("sqrt", &symbolic::sqrt, doc.ExpressionSqrt.doc)
      // TODO(eric.cousineau): Move `__pow__` here.
      .def("sin", &symbolic::sin, doc.ExpressionSin.doc)
      .def("cos", &symbolic::cos, doc.ExpressionCos.doc)
      .def("tan", &symbolic::tan, doc.ExpressionTan.doc)
      .def("arcsin", &symbolic::asin, doc.ExpressionAsin.doc)
      .def("arccos", &symbolic::acos, doc.ExpressionAcos.doc)
      .def("arctan2", &symbolic::atan2, doc.ExpressionAtan2.doc)
      .def("sinh", &symbolic::sinh, doc.ExpressionSinh.doc)
      .def("cosh", &symbolic::cosh, doc.ExpressionCosh.doc)
      .def("tanh", &symbolic::tanh, doc.ExpressionTanh.doc)
      .def("min", &symbolic::min, doc.ExpressionMin.doc)
      .def("max", &symbolic::max, doc.ExpressionMax.doc)
      .def("ceil", &symbolic::ceil, doc.ExpressionCeiling.doc_2)
      .def("floor", &symbolic::floor, doc.ExpressionFloor.doc);
