...
def _actual_main():
    ...
    # They are probably relative paths, which we'll convert to an absolute root
    # path for the parent of "pydrake" lives, and then a list of relative paths
    # under that. We must use rsplit because we need the _last_ "/pydrake/".
