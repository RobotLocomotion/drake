...
/// Executes Python code to inroduce additional symbols for a given module. For
/// a module with local name `{name}`, the code executed will be
/// `_{name}_extra.py`.
/// @see Issue #9599 for relevant background.
