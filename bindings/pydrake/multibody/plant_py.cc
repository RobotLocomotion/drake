...
#pragma GCC diagnostic pop
  ...
  // ContactResultsToMeshcatSystem
  if constexpr (!std::is_same_v<T, symbolic::Expression>) {
    using Class = ContactResultsToMeshcatSystem<T>;
    constexpr auto& cls_doc = doc.ContactResultsToMeshcatSystem;
    auto cls = DefineTemplateClassWithDefault<Class, systems::LeafSystem<T>>(
        m, "ContactResultsToMeshcatSystem", param, cls_doc.doc);
    cls  // BR
