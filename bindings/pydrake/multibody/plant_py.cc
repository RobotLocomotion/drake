...
PYBIND11_MODULE(plant, m) {
...

  {
    ...
    cls  // BR
        ...
        .def(
            "num_bodies", &Class::num_bodies, cls_doc.num_bodies.doc)
        .def(
            "num_joints", &Class::num_joints, cls_doc.num_joints.doc)
        .def("num_actuators", &Class::num_actuators,
            cls_doc.num_actuators.doc)
        ...
        .def("num_positions",
            ...
            cls_doc.num_positions.doc_1args)
        .def("num_velocities",
    ...
    cls  // BR
        .def(
            "num_frames", &Class::num_frames, cls_doc.num_frames.doc)
    ...
    cls  // BR
        ...
        .def("SetPositionsAndVelocities",
            ...
            py_reference, py::arg("context"), py::arg("model_instance"),
            py::arg("q_v"),
            cls_doc.SetPositionsAndVelocities.doc_3args)
        .def("SetDefaultState",
  ...
  // PointPairContactInfo
  {
    ...
    py::class_<Class>(m, "PointPairContactInfo", cls_doc.doc)
        .def(py::init<BodyIndex, BodyIndex, const Vector3<T>, const Vector3<T>,
            ...
            py::arg("point_pair"), cls_doc.ctor.doc_7args)
  ...
  // ContactResultsToLcmSystem
  {
    ...
    py::class_<Class, systems::LeafSystem<T>>(
        ...
        .def(py::init<const MultibodyPlant<double>&>(), py::arg("plant"),
            ...
            py::keep_alive<1, 2>(), cls_doc.ctor.doc_0argss)
  ...
  m.def("ConnectContactResultsToDrakeVisualizer",
      ...
      doc.ConnectContactResultsToDrakeVisualizer.doc);
