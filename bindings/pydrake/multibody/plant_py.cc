...
#pragma GCC diagnostic pop
  ...
  // Propeller
  {
    ...
    cls  // BR
        .def(py::init<const MultibodyPlant<T>&, const Body<T>&,
                 const math::RigidTransform<double>&, double, double>(),
            py::arg("multibody_plant"), py::arg("body"), py::arg("X_BP"),
            py::arg("thrust_ratio") = 1.0, py::arg("moment_ratio") = 0.0,
            doc.Propeller.ctor.doc_5args)
        ...
        .def("get_geometry_poses_input_port",
            &Class::get_geometry_poses_input_port, py_reference_internal,
            doc.Propeller.get_geometry_poses_input_port.doc)
...
PYBIND11_MODULE(plant, m) {
  ...
  py::class_<PropellerInfo>(m, "PropellerInfo", doc.PropellerInfo.doc)
      .def(py::init<const MultibodyPlant<double>&, const Body<double>&,
               const math::RigidTransform<double>&, double, double>(),
          py::arg("multibody_plant"), py::arg("body"), py::arg("X_BP"),
          py::arg("thrust_ratio") = 1.0, py::arg("moment_ratio") = 0.0,
          doc.PropellerInfo.ctor.doc)
      .def_readwrite("body_index", &PropellerInfo::body_index,
          doc.PropellerInfo.body_index.doc)
      .def_readwrite(
          "frame_id", &PropellerInfo::frame_id, doc.PropellerInfo.frame_id.doc)
