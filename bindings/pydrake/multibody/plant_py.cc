...

  {
    ...
    cls  // BR
        ...
        .def("WeldFrames",
            ...
            py::arg("frame_on_parent"), py::arg("frame_on_child"),
        ...
        .def(
            ...
            [](Class* self, const Frame<T>& A, const Frame<T>& B,
              ...
              WarnDeprecated(
                  ...
                  "frame_on_parent=value1, frame_on_child=value2, X_PC=value3)"
                  " instead. This variant will be removed after 2021-07-01.");
