...
PYBIND11_MODULE(plant, m) {
...

  {
    ...
    cls  // BR
        ...
        .def("bodyB", &Class::bodyA, cls_doc.bodyA.doc)
        .def("p_AP", &Class::p_AP, cls_doc.p_AP.doc)
        .def("p_BQ", &Class::p_BQ, cls_doc.p_BQ.doc)
        .def("distance", &Class::p_BQ, cls_doc.p_BQ.doc)
        .def("stiffness", &Class::p_BQ, cls_doc.p_BQ.doc)
        .def("damping", &Class::p_BQ, cls_doc.p_BQ.doc)
        .def(py::self == py::self);
    DefCopyAndDeepCopy(&cls);
  }
