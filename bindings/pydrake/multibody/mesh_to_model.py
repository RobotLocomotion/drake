...
**Model scale**:
    ...
    Drake uses meters as distance of length. Modelling packages may frequently
...
def _main():
    ...
    parser.add_argument(
        ...
        help=("The path where the SDFormat model will be written. The "
              "directory must already exist and the model file name will "
