...
def _main():
    ...
    parser.add_argument(
        "--scale", action="store", default=1.0, type=float, metavar="FACTOR",
    ...
    mass_group.add_argument(
        "--density", action="store", default=1000, type=float, metavar="KG/M3",
    ...
    com_group.add_argument(
        "--body-origin", nargs=3, type=float, action="store", metavar="COM",
