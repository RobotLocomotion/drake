...
void DefineDeformableBody(py::module m) {
  ...
  cls  // BR
      ...
      .def("CalcCenterOfMassTranslationalVelocityInWorld",
          ...
          py::arg("context"),
          cls_doc.CalcCenterOfMassTranslationalVelocityInWorld.doc)
      .def("CalcEffectiveAngularVelocityForCenterOfMass",
          &Class::CalcEffectiveAngularVelocityForCenterOfMass,
          py::arg("context"),
          cls_doc.CalcEffectiveAngularVelocityForCenterOfMass.doc)
