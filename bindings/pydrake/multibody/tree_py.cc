...
#pragma GCC diagnostic pop
    cls  // BR
        .def("default_damping_vector", &Class::default_damping_vector,
            py_rvp::reference_internal, cls_doc.default_damping_vector.doc)
        ...
        .def("GetDampingVector", &Class::GetDampingVector, py::arg("context"),
            py::keep_alive<0, 1>(), cls_doc.GetDampingVector.doc)
        .def("SetDampingVector", &Class::SetDampingVector, py::arg("context"),
            py::arg("damping"), py::keep_alive<0, 1>(),
            cls_doc.SetDampingVector.doc);
  }
