...
void DoScalarDependentDefinitions(py::module m, T) {
  ...
  // Joints.
  {
    ...
    cls  // BR
        ...
        .def("SetDefaultPose", &Class::SetDefaultPose,
             py::arg("X_FM"), cls_doc.SetDefaultPose.doc)
  ...
  // RpyFloatingJoint
  {
    ...
    cls  // BR
        ...
        .def("SetOrientationFromRotationMatrix",
             &Class::SetOrientationFromRotationMatrix, py::arg("context"),
             py::arg("R_FM"), cls_doc.SetOrientationFromRotationMatrix.doc)
        .def("get_translation", &Class::get_translation, py::arg("context"),
             cls_doc.get_translation.doc)
        .def("set_translation", &Class::set_translation, py::arg("context"),
