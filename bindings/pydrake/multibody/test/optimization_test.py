...
class TestStaticEquilibriumProblem(unittest.TestCase):
    ...
    def test_one_box(self):
        ...
        box_quat, box_xyz = self.split_se3(dut.q_vars())
        dut.get_mutable_prog().AddConstraint(
            quaternion_squared_norm, [1], [1], vars=box_quat)
        ...
        box_quat_sol, box_xyz_sol = self.split_se3(q_sol)
    ...
    def test_two_boxes(self):
        ...
        for i in range(len(boxes)):
            ...
            box_quat, box_xyz = self.split_se3(
