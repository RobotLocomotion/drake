...
class TestPlant(unittest.TestCase):
    ...
    def test_multibody_force_element(self, T):
        ...
        # Test GetForceElement() and get_force_element().
        self.assertIs(plant.GetForceElement(linear_spring_index),
                      linear_spring)
        self.assertIs(plant.GetForceElement(revolute_spring_index),
                      revolute_spring)
        self.assertIs(plant.GetForceElement(door_hinge_index),
                      door_hinge)
        self.assertIs(plant.GetForceElement(bushing_index),
                      bushing)
