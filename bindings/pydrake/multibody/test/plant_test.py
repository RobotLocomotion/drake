...
class TestPlant(unittest.TestCase):
    ...
    def test_constraint_active_status_api(self):
        ...
        self.assertTrue(
            plant.GetConstraintActiveStatus(context, coupler_id))
        self.assertTrue(
            plant.GetConstraintActiveStatus(context, distance_id))
        self.assertTrue(
            plant.GetConstraintActiveStatus(context, ball_id))

        # Set all constraints to inactive.
        plant.SetConstraintActiveStatus(context, coupler_id, False)
        plant.SetConstraintActiveStatus(context, distance_id, False)
        plant.SetConstraintActiveStatus(context, ball_id, False)
        ...
        plant.SetConstraintActiveStatus(context, coupler_id, True)
        plant.SetConstraintActiveStatus(context, distance_id, True)
        plant.SetConstraintActiveStatus(context, ball_id, True)
