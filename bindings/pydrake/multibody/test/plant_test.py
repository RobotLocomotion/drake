...
class TestPlant(unittest.TestCase):
    ...
    def test_constraint_active_status_api(self):
        ...
        self.assertTrue(
            plant.get_constraint_active_status(context, coupler_id))
        self.assertTrue(
            plant.get_constraint_active_status(context, distance_id))
        self.assertTrue(
            plant.get_constraint_active_status(context, ball_id))

        # Set all constraints to inactive.
        plant.set_constraint_active_status(context, coupler_id, False)
        plant.set_constraint_active_status(context, distance_id, False)
        plant.set_constraint_active_status(context, ball_id, False)
        ...
        plant.set_constraint_active_status(context, coupler_id, True)
        plant.set_constraint_active_status(context, distance_id, True)
        plant.set_constraint_active_status(context, ball_id, True)
