...
Still missing:
multiple geometries combined on a link
"""
  ...
  <model name="a">
    <link name="b">
      ...
      <collision name="sphere">
        ...
        self.assertEqual(expected_text, output)
        output = fix_inertia_from_string(input_text, "sdf", invalid_only=True)
        # See above comments about sdformat processing of inertia.  Using
        # deliberately bad input inertia avoids the problem of the sdformat
        # library providing a physically valid (but otherwise arbitrary)
        # default value.
        self.assertEqual(expected_text, output)
...
<robot name="a">
  ...
  <link name="b">
    <inertial>
      <inertia ixx="0.0058222765693962675" ixy="0.00048752762542586536"\
 ixz="-0.002654357987214445" iyy="0.009074353883164021"\
 iyz="-0.001043865245398734" izz="0.00843670288077314"/>
...
<robot name="a">
  ...
  <link name="b">
    <inertial>
      <inertia ixx="0.16333333333333336" ixy="-0.05"\
 ixz="-0.059999999999999984" iyy="0.13833333333333336"\
 iyz="-0.075" izz="0.10666666666666666"/>
      <origin rpy="0.0 0.0 0.0" xyz="0.2 0.25 0.3"/>
      <mass value="1.0"/>
    </inertial>
    <collision name="box1">
      <origin rpy="0.0 0.0 0.0" xyz="0.0 0.0 0.0"/>
