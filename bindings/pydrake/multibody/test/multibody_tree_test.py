...
class TestMultibodyTree(unittest.TestCase):
    ...
    def test_multibody_plant_parsing(self):
        ...
        # functions and inspecting their return type.
        ...
        for dut, file_name, model_name, result_type in (
                ...
                (Parser.AddModelsFromFile, sdf_file, None, list),
                (Parser.AddModelsFromFile, sdf_file, "", list),
                (Parser.AddModelsFromFile, sdf_file, "a", list),
                (Parser.AddModelsFromFile, urdf_file, None, list),
                (Parser.AddModelsFromFile, urdf_file, "", list),
                (Parser.AddModelsFromFile, urdf_file, "a", list),
