...
parameterization. ``parameterization`` is the function itself,
``parameterization_is_threadsafe`` specifies whether or not its threadsafe, and
``parameterization_dimension`` is the input dimension.
