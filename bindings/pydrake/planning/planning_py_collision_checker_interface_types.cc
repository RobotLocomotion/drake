...

  {
    ...
    cls  // BR
        ...
        .def(
            ...
            "Returns a new RobotCollisionType with a possibly-updated value; "
            "the ``self`` object is unchanged. If ``in_environment_collision`` "
            "is given, the environment-collision value will be reset to the "
            "new value. If ``in_self_collision`` is given, the self-collision "
            "value will be reset to the new value.");
  }
}
