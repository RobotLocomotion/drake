...
void DefinePlanningTrajectoryOptimization(py::module m) {
...

  {
    ...
    py::class_<Class::Subgraph>(gcs_traj_opt, "Subgraph", subgraph_doc.doc)
        ...
        .def("Vertices",
            overload_cast_explicit<std::vector<
    ...
    gcs_traj_opt  // BR
        ...
        .def("SolvePathAsConvexRestriction",
            &Class::SolvePathAsConvexRestriction, py::arg("active_vertices"),
            py::arg("options") =
                geometry::optimization::GraphOfConvexSetsOptions(),
            cls_doc.SolvePathAsConvexRestriction.doc)
