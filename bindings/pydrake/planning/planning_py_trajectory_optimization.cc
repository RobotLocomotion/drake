...
void DefinePlanningTrajectoryOptimization(py::module m) {
...

  {
    ...
    py::class_<Class>(m, "KinematicTrajectoryOptimization", cls_doc.doc)
        ...
        .def("placeholder_q_vars", &Class::placeholder_q_vars,
            cls_doc.placeholder_q_vars.doc)
        .def("placeholder_qdot_vars", &Class::placeholder_qdot_vars,
            cls_doc.placeholder_qdot_vars.doc);
  }
