...
void DefinePlanningIrisNp2(py::module m) {
  ...
  iris_np2_options.def(py::init<>())
      ...
      .def_readwrite("add_hyperplane_if_solve_fails", &IrisNp2Options::add_hyperplane_if_solve_fails, cls_doc.add_hyperplane_if_solve_fails.doc)
      .def("__repr__", [](const IrisNp2Options& self) {
        return py::str(
            ...
            ")")
            .format(self.sampled_iris_options, self.add_hyperplane_if_solve_fails);
      });
