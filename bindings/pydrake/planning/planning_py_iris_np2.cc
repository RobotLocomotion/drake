...
void DefinePlanningIrisNp2(py::module m) {
  ...
  // IrisNp2SamplingStrategy
  py::enum_<IrisNp2SamplingStrategy>(m, "IrisNp2SamplingStrategy")
      .value("kGreedySampler", IrisNp2SamplingStrategy::kGreedySampler)
      .value("kRaySampler", IrisNp2SamplingStrategy::kRaySampler);
