...
<robot name="limits">
  ...
  <joint name="movable" type="prismatic">
    ...
    def test_graph_of_convex_sets(self):
        ...
        self.assertIsInstance(binding, Binding[Constraint])
        binding = source.AddConstraintToRelaxation(f=(source.x()[0] <= 1.0))
        self.assertIsInstance(binding, Binding[Constraint])
        binding = source.AddConstraintToRelaxation(binding=binding)
        self.assertIsInstance(binding, Binding[Constraint])
        binding = source.AddConstraintToRounding(f=(source.x()[0] <= 1.0))
        self.assertIsInstance(binding, Binding[Constraint])
        binding = source.AddConstraintToRounding(binding=binding)
        self.assertIsInstance(binding, Binding[Constraint])
        self.assertEqual(len(source.GetConstraints()), 6)
        self.assertEqual(len(source.GetConstraintsFromRelaxation()), 4)
        self.assertEqual(len(source.GetConstraintsFromRounding()), 4)
        ...
        self.assertIsInstance(binding, Binding[Constraint])
        binding = edge0.AddConstraintToRelaxation(
            f=(edge0.xu()[0] == edge0.xv()[0]))
        self.assertIsInstance(binding, Binding[Constraint])
        binding = edge0.AddConstraintToRelaxation(binding=binding)
        self.assertIsInstance(binding, Binding[Constraint])
        binding = edge0.AddConstraintToRounding(
            f=(edge0.xu()[0] == edge0.xv()[0]))
        self.assertIsInstance(binding, Binding[Constraint])
        binding = edge0.AddConstraintToRounding(binding=binding)
        self.assertIsInstance(binding, Binding[Constraint])
        self.assertEqual(len(edge0.GetConstraints()), 6)
        self.assertEqual(len(edge0.GetConstraintsFromRelaxation()), 4)
        self.assertEqual(len(edge0.GetConstraintsFromRounding()), 4)
