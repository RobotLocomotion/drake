...
class TestGeometryOptimization(unittest.TestCase):
    ...
    def test_affine_subspace(self):
        ...
        self.assertEqual(dut.ToLocalCoordinates(test_point_batch).shape,
                         (2, 5))
        self.assertEqual(dut.Project(test_point_batch).shape, (3, 5))
        local_coords_batch = np.zeros((2, 5))
        self.assertEqual(dut.ToGlobalCoordinates(local_coords_batch).shape,
                         (3, 5))
