  ...
  <joint name="movable" type="prismatic">
    ...
    def test_graph_of_convex_sets(self):
        ...
        self.assertEqual(len(source.GetConstraints(
            component=mut.GraphOfConvexSets.ProblemComponent.kBoth)), 2)
        self.assertEqual(len(source.GetConstraints(
            component=mut.GraphOfConvexSets.ProblemComponent.kRelaxation)), 4)
        self.assertEqual(len(source.GetConstraints(
            component=mut.GraphOfConvexSets.ProblemComponent.kRounding)), 4)
