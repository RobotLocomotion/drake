...
class TestGeometryOptimization(unittest.TestCase):
    ...
    def test_h_polyhedron(self):
        ...
        new_vars = hpoly.AddPointInSetConstraints(self.prog, self.x)
    ...
    def test_hyper_ellipsoid(self):
        ...
        new_vars = ellipsoid.AddPointInSetConstraints(self.prog, self.x)
        self.assertEqual(new_vars.size, 0)
    ...
    def test_v_polytope(self):
        ...
        new_vars = vpoly.AddPointInSetConstraints(self.prog, self.x[0:2])
