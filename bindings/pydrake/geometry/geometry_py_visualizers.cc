...
void DoScalarIndependentDefinitions(py::module m) {
  ...
  // Meshcat
  {
    ...
    meshcat  // BR
        ...
        .def("SetTriangleColorMesh",
            py::overload_cast<std::string_view,
                const Eigen::Ref<const Eigen::Matrix3Xd>&,
                const Eigen::Ref<const Eigen::Matrix3Xi>&,
                const Eigen::Ref<const Eigen::Matrix3Xd>&, bool, double,
                Meshcat::SideOfFaceToRender>(&Class::SetTriangleColorMesh),
            py::arg("path"), py::arg("vertices"), py::arg("faces"),
            py::arg("colors"), py::arg("wireframe") = false,
            py::arg("wireframe_line_width") = 1.0,
            py::arg("side") = Meshcat::SideOfFaceToRender::kDoubleSide,
            cls_doc.SetTriangleColorMesh.doc_no_recording)
        .def("SetTriangleColorMesh",
            py::overload_cast<std::string_view,
                const Eigen::Ref<const Eigen::Matrix3Xd>&,
                const Eigen::Ref<const Eigen::Matrix3Xi>&,
                const Eigen::Ref<const Eigen::Matrix3Xd>&, double, bool, double,
                Meshcat::SideOfFaceToRender>(&Class::SetTriangleColorMesh),
            py::arg("path"), py::arg("vertices"), py::arg("faces"),
            py::arg("colors"), py::arg("time_in_recording"),
            py::arg("wireframe") = false, py::arg("wireframe_line_width") = 1.0,
            py::arg("side") = Meshcat::SideOfFaceToRender::kDoubleSide,
            cls_doc.SetTriangleColorMesh.doc_for_recording)
