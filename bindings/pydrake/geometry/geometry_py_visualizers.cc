...
void DefineDrakeVisualizer(py::module m, T) {
  py::tuple param = GetPyParam<T>();
  {
    ...
    // For AddToBuilder operations, using builder_life_support_stash makes the
    // builder temporarily immortal (uncollectible self cycle). This will be
    // resolved by the Build() step. See BuilderLifeSupport for rationale.
