...
_HAS_CV2 = "darwin" not in sys.platform
...
class TestColorizeDepthImage(unittest.TestCase):
    ...
    def test_smoke(self):
        ...
        # The closest pixel is white; the furthest pixel is black.
...
class TestVideoWriter(unittest.TestCase):
    ...
    @staticmethod
    def _cv2():
        """On macOS, we don't have OpenCV as a dependency so we can't import it
        atop this file as would be usual.
        """
        if _HAS_CV2:
            import cv2
            return cv2
    ...
    @unittest.skipUnless(_HAS_CV2, "Not tested on macOS")
