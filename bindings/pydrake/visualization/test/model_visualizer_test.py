...
class TestModelVisualizer(unittest.TestCase):
    ...
    def test_model_in_buffer(self):
        ...
        Also tests getters, adding a stop button, and re-using a Meshcat
        instance. (The stop button is not virtually clicked, however.)
        """
        ...
        dut.Run(loop_once=True, add_stop_button=True)
