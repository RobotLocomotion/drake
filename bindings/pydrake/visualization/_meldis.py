...
class Meldis:
    ...
    def __init__(self, *,
                 meshcat_host: typing.Optional[str] = None,
                 meshcat_port: typing.Optional[int] = None,
                 meshcat_params: typing.Optional[MeshcatParams] = None,
                 environment_map: typing.Optional[Path] = None):
        """Constructs a new Meldis instance.
        The meshcat_host (when given) takes precence over meshcat_params.host.
        The meshcat_post (when given) takes precence over meshcat_params.port.
        """
