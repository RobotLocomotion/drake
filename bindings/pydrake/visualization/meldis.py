...
def _main():
    ...
    parser.add_argument(
        ...
        help="When opening the MeshCat display, try to use the given browser. "
        "When not provided, uses the $BROWSER environment variable instead. "
        f"(Available names: {_available_browsers()})")
    parser.add_argument(
