...
class Meldis(_Meldis):
    """(Deprecated.) The import path pydrake.visualiation.meldis.Meldis is
    deprecated. Use the import path pydrake.visualiation.Meldis instead.
    The deprecated code will be removed from Drake on or after 2023-02-01.
    """

    def __init__(self, **kwargs):
        message = (
            "The import path pydrake.visualiation.meldis.Meldis is deprecated."
            " Use the shorter import path pydrake.visualiation.Meldis instead."
        )
