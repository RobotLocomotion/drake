...
- [`drake/bindings/.../deprecation_example_test.py`](https://github.com/RobotLocomotion/drake/blob/master/bindings/pydrake/common/test/deprecation_example_test.py)
