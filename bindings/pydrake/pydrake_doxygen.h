...
- "Keep alive, ownership" implies that a Patient owns the Nurse.
...
object(s) (Nurses) from one container to a new container (Patient) (e.g.
transferring all `System`s from `DiagramBuilder` to `Diagram` when calling
