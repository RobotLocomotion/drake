...
- Docstring are stored in files named after the subdirectory where the original
C++ header file lives, e.g., `multibody_tree.h` for `drake/multibody/tree` docs.
- The constants in the nested structure `pydrake_doc_{directory_names}`, e.g.,
`pydrake_doc_multibody_tree` for `drake/multibody/tree` docs.
