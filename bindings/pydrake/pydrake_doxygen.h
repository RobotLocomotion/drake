...
For this reason, only bind `const` methods when there is *not* an identical
mutable overload (e.g. same name and same arguments).
...
// DO NOT BIND: Identical to above mutable overload, may constrain user. Do not
// bind!
void MyFunction(const MyClass& value);

// Dismabiguating an accessor solely based on `const`-ness of `this`. In
