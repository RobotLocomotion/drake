...
def run_pendulum_example(args, playback=False):
...
def run_manipulation_example(args, playback=False):
    builder = DiagramBuilder()
...
def main():
    ...
    for model in args.models:
        if model == "pend":
            run_pendulum_example(args, args.playback)
        elif model == "manip":
            run_manipulation_example(args, args.playback)
        else:
