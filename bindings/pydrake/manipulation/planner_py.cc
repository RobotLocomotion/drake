...

  {
    ...
    cls
        ...
        .def_readwrite("joint_velocities", &Class::joint_velocities,
            doc.DifferentialInverseKinematicsResult.joint_velocities.doc)
        .def_readwrite("status", &Class::status,
            doc.DifferentialInverseKinematicsResult.status.doc);
  }
  {
    using Class =
