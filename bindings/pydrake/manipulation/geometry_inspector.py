...
position_group.add_argument("--position",
                            type=float,
                            nargs="+",
                            help="A list of positions which must be the same "
                                 "length as the number of positions in the "
                                 "sdf model.  Note that most models have a "
                                 "floating-base joint by default (unless the "
                                 "sdf explicitly welds the base to the world, "
                                 "and so have 7 positions corresponding to "
                                 "the quaternion representation of that "
                                 "floating-base position.",
                            default=[])
position_group.add_argument("--joint_position",
                            type=float,
                            nargs="+",
                            help="A list of positions which must be the same "
                                 "length as the number of positions "
                                 "ASSOCIATED WITH JOINTS in the sdf model.  "
                                 "This does not include, e.g., floating-base "
                                 "coordinates, which will be assigned a "
                                 "default value.",
                            default=[])
