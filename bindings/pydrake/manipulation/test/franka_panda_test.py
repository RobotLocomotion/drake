...
from pydrake.lcmt_panda_command import lcmt_panda_command
from pydrake.lcmt_panda_status import lcmt_panda_status
...
class TestFrankaPanda(unittest.TestCase):
    ...
    def test_franka_panda_command_receiver(self):
        ...
        control_mode = (lcmt_panda_status.CONTROL_MODE_POSITION |
                        lcmt_panda_status.CONTROL_MODE_TORQUE)
        ...
        control_mode_all = (lcmt_panda_status.CONTROL_MODE_POSITION |
                            lcmt_panda_status.CONTROL_MODE_VELOCITY |
                            lcmt_panda_status.CONTROL_MODE_TORQUE)
