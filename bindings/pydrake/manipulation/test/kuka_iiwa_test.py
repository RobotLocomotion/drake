...
class TestKukaIiwa(unittest.TestCase):
    ...
    def test_schunk_wsg_build_control(self):
        ...
        plant.Finalize()
        ctrl_plant = MultibodyPlant(1.)
        parser = Parser(ctrl_plant)
        parser.AddModelFromFile(FindResourceOrThrow(
            "drake/manipulation/models/iiwa_description/iiwa7/"
            "iiwa7_no_collision.sdf"))
        ctrl_plant.WeldFrames(ctrl_plant.world_frame(),
                              ctrl_plant.GetFrameByName("iiwa_link_0"),
                              RigidTransform())
        ctrl_plant.Finalize()
        ...
        mut.BuildIiwaControl(
            ...
            controller_plant=ctrl_plant, lcm=DrakeLcm(), builder=builder,
    ...
    def test_kuka_iiwa_driver(self):
        ...
        mut.ApplyDriverConfig(
            ...
            sim_plant=plant, models_from_directives=model_dict, lcm=lcm_bus,
            builder=builder)
