...
// makes it misnomer: SE(3) ⊂ Isometry(3) b/c Isometry admits reflection
// Additionally, do not validate for Quatnerion, b/c it will break parity with
// C++ and cause odd edge cases when attempting to do projections from non-unit
// quaternions to unit quaternions.
