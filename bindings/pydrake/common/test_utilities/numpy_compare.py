...
# To simplify test dependencies, do not require AutoDiffXd to be available as a
# module.
try:
    _register_autodiff()
except ImportError:
...
# To simplify test dependencies, do not require Expression to be available as a
# module.
try:
    _register_sym()
except ImportError:
