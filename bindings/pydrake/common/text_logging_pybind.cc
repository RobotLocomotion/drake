...
void RedirectPythonLogging() {
  ...
  // text_logging.cc configures itself by default. If the spdlog configuration
  // we observe here differs in any way, then we'll assume that a user has
  // configured spdlog to their taste already and we won't change anything.
