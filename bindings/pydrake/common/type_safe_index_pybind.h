...
auto BindTypeSafeIndex(
  ...
  cls  // BR
      .def(py::init<>(), pydrake_doc_common.drake.TypeSafeIndex.ctor.doc_0args)
      .def(py::init<int>(),
          pydrake_doc_common.drake.TypeSafeIndex.ctor.doc_1args_index)
      ...
      .def("is_valid", &Class::is_valid,
          pydrake_doc_common.drake.TypeSafeIndex.is_valid.doc)
