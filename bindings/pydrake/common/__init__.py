...
# to lift it up to the common module directly.)
#
...
# such as Mypy.)
#
# See _pretty_tparam() below for a demangling function to help display the
...
def _pretty_tparam(cls: type, *, use_qualname: bool = False) -> str:
