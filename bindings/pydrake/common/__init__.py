...
class _MangledName:
    ...
    prefer to use the pretty name, but in cases where we must use an identifer
    ...
    def module_getattr(*, module_name: str,
        ...
        Either way, it's looked up in the module_globals. Unknown names are
        reported with AttributeError.

        This function is intended to help implement __getattr__ on a module
        for backwards-compatibility with unpickling, i.e.,
