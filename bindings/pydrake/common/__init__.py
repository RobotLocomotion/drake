...
def _monkey_patch_logger_level_events():
    ...
    # Drake'd own logger. Therefore, hooking that notification to sync the
    # C++ logging level is suffucient to cover all cases.
    #
    # This relies on the implementation details of CPython logging, but since
    # all of pydrake is native code that only supports CPyhon and we must
