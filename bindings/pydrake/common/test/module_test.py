...
class TestCommon(unittest.TestCase):
    ...
    def test_sha256(self):
        ...
        assert_pickle(self, not_empty, lambda sha: [not_empty.to_string()])
    ...
    def test_memory_file(self):
        ...
        assert_pickle(self, file,
                      lambda file: [file.contents(), file.extension(),
                                    file.sha256(), file.filename_hint()])
