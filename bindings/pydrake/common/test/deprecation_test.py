...
class TestDeprecationEnv(unittest.TestCase):
    ...
    def test_invalid_deprecation_env(self):
        ...
        self.assertEqual(
            ...
            " value 'bad_value'; treating as \"default\".",
        )
    ...
    def test_deprecation_as_errors(self):
        ...
        cases = {
            example.ExampleClass.message_method: lambda: obj.deprecated_method(),
        ...
        for message, action in cases.items():
            with self.assertRaises(mut.DrakeDeprecationWarning) as exception_context:
                action()
