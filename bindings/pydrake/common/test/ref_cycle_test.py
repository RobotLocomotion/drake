...
def actual_ref_count(o):
    ...
    # machinery of python function calls involved. Since we wrap it here, we
    # have to adjust the result even more.
    return sys.getrefcount(o) - 3


# Sanity check: An unnamed object, constructed in the argument list, has a
# count of 0 in the caller's scope.
assert actual_ref_count(object()) == 0
