...
void DoScalarIndependentDefinitions(py::module m) {
  ...
  // Meshcat
  {
    ...
    cls  // BR
        ...
        .def("set_web_url", &Class::set_web_url, cls_doc.set_web_url.doc)
        ...
        .def("DeleteAllButtonsAndSliders", &Class::DeleteAllButtonsAndSliders, cls_doc.DeleteAllButtonsAndSliders.doc);
