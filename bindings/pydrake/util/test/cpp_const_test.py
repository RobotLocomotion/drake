...
class TestCppConst(unittest.TestCase):
    ...
    def test_list(self):
        ...
        for i in x_const:
            self.assertFalse(cpp_const.is_const(i))
        self.assertFalse(cpp_const.is_const(x_const[3]))
    ...
    def test_dict(self):
        ...
        self.assertFalse(cpp_const.is_const(d_const["z"]))
    ...
    def test_basic(self):
        ...
        # N.B. Access does not implicitly propagate.
        self.assertFalse(cpp_const.is_const(obj_const.value))
    ...
    def test_advanced(self):
        ...
        obj.add("z", [10])
        obj_const = cpp_const.to_const(obj)
        self.assertTrue(cpp_const.is_const(obj_const.get_values()))
        ...
        # N.B. Access does not implicitly propagate.
        self.assertFalse(cpp_const.is_const(obj_const.get("z")))
        self.assertFalse(cpp_const.is_const(obj_const.__dict__["_values"]))
