...
#pragma GCC diagnostic pop
    ...
    DefineTemplateClassWithDefault<DiagramBuilder<T>>(
        ...
        .def("ConnectInput",
            ...
            py::arg("port_name"), py::arg("input"),
            doc.DiagramBuilder.ConnectInput.doc_2args_port_name_input)
        .def("ConnectInput",
            py::overload_cast<InputPortIndex, const InputPort<T>&>(
                &DiagramBuilder<T>::ConnectInput),
            py::arg("port_index"), py::arg("input"),
            doc.DiagramBuilder.ConnectInput.doc_2args_port_index_input)
