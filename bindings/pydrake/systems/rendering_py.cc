...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
      .def(
          "get_isometry",
          [](const PoseVector<T>* self) {
            WarnDeprecated(
                "Use transform() instead of get_isometry(). Support will be "
                "removed after 2020-09-01.");
            return self->get_isometry();
          },
          doc_iso3_deprecation)
#pragma GCC diagnostic pop
      .def("transform", &PoseVector<T>::transform, doc.PoseVector.transform.doc)
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
      .def(
          "get_pose",
          [](const PoseBundle<T>* self, int index) {
            WarnDeprecated(
                "Use transform() instead of get_pose(). Support will be "
                "removed after 2020-09-01.");
      ...
      .def(
          "set_pose",
          [](PoseBundle<T>* self, int index, const Isometry3<T>& pose) {
            WarnDeprecated(
                "Use set_set_transform() instead of set_pose(). Support will "
                "be removed after 2020-09-01.");
            return self->set_pose(index, pose);
          },
          doc_iso3_deprecation)
#pragma GCC diagnostic pop
      .def("transform", &PoseBundle<T>::transform, doc.PoseBundle.transform.doc)
