...
def _convert_mesh(geom, element_local_tf):
    # Given a LCM geometry message and its current local tf, forms a meshcat
    # geometry + material pair for that geometry, and returns an updated
    # local tf so that the meshcat geometry matches the LCM geometry.
    ...
    meshcat_geom = None
    material = None
    element_local_tf = element_local_tf.copy()
