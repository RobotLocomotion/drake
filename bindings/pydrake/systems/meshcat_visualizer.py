...
Note:
    This is an optional module, dependent on `meshcat-python` being
    installed.  Please use the instructions in the Readme.rst at
...
class MeshcatVisualizer(LeafSystem):
    ...
    port of a SceneGraph and visualizes the scene at every time step in

    This client expects that you have *already* started a `meshcat-server` in
    another terminal.  The visualization will be available at the web url
    ...
    def __init__(self,
        ...
        """
        @param scene_graph: A SceneGraph object.
        @param draw_period: The rate at which this class publishes to the
                            visualizer.
        @param prefix:      Appears as the root of the tree structure in the
                            meshcat data structure
        @param zmq_url:     Optionally set a non-default url to connect to
                            the visualizer.
        """
