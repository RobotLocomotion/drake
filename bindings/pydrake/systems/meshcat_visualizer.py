...
class MeshcatVisualizer(LeafSystem):
    ...
    def load(self, context=None):
        ...
        Precondition:
            ...
            constructor must a valid SceneGraph that is part of a fully
            constructed diagram (e.g. via ``DiagramBuilder.Build()``).
        """
        ...
        if context and self.get_geometry_query_input_port().HasValue(context):
            ...
            raise RuntimeError(
                ...
                "in the constructor must a valid SceneGraph that is part of a "
                "fully constructed diagram.")
    ...
    def DoPublish(self, context, event):
        ...
        if (not self._warned_pose_bundle_input_port_connected
            ...
            warnings.warn(
                "The pose_bundle input port is deprecated and will be removed "
                "on or after 2021-02-01.  Use e.g.\n"
                "builder.Connect("
...
def ConnectMeshcatVisualizer(builder, scene_graph=None, output_port=None,
    ...
    diagram, and wires the scene_graph query output port to the input
    ...
    Args:
        ...
        output_port: (optional) If not None, then output_port will be connected
            ...
            the SceneGraph is inside a Diagram, and we must connect the exposed
            port to the visualizer instead of the original SceneGraph port.
