...
void DefineSensorsRgbd(py::module m) {
...

  {
    ...
    rgbd_sensor_async
        ...
        .def("default_fps", &Class::default_fps, py_rvp::reference_internal,
            cls_doc.default_fps.doc)
        .def("set_default_fps", &Class::set_default_fps, py::arg("fps"),
            cls_doc.set_default_fps.doc)
        .def("GetFps", &Class::GetFps, py::arg("context"),
            py_rvp::reference_internal, cls_doc.GetFps.doc)
        .def("SetFps", &Class::SetFps, py::arg("context"), py::arg("fps"),
            cls_doc.SetFps.doc)
        .def("default_capture_offset", &Class::default_capture_offset,
            py_rvp::reference_internal, cls_doc.default_capture_offset.doc)
        .def("set_default_capture_offset", &Class::set_default_capture_offset,
            py::arg("capture_offset"), cls_doc.set_default_capture_offset.doc)
        .def("GetCaptureOffset", &Class::GetCaptureOffset, py::arg("context"),
            py_rvp::reference_internal, cls_doc.GetCaptureOffset.doc)
        .def("SetCaptureOffset", &Class::SetCaptureOffset, py::arg("context"),
            py::arg("capture_offset"), cls_doc.SetCaptureOffset.doc)
        .def("default_output_delay", &Class::default_output_delay,
            py_rvp::reference_internal, cls_doc.default_output_delay.doc)
        .def("set_default_output_delay", &Class::set_default_output_delay,
            py::arg("output_delay"), cls_doc.set_default_output_delay.doc)
        .def("GetOutputDelay", &Class::GetOutputDelay, py::arg("context"),
            py_rvp::reference_internal, cls_doc.GetOutputDelay.doc)
        .def("SetOutputDelay", &Class::SetOutputDelay, py::arg("context"),
            py::arg("output_delay"), cls_doc.SetOutputDelay.doc)
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
    rgbd_sensor_async  // BR
        ...
        .def("fps", WrapDeprecated(cls_doc.fps.doc_deprecated, &Class::fps),
            cls_doc.fps.doc_deprecated)
        .def("capture_offset",
            WrapDeprecated(
                cls_doc.capture_offset.doc_deprecated, &Class::capture_offset),
            cls_doc.capture_offset.doc_deprecated)
        .def("output_delay",
            WrapDeprecated(
                cls_doc.output_delay.doc_deprecated, &Class::output_delay),
            cls_doc.output_delay.doc_deprecated)
        .def("color_camera",
            WrapDeprecated(
