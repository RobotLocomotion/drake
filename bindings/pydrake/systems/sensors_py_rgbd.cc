...
void DefineSensorsRgbd(py::module m) {
  ...
  rgbd_sensor
      ...
      .def("default_color_render_camera",
          &RgbdSensor::default_color_render_camera,
          doc.RgbdSensor.default_color_render_camera.doc)
      .def("GetColorRenderCamera", &RgbdSensor::GetColorRenderCamera,
          py::arg("context"), doc.RgbdSensor.GetColorRenderCamera.doc)
      .def("set_default_color_render_camera",
          &RgbdSensor::set_default_color_render_camera, py::arg("id"),
      ...
      .def("default_depth_render_camera",
          &RgbdSensor::default_depth_render_camera,
          doc.RgbdSensor.default_depth_render_camera.doc)
      .def("GetDepthRenderCamera", &RgbdSensor::GetDepthRenderCamera,
          py::arg("context"), doc.RgbdSensor.GetDepthRenderCamera.doc)
      .def("set_default_depth_render_camera",
          &RgbdSensor::set_default_depth_render_camera, py::arg("id"),
      ...
      .def("default_X_PB", &RgbdSensor::default_X_PB,
          doc.RgbdSensor.default_X_PB.doc)
      .def("default_X_BC", &RgbdSensor::default_X_BC,
          doc.RgbdSensor.default_X_BC.doc)
      .def("default_X_BD", &RgbdSensor::default_X_BD,
          doc.RgbdSensor.default_X_BD.doc)
      .def("GetX_PB", &RgbdSensor::GetX_PB, py::arg("context"),
          doc.RgbdSensor.GetX_PB.doc)
      .def("set_default_X_PB", &RgbdSensor::set_default_X_PB, py::arg("id"),
          doc.RgbdSensor.set_default_X_PB.doc)
