...
// Construct a publish event for bound Declare*Event methods.
...
// Construct a DiscreteUpdate event for bound Declare*Event methods.
// @param trigger_type the trigger type.
...
// Construct a UnrestrictedUpdate event for bound Declare*Event methods.
// @param trigger_type the trigger type.
