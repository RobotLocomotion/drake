...
PYBIND11_MODULE(primitives, m) {
  ...
  py::enum_<IntegrationMethod>(
      m, "IntegrationMethod", doc.IntegrationMethod.doc)
      .value("kExplicitEuler", IntegrationMethod::kExplicitEuler,
          doc.IntegrationMethod.kExplicitEuler.doc);
  ...
  auto bind_common_scalar_types = [&m, &doc](auto dummy) {
    ...
    DefineTemplateClassWithDefault<DiscreteTimeIntegrator<T>, LeafSystem<T>>(m,
        ...
        .def(py::init<int, double, IntegrationMethod>(), py::arg("size"),
            py::arg("time_step"),
            py::arg("method") = IntegrationMethod::kExplicitEuler,
        ...
        .def("integration_method",
            &DiscreteTimeIntegrator<T>::integration_method,
            doc.DiscreteTimeIntegrator.integration_method.doc)
