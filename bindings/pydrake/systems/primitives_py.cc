  ...
  auto bind_common_scalar_types = [&m, &doc](auto dummy) {
    ...
    DefineTemplateClassWithDefault<ZeroOrderHold<T>, LeafSystem<T>>(
        ...
        .def(py::init<double, int>(), py::arg("period_sec"),
            py::arg("vector_size"), py::arg("initialize") = false,
            doc.ZeroOrderHold.ctor.doc_3args_period_sec_vector_size_initialize)
        .def(py::init<double, const AbstractValue&>(), py::arg("period_sec"),
            py::arg("abstract_model_value"), py::arg("initialize") = false,
            doc.ZeroOrderHold.ctor
                .doc_2args_period_sec_abstract_model_value_initialize);
  };
