...
PYBIND11_MODULE(analysis, m) {
...

  {
    constexpr auto& cls_doc =
        pydrake_doc_systems_analysis.drake.systems.InitializeParams;
...
Parameter ``interruptible``:
    ...
    m  // BR
        .def("ApplySimulatorConfig",
            ...
            pydrake_doc_systems_analysis.drake.systems.ApplySimulatorConfig
                .doc_config_sim)
        .def("ExtractSimulatorConfig", &ExtractSimulatorConfig<T>,
            py::arg("simulator"),
            pydrake_doc_systems_analysis.drake.systems.ExtractSimulatorConfig
                .doc);
  };
  ...
  m  // BR
      .def(
          ...
          py::keep_alive<0, 1>(),
          pydrake_doc_systems_analysis.drake.systems.ResetIntegratorFromFlags
              .doc)
      .def(
          "ResetIntegratorFromFlags",
      ...
      .def("GetIntegrationSchemes", &GetIntegrationSchemes,
          pydrake_doc_systems_analysis.drake.systems.GetIntegrationSchemes.doc);

  // Print Simulator Statistics
  m  // BR
      .def("PrintSimulatorStatistics", &PrintSimulatorStatistics<double>,
          pydrake_doc_systems_analysis.drake.systems.PrintSimulatorStatistics
              .doc)
