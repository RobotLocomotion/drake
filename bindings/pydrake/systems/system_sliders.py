...
class SystemSliders(VectorSystem):
    """
    Provides a set of tcl/tk-based sliders to intended to control the values
    ...
    def __init__(self, port_size, slider_names=None,
        ...
        Args:
            ...
            update_period_sec: Specifies how often the window update() method
                         gets called. Smaller values with theoretically make
                         GUI values available to the simulation more quickly,
                         but may require the simulation to take. The default
                         value of 0.005 is suitable for most applications.
