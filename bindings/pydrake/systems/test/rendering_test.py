...
class TestRendering(unittest.TestCase):
    def test_pose_vector(self):
        ...
        self.assertTrue(isinstance(value.transform(), RigidTransform))
        ...
        self.assertTrue(np.allclose(
            value.transform().GetAsMatrix4(), np.eye(4, 4)))
        # - Mutators.
        p = [0, 1, 2]
        ...
        self.assertTrue(np.allclose(
            value.transform().GetAsMatrix4(), X_expected.GetAsMatrix4()))
        ...
        self.assertTrue(np.allclose(
            value1.transform().GetAsMatrix4(), X_expected.GetAsMatrix4()))
        ...
        self.assertTrue(np.allclose(
            value.transform().GetAsMatrix4(), X2_expected.GetAsMatrix4()))
    ...
    def test_pose_bundle(self):
        ...
        self.assertTrue(isinstance(bundle.transform(0), RigidTransform))
        ...
        self.assertTrue((bundle.transform(kIndex).GetAsMatrix34()
