...
class TestSensors(unittest.TestCase):
    ...
    def test_rgbd_sensor(self):
        ...
        sensor.SetX_PB(context=sensor.CreateDefaultContext(),
                       X_PB=RigidTransform(p=[1, 2, 3]))
        self.assertIsInstance(
            sensor.X_PB(context=sensor.CreateDefaultContext()), RigidTransform)
    ...
    def test_rgbd_sensor_async(self):
        ...
        dut.SetX_PB(context=dut.CreateDefaultContext(),
                    X_PB=RigidTransform(p=[1, 2, 3]))
        self.assertIsInstance(
            dut.X_PB(context=dut.CreateDefaultContext()), RigidTransform)
