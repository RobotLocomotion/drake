...
class TestSensors(unittest.TestCase):
    ...
    def test_rgbd_sensor_async(self):
        ...
        self.assertIsInstance(dut.default_fps(), float)
        self.assertIsInstance(dut.default_capture_offset(), float)
        self.assertIsInstance(dut.default_output_delay(), float)
        ...
        dut.set_default_fps(fps=10.0)
        dut.set_default_capture_offset(capture_offset=10.0)
        dut.set_default_output_delay(output_delay=10.0)
        ...
        self.assertIsInstance(dut.GetFps(context=context), float)
        dut.SetFps(context=context, fps=22.0)
        self.assertIsInstance(dut.GetCaptureOffset(context=context), float)
        dut.SetCaptureOffset(context=context, capture_offset=22.0)
        self.assertIsInstance(dut.GetOutputDelay(context=context), float)
        dut.SetOutputDelay(context=context, output_delay=22.0)
