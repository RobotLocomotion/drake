...
class TestGeneral(unittest.TestCase):
    ...
    def test_bus_creator(self, T):
        ...
        self.assertIsInstance(output.Find("vec").get_value(), BasicVector_[T])
        self.assertIsInstance(output.Find("u1").get_value(), BasicVector_[T])
        self.assertIsInstance(output.Find("abst").get_value(), str)
        self.assertIsInstance(output.Find("u3").get_value(), tuple)
