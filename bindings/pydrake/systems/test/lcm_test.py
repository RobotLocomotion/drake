...
class TestSystemsLcm(unittest.TestCase):
    ...
    def _cpp_value_and_converter(self):
        # Setup C++ serializer.
        ...
        return model_message, model_value, cpp_to_lcm

    def test_serializer_cpp(self):
        # Tests relevant portions of API.
        model_message, model_value, cpp_to_lcm = (
            self._cpp_value_and_converter())
        self.assert_lcm_equal(cpp_to_lcm(model_value), model_message)
    ...
    def test_subscriber_cpp(self):
        ...
        model_message, _, cpp_to_lcm = self._cpp_value_and_converter()
        lcm.InduceSubscriberCallback(
            channel="TEST_CHANNEL", buffer=model_message.encode())
        actual_message = cpp_to_lcm(self._calc_output(dut))
        self.assert_lcm_equal(actual_message, model_message)
