...
/* The PixelTypeList defines subset of enumerated PixelType values will be bound
in pydrake. If you change this, you'll also need to change `pixel_type_names`
list within the DefineSensorsImage() function. */
