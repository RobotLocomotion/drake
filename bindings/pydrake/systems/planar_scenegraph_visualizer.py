...
class PlanarSceneGraphVisualizer(PyPlotVisualizer):
    ...
    def __init__(self,
        ...
        # SceneGraph once its output port has been updated. See:
        # https://github.com/RobotLocomotion/drake/issues/12214.
        ...
        for frame_i in range(pose_bundle.get_num_poses()):
            ...
            for i, patch in enumerate(view_patches):
                ...
                patch_proj = np.pad(
                    ...
                    mode="edge")
                body_fill.get_path().vertices[:, :] = np.transpose(patch_proj)
