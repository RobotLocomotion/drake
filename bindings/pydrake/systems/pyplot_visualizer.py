...
class PyPlotVisualizer(LeafSystem):
    ...
    Subclasses must:
    - During initialization, set up the figure bounds and register and input
    port with the appropriate message type.
    - Override the draw method to parse the input and draw the robot in the
    appropriate state.
    """

    def __init__(self, draw_timestep=1./30, facecolor=[1, 1, 1],
    ...
    def draw(self, context):
        """Returns a list of updated artists if blitting is used."""
    ...
    def animate(self, log, resample=True, repeat=False):
        ...
        Args:
            ...
            resample: Whether we should do a resampling operation to make the
                ...
                know the draw_timestep passed into the constructor exactly
