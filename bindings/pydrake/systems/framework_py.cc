...
PYBIND11_MODULE(framework, m) {
  ...
  // TODO(eric.cousineau): Determine what the use case is for non-owned
  // AbstractValues. Seems like a potentially confusing asymmetry right now
  // w.r.t. the rest of the code base? I'd prefer not to try and mess with that
  // logic in Python.
