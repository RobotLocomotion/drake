...
proximity properties ``G = D ⋃ A = {g₀, g₁, ..., gₙ}``, where D is the
set of dynamic geometries and A is the set of anchored geometries (by
definition ``D ⋂ A = ∅``). Many proximity queries operate on pairs of
