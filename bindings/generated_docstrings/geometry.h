...
size of the box is given by three sizes.)""";
        ...
        struct /* ctor */ {
          // Source: drake/geometry/shape_specification.h:162
...
Raises:
    ...
    positive.)""";
          // Source: drake/geometry/shape_specification.h:167
          const char* doc_1args =
...
R"""(Returns the box's dimension along the x axis.)""";
      ...
      struct /* CalcVolume */ {
        // Source: drake/geometry/shape_specification.h:785
        const char* doc =
...
the length of the cylinder parallel with the frame's z-axis.)""";
        ...
        struct /* ctor */ {
          // Source: drake/geometry/shape_specification.h:379
          const char* doc_2args =
...
Raises:
    RuntimeError if ``radius`` or ``length`` are not strictly
    positive.)""";
          // Source: drake/geometry/shape_specification.h:383
          const char* doc_1args =
...
Raises:
    RuntimeError if the measures are not strictly positive.)""";
        ...
        struct /* length */ {
          // Source: drake/geometry/shape_specification.h:388
          const char* doc = R"""()""";
        } length;
...
``double`` scalar type.)""";
      ...
      struct /* Ellipsoid */ {
        // Source: drake/geometry/shape_specification.h:410
        const char* doc =
...
ellipsoid. The bounding box of the ellipsoid is [-a,a]x[-b,b]x[-c,c].)""";
        ...
        struct /* ctor */ {
          // Source: drake/geometry/shape_specification.h:419
          const char* doc_3args =
...
Raises:
    RuntimeError if ``a``, `b`, or ``c`` are not strictly positive.)""";
          // Source: drake/geometry/shape_specification.h:425
          const char* doc_1args =
...
Raises:
    RuntimeError if the measures are not strictly positive.)""";
        ...
        struct /* b */ {
          // Source: drake/geometry/shape_specification.h:430
          const char* doc = R"""()""";
        } b;
        // Symbol: drake::geometry::Ellipsoid::c
        struct /* c */ {
          // Source: drake/geometry/shape_specification.h:431
          const char* doc = R"""()""";
        } c;
      } Ellipsoid;
...
that lies on the side of the plane opposite the normal.)""";
        ...
        struct /* ctor */ {
          // Source: drake/geometry/shape_specification.h:451
          const char* doc = R"""()""";
        } ctor;
        // Symbol: drake::geometry::HalfSpace::MakePose
        struct /* MakePose */ {
          // Source: drake/geometry/shape_specification.h:471
          const char* doc =
...
"phong" material using only the given ``diffuse`` color.)""";
      ...
      struct /* Mesh */ {
        // Source: drake/geometry/shape_specification.h:527
        const char* doc =
...
vertex index list ``[0 1 2 3]`` to ``[2 1 0 3]``).)""";
        ...
        struct /* GetConvexHull */ {
          // Source: drake/geometry/shape_specification.h:611
          const char* doc =
R"""(Reports the convex hull of the named mesh.
...
Raises:
    ...
    considered degenerate.)""";
        ...
        struct /* ctor */ {
          // Source: drake/geometry/shape_specification.h:548
          const char* doc_2args_filename_scale =
...
Raises:
    ...
    8 orders of magnitude should be plenty without considering
    revisiting the model itself.)""";
          // Source: drake/geometry/shape_specification.h:551
          const char* doc_2args_filename_scale3 =
R"""(Mesh-file variant that allows for specification of non-uniform scale.)""";
          // Source: drake/geometry/shape_specification.h:564
          const char* doc_2args_mesh_data_scale =
...
Parameter ``scale``:
    An optional scale to coordinates.)""";
          // Source: drake/geometry/shape_specification.h:568
          const char* doc_2args_mesh_data_scale3 =
R"""(Mesh-contents variant that allows for specification of non-uniform
scale.)""";
          // Source: drake/geometry/shape_specification.h:574
          const char* doc_2args_source_scale =
...
Parameter ``scale``:
    An optional scale to coordinates.)""";
          // Source: drake/geometry/shape_specification.h:578
          const char* doc_2args_source_scale3 =
R"""(Mesh-source variant that allows for specification of non-uniform
scale.)""";
        } ctor;
        ...
        struct /* extension */ {
          // Source: drake/geometry/shape_specification.h:593
          const char* doc =
...
extension of the MemoryFile passed to the constructor.)""";
        ...
        struct /* scale */ {
          // Source: drake/geometry/shape_specification.h:597
          const char* doc =
R"""(Returns a single scale representing the *uniform* scale factor.
...
Raises:
    if the scale is not uniform in all directions.)""";
        ...
        struct /* scale3 */ {
          // Source: drake/geometry/shape_specification.h:600
          const char* doc =
R"""(Returns general scale factors for this mesh.)""";
        } scale3;
        // Symbol: drake::geometry::Mesh::source
        struct /* source */ {
          // Source: drake/geometry/shape_specification.h:583
          const char* doc =
...
previously been set. The default is zero.)""";
      ...
      struct /* MeshcatCone */ {
        // Source: drake/geometry/shape_specification.h:641
        const char* doc =
...
in any renderings, proximity queries, or other visualizers.)""";
        ...
        struct /* ctor */ {
          // Source: drake/geometry/shape_specification.h:648
          const char* doc_3args =
...
Raises:
    ...
    positive.)""";
          // Source: drake/geometry/shape_specification.h:653
          const char* doc_1args =
...
Raises:
    RuntimeError if the measures are not strictly positive.)""";
        ...
        struct /* a */ {
          // Source: drake/geometry/shape_specification.h:658
          const char* doc = R"""()""";
        } a;
        // Symbol: drake::geometry::MeshcatCone::b
        struct /* b */ {
          // Source: drake/geometry/shape_specification.h:659
          const char* doc = R"""()""";
        } b;
        // Symbol: drake::geometry::MeshcatCone::height
        struct /* height */ {
          // Source: drake/geometry/shape_specification.h:657
          const char* doc = R"""()""";
        } height;
      } MeshcatCone;
...
R"""(Returns the (unqualified) type name of this Shape, e.g., "Box".)""";
      ...
      struct /* ShapeReifier */ {
        // Source: drake/geometry/shape_specification.h:747
        const char* doc =
...
the shape implementations require.)""";
        ...
        struct /* DefaultImplementGeometry */ {
          // Source: drake/geometry/shape_specification.h:769
          const char* doc =
...
implementation boilerplate.)""";
        ...
        struct /* ImplementGeometry */ {
          // Source: drake/geometry/shape_specification.h:751
          const char* doc = R"""()""";
        } ImplementGeometry;
        // Symbol: drake::geometry::ShapeReifier::ShapeReifier
        struct /* ctor */ {
          // Source: drake/geometry/shape_specification.h:762
          const char* doc = R"""()""";
        } ctor;
        // Symbol: drake::geometry::ShapeReifier::ThrowUnsupportedGeometry
        struct /* ThrowUnsupportedGeometry */ {
          // Source: drake/geometry/shape_specification.h:774
          const char* doc =
...
Raises:
    ...
    considered valid.)""";
        ...
        struct /* radius */ {
          // Source: drake/geometry/shape_specification.h:686
          const char* doc = R"""()""";
        } radius;
      } Sphere;
