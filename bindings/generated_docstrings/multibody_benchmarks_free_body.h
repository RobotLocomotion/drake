...
<table> <tr> <th>std::tuple</th> <th>Description</th></tr> <tr>
<td>quat_NB</td> <td>Quaternion relating frame N to frame B [e0, e1,
e2, e3].

quat_NB is analogous to the rotation matrix R_NB. </td> </tr> <tr>
<td>quatDt</td> <td>Time-derivative of ``quat_NB``, i.e., [ė0, ė1,
ė2, ė3].</td> </tr> <tr> <td>w_NB_B</td> <td>B's angular velocity in
N, expressed in B.</td> </tr> <tr> <td>alpha_NB_B</td> <td>B's angular
acceleration in N, expressed in B.</td> </tr> </table>
