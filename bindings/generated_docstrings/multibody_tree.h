...
Note:
    ...
    method are inexpensive.)""";
        ...
        struct /* EvalSpatialVelocityInWorld */ {
          // Source: drake/multibody/tree/rigid_body.h
          const char* doc =
R"""(Evaluates V_WB, this RigidBody (Link) B's SpatialVelocity in the world
frame W.
...
Raises:
    RuntimeError if context is null.)""";
        ...
        struct /* SetSpatialInertiaInBodyFrame */ {
          // Source: drake/multibody/tree/rigid_body.h
          const char* doc =
R"""(For this RigidBody (Link) B, sets its SpatialInertia that is stored in
``context`` to ``M_Bo_B``.
...
Note:
    ...
    mass parameter in the Context.)""";
        ...
        struct /* default_rotational_inertia */ {
          // Source: drake/multibody/tree/rigid_body.h
          const char* doc =
R"""(Gets the default value of this RigidBody (Link) B's rotational inertia
about Bo (B's origin), expressed in B (this body's body frame). This
value is calculated from the SpatialInertia supplied at construction
of this body.
...
Returns ``V_WL_W``:
    ...
    W (for point Lo, the link frame's origin).)""";
        ...
        struct /* has_quaternion_dofs */ {
          // Source: drake/multibody/tree/rigid_body.h
          const char* doc =
R"""((Advanced) If ``True``, this RigidBody's (Link's) generalized position
coordinates q include a quaternion, which occupies the first four
elements of q. Note that this does not imply that the body is a
...
Note:
    "link" is the terminology used in urdf/sdformat.)""";
        ...
        struct /* mobod_index */ {
          // Source: drake/multibody/tree/rigid_body.h
          const char* doc =
R"""((Advanced) Returns the index of the mobilized body ("mobod") that this
RigidBody (Link) follows. This index serves as the BodyNode index and
...
follow the same mobod.)""";
        ...
        struct /* name */ {
          // Source: drake/multibody/tree/rigid_body.h
          const char* doc =
R"""(Gets the ``name`` associated with this RigidBody (Link). The name will
never be empty.)""";
        } name;
