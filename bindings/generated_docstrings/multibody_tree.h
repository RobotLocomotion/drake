...
- [Goldstein 2001] H Goldstein, CP Poole, JL Safko, Classical Mechanics
        ...
        struct /* AddInForce */ {
          // Source: drake/multibody/tree/rigid_body.h:513
          const char* doc =
...
Raises:
    ...
    with the model to which this body belongs.)""";
        ...
        struct /* AddInForceInWorld */ {
          // Source: drake/multibody/tree/rigid_body.h:487
          const char* doc =
...
Bo and expressed in the world frame W into ``forces``.)""";
        ...
        struct /* CalcCenterOfMassInBodyFrame */ {
          // Source: drake/multibody/tree/rigid_body.h:522
          const char* doc =
...
Precondition:
    the context makes sense for use by this RigidBody.)""";
        ...
        struct /* CalcCenterOfMassTranslationalAccelerationInWorld */ {
          // Source: drake/multibody/tree/rigid_body.h:544
          const char* doc =
...
Note:
    ...
    method are inexpensive.)""";
        ...
        struct /* CalcCenterOfMassTranslationalVelocityInWorld */ {
          // Source: drake/multibody/tree/rigid_body.h:534
          const char* doc =
...
Returns ``v_WBcm_W``:
    ...
    mass) in the world frame W, expressed in W.)""";
        ...
        struct /* CalcSpatialInertiaInBodyFrame */ {
          // Source: drake/multibody/tree/rigid_body.h:554
          const char* doc =
...
Precondition:
    the context makes sense for use by this RigidBody.)""";
        ...
        struct /* CloneToScalar */ {
          // Source: drake/multibody/tree/rigid_body.h:744
          const char* doc =
...
a function of the state of the model stored in ``context``.)""";
        ...
        struct /* EvalSpatialAccelerationInWorld */ {
          // Source: drake/multibody/tree/rigid_body.h:466
          const char* doc =
...
Note:
    ...
    method are inexpensive.)""";
        ...
        struct /* EvalSpatialVelocityInWorld */ {
          // Source: drake/multibody/tree/rigid_body.h:451
          const char* doc =
...
Returns ``V_WB_W``:
    ...
    W (for point Bo, the body frame's origin).)""";
        ...
        struct /* GetForceInWorld */ {
          // Source: drake/multibody/tree/rigid_body.h:476
          const char* doc =
...
Note:
    ...
    used for spatial inertia quantities.)""";
        ...
        struct /* SetCenterOfMassInBodyFrame */ {
          // Source: drake/multibody/tree/rigid_body.h:594
          const char* doc =
...
Warning:
    Do not use this function unless it is needed (think twice).)""";
        ...
        struct /* SetCenterOfMassInBodyFrameAndPreserveCentralInertia */ {
          // Source: drake/multibody/tree/rigid_body.h:613
          const char* doc =
...
Raises:
    RuntimeError if context is null.)""";
        ...
        struct /* SetMass */ {
          // Source: drake/multibody/tree/rigid_body.h:571
          const char* doc =
...
Raises:
    RuntimeError if context is null.)""";
        ...
        struct /* SetSpatialInertiaInBodyFrame */ {
          // Source: drake/multibody/tree/rigid_body.h:626
          const char* doc =
...
R"""(Returns a const reference to the associated BodyFrame.)""";
        ...
        struct /* default_com */ {
          // Source: drake/multibody/tree/rigid_body.h:402
          const char* doc =
...
Returns ``p_BoBcm_B``:
    ...
    frame).)""";
        ...
        struct /* default_mass */ {
          // Source: drake/multibody/tree/rigid_body.h:395
          const char* doc =
...
Returns ``I_BBo_B``:
    body B's rotational inertia about Bo, expressed in B.)""";
        ...
        struct /* default_spatial_inertia */ {
          // Source: drake/multibody/tree/rigid_body.h:425
          const char* doc =
...
Returns ``G_BBo_B``:
    rigid body B's unit inertia about Bo, expressed in B.)""";
        ...
        struct /* floating_position_suffix */ {
          // Source: drake/multibody/tree/rigid_body.h:359
          const char* doc =
R"""(Returns a string suffix (e.g. to be appended to the name()) to
identify the ``k`th position in the floating base.
...
See also:
    is_floating(), has_quaternion_dofs(), MultibodyPlant::Finalize())""";
        ...
        struct /* floating_positions_start */ {
          // Source: drake/multibody/tree/rigid_body.h:334
          const char* doc =
R"""((Advanced) For floating base bodies (see is_floating()) this method
...
See also:
    is_floating(), has_quaternion_dofs(), MultibodyPlant::Finalize())""";
        ...
        struct /* floating_velocities_start_in_v */ {
          // Source: drake/multibody/tree/rigid_body.h:347
          const char* doc =
R"""((Advanced) For floating base bodies (see is_floating()) this method
...
See also:
    is_floating(), MultibodyPlant::Finalize())""";
        ...
        struct /* floating_velocity_suffix */ {
          // Source: drake/multibody/tree/rigid_body.h:379
          const char* doc =
R"""(Returns a string suffix (e.g. to be appended to the name()) to
identify the ``k`th velocity in the floating base.
...
See also:
    is_floating(), MultibodyPlant::Finalize())""";
        ...
        struct /* get_angular_acceleration_in_world */ {
          // Source: drake/multibody/tree/rigid_body.h:723
          const char* doc =
...
Returns ``alpha_WB_W``:
    B's angular acceleration in world W, expressed in W.)""";
        ...
        struct /* get_angular_velocity_in_world */ {
          // Source: drake/multibody/tree/rigid_body.h:689
          const char* doc =
...
Returns ``w_WB_W``:
    rigid body B's angular velocity in world W, expressed in W.)""";
        ...
        struct /* get_mass */ {
          // Source: drake/multibody/tree/rigid_body.h:432
          const char* doc =
...
Precondition:
    the context makes sense for use by this RigidBody.)""";
        ...
        struct /* get_origin_acceleration_in_world */ {
          // Source: drake/multibody/tree/rigid_body.h:732
          const char* doc =
...
Returns ``a_WBo_W``:
    acceleration of body origin Bo in world W, expressed in W.)""";
        ...
        struct /* get_origin_position_in_world */ {
          // Source: drake/multibody/tree/rigid_body.h:664
          const char* doc =
...
Returns ``p_WoBo_W``:
    ...
    expressed in W (world).)""";
        ...
        struct /* get_origin_velocity_in_world */ {
          // Source: drake/multibody/tree/rigid_body.h:698
          const char* doc =
...
Returns ``v_WBo_W``:
    velocity of Bo (body origin) in world W, expressed in W.)""";
        ...
        struct /* get_pose_in_world */ {
          // Source: drake/multibody/tree/rigid_body.h:645
          const char* doc =
...
Returns ``X_WB``:
    pose of rigid body B in world frame W.)""";
        ...
        struct /* get_rotation_matrix_in_world */ {
          // Source: drake/multibody/tree/rigid_body.h:654
          const char* doc =
...
Returns ``R_WB``:
    rotation matrix relating rigid body B in world frame W.)""";
        ...
        struct /* get_spatial_acceleration_in_world */ {
          // Source: drake/multibody/tree/rigid_body.h:714
          const char* doc =
...
Returns ``A_WB_W``:
    ...
    expressed in W (for point Bo, the body frame's origin).)""";
        ...
        struct /* get_spatial_velocity_in_world */ {
          // Source: drake/multibody/tree/rigid_body.h:680
          const char* doc =
...
See also:
    is_floating(), MultibodyPlant::Finalize())""";
        ...
        struct /* is_floating */ {
          // Source: drake/multibody/tree/rigid_body.h:306
          const char* doc =
