...
Returns:
    ...
    other potential energy, or heat, and therefore to a decrease of
...
height. That is, a body will have zero potential energy when the
height of its center of mass is at the height of the World origin.)""";
        } CalcPotentialEnergy;
