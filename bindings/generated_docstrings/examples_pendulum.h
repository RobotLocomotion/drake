...
* ``tau`` defaults to 0.0 Newton-meters.)""";
          ...
          struct /* Serialize */ {
            // Source: drake/examples/pendulum/pendulum_input.h:114
            const char* doc =
...
One common use of Serialize is the //common/yaml tools.)""";
          ...
          struct /* SetToNamedVariables */ {
            // Source: drake/examples/pendulum/pendulum_input.h:80
            const char* doc =
...
name. This is only available for T == symbolic::Expression.)""";
          ...
          struct /* set_tau */ {
            // Source: drake/examples/pendulum/pendulum_input.h:97
            const char* doc = R"""(Setter that matches tau().)""";
          } set_tau;
          // Symbol: drake::examples::pendulum::PendulumInput::tau
          struct /* tau */ {
            // Source: drake/examples/pendulum/pendulum_input.h:92
            const char* doc =
...
Note:
    ``tau`` is expressed in units of Newton-meters.)""";
          ...
          struct /* with_tau */ {
            // Source: drake/examples/pendulum/pendulum_input.h:103
            const char* doc =
...
``BasicVector::GetAtIndex(i)``.)""";
        ...
        struct /* PendulumParams */ {
          // Source: drake/examples/pendulum/pendulum_params.h:48
          const char* doc =
R"""(Specializes BasicVector with specific getters and setters.)""";
          // Symbol: drake::examples::pendulum::PendulumParams::DoClone
          struct /* DoClone */ {
            // Source: drake/examples/pendulum/pendulum_params.h:96
            const char* doc = R"""()""";
          } DoClone;
          // Symbol: drake::examples::pendulum::PendulumParams::GetCoordinateNames
          struct /* GetCoordinateNames */ {
            // Source: drake/examples/pendulum/pendulum_params.h:196
            const char* doc =
R"""(See PendulumParamsIndices::GetCoordinateNames().)""";
          ...
          struct /* GetElementBounds */ {
            // Source: drake/examples/pendulum/pendulum_params.h:215
            const char* doc = R"""()""";
          } GetElementBounds;
          // Symbol: drake::examples::pendulum::PendulumParams::IsValid
          struct /* IsValid */ {
            // Source: drake/examples/pendulum/pendulum_params.h:201
            const char* doc =
R"""(Returns whether the current values of this vector are well-formed.)""";
          } IsValid;
          // Symbol: drake::examples::pendulum::PendulumParams::K
          struct /* K */ {
            // Source: drake/examples/pendulum/pendulum_params.h:51
            const char* doc =
R"""(An abbreviation for our row index constants.)""";
          } K;
          // Symbol: drake::examples::pendulum::PendulumParams::PendulumParams<T>
          struct /* ctor */ {
            // Source: drake/examples/pendulum/pendulum_params.h:58
            const char* doc =
R"""(Default constructor. Sets all rows to their default value:
...
* ``gravity`` defaults to 9.81 m/s^2.)""";
          ...
          struct /* Serialize */ {
            // Source: drake/examples/pendulum/pendulum_params.h:184
            const char* doc =
R"""(Visit each field of this named vector, passing them (in order) to the
given Archive. The archive can read and/or write to the vector values.
One common use of Serialize is the //common/yaml tools.)""";
          ...
          struct /* SetToNamedVariables */ {
            // Source: drake/examples/pendulum/pendulum_params.h:89
            const char* doc =
R"""(Create a symbolic::Variable for each element with the known variable
name. This is only available for T == symbolic::Expression.)""";
          } SetToNamedVariables;
          ...
          struct /* damping */ {
            // Source: drake/examples/pendulum/pendulum_params.h:143
            const char* doc =
...
Note:
    ``damping`` has a limited domain of [0.0, +Inf].)""";
          ...
          struct /* gravity */ {
            // Source: drake/examples/pendulum/pendulum_params.h:162
            const char* doc =
...
Note:
    ``gravity`` has a limited domain of [0.0, +Inf].)""";
          ...
          struct /* length */ {
            // Source: drake/examples/pendulum/pendulum_params.h:124
            const char* doc =
...
Note:
    ``length`` has a limited domain of [0.0, +Inf].)""";
          ...
          struct /* mass */ {
            // Source: drake/examples/pendulum/pendulum_params.h:105
            const char* doc =
...
damping set to a new value.)""";
          ...
          struct /* with_gravity */ {
            // Source: drake/examples/pendulum/pendulum_params.h:173
            const char* doc =
...
gravity set to a new value.)""";
          ...
          struct /* with_length */ {
            // Source: drake/examples/pendulum/pendulum_params.h:135
            const char* doc =
...
length set to a new value.)""";
          ...
          struct /* with_mass */ {
            // Source: drake/examples/pendulum/pendulum_params.h:116
            const char* doc =
...
``BasicVector::GetAtIndex(i)``.)""";
        ...
        struct /* PendulumPlant */ {
          // Source: drake/examples/pendulum/pendulum_plant.h:28
          const char* doc =
...
to be zero.)""";
          ...
          struct /* CalcTotalEnergy */ {
            // Source: drake/examples/pendulum/pendulum_plant.h:45
            const char* doc =
R"""(Calculates the kinetic + potential energy.)""";
          } CalcTotalEnergy;
          // Symbol: drake::examples::pendulum::PendulumPlant::PendulumPlant<T>
          struct /* ctor */ {
            // Source: drake/examples/pendulum/pendulum_plant.h:33
            const char* doc = R"""(Constructs a default plant.)""";
            // Source: drake/examples/pendulum/pendulum_plant.h:37
...
R"""(Scalar-converting copy constructor. See system_scalar_conversion.)""";
          ...
          struct /* get_state */ {
            // Source: drake/examples/pendulum/pendulum_plant.h:55
            const char* doc = R"""()""";
          } get_state;
...
* ``thetadot`` defaults to 0.0 radians/sec.)""";
          ...
          struct /* Serialize */ {
            // Source: drake/examples/pendulum/pendulum_state.h:136
            const char* doc =
R"""(Visit each field of this named vector, passing them (in order) to the
given Archive. The archive can read and/or write to the vector values.
One common use of Serialize is the //common/yaml tools.)""";
          ...
          struct /* SetToNamedVariables */ {
            // Source: drake/examples/pendulum/pendulum_state.h:83
            const char* doc =
R"""(Create a symbolic::Variable for each element with the known variable
name. This is only available for T == symbolic::Expression.)""";
          } SetToNamedVariables;
...
Note:
    ``theta`` is expressed in units of radians.)""";
          ...
          struct /* thetadot */ {
            // Source: drake/examples/pendulum/pendulum_state.h:114
            const char* doc =
...
Note:
    ``thetadot`` is expressed in units of radians/sec.)""";
          ...
          struct /* with_theta */ {
            // Source: drake/examples/pendulum/pendulum_state.h:107
            const char* doc =
...
theta set to a new value.)""";
          ...
          struct /* with_thetadot */ {
            // Source: drake/examples/pendulum/pendulum_state.h:125
            const char* doc =
