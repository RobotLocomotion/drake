...
added.)""";
        ...
        struct /* meshcat */ {
          // Source: drake/planning/iris/iris_common.h:150
          const char* doc =
...
``parameterization_is_threadsafe``.)""";
        ...
        struct /* prog_with_additional_constraints */ {
          // Source: drake/planning/iris/iris_common.h:167
          const char* doc =
...
Note:
    ...
    checking is performed.)""";
        ...
        struct /* random_seed */ {
          // Source: drake/planning/iris/iris_common.h:133
          const char* doc =
...
algorithm.)""";
        ...
        struct /* relative_termination_threshold */ {
          // Source: drake/planning/iris/iris_common.h:122
          const char* doc =
...
is collision-free.)""";
        ...
        struct /* sample_particles_in_parallel */ {
          // Source: drake/planning/iris/iris_common.h:146
          const char* doc =
...
a value of 0.5 a good trade-off.)""";
        ...
        struct /* termination_threshold */ {
          // Source: drake/planning/iris/iris_common.h:117
          const char* doc =
R"""(IRIS will terminate if the change in the *volume* of the
...
solvers::MakeFirstAvailableSolver will be used to pick the solver.)""";
      ...
      struct /* IrisParameterizationFunction */ {
        // Source: drake/planning/iris/iris_common.h:182
        const char* doc =
...
threadsafe, and ``parameterization_dimension`` is the input dimension.)""";
          // Source: drake/planning/iris/iris_common.h:211
...
``parameterization_is_threadsafe`` specifies whether or not its
threadsafe, and ``parameterization_dimension`` is the input dimension.)""";
          // Source: drake/planning/iris/iris_common.h:222
...
threadsafe and compatible with any dimension configuration space.)""";
          // Source: drake/planning/iris/iris_common.h:238
...
Raises:
    ...
    ``expression_parameterization``.)""";
          // Source: drake/planning/iris/iris_common.h:251
...
Note:
    ...
    deleted, then the parameterization can no longer be used.)""";
        ...
        struct /* ParameterizationFunctionAutodiff */ {
          // Source: drake/planning/iris/iris_common.h:190
          const char* doc = R"""()""";
        ...
        struct /* ParameterizationFunctionDouble */ {
          // Source: drake/planning/iris/iris_common.h:187
          const char* doc = R"""()""";
        ...
        struct /* get_parameterization_autodiff */ {
          // Source: drake/planning/iris/iris_common.h:271
          const char* doc =
...
Raises:
    ...
    not the VectorX<AutoDiffXd> parameterization.)""";
        ...
        struct /* get_parameterization_dimension */ {
          // Source: drake/planning/iris/iris_common.h:289
          const char* doc =
...
the parameterization.)""";
        ...
        struct /* get_parameterization_double */ {
          // Source: drake/planning/iris/iris_common.h:260
          const char* doc =
...
Note:
    ...
    (in the standard coordinate system).)""";
        ...
        struct /* get_parameterization_is_threadsafe */ {
          // Source: drake/planning/iris/iris_common.h:280
          const char* doc =
