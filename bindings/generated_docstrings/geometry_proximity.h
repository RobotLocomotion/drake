...
.. raw:: html
        ...
        struct /* BoxOverlaps */ {
          // Source: drake/geometry/proximity/plane.h
          const char* doc =
R"""(Reports if the given box intersects this plane. The box is specified
in generic terms. It is an axis-aligned box, centered on a point with
*half* measures along the axis directions.
...
Parameter ``box_orientation_in_plane``:
    ...
    column goes with the ith half width.)""";
        } BoxOverlaps;
...
Parameter ``point_on_plane``:
    A point on the plane measured and expressed in Frame F. The ``d``
    in the implicit equation is derived from this quantity.
...
Precondition:
    ...
    magnitude ≥ 1e-10.)""";
        ...
        struct /* normal */ {
          // Source: drake/geometry/proximity/plane.h
          const char* doc =
R"""(Gets the plane's normal expressed in frame F.)""";
        } normal;
        // Symbol: drake::geometry::Plane::point_on_plane
        struct /* point_on_plane */ {
          // Source: drake/geometry/proximity/plane.h
          const char* doc =
R"""(Gets a point on the plane, measured and expressed in frame F. This is
