...
AbstractValue "abstract-valued" output port of type
...
AbstractValue "abstract-valued" output port of type
drake∷geometry∷FramePoseVector<T>. Poses are measured and expressed in
the World frame. This port is intended to be connected to a
drake∷geometry∷SceneGraph<T> pose input port to communicate frame
poses.)""";
