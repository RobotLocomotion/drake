...
SetSurfaceVelocityAxis(). Each signal's name is the scoped body name.
...
name is the scoped body name and its value is a finite ``double``
speed in m/s. If the port is not connected, or a body's signal is
