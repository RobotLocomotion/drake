...
See also:
    SetBaseBodyJointType(), GetFuseWeldedBodies(), Finalize())""";
...
Raises:
    RuntimeError if ``body`` is not a free body.)""";
        ...
        // Symbol: drake::multibody::MultibodyPlant::GetFuseWeldedBodies
        struct /* GetFuseWeldedBodies */ {
          // Source: drake/multibody/plant/multibody_plant.h
          const char* doc =
R"""((Internal use only for now) Returns the global or a model_instance
setting for whether or not to fuse welded RigidBody (Link) elements.
...
See also:
    SetFuseWeldedBodies(), GetBaseBodyJointType(), Finalize())""";
        } GetFuseWeldedBodies;
...
See also:
    GetBaseBodyJointType(), SetFuseWeldedBodies(), Finalize())""";
...
Precondition:
    ``state`` comes from this MultibodyPlant.)""";
        ...
        // Symbol: drake::multibody::MultibodyPlant::SetFuseWeldedBodies
        struct /* SetFuseWeldedBodies */ {
          // Source: drake/multibody/plant/multibody_plant.h
          const char* doc =
R"""((Internal use only for now) Controls whether welded-together RigidBody
(Link) elements are to be fused into a single mobilized body in the
generated model. If so, those Weld joints will not be modeled (i.e.
will have no corresponding mobilizer) in the post-Finalize() model and
there will be fewer mobilized bodies and modeled joints in the
generated model than in the user's specification of links and joints.
Results for the original RigidBody (Link) elements can still be
obtained by name or BodyIndex, but no results (in particular, no
reaction forces) are available for the unmodeled Weld joints.
...
See also:
    GetFuseWeldedBodies(), SetBaseBodyJointType(), Finalize())""";
        } SetFuseWeldedBodies;
