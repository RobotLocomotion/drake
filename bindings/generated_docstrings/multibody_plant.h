...
Warning:
    ...
    DiscreteContactSolver::kSap.), and for certain uses of continuous
    models. Unsupported uses will not raise exceptions at
    configuration time, but may raise exceptions at run time.
