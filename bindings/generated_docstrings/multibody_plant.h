...
``scene_graph_config``.)""";
      ...
      struct /* AddMultibodyPlantSceneGraph */ {
        // Source: drake/multibody/plant/multibody_plant.h:6531
...
Precondition:
    ``builder`` must be non-null.)""";
        // Source: drake/multibody/plant/multibody_plant.h:6552
...
Precondition:
    ``builder`` and ``plant`` must be non-null.)""";
      ...
      struct /* AddMultibodyPlantSceneGraphResult */ {
        // Source: drake/multibody/plant/multibody_plant.h:6578
        const char* doc =
...
Warning:
    ...
    lifetime of this object should be as short as possible.)""";
        ...
        struct /* ctor */ {
          // Source: drake/multibody/plant/multibody_plant.h:6607
          const char* doc = R"""()""";
        } ctor;
        // Symbol: drake::multibody::AddMultibodyPlantSceneGraphResult::get
        struct /* get */ {
          // Source: drake/multibody/plant/multibody_plant.h:6596
          const char* doc = R"""()""";
        } get;
        ...
        struct /* operator_MultibodyPlant_ */ {
          // Source: drake/multibody/plant/multibody_plant.h:6583
          const char* doc =
...
Raises:
    ...
    DiscreteContactSolver::kSap))""";
        ...
        struct /* CalcBiasCenterOfMassTranslationalAcceleration */ {
          // Source: drake/multibody/plant/multibody_plant.h:4920
          const char* doc_4args =
...
Note:
    ...
    theory and details.)""";
        ...
        struct /* CalcBiasSpatialAcceleration */ {
          // Source: drake/multibody/plant/multibody_plant.h:4886
          const char* doc =
...
Note:
    ...
    theory and details.)""";
        ...
        struct /* CalcBiasTerm */ {
          // Source: drake/multibody/plant/multibody_plant.h:4820
          const char* doc =
...
Parameter ``Cv``:
    ...
    the proper size.)""";
        ...
        struct /* CalcBiasTranslationalAcceleration */ {
          // Source: drake/multibody/plant/multibody_plant.h:4851
          const char* doc =
...
Note:
    ...
    theory and details.)""";
        ...
        struct /* CalcCenterOfMassPositionInWorld */ {
          // Source: drake/multibody/plant/multibody_plant.h:3776
          const char* doc_1args =
...
Note:
    ...
    expressed in frame W (Bᵢcm is the center of mass of the iᵗʰ body).)""";
        ...
        struct /* CalcCenterOfMassTranslationalAccelerationInWorld */ {
          // Source: drake/multibody/plant/multibody_plant.h:3857
          const char* doc_1args =
...
Note:
    ...
    method are inexpensive.)""";
          // Source: drake/multibody/plant/multibody_plant.h:3882
          const char* doc_2args =
R"""(For the system S containing the selected model instances, calculates
...
Note:
    ...
    world W (Bᵢcm is the center of mass of the iᵗʰ body).)""";
          // Source: drake/multibody/plant/multibody_plant.h:3904
          const char* doc_2args =
R"""(Calculates system center of mass translational velocity in world frame
W.
...
Note:
    ...
    the center of mass of the iᵗʰ body).)""";
        ...
        struct /* CalcForceElementsContribution */ {
          // Source: drake/multibody/plant/multibody_plant.h:4080
          const char* doc =
...
Raises:
    ...
    model, per MultibodyForces::CheckInvariants().)""";
        ...
        struct /* CalcFullSystemJacobian */ {
          // Source: drake/multibody/plant/multibody_plant.h:4494
          const char* doc =
...
See also:
    EvalBlockSystemJacobian(), CalcJacobianSpatialVelocity())""";
        ...
        struct /* CalcGeneralizedForces */ {
          // Source: drake/multibody/plant/multibody_plant.h:4140
          const char* doc =
...
Raises:
    ...
    pointer.)""";
        ...
        struct /* CalcGravityGeneralizedForces */ {
          // Source: drake/multibody/plant/multibody_plant.h:4105
          const char* doc =
...
Returns:
    ...
    and therefore to a decrease of the gravitational potential energy.)""";
        ...
        struct /* CalcInverseDynamics */ {
          // Source: drake/multibody/plant/multibody_plant.h:4031
          const char* doc =
...
Returns:
    ...
    given by ``known_vdot``.)""";
        ...
        struct /* CalcJacobianAngularVelocity */ {
          // Source: drake/multibody/plant/multibody_plant.h:4584
          const char* doc =
...
Raises:
    RuntimeError if ``J𝑠_w_AB_E`` is nullptr or not of size ``3 x n``.)""";
        ...
        struct /* CalcJacobianCenterOfMassTranslationalVelocity */ {
          // Source: drake/multibody/plant/multibody_plant.h:4726
          const char* doc_5args =
...
See also:
    See Jacobian_functions "Jacobian functions" for related functions.)""";
          // Source: drake/multibody/plant/multibody_plant.h:4765
          const char* doc_6args =
R"""(Calculates J𝑠_v_AScm_E, point Scm's translational velocity Jacobian in
frame A with respect to "speeds" 𝑠, expressed in frame E, where point
Scm is the center of mass of the system S of all non-world bodies
...
See also:
    See Jacobian_functions "Jacobian functions" for related functions.)""";
        ...
        struct /* CalcJacobianSpatialVelocity */ {
          // Source: drake/multibody/plant/multibody_plant.h:4543
          const char* doc =
...
Raises:
    RuntimeError if ``J𝑠_V_ABp_E`` is nullptr or not sized ``6 x n``.)""";
        ...
        struct /* CalcJacobianTranslationalVelocity */ {
          // Source: drake/multibody/plant/multibody_plant.h:4637
          const char* doc =
...
See also:
    See Jacobian_functions "Jacobian functions" for related functions.)""";
        ...
        struct /* CalcMassMatrix */ {
          // Source: drake/multibody/plant/multibody_plant.h:4328
          const char* doc =
...
See also:
    CalcMassMatrixViaInverseDynamics() (slower))""";
        ...
        struct /* CalcMassMatrixViaInverseDynamics */ {
          // Source: drake/multibody/plant/multibody_plant.h:4299
          const char* doc =
...
Returns ``R_AB``:
    The RigidTransform relating frame A and frame B.)""";
        ...
        struct /* CalcRelativeTransform */ {
          // Source: drake/multibody/plant/multibody_plant.h:3676
          const char* doc =
...
Raises:
    RuntimeError if A_WB_array is not of size ``num_bodies()``.)""";
        ...
        struct /* CalcSpatialInertia */ {
          // Source: drake/multibody/plant/multibody_plant.h:3818
          const char* doc =
...
Note:
    ...
    the the returned spatial inertia.)""";
        ...
        struct /* CalcSpatialMomentumInWorldAboutPoint */ {
          // Source: drake/multibody/plant/multibody_plant.h:3929
          const char* doc_2args =
...
.. raw:: html
          ...
          // Source: drake/multibody/plant/multibody_plant.h:3962
          const char* doc_3args =
...
Raises:
    ...
    ModelInstanceIndex.)""";
        ...
        struct /* CalcTotalMass */ {
          // Source: drake/multibody/plant/multibody_plant.h:3745
          const char* doc_1args =
...
Note:
    ...
    mass.)""";
          // Source: drake/multibody/plant/multibody_plant.h:3759
          const char* doc_2args =
...
Raises:
    ...
    SceneGraph.)""";
        ...
        struct /* EvalBlockSystemJacobian */ {
          // Source: drake/multibody/plant/multibody_plant.h:4476
          const char* doc =
...
See also:
    CalcJacobianSpatialVelocity(), CalcFullSystemJacobian())""";
        ...
        struct /* EvalBodyPoseInWorld */ {
          // Source: drake/multibody/plant/multibody_plant.h:3634
          const char* doc =
...
Raises:
    ...
    ``body_B`` does not belong to this model.)""";
        ...
        struct /* EvalBodySpatialAccelerationInWorld */ {
          // Source: drake/multibody/plant/multibody_plant.h:3663
          const char* doc =
...
Note:
    ...
    method are inexpensive.)""";
        ...
        struct /* EvalBodySpatialVelocityInWorld */ {
          // Source: drake/multibody/plant/multibody_plant.h:3647
          const char* doc =
...
Raises:
    RuntimeError if the MultibodyPlant has already been finalized.)""";
        ...
        struct /* FindSubgraphsOfWeldedBodies */ {
          // Source: drake/multibody/plant/multibody_plant.h:5687
          const char* doc = R"""()""";
        ...
        struct /* GetAccelerationLowerLimits */ {
          // Source: drake/multibody/plant/multibody_plant.h:5586
          const char* doc =
...
Raises:
    RuntimeError if called pre-finalize.)""";
        ...
        struct /* GetAccelerationUpperLimits */ {
          // Source: drake/multibody/plant/multibody_plant.h:5593
          const char* doc =
...
See also:
    GetAccelerationLowerLimits() for more information.)""";
        ...
        struct /* GetActuatedJointIndices */ {
          // Source: drake/multibody/plant/multibody_plant.h:5241
          const char* doc =
...
See also:
    SetBaseBodyJointType())""";
        ...
        struct /* GetBodiesKinematicallyAffectedBy */ {
          // Source: drake/multibody/plant/multibody_plant.h:5168
          const char* doc =
...
Raises:
    ...
    doesn't correspond to a mobilizer, or is welded.)""";
        ...
        struct /* GetBodiesWeldedTo */ {
          // Source: drake/multibody/plant/multibody_plant.h:5145
          const char* doc =
...
Raises:
    RuntimeError if ``body`` is not part of this plant.)""";
        ...
        struct /* GetBodyByName */ {
          // Source: drake/multibody/plant/multibody_plant.h:5070
          const char* doc_1args =
...
See also:
    ...
    MultibodyPlant with a given specified name.)""";
          // Source: drake/multibody/plant/multibody_plant.h:5079
          const char* doc_2args =
...
associated with that id (nullptr if there is no such body).)""";
        ...
        struct /* GetBodyIndices */ {
          // Source: drake/multibody/plant/multibody_plant.h:5085
          const char* doc =
...
context.)""";
        ...
        struct /* GetDefaultFreeBodyPose */ {
          // Source: drake/multibody/plant/multibody_plant.h:3442
          const char* doc =
...
Note:
    The parent frame is not necessarily the world frame. See
...
Raises:
    if ``id`` is not a valid identifier for a distance constraint.)""";
        ...
        struct /* GetEffortLowerLimits */ {
          // Source: drake/multibody/plant/multibody_plant.h:5603
          const char* doc =
...
Raises:
    RuntimeError if called pre-finalize.)""";
        ...
        struct /* GetEffortUpperLimits */ {
          // Source: drake/multibody/plant/multibody_plant.h:5614
          const char* doc =
...
Raises:
    RuntimeError if called pre-finalize.)""";
        ...
        struct /* GetFloatingBaseBodies */ {
          // Source: drake/multibody/plant/multibody_plant.h:3378
          const char* doc =
...
Raises:
    RuntimeError if called pre-finalize, see Finalize().)""";
        ...
        struct /* GetForceElement */ {
          // Source: drake/multibody/plant/multibody_plant.h:5444
          const char* doc =
...
See also:
    ...
    with a given specified name.)""";
          // Source: drake/multibody/plant/multibody_plant.h:5322
          const char* doc_2args =
...
See also:
    ...
    with a given specified name.)""";
        ...
        struct /* GetFrameIndices */ {
          // Source: drake/multibody/plant/multibody_plant.h:5328
          const char* doc =
R"""(Returns a list of frame indices associated with ``model_instance``.)""";
        ...
        struct /* GetFreeBodyPose */ {
          // Source: drake/multibody/plant/multibody_plant.h:3387
          const char* doc =
R"""(Gets the pose of a given ``body`` in the parent frame P.

Note:
    The parent frame is not necessarily the world frame. See
    mbp_working_with_free_bodies "above for details". To acquire X_WB,
    regardless of what P is, kinematics need to be evaluated by
    calling EvalBodyPoseInWorld().
...
Raises:
    RuntimeError if called pre-finalize.)""";
        ...
        struct /* GetJointActuatorByName */ {
          // Source: drake/multibody/plant/multibody_plant.h:5405
          const char* doc_1args =
...
See also:
    ...
    ``this`` MultibodyPlant with a given specified name.)""";
        ...
        struct /* GetJointActuatorIndices */ {
          // Source: drake/multibody/plant/multibody_plant.h:5227
          const char* doc_0args =
...
general not be consecutive due to actuators that were removed.)""";
          // Source: drake/multibody/plant/multibody_plant.h:5234
          const char* doc_1args =
...
Raises:
    RuntimeError if called pre-finalize.)""";
        ...
        struct /* GetJointByName */ {
          // Source: drake/multibody/plant/multibody_plant.h:5258
          const char* doc =
...
not be consecutive due to joints that were removed.)""";
          // Source: drake/multibody/plant/multibody_plant.h:5219
          const char* doc_1args =
R"""(Returns a list of joint indices associated with ``model_instance``.)""";
        ...
        struct /* GetModelInstanceByName */ {
          // Source: drake/multibody/plant/multibody_plant.h:5500
          const char* doc =
...
See also:
    ...
    ``this`` MultibodyPlant with a given specified name.)""";
        ...
        struct /* GetModelInstanceName */ {
          // Source: drake/multibody/plant/multibody_plant.h:5484
          const char* doc =
...
Raises:
    ...
    model in this model.)""";
        ...
        struct /* GetMutableJointByName */ {
          // Source: drake/multibody/plant/multibody_plant.h:5268
          const char* doc =
...
See also:
    GetJointByName.)""";
        ...
        struct /* GetMutableSceneGraphPreFinalize */ {
          // Source: drake/multibody/plant/multibody_plant.h:5669
          const char* doc =
...
Raises:
    ...
    geometry_source_is_registered() == false)""";
        ...
        struct /* GetPositionLowerLimits */ {
          // Source: drake/multibody/plant/multibody_plant.h:5554
          const char* doc =
...
Raises:
    ...
    ``model_instance`` is invalid.)""";
        ...
        struct /* GetPositionUpperLimits */ {
          // Source: drake/multibody/plant/multibody_plant.h:5561
          const char* doc =
...
See also:
    ...
    with a given specified name.)""";
          // Source: drake/multibody/plant/multibody_plant.h:5110
          const char* doc_2args =
...
Note: this method can be called either before or after ``Finalize()``.)""";
        ...
        struct /* GetUniqueFreeBaseBodyOrThrow */ {
          // Source: drake/multibody/plant/multibody_plant.h:3597
          const char* doc =
...
``v`` is not of size MultibodyPlant::num_velocities().)""";
        ...
        struct /* GetVelocityLowerLimits */ {
          // Source: drake/multibody/plant/multibody_plant.h:5570
          const char* doc =
R"""(Returns a vector of size ``num_velocities()`` containing the lower
...
Raises:
    ...
    ``model_instance`` is invalid.)""";
        ...
        struct /* GetVelocityUpperLimits */ {
          // Source: drake/multibody/plant/multibody_plant.h:5577
          const char* doc =
...
See also:
    RegisterVisualGeometry(), Finalize())""";
        ...
        struct /* HasBodyNamed */ {
          // Source: drake/multibody/plant/multibody_plant.h:5043
          const char* doc_1args =
R"""(Returns:
...
Raises:
    RuntimeError if the body name occurs in multiple model instances.)""";
          // Source: drake/multibody/plant/multibody_plant.h:5058
          const char* doc_2args =
R"""(Returns:
    ``True`` if a body named ``name`` was added to the MultibodyPlant
    in ``model_instance``.
...
Raises:
    RuntimeError if ``model_instance`` is not valid for this model.)""";
        ...
        struct /* HasFrameNamed */ {
          // Source: drake/multibody/plant/multibody_plant.h:5292
          const char* doc_1args =
R"""(Returns:
...
Raises:
    RuntimeError if the frame name occurs in multiple model instances.)""";
          // Source: drake/multibody/plant/multibody_plant.h:5299
          const char* doc_2args =
R"""(Returns:
...
Raises:
    RuntimeError if ``model_instance`` is not valid for this model.)""";
        ...
        struct /* HasJointActuatorNamed */ {
          // Source: drake/multibody/plant/multibody_plant.h:5385
          const char* doc_1args =
R"""(Returns:
...
Raises:
    RuntimeError if the actuator name occurs in multiple model
    instances.)""";
          // Source: drake/multibody/plant/multibody_plant.h:5393
          const char* doc_2args =
R"""(Returns:
...
Raises:
    RuntimeError if ``model_instance`` is not valid for this model.)""";
        ...
        struct /* HasJointNamed */ {
          // Source: drake/multibody/plant/multibody_plant.h:5192
          const char* doc_1args =
R"""(Returns:
...
Raises:
    RuntimeError if the joint name occurs in multiple model instances.)""";
          // Source: drake/multibody/plant/multibody_plant.h:5199
          const char* doc_2args =
R"""(Returns:
...
Raises:
    RuntimeError if ``model_instance`` is not valid for this model.)""";
        ...
        struct /* HasModelInstanceNamed */ {
          // Source: drake/multibody/plant/multibody_plant.h:5491
          const char* doc =
R"""(Returns:
...
Raises:
    RuntimeError if ``model_instance`` is not valid.)""";
        ...
        struct /* IsAnchored */ {
          // Source: drake/multibody/plant/multibody_plant.h:5033
          const char* doc =
...
Raises:
    RuntimeError if called pre-finalize.)""";
        ...
        struct /* IsVelocityEqualToQDot */ {
          // Source: drake/multibody/plant/multibody_plant.h:4148
          const char* doc =
...
joints.)""";
        ...
        struct /* MakeActuationMatrix */ {
          // Source: drake/multibody/plant/multibody_plant.h:4399
          const char* doc =
...
Warning:
    ...
    significant for very large systems.)""";
        ...
        struct /* MakeActuationMatrixPseudoinverse */ {
          // Source: drake/multibody/plant/multibody_plant.h:4406
          const char* doc =
...
the pseudoinverse is a true inverse.)""";
        ...
        struct /* MakeActuatorSelectorMatrix */ {
          // Source: drake/multibody/plant/multibody_plant.h:4380
...
found at offset JointActuator::input_start().)""";
          // Source: drake/multibody/plant/multibody_plant.h:4418
...
Raises:
    ...
    does not have an actuator.)""";
        ...
        struct /* MakeQDotToVelocityMap */ {
          // Source: drake/multibody/plant/multibody_plant.h:4243
          const char* doc =
...
See also:
    MapVelocityToQDot())""";
        ...
        struct /* MakeStateSelectorMatrix */ {
          // Source: drake/multibody/plant/multibody_plant.h:4356
          const char* doc =
...
Raises:
    ...
    ``user_to_joint_index_map``.)""";
        ...
        struct /* MakeVelocityToQDotMap */ {
          // Source: drake/multibody/plant/multibody_plant.h:4227
          const char* doc =
...
See also:
    MapVelocityToQDot())""";
        ...
        struct /* MapQDotToVelocity */ {
          // Source: drake/multibody/plant/multibody_plant.h:4208
          const char* doc =
...
See also:
    Mobilizer::MapQDotToVelocity())""";
        ...
        struct /* MapVelocityToQDot */ {
          // Source: drake/multibody/plant/multibody_plant.h:4175
          const char* doc =
...
R"""(Scalar-converting copy constructor. See system_scalar_conversion.)""";
        ...
        struct /* NumBodiesWithName */ {
          // Source: drake/multibody/plant/multibody_plant.h:5049
          const char* doc =
R"""(Returns:
...
Raises:
    ...
    in ``context``.)""";
        ...
        struct /* SetDefaultFreeBodyPose */ {
          // Source: drake/multibody/plant/multibody_plant.h:3430
          const char* doc =
...
Raises:
    ...
    bodies in ``this`` MultibodyPlant.)""";
        ...
        struct /* SetFreeBodyPose */ {
          ...
          const char* doc_3args =
R"""(Sets ``context`` to store the pose ``X_PB`` of a given ``body`` B in
the parent frame P.
...
Raises:
    RuntimeError if called pre-finalize.)""";
          // Source: drake/multibody/plant/multibody_plant.h:3412
          const char* doc_4args =
R"""(Sets ``state`` to store the pose ``X_PB`` of a given ``body`` B in its
parent frame P, for a given ``context`` of ``this`` model.
...
Precondition:
    ``state`` comes from this MultibodyPlant.)""";
        ...
        struct /* SetFreeBodyPoseInAnchoredFrame */ {
          // Source: drake/multibody/plant/multibody_plant.h:3586
          const char* doc =
...
Raises:
    RuntimeError if frame F is not anchored to the world.)""";
        ...
        struct /* SetFreeBodyPoseInWorldFrame */ {
          // Source: drake/multibody/plant/multibody_plant.h:3575
          const char* doc =
R"""(Sets ``context`` to store the pose ``X_WB`` of a given *floating base*
...
Parameter ``body``:
    The *floating base* body B corresponding to the pose ``X_WB`` to
...
Warning:
    This method only applies to "floating base" bodies; i.e.,
    ``body.is_floating()`` returns ``True``. I.e., not just any free
...
Raises:
    RuntimeError if ``body.is_floating()`` returns ``False``.)""";
...
See also:
    ...
    added joints.)""";
        ...
        struct /* SetFreeBodyRandomRotationDistributionToUniform */ {
          // Source: drake/multibody/plant/multibody_plant.h:3530
          const char* doc =
R"""(Sets the distribution used by SetRandomState() to populate the free
body's orientation with respect to its parent frame using uniformly
random rotations (expressed as a quaternion). Requires that the free
body is modeled using a QuaternionFloatingJoint.
...
See also:
    ...
    added joints.)""";
        ...
        struct /* SetFreeBodyRandomTranslationDistribution */ {
          // Source: drake/multibody/plant/multibody_plant.h:3483
          const char* doc =
R"""(Sets the distribution used by SetRandomState() to populate the free
...
Raises:
    RuntimeError if called pre-finalize.)""";
        ...
        struct /* SetFreeBodySpatialVelocity */ {
          // Source: drake/multibody/plant/multibody_plant.h:3453
          const char* doc_3args =
R"""(Sets ``context`` to store the spatial velocity ``V_PB`` of a given
``body`` B in its parent frame P.
...
Raises:
    RuntimeError if called pre-finalize.)""";
          // Source: drake/multibody/plant/multibody_plant.h:3467
          const char* doc_4args =
R"""(Sets ``state`` to store the spatial velocity ``V_PB`` of a given
``body`` B in its parent frame P, for a given ``context`` of ``this``
model.
...
Warning:
    ...
    time.)""";
        ...
        struct /* geometry_source_is_registered */ {
          // Source: drake/multibody/plant/multibody_plant.h:5650
          const char* doc =
...
BallConstraintSpec.)""";
        ...
        struct /* get_body */ {
          // Source: drake/multibody/plant/multibody_plant.h:5026
          const char* doc =
...
Raises:
    RuntimeError if called pre-finalize.)""";
        ...
        struct /* get_contact_model */ {
          // Source: drake/multibody/plant/multibody_plant.h:5620
          const char* doc =
...
models.)""";
        ...
        struct /* get_force_element */ {
          // Source: drake/multibody/plant/multibody_plant.h:5430
          const char* doc =
...
Raises:
    ...
    force element in this model.)""";
        ...
        struct /* get_frame */ {
          // Source: drake/multibody/plant/multibody_plant.h:5284
          const char* doc =
...
collision geometry registration and connection with a SceneGraph.)""";
        ...
        struct /* get_joint */ {
          // Source: drake/multibody/plant/multibody_plant.h:5184
          const char* doc =
...
Raises:
    ...
    in this model.)""";
        ...
        struct /* get_joint_actuator */ {
          // Source: drake/multibody/plant/multibody_plant.h:5367
          const char* doc =
...
Raises:
    ...
    actuator in this tree.)""";
        ...
        struct /* get_mutable_joint */ {
          // Source: drake/multibody/plant/multibody_plant.h:5207
          const char* doc =
...
Raises:
    ...
    in this model.)""";
        ...
        struct /* get_mutable_joint_actuator */ {
          // Source: drake/multibody/plant/multibody_plant.h:5376
          const char* doc =
...
See also:
    See set_sap_near_rigid_threshold().)""";
        ...
        struct /* get_source_id */ {
          // Source: drake/multibody/plant/multibody_plant.h:5643
          const char* doc =
...
WeldConstraintSpec.)""";
        ...
        struct /* graph */ {
          // Source: drake/multibody/plant/multibody_plant.h:5678
          const char* doc =
...
internal::SpanningForest if you've already called Finalize().)""";
        ...
        struct /* gravity_field */ {
          // Source: drake/multibody/plant/multibody_plant.h:5464
          const char* doc =
R"""(An accessor to the current gravity field.)""";
        } gravity_field;
        // Symbol: drake::multibody::MultibodyPlant::has_body
        struct /* has_body */ {
          // Source: drake/multibody/plant/multibody_plant.h:5019
          const char* doc =
...
``body_index``.)""";
        ...
        struct /* has_joint */ {
          // Source: drake/multibody/plant/multibody_plant.h:5177
          const char* doc =
...
The value could be false if the joint was removed using RemoveJoint().)""";
        ...
        struct /* has_joint_actuator */ {
          // Source: drake/multibody/plant/multibody_plant.h:5359
          const char* doc =
...
removed using RemoveJointActuator().)""";
        ...
        struct /* has_sampled_output_ports */ {
          // Source: drake/multibody/plant/multibody_plant.h:5001
          const char* doc =
...
ports). See output_port_sampling "Output port sampling" for details.)""";
        ...
        struct /* is_finalized */ {
          // Source: drake/multibody/plant/multibody_plant.h:4994
          const char* doc =
...
See also:
    Finalize().)""";
        ...
        struct /* is_gravity_enabled */ {
          // Source: drake/multibody/plant/multibody_plant.h:5453
          const char* doc =
R"""(Returns:
...
R"""(A mutable accessor to the current gravity field.)""";
        ...
        struct /* num_actuated_dofs */ {
          // Source: drake/multibody/plant/multibody_plant.h:5346
          const char* doc_0args =
...
vector of actuation values u has this size. See AddJointActuator().)""";
          // Source: drake/multibody/plant/multibody_plant.h:5352
          const char* doc_1args =
...
Raises:
    RuntimeError if called pre-finalize.)""";
        ...
        struct /* num_actuators */ {
          // Source: drake/multibody/plant/multibody_plant.h:5335
          const char* doc_0args =
R"""(Returns the number of joint actuators in the model.

See also:
    AddJointActuator().)""";
          // Source: drake/multibody/plant/multibody_plant.h:5339
          const char* doc_1args =
...
R"""(Returns the total number of ball constraints specified by the user.)""";
        ...
        struct /* num_bodies */ {
          // Source: drake/multibody/plant/multibody_plant.h:5016
          const char* doc =
...
See also:
    AddRigidBody().)""";
        ...
        struct /* num_collision_geometries */ {
          // Source: drake/multibody/plant/multibody_plant.h:5632
          const char* doc =
...
user.)""";
        ...
        struct /* num_force_elements */ {
          // Source: drake/multibody/plant/multibody_plant.h:5422
          const char* doc =
...
See also:
    AddForceElement().)""";
        ...
        struct /* num_frames */ {
          // Source: drake/multibody/plant/multibody_plant.h:5279
          const char* doc =
...
This means the minimum number of frames is one.)""";
        ...
        struct /* num_joints */ {
          // Source: drake/multibody/plant/multibody_plant.h:5173
          const char* doc =
...
See also:
    AddJoint().)""";
        ...
        struct /* num_model_instances */ {
          // Source: drake/multibody/plant/multibody_plant.h:5477
          const char* doc =
...
See also:
    AddModelInstance().)""";
        ...
        struct /* num_multibody_states */ {
          // Source: drake/multibody/plant/multibody_plant.h:5538
          const char* doc_0args =
...
Raises:
    RuntimeError if called pre-finalize.)""";
          // Source: drake/multibody/plant/multibody_plant.h:5545
          const char* doc_1args =
...
Raises:
    RuntimeError if called pre-finalize.)""";
        ...
        struct /* num_positions */ {
          // Source: drake/multibody/plant/multibody_plant.h:5513
          const char* doc_0args =
R"""(Returns the size of the generalized position vector q for this model.

Raises:
    RuntimeError if called pre-finalize.)""";
          // Source: drake/multibody/plant/multibody_plant.h:5518
          const char* doc_1args =
...
R"""(Returns the total number of tendon constraints specified by the user.)""";
        ...
        struct /* num_velocities */ {
          // Source: drake/multibody/plant/multibody_plant.h:5524
          const char* doc_0args =
R"""(Returns the size of the generalized velocity vector v for this model.

Raises:
    RuntimeError if called pre-finalize.)""";
          // Source: drake/multibody/plant/multibody_plant.h:5529
          const char* doc_1args =
...
Raises:
    RuntimeError if called pre-finalize.)""";
        ...
        struct /* num_visual_geometries */ {
          // Source: drake/multibody/plant/multibody_plant.h:5626
          const char* doc =
...
Raises:
    RuntimeError iff called post-finalize.)""";
        ...
        struct /* set_gravity_enabled */ {
          // Source: drake/multibody/plant/multibody_plant.h:5461
          const char* doc =
...
See also:
    set_stiction_tolerance.)""";
        ...
        struct /* time_step */ {
          // Source: drake/multibody/plant/multibody_plant.h:4989
          const char* doc =
...
See also:
    MultibodyPlant::MultibodyPlant(double))""";
        ...
        struct /* world_body */ {
          // Source: drake/multibody/plant/multibody_plant.h:5004
          const char* doc =
R"""(Returns a constant reference to the *world* body.)""";
        } world_body;
        // Symbol: drake::multibody::MultibodyPlant::world_frame
        struct /* world_frame */ {
          // Source: drake/multibody/plant/multibody_plant.h:5009
          const char* doc =
