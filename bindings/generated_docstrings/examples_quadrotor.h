...
static method to create and add it to a DiagramBuilder directly.)""";
          ...
          struct /* AddToBuilder */ {
            // Source: drake/examples/quadrotor/quadrotor_geometry.h:39
            const char* doc =
...
QuadrotorGeometry system that is owned by the ``builder``.)""";
          ...
          struct /* get_frame_id */ {
            // Source: drake/examples/quadrotor/quadrotor_geometry.h:30
            const char* doc =
...
quadrotor.)""";
        ...
        struct /* QuadrotorPlant */ {
          // Source: drake/examples/quadrotor/quadrotor_plant.h:32
          const char* doc =
...
force is taken to be zero.)""";
          ...
          struct /* ctor */ {
            // Source: drake/examples/quadrotor/quadrotor_plant.h:34
            const char* doc = R"""()""";
            // Source: drake/examples/quadrotor/quadrotor_plant.h:40
