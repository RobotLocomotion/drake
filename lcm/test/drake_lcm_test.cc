...
TEST_F(DrakeLcmTest, AdressFilterAcceptanceTest) {
  const std::string channel_name = "DrakeLcmTest.AdressFilterAcceptanceTest";
  ...
  // A crosstralker with the same port number but different address.
