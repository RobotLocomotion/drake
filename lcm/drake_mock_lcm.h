...
class DrakeMockLcm : public DrakeLcmInterface {
 public:
  ...
  DRAKE_DEPRECATED("2019-06-01",
      "Call HandleSubscriptions periodically instead.")
...
#pragma GCC diagnostic pop
   ...
   */
  DRAKE_DEPRECATED("2019-06-01", "Use a DrakeLcmLog to record times instead.")
  ...
  DRAKE_NODISCARD std::unique_ptr<DrakeSubscription> Subscribe(
      const std::string&, int, HandlerFunction) override;
