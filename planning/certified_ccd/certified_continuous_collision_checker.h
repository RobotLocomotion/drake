...
#include "drake/planning/certified_ccd/certificate.h"
#include "drake/planning/certified_ccd/distance_oracle.h"
...
class CertifiedContinuousCollisionChecker {
 public:
  struct Params {
  ...
  scope). */
  explicit CertifiedContinuousCollisionChecker(Params params);
