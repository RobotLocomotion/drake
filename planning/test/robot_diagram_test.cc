...
GTEST_TEST(RobotDiagramBuilderTest, NoDefaultExport_CustomInputPort) {
  std::unique_ptr<RobotDiagramBuilder<double>> dut = MakeSampleDut();
  dut->plant().Finalize();
...
GTEST_TEST(RobotDiagramBuilderTest, NoDefaultExport_CustomOutputPort) {
  std::unique_ptr<RobotDiagramBuilder<double>> dut = MakeSampleDut();
...
// exported.
GTEST_TEST(RobotDiagramBuilderTest, NoDefaultExport_CustomSystems) {
