...
namespace drake {
namespace planning {
/// Base class for implementations of symmetric planning spaces with a
...
class SymmetricCollisionCheckerPlanningSpace
 ...
 public:
  ...
  SymmetricCollisionCheckerPlanningSpace(
      SymmetricCollisionCheckerPlanningSpace<StateType>&&) = delete;
  SymmetricCollisionCheckerPlanningSpace& operator=(
      const SymmetricCollisionCheckerPlanningSpace<StateType>&) = delete;
  SymmetricCollisionCheckerPlanningSpace& operator=(
      SymmetricCollisionCheckerPlanningSpace<StateType>&&) = delete;

  ~SymmetricCollisionCheckerPlanningSpace() override;
