...
GTEST_TEST(GcsTrajectoryOptimizationTest, MinimumTimeVsPathLength) {
  ...
  */
  ...
  // trajectory to be 5 (one for start, three for the scooter_regions and one
  // for the goal) and the path length to be greater than 2.4 (the minimum path
  // length for the detour).
