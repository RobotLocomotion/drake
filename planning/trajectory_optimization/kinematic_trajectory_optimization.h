...
class KinematicTrajectoryOptimization {
  ...
  */
  ...
  const VectorX<symbolic::Variable>& placeholder_q_vars() const {
    return placeholder_q_vars_;
  }

  const VectorX<symbolic::Variable>& placeholder_qdot_vars() const {
    return placeholder_qdot_vars_;
  }

  const VectorX<symbolic::Variable>& placeholder_qddot_vars() const {
