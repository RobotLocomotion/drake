...
class KinematicTrajectoryOptimization {
  ...
  */
  ...
  constraining all of the control points for one element of q̇ (e.g. the
  velocity of the ith joint at all times). */
  ...
  acceleration of the ith joint at all times). */
  ...
  jerk of the ith joint at all times). */
