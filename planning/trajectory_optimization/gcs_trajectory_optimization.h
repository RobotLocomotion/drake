...
it supports continuity on the path r(s) for arbitrary degree. The resulting
trajectories can descaled @see
`planning::trajectory_optimization::DescaleGcsTrajectory()` and post-processed
with e.g. Toppra in order to enforce proper acceleration constraints on the
trajectory.
...
class GcsTrajectoryOptimization final {
  ...
  */
  class Subgraph final {
    ...
    */
    ...
    /** Enforces higher order continuity constraints on the subgraph.
    ...
    `planning::trajectory_optimization::DescaleGcsTrajectory()` will return r(s)
    with valid continuity.

    @throws std::exception if the continuity order is not equal or less than
        the order the subgraphs.
    @throws std::exception if the continuity order is less than one.
    */
  ...
  */
  class EdgesBetweenSubgraphs final {
    ...
    */
    ...
    /** Enforces higher order continuity constraints on the edges between the
    subgraphs.
     @param continuity_order is the order of the continuity constraint.
  ...
  */
  ...
  /** Enforces higher order continuity constraints on the entire graph.
  @param continuity_order is the order of the continuity constraint.
...
/** Descales the solution trajectory of GcsTrajectoryOptimization s.t. each
segment is one second long.
