...
class GcsTrajectoryOptimization final {
  ...
  */
  ...
  GcsTrajectoryOptimization::AddRegions() automatically manages edge creation and
  intersection checks, which makes passing a sequence of edges less convenient.
