...
class GcsTrajectoryOptimization final {
  ...
  */
  class Subgraph final {
   ...
   private:
    ...
    Eigen::Map<const MatrixX<symbolic::Variable>> GetControlPoints(const 
        geometry::optimization::GraphOfConvexSets::Vertex& v) const;
  ...
  */
  ...
  const geometry::optimization::GraphOfConvexSets& gcs() const { return gcs_; }
