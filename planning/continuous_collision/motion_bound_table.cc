...
MotionBoundTable KinematicsEngine::ComputeMotionBoundTable(
  ...
  // range collapses to within kContinuityTolerance. That is a
  ...
  // *whole* control-point range fits inside kContinuityTolerance.
  ...
  // else and is orders of magnitude above kNumericalSlack, so the
  ...
  //    ρ ≤ kContinuityTolerance around a unit quaternion, m ≥ 1 − ρ, so
