...
//     Eigen::Matrix3Xd obstacle = obs_points;
//     obstacle.colwise() += centers.col(obstacle_idx);
//     meshcat->SetLine(fmt::format("/obstacles/obs_{}", obstacle_idx),
//     obstacle,
//                      8.0, Rgba(0, 0, 0));
//   }
...
//                             .GetMinimalRepresentation();
//     Draw2dVPolytope(vregion, fmt::format("manual_decomposition_{}", i),
//     color,
//                     meshcat);
//   }
...
//     color.normalize();
//     VPolytope vregion = VPolytope(sets.at(i)).GetMinimalRepresentation();
//     Draw2dVPolytope(vregion, fmt::format("iris_from_clique_cover_greedy{}",
//     i),
//                     color, meshcat);
//   }
