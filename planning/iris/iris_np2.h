...
struct RaySamplerOptions {
  ...
  /** The number of steps used for ray search. A larger number requires more
   * time for computing samples, but will lead to the samples in-collision being
   * closer to the ellipsoid center, and higher quality hyperplanes. We choose a
   * default value to roughly match the results in [Werner et al., 2024]. */
