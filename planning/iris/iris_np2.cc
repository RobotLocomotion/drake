 ...
 * collision, and then the resulting particle in collision will be stored into
 * the output argument `particle`. If no collision is found, returns false, and
 * no change is made to `particle`. */
