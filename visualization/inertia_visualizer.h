...
namespace internal {
/* Returns the inertia geometry Shape and X_BoBcm that represent the given
body's moments of inertia. */
template <typename T>
std::pair<std::unique_ptr<geometry::Shape>, math::RigidTransform<double>>
