...
std::vector<MeshcatVisualizerParams> ConvertVisualizationConfigToMeshcatParams(
  ...
  if (config.publish_inertia) {
    ...
    inertia.default_color = config.default_inertia_color;
...
InertiaVisualizerParams ConvertVisualizationConfigToInertiaParams(
  ...
  result.default_color = config.default_inertia_color;
  ...
  result.default_color.set(result.default_color.r(), result.default_color.g(),
                           result.default_color.b(), 0.0);
