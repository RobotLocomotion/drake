...
Labels are mapped to colors with a built-in, fixed palette. For label pixels
that do not represent a label ("don't care", "empty", "unspecified", etc.), the
color pixel will use the `background_color` property (by default, black with 0%
alpha).
