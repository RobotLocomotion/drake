...
class MultipleShooting : public solvers::MathematicalProgram {
 ...
 protected:
  ...
  /// Constructs a MultipleShooting instance with fixed sample times.
  ///
  /// Instead of creating new placeholder variables for input and state, this
  /// version of constructor uses the provided `input` and `state` as
  /// placeholders.
  ///
  ...
  /// variables.
  ///
  /// Instead of creating new placeholder variables for input, state, and time,
  /// this version of constructor uses the provided `input`, `state`, and `time`
  /// as placeholders.
  ///
  /// @param input Placeholder variables for input.
  /// @param state Placeholder variables for state.
  ...
  MultipleShooting(const solvers::VectorXDecisionVariable& input,
                   const solvers::VectorXDecisionVariable& state,
                   const symbolic::Variable& time, int num_time_samples,
                   double minimum_timestep, double maximum_timestep);
