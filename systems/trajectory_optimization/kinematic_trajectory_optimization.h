...
class KinematicTrajectoryOptimization {
 public:
  ...
  set to the zero trajectory. The initial guess for the duration will be set to
  `duration`. */
  ...
  */
  ...
  `ub`. Note that this does NOT directly constraint q̇(t).
  @pre 0 <= `s` <= 1. */
  ...
  `lb` ≤ r̈(s) ≤ `ub`. Note that this does NOT directly constraint q̈(t).
  @pre 0 <= `s` <= 1. */
  ...
  bounds will be respected at all times. Note this does NOT directly constraint
  ṙ(s). */
