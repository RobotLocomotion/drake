...
struct DynamicProgrammingOptions {
  ...
  /// considering the dynamics of any non-continuous states. This is helpful for
  /// optimizing systems that might have some additional book-keeping variables
  /// in their state. Only use this if you are sure that the dynamics of the
  /// additional state variables cannot impact the dynamics of the continuous
