...
// For a time-invariant system and cost, the LinearQuadraticRegular should be a
// stable fixed-point for the finite-horizon solution.
...
// Verify that we can stabilize a non-zero fixed-point trajectory.
GTEST_TEST(FiniteHorizonLQRTest, NominalTrajectoryTest) {
  ...
  // This system has fixed points at -1, 0, and 1.
