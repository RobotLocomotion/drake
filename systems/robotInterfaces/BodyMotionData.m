classdef BodyMotionData
  ...
  methods
    ...
    function [x, xd, xdd] = eval(obj, t)
      ...
      [x, xd, xdd] = obj.evalAtTInd(obj, t_ind, t);
    end

    function [x, xd, xdd] = evalAtTInd(obj, t_ind, t)
    ...
    function body_motion_slice = sliceAtTime(obj, t)
      body_motion_slice = obj.sliceAtTInd(obj.findTInd(t));
    end

    function body_motion_slice = sliceAtTInd(obj, t_ind)
