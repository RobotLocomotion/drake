...
LcmPublisherSystem::LcmPublisherSystem(
    ...
    std::unique_ptr<LcmAndVectorBaseTranslator> owned_translator,
...
LcmPublisherSystem::LcmPublisherSystem(
    const std::string& channel,
    std::unique_ptr<LcmAndVectorBaseTranslator> translator,
    drake::lcm::DrakeLcmInterface* lcm)
    : LcmPublisherSystem(channel, nullptr, std::move(translator),
                         nullptr,
                         lcm) {}
