...
@param lcm_buses A map of {bus_name: interface} for LCM transceivers, to be used
used by drivers, sensors, etc.

@exclude_from_pydrake_mkdoc{Cannot overload on dict key type.} */
...
for each bus within the given diagram builder, and returns an LcmBuses object
