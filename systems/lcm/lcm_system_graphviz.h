...
class LcmSystemGraphviz {
 public:
  ...
  @param lcm The interface pointer the system communicated with.
  ...
  @param subscribe True iff the system publishes messages to LCM.
   This draws a Graphviz arrow from the system to `lcm`.
  @param subscribe True iff the system receives messages from LCM.
