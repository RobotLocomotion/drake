...
/// following section as classes.
/// On the other hand, there are other sensors that can be implemented using the
/// internal functionalities of other classes (e.g. ports), such as:
/// - **Multibody Force/Torque**, can be modeled using
/// @ref drake::multibody::MultibodyPlant::get_reaction_forces_output_port()
/// "get_reaction_forces_output_port()". More details can be referred to
/// this function. You can also refer to *planar_gripper* for an example.
/// @}
