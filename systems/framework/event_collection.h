...
class LeafEventCollection final : public EventCollection<EventType> {
 ...
 private:
  ...
  // This flag is true iff the events_ vector is invalid.
  mutable bool events_are_invalid_{false};
};
