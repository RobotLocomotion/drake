...
class DiagramBuilder {
 public:
  ...
  /// Connects an input to the entire Diagram, indicated by @p port_name, to
  /// the given @p input port of a constituent system.
  /// @pre The Diagram input indicated by @p port_name must have been
  /// previously built via ExportInput().
  /// @post @p input is connected to the indicated Diagram input port.
  void ConnectInput(const std::string& port_name, const InputPort<T>& input);

  /// Connects an input to the entire Diagram, indicated by @p port_index, to
  /// the given @p input port of a constituent system.
  /// @pre The Diagram input indicated by @p port_index must have been
  /// previously built via ExportInput().
  /// @post @p input is connected to the indicated Diagram input port.
  void ConnectInput(InputPortIndex port_index, const InputPort<T>& input);
