...
class DiagramBuilder {
 public:
  ...
  /// name for the input port; if it is unspecified, then a default name will
  /// be provided.
  ...
  /// Connects the given @p input port of a constituent system to an input to
  /// the entire Diagram, indicated either by @p name or @p port_index.
  void ConnectInput(const InputPort<T>& input, const std::string& port_name);
  void ConnectInput(const InputPort<T>& input, InputPortIndex port_index);
