...
/// @tparam U the donor scalar type (to convert from), which must be one of
...
class SystemScalarConverter {
 public:
  ...
  /// Creates a converter that supports no conversions.  The single-argument
  /// constructor below is the typical way to create instances of this type.
  ...
  using ConverterFunction
      ...
      "Only scalar-converting copy constructors are supported anymore.")
...
#pragma GCC diagnostic pop
  ...
  DRAKE_DEPRECATED("2021-10-01",
      "User-defined scalar types cannot be added anymore.")
  void AddIfSupported() {
