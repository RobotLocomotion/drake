...
class WitnessFunction {
 public:
  ...
  ///       Simulator's integration of an ODE to terminate a step at the
  ///       witness isolation time. For example, isolating a function's
  ///       minimum or maximum values can be realized with a witness that
  ///       triggers on a sign change of the function's time derivative,
  ///       ensuring that the actual extreme value is present in the discretized
  ///       trajectory.
