...
GTEST_TEST(ModelLeafSystemTest, ModelAbstractState) {
  ...
  // The default implementation (used here) clones declared resources,
  // that is, it sets the values. This however, is not strictly
  // required of any implementation that overrides AllocateContext().
  ...
  value.SetValue<std::string>("whoops");
