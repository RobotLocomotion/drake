...
// The preferred method of handling events is no longer to override the
// DoPublish(), etc. dispatchers as most of the test above validate. Instead
// users should provide individual handler functions for each event. There
