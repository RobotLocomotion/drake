...
class LeafContextTest : public ::testing::Test {
 protected:
  void SetUp() override {
    ...
    // LeafContextTest has attorney-client privilege to do this.
    detail::LeafSystemContextAttorney<double>::init_parameters(
        &context_, std::make_unique<Parameters<double>>(
