...
TEST_F(LeafContextTest, ToString) {
  ...
  EXPECT_THAT(str, ::testing::HasSubstr("Time: 12"));
  EXPECT_THAT(str, ::testing::HasSubstr("5 continuous states"));
  EXPECT_THAT(str, ::testing::HasSubstr("2 discrete state groups"));
  EXPECT_THAT(str, ::testing::HasSubstr("1 abstract state"));
  EXPECT_THAT(str, ::testing::HasSubstr("2 numeric parameter groups"));
  EXPECT_THAT(str, ::testing::HasSubstr("1 abstract parameters"));
}
