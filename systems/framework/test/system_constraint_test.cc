...
GTEST_TEST(SystemConstraintTest, Basic) {
  ...
  SystemConstraint<double> equality_constraint(
      ...
      "equality constraint");
  context->get_mutable_continuous_state_vector().at(1) = 5.0;
  ...
  context->get_mutable_continuous_state_vector().at(1) = 0.0;
  equality_constraint.Calc(*context, &value);
  ...
  EXPECT_TRUE(CompareMatrices(inequality_constraint.upper_bound(),
                              Eigen::Vector2d(4, 6)));
  context->get_mutable_continuous_state_vector().at(0) = 3.0;
  context->get_mutable_continuous_state_vector().at(1) = 5.0;
  ...
  context->get_mutable_continuous_state_vector().at(1) = -0.5;
  inequality_constraint.Calc(*context, &value);
