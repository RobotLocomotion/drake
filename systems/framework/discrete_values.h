...
class DiscreteValues {
 public:
  ...
  /// (To be deprecated) Returns the entire vector as a const Eigen::VectorBlock
  /// for the _only_ group. Prefer `value()` which returns direct access to the
  ...
  /// @name Accessors for %DiscreteValues with multiple groups, or with an
  /// unknown number of groups. If you know there is only one group consider
  ...
  // TODO(sherm1) Deprecate this.
  /// (To be deprecated) Returns the entire vector as a const Eigen::VectorBlock
  /// for the indicated group. Prefer `value()` which returns direct access to
