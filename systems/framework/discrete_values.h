...
class DiscreteValues {
 public:
  ...
  // TODO(jwnimmer-tri) Deprecate me, use SetFrom instead.
  /// (To be deprecated.)  Writes the values from @p other into this
  /// DiscreteValues, possibly writing through to unowned data. Asserts if the
