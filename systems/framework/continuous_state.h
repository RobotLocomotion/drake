...
/// in contiguous memory. Nevertheless this %ContinuousState class provides a
/// vector view of the data that groups together all the q partitions, v
/// partitions, and z partitions. For example, if there are three subsystems
/// whose continuous state variables are respectively xc₁={q₁,v₁,z₁},
/// xc₂={q₂,v₂,z₂}, and xc₃={q₃,v₃,z₃} the composite xc appears in subsystem
/// order as xc=[xc₁ xc₂ xc₃]. Similarly composite q, v, and z appear ordered as
/// q=[q₁ q₂ q₃], v=[v₁ v₂ v₃], z=[z₁ z₂ z₃]. Note that the element ordering
/// of the composite xc is not a concatenation of the composite subgroups.
///
