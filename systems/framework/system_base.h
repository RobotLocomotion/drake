...
#pragma GCC diagnostic pop
 ...
 protected:
  ...
  ContextSizes data. */
  virtual void AddInSubsystemContextSizes(ContextSizes* sizes) const = 0;

  /** Allows Diagram to access protected AddInSubsystemContextSizes()
  recursively on its subsystems. */
  static void AddInSubsystemContextSizes(const SystemBase& system,
                                         ContextSizes* sizes) {
    return system.AddInSubsystemContextSizes(sizes);
  }
