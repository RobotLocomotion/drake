...
class Diagram : public System<T>, internal::SystemParentServiceInterface {
 ...
 private:
  ...
  // To get here:
  // - The EventCollection must be a DiagramEventCollection.
  // - The DiscreteValues must be a DiagramDiscreteValues.
  // - The Context must be a DiagramContext.
  ...
  // To get here:
  // - The EventCollection must be a DiagramEventCollection.
  // - The State must be a DiagramState.
  // - The Context must be a DiagramContext.
