...
/// diagram at Build() time. Data stored here will have a life-cycle that is
/// the union of the builder and the diagram.
///
/// This mechanism is particularly useful for the Python FFI. It can be used
/// to extend the lifetime of Python-wrapped systems, when the Build() call
/// occurs in C++ that is not exposed to the Python bindings.
