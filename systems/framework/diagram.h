...
class Diagram : public System<T>, internal::SystemParentServiceInterface {
 ...
 private:
  ...
  // If this method is called we know:
  // - the EventCollection is a DiagramEventCollection, and
  // - the DiscreteValues is a DiagramDiscreteValues, and
  // - the Context is a DiagramContext.
  ...
  // If this method is called we know:
  // - the EventCollection is a DiagramEventCollection, and
  // - the State is a DiagramState, and
  // - the Context is a DiagramContext.
