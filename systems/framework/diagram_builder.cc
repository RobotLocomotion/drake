...
void DiagramBuilderImpl::ThrowIfAlgebraicLoopsExist(
  ...
  constexpr const char* const kAdvice =
      ...
      " 'is direct-feedthrough to' lines above indicates that"
      " a System's output port is declared to depend on one of"
      " its input ports, but such a dependency is spurious."
      " In that case, remove the spurious dependency as shown"
      " in the API documentation for LeafSystem::DoHasDirectFeedthrough.";
