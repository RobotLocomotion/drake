...
class LeafSystem : public System<T> {
 ...
 protected:
  ...
  /// Declares that a Publish event should occur at initialization at the end
  /// of every trajectory-advancing substep and that it should invoke the given
  ...
  ///
  /// During initialization, initialization unrestricted update events are
