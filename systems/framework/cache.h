...
class CacheEntryValue {
  ...
  */
  ...
  Note that if this returns true while the cache is frozen, trouble will ensue
  since recomputation is forbidden in that case. However, operation of _this_
  method is unaffected by whether the cache is frozen. */
