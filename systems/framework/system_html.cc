...
class InputPortTokenWriter : public SystemVisitor<double> {
 public:
  InputPortTokenWriter(int port_index, std::stringstream* html)
...
class OutputPortTokenWriter : public SystemVisitor<double> {
 public:
  OutputPortTokenWriter(int port_index, std::stringstream* html)
      : port_index_(port_index), html_(html) {}
 ...
 public:
  ...
  void VisitDiagram(const Diagram<double>& diagram) final {
    ...
    for (const auto& edge : diagram.connection_map()) {
      ...
      *html_ << "{ ";
      InputPortTokenWriter input_writer(src.second, html_);
      src_sys->Accept(&input_writer);
      OutputPortTokenWriter output_writer(dest.second, html_);
