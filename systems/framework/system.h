...
class System : public SystemBase {
 public:
  ...
  /// context for the containing %System (typically a Diagram). If `this`
  /// %System is already the top level (root) %System, just returns the
  /// root_context. (A root Context is one that does not have a parent Context.)
  ...
  /// context for the containing %System (typically a Diagram).
