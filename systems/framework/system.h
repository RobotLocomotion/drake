...
class System : public SystemBase {
  ...
  */
  ...
  // These are internal use only, intended for use by the Simulator so it can
  // issue forced events in the same manner as for other triggers, and in some
  // narrowly-targeted unit tests of the event system.
