...
class System : public SystemBase {
 public:
  ...
  ///     call. This is mutable to permit entries to be swapped rather than
  ///     copied for better performance.
  /// @param[in,out] context
  ///     The Context whose discrete state is modified to match
  ///     @p discrete_state. Note that swapping may cause object addresses
  ...
  ///     mutable to permit entries to be swapped rather than copied for better
  ///     performance.
  /// @param[in,out] context
  ///     The Context whose State is modified to match @p state. Note that
  ///     swapping may cause object addresses to be different on return than
  ///     they were on entry.
