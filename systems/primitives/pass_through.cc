...
// TODO(russt): Put this is into common (but I tried and failed in #13003).
...
PassThrough<T>::PassThrough(const PassThrough<U>& other)
    : PassThrough(internal::ExtractDoublesOrThrow(other.model_vector_)
                      .template cast<T>(),
