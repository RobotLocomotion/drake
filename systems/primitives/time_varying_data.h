...
inline TimeVaryingData::TimeVaryingData(
...
inline TimeVaryingData::TimeVaryingData(const PiecewisePolynomial<double>& Ain,
...
inline LinearTimeVaryingData::LinearTimeVaryingData(
    const std::vector<Eigen::MatrixXd>& Ain,
    const std::vector<Eigen::MatrixXd>& Bin,
    const std::vector<Eigen::MatrixXd>& Cin,
