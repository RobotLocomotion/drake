...
valued outputs. The inputs to this system directly feeds through to its outputs.
...
The port names shown in the figure above are just the defaults. Custom names may
be specified in the SelectorParams.
