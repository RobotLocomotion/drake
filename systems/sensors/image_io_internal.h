...
@param dest_channels Number of destination channels (typically 1, 3, or 4). This
 option is intended to either add or remove the alpha channel, so it must be
 within ±1 of source_channels.
