...
// acceptance test of RgbdSensorAsync lives in rgbd_sensor_async_test.cc.
...
class RgbdSensorAsyncTest : public ::testing::Test {
 public:
  ...
  "default" image (notably, not the "clear" image) of the correct size. */
  ...
  /* Checks that all four image output ports of the given system are producing a
  "clear" image (notably, not the "default" image) of the correct size. */
  ...
  images of the correct size and with the given pixel values. */
