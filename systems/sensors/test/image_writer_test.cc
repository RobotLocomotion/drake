...
class ImageWriterTester {
 public:
  ...
  static bool DirectoryIsMissing(const spruce::path& file_path) {
    return ImageWriter::ValidateDirectory(file_path) ==
        ImageWriter::FolderState::kMissing;
  }

  static bool DirectoryIsFile(const spruce::path& file_path) {
    return ImageWriter::ValidateDirectory(file_path) ==
        ImageWriter::FolderState::kIsFile;
  }

  static bool DirectoryIsUnwritable(const spruce::path& file_path) {
    return ImageWriter::ValidateDirectory(file_path) ==
...
EXPECT_TRUE(ImageWriterTester::DirectoryIsUnwritable(spruce::path("/root")));
  ...
  EXPECT_TRUE(ImageWriterTester::DirectoryIsFile(spruce::path(file_name)));
}
