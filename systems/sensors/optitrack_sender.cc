...
void OptitrackLcmFrameSender::PopulatePoseMessage(
  ...
  const auto& poses =
      get_optitrack_input_port().Eval<geometry::FramePoseVector<double>>(
          context);
