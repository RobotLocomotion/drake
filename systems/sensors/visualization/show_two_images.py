...
if __name__ == "__main__":
    ...
    if args.test_image:
        ...
        image_viewer = DrakeLcmImageViewer("DRAKE_RGBD_CAMERA_IMAGES_simulated_xtion", args.frame_names)
        image_viewer = DrakeLcmImageViewer("DRAKE_RGBD_CAMERA_IMAGES_simulated_xtion_no_robot", args.frame_names)
