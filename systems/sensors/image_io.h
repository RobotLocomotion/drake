...
class ImageIo {
 public:
  ...
  on the result; the actual file contents solely determines the file format. */
  ...
  contents solely determines the file format.
  ...
  bearing on the result; the actual file contents solely determines the file
  format.
