...
constexpr float ImageTraits<PixelType::kDepth32F>::kTooClose;
constexpr float ImageTraits<PixelType::kDepth32F>::kTooFar;
...
constexpr uint16_t ImageTraits<PixelType::kDepth16U>::kTooClose;
constexpr uint16_t ImageTraits<PixelType::kDepth16U>::kTooFar;
