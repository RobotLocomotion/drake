...
class RgbdSensorAsync final : public LeafSystem<double> {
 public:
  ...
  DRAKE_DEPRECATED("2025-04-01", "Use default_parent_frame_id() instead.")
  geometry::FrameId parent_id() const { return default_parent_frame_id(); }

  DRAKE_DEPRECATED("2025-04-01", "Use default_X_PB() instead.")
  const math::RigidTransformd& X_PB() const { return default_X_PB(); }

  DRAKE_DEPRECATED("2025-04-01", "Use default_fps() instead.")
  double fps() const { return default_fps(); }

  DRAKE_DEPRECATED("2025-04-01", "Use default_capture_offset() instead.")
  double capture_offset() const { return default_capture_offset(); }

  DRAKE_DEPRECATED("2025-04-01", "Use default_output_delay() instead.")
  double output_delay() const { return default_output_delay(); }

  DRAKE_DEPRECATED("2025-04-01", "Use default_color_render_camera() instead.")
  const std::optional<geometry::render::ColorRenderCamera>& color_camera()
      const {
    return default_color_render_camera();
  }

  DRAKE_DEPRECATED("2025-04-01", "Use default_depth_render_camera() instead.")
  ...
  double default_fps() const;

  /** Sets the default `fps`.  */
  void set_default_fps(double fps);

  /** Returns the context dependent `fps`. */
  double GetFps(const Context<double>& context) const;

  /** Sets the `fps`, as stored as parameters in `context`. */
  void SetFps(Context<double>* context, double fps) const;

  /** Returns the default `capture_offset`.  */
  double default_capture_offset() const;

  /** Sets the default `capture_offset`.  */
  void set_default_capture_offset(double capture_offset);

  /** Returns the context dependent `capture_offset`. */
  double GetCaptureOffset(const Context<double>& context) const;

  /** Sets the `capture_offset`, as stored as parameters in `context`. */
  void SetCaptureOffset(Context<double>* context, double capture_offset) const;

  /** Returns the default `output_delay`.  */
  double default_output_delay() const;

  /** Sets the default `output_delay`.  */
  void set_default_output_delay(double output_delay);

  /** Returns the context dependent `output_delay`. */
  double GetOutputDelay(const Context<double>& context) const;

  /** Sets the `output_delay`, as stored as parameters in `context`. */
  void SetOutputDelay(Context<double>* context, double output_delay) const;
  ...
  void SetColorRenderCamera(
      ...
      std::optional<geometry::render::ColorRenderCamera> color_camera) const;
  ...
  void SetDepthRenderCamera(
      Context<double>* context,
      std::optional<geometry::render::DepthRenderCamera> depth_camera) const;
