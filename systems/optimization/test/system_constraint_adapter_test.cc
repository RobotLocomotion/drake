...
GTEST_TEST(SystemConstraintAdapterTest,
  ...
  EXPECT_TRUE(CompareMatrices(
      math::ExtractValueMatrixFromAutoDiff(constraint_autodiff),
      math::ExtractValueMatrixFromAutoDiff(constraint_autodiff_expected), tol));
  EXPECT_TRUE(CompareMatrices(
      math::ExtractGradientMatrixFromAutoDiff(constraint_autodiff),
      math::ExtractGradientMatrixFromAutoDiff(constraint_autodiff_expected),
      tol));
