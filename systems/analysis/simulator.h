...
class Simulator {
 public:
  ...
  /// `set_publish_at_initialization(true)`. Most commonly if you want a
  /// forced-publish at the end of every step you will also want one at the end
  /// of initialization so both options should be enabled together.
  ///
