...
class Simulator {
 public:
  ...
  /// Initialize() after replacing the Context.  @param context The new
  /// context, which may be null. If the context is null, a new context must be
  /// set before attempting to step the system forward.
