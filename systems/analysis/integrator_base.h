...
class IntegratorBase {
 ...
 protected:
  ...
  bool DoDenseStep(const T& h) {
    ...
    // double values here.
    if (!dense_output_->empty() && start_time < dense_output_->end_time() &&
