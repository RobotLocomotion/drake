...
class IntegratorBase {
 ...
 protected:
   ...
   */
  virtual std::unique_ptr<trajectories::PiecewiseTrajectory<T>>
  ...
  virtual bool DoDenseStep(const T& h) {
    ...
    auto& dense_output =
        dynamic_cast<trajectories::PiecewisePolynomial<T>&>(*dense_output_);
    ...
    dense_output.ConcatenateInTime(
 ...
 private:
  ...
  std::unique_ptr<trajectories::PiecewiseTrajectory<T>> dense_output_{nullptr};
