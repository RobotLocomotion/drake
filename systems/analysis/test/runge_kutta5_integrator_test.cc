...
TEST_F(RK5IntegratorTest, ComparisonWithRK2) {
  ...
  // Re-integrate with RK5.
  std::unique_ptr<Context<double>> rk5_context = MakePlantContext();
  RungeKutta5Integrator<double> rk5(*plant_, rk5_context.get());
