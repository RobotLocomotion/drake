...
class PeriodicPublishWithTimedWitnessSystem final : public LeafSystem<double> {
 public:
  PeriodicPublishWithTimedWitnessSystem(double witness_trigger_time) {
...
// and a witnessed triggered event. All three combination of sequences is
...
GTEST_TEST(SimulatorTest, WitnessAndTimedSequences) {
  ...
  EXPECT_NEAR(sys_25.periodic_publish_time(), 0.5, accuracy);
  ...
  EXPECT_NEAR(sys_50.periodic_publish_time(), 0.5, accuracy);
  ...
  EXPECT_NEAR(sys_75.periodic_publish_time(), 0.5, accuracy);
