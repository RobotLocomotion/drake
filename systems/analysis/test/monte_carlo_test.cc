...
class RandomContextSystem : public VectorSystem<double> {
 public:
  RandomContextSystem() : VectorSystem(0, 1) {
    this->DeclareDiscreteState(1);
    this->DeclarePeriodicDiscreteUpdate(0.1, 0);
  }
 ...
 private:
  ...
  void DoCalcVectorDiscreteVariableUpdates(
      ...
      Eigen::VectorBlock<VectorX<double>>* next_state) const override {
