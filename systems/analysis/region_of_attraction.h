 ...
 * of attraction.
 *
 * @pre For the given @p system and @p context, any input ports on @p system
 * must be "defined", i.e., connected to other systems in a larger diagram or
 * holding fixed values; see System::FixInputPortsFrom for possible caveats.
 * Analyzing a closed-loop system would typically be accomplished by having both
