...
class RealtimeRateCalculator {
 public:
  ...
  struct RateReport {
    ...
    static RateReport Initialized();

    /* Constructs an instance representing the "empty" value. */
    static RateReport Empty();

    /* Constructs an instance representing the "computed" value. */
    static RateReport Computed(int period_count, double rate);
  };
