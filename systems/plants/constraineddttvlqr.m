function [c,Ktraj,Straj,Ptraj,Btraj,Ftraj,Straj_full] = constraineddttvlqr(obj,h,xtraj,utraj,Q,R,Qf,constraint_ind,options)
%CONSTRAINEDDTTVLQR
% discrete time TVLQR with constraints
% @input obj The plant object
% @input h the timestep
