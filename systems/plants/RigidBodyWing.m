    ...
    function obj = RigidBodyWing(profile, aero_origin, chord, span, stallAngle, velocity, parent_body)
            ...
            elseif strcmpi(profile, 'flat plate')
              ...
              error('avl support not ported to trunk yet');
                ...
                avlfile = fileread('avlblank.avl');
                runfiletemplate = fileread('avlblank.run');
                ...
                avlid = fopen('URDF.avl', 'w');
                fprintf(avlid, avlfile);
                %writes the case-specific files avl requires to run
                runid = fopen('URDF.run', 'w');
                avlcommandfile = fopen('myavlcommands.txt', 'w');
                ...
                try
                    if(linux)
                        commandfilepath = strcat(pwd, '/myavlcommands.txt');
                        avlfilepath = strcat(pwd, '/URDF.avl');
                        runfilepath = strcat(pwd, '/URDF.run');
                ...
                avlresult = fileread('avlresults.txt');
