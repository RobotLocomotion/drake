...
{
  RelativeGazeTargetConstraint* cnst = (RelativeGazeTargetConstraint*) getDrakeMexPointer(prhs[0]);
  ...
  {
    mexErrMsgIdAndTxt("Drake:updatePtrRelativeGazeTargetConstraintmex:BadInputs","argument 2 is not accepted");
  }
  delete[] field;
}
