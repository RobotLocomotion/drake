classdef Point2LineSegDistConstraint < SingleTimeKinematicConstraint
  ...
  methods
    function obj = Point2LineSegDistConstraint(robot,pt_body,pt,line_body,line_ends,dist_lb,dist_ub,tspan)
      ...
      ptr = constructPtrRigidBodyConstraintmex(RigidBodyConstraint.Point2LineSegDistConstraintType,robot.getMexModelPtr,pt_body,pt,line_body,line_ends,dist_lb,dist_ub,tspan);
