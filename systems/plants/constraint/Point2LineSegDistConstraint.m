classdef Point2LineSegDistConstraint < SingleTimeKinematicConstraint
  ...
  methods
    function obj = Point2LineSegDistConstraint(robot,pt_body,pt,line_body,line_ends,dist_lb,dist_ub,tspan)
      ...
      ptr = constructPtrPoint2LineSegDistConstraintmex(robot.getMexModelPtr,pt_body,pt,line_body,line_ends,dist_lb,dist_ub,tspan);
    ...
    function ptr = constructPtr(varargin)
      ptr = constructPtrPoint2LineSegDistConstraintmex(varargin{:});
    end
  end
end