...
{
  WorldFixedPositionConstraint* cnst = (WorldFixedPositionConstraint*) getDrakeMexPointer(prhs[0]);
  ...
  {
    mexErrMsgIdAndTxt("Drake:updatePtrWorldFixedPositionConstraintmex:BadInputs","argument 2 is not accepted");
  }
  delete[] field;
}
