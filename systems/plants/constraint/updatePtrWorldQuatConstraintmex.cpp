...
{
  WorldQuatConstraint* cnst = (WorldQuatConstraint*) getDrakeMexPointer(prhs[0]);
  ...
  {
    mexErrMsgIdAndTxt("Drake:updatePtrWorldQuatConstraintmex:BadInputs","argument 2 is not accepted");
  }
  delete[] field;
}
