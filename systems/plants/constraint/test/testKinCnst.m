...
testKinCnst_userfun(true,t,q,RigidBodyConstraint.WorldCoMConstraintType,robot,[0;0;0.9],[0;0;1],tspan0,1);
display('Check world CoM constraint with empty robot number');
testKinCnst_userfun(true,t,q,RigidBodyConstraint.WorldCoMConstraintType,robot,[0;0;0.9],[0;0;1],tspan0);
display('Check world CoM constraint with empty tspan');
testKinCnst_userfun(true,t,q,RigidBodyConstraint.WorldCoMConstraintType,robot,[0;0;0.9],[0;0;1]);
display('Check world CoM constraint with nan');
testKinCnst_userfun(true,t,q,RigidBodyConstraint.WorldCoMConstraintType,robot,[-inf;nan;0.9],[nan;inf;0.92],tspan0/2);
display('Check world CoM constraint with multiple robots');
testKinCnst_userfun(true,t,q_aff,RigidBodyConstraint.WorldCoMConstraintType,robot_aff,[0;0;0.9],[0;0;1],tspan0,[1,2]);

display('Check world position constraint');
testKinCnst_userfun(true,t,q,RigidBodyConstraint.WorldPositionConstraintType,robot,l_foot,l_foot_pts,[-100*ones(2,4);zeros(1,4)],[100*ones(2,4);zeros(1,4)],tspan0);

display('Check world position constraint with nan');
testKinCnst_userfun(true,t,q,RigidBodyConstraint.WorldPositionConstraintType,robot,l_foot,l_foot_pts,[nan(2,4);zeros(1,4)],[nan(2,4);zeros(1,4)],tspan0);

display('Check world quaternion constraint')
testKinCnst_userfun(true,t,q,RigidBodyConstraint.WorldQuatConstraintType,robot,r_foot,[1;0;0;0],0.01,tspan0);

display('Check world quaternion constraint, a subtle case')
testKinCnst_userfun(true,t,q,RigidBodyConstraint.WorldQuatConstraintType,robot,l_foot,l_foot_pos(4:7,1),0,tspan0);

display('Check world euler constraint')
testKinCnst_userfun(true,t,q,RigidBodyConstraint.WorldEulerConstraintType,robot,l_foot,[0;nan;0.9*pi],[0;nan;1.1*pi],tspan0);

display('Check world gaze orientation constraint')
testKinCnst_userfun(true,t,q,RigidBodyConstraint.WorldGazeOrientConstraintType,robot,head,[1;0;0],[0.5;0.5;-0.5;0.5],0.3*pi,0.1*pi,tspan0);

display('Check world gaze orientation constraint with empty threshold')
testKinCnst_userfun(true,t,q,RigidBodyConstraint.WorldGazeOrientConstraintType,robot,head,[1;0;0],[0.5;0.5;-0.5;0.5],[],[],tspan0);

display('Check world gaze direction constraint')
testKinCnst_userfun(true,t,q,RigidBodyConstraint.WorldGazeDirConstraintType,robot,l_hand,[1;0;0],[0.5;0.3;0.4],0.3*pi,tspan0);

display('Check world gaze direction constraint with empty threshold')
testKinCnst_userfun(true,t,q,RigidBodyConstraint.WorldGazeDirConstraintType,robot,head,[1;0;0],[0.5;0.3;0.4],[],tspan0);

display('Check world gaze target constraint');
testKinCnst_userfun(true,t,q,RigidBodyConstraint.WorldGazeTargetConstraintType,robot,head,[1;0;0],[20;10;1],[0.3;0.1;0.2],0.3*pi,tspan0);

display('Check world gaze target constraint with empty threshold');
testKinCnst_userfun(true,t,q,RigidBodyConstraint.WorldGazeTargetConstraintType,robot,head,[1;0;0],[20;10;1],[0.3;0.1;0.2],[],tspan0);
...
testKinCnst_userfun(false,t2,q21,MultipleTimeKinematicConstraint.WorldFixedPositionConstraintType,robot,l_hand,[[0;0;1] [1;0;1]],tspan0);
kc = WorldFixedPositionConstraint(robot,l_hand,[[0;0;1] [1;0;1]],tspan0);
[c,dc] = kc.eval(t2,q22);
valuecheck(c,[0;0]);
testKinCnst_userfun(false,t2,q22,MultipleTimeKinematicConstraint.WorldFixedPositionConstraintType,robot,l_hand,[[0;0;1] [1;0;1]],tspan0);

kc = WorldFixedPositionConstraint(robot,l_hand,[[0;0;1] [1;0;1]],tspan2);
[c,dc] = kc.eval(t3,q31);
valuecheck(c,[0;0]);
testKinCnst_userfun(false,t3,q31,MultipleTimeKinematicConstraint.WorldFixedPositionConstraintType,robot,l_hand,[[0;0;1] [1;0;1]],tspan2);

display('Check world fixed orientation constraint')
testKinCnst_userfun(false,t2,q21,MultipleTimeKinematicConstraint.WorldFixedOrientConstraintType,robot,l_hand,tspan0);
kc = WorldFixedOrientConstraint(robot,l_hand,tspan0);
[c,dc] = kc.eval(t2,q22);
valuecheck(c,length(t2));
testKinCnst_userfun(false,t2,q22,MultipleTimeKinematicConstraint.WorldFixedOrientConstraintType,robot,l_hand,tspan0);

kc = WorldFixedOrientConstraint(robot,l_hand,tspan2);
[c,dc] = kc.eval(t3,q31);
valuecheck(c,sum(kc.isTimeValid(t3)));
testKinCnst_userfun(false,t3,q31,MultipleTimeKinematicConstraint.WorldFixedOrientConstraintType,robot,l_hand,tspan2);

display('Check world fixed body pose constraint')
testKinCnst_userfun(false,t2,q21,MultipleTimeKinematicConstraint.WorldFixedBodyPoseConstraintType,robot,l_hand,tspan0);
kc = WorldFixedBodyPoseConstraint(robot,l_hand,tspan0);
[c,dc] = kc.eval(t2,q22);
valuecheck(c,[0;length(t2)]);
testKinCnst_userfun(false,t2,q22,MultipleTimeKinematicConstraint.WorldFixedBodyPoseConstraintType,robot,l_hand,tspan0);

kc = WorldFixedBodyPoseConstraint(robot,l_hand,tspan2);
[c,dc] = kc.eval(t3,q31);
valuecheck(c,[0;sum(kc.isTimeValid(t3))]);
testKinCnst_userfun(false,t3,q31,MultipleTimeKinematicConstraint.WorldFixedBodyPoseConstraintType,robot,l_hand,tspan2);


% display('Check all-to-all closest-distance constraint');
% testKinCnst_userfun(true,t,q,RigidBodyConstraint.AllBodiesClosestDistanceConstraint,r_collision,0.05,1e1,tspan0);
...
testKinCnst_userfun(true,t,q,RigidBodyConstraint.Point2PointDistanceConstraintType,robot,l_hand,r_hand,lhand_pts,rhand_pts,[0 0],[1 1],tspan0);
testKinCnst_userfun(true,t,q,RigidBodyConstraint.Point2PointDistanceConstraintType,robot,0,r_hand,rand(3,2),rhand_pts,[0 0],[1 1],tspan0);
...
testKinCnst_userfun(true,t,q,RigidBodyConstraint.WorldPositionInFrameConstraintType,robot,l_foot,l_foot_pts,T,[-100*ones(2,4);zeros(1,4)],[100*ones(2,4);zeros(1,4)],tspan0);

display('Check point to line segment distance constraint');
testKinCnst_userfun(true,t,q,RigidBodyConstraint.Point2LineSegDistConstraintType,robot,l_hand,[0;0;0],r_foot,r_foot_pts(:,1:2),0.1,1,tspan0);

display('Check Relative gaze target constraint');
testKinCnst_userfun(true,t,q,RigidBodyConstraint.RelativeGazeTargetConstraintType,robot,head,r_hand,[1;0;0],[0;0;0],[0;0;0],pi/30,tspan0);
end

function testKinCnst_userfun(singleTimeFlag,t,q,cnst_type,varargin)
robot = varargin{1};
robot_ptr = robot.getMexModelPtr;
if(singleTimeFlag)
  kc_mex = constructRigidBodyConstraint(cnst_type,true,robot_ptr,varargin{2:end});
  kc = constructRigidBodyConstraint(cnst_type,false,varargin{:});
