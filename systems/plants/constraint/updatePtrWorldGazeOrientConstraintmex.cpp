...
{
  WorldGazeOrientConstraint* cnst = (WorldGazeOrientConstraint*) getDrakeMexPointer(prhs[0]);
  ...
  {
    mexErrMsgIdAndTxt("Drake:updatePtrWorldGazeOrientConstraintmex:BadInputs","argument 2 is not accepted");
  }
  delete[] field;
}
