...
{
  WorldPositionInFrameConstraint* cnst = (WorldPositionInFrameConstraint*) getDrakeMexPointer(prhs[0]);
  ...
  {
    mexErrMsgIdAndTxt("Drake:updatePtrWorldPositionInFrameConstraintmex:BadInputs","argument 2 is not accepted");
  }
  delete[] field;
}
