...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
  ...
  int num_kc = 0;
  SingleTimeKinematicConstraint** kc_array = new SingleTimeKinematicConstraint*[num_constraint];
  ...
  mxArray* pm;
  pm = mxGetProperty(prhs[nrhs-1],0,"Q");
  Map<MatrixXd> Q(mxGetPr(pm),nq,nq);
  int error;
  GRBenv *grb_env = NULL;
