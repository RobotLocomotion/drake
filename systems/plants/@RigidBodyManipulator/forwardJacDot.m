...
if (kinsol.mex)
  ...
  if(body_or_frame_ind == 0)
    Jdot = rigidBodyManipulatormex(4,obj.mex_model_ptr,kinsol.q,0,robotnum,true);
  else
    Jdot = rigidBodyManipulatormex(4,obj.mex_model_ptr,kinsol.q,body_or_frame_ind,pts,rotation_type,true);
  end
else
