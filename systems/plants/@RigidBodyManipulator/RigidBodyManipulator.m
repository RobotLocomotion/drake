    ...
    function model = adjustContactShapes(model)
      ...
      if model.contact_options.replace_cylinders_with_capsules
        ...
        for i = 1:model.getNumBodies()
          [model.body(i),body_changed] = replaceCylindersWithCapsules(model.body(i));
          if body_changed
            warning(message_id, ...
              ['Body %d (''%s'') contained at least one ' ...
               'RigidBodyCylinder. This was replaced by a ' ...
               'RigidBodyCapsule, as the cylinder contact geometry ' ...
               ...
               '    >> r = %s(...);\n' ...
               '    >> warning(w)' ...
               '\n\n'],i,model.getLinkName(i),class(model),message_id,class(model));
          end
        end
      end
    end
