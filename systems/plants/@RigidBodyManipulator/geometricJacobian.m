...
if (kinsol.mex)
  ...
  if nargout > 2
    [J, v_or_qdot_indices, dJ] = rigidBodyManipulatormex(obj.GEOMETRIC_JACOBIAN_COMMAND,obj.mex_model_ptr, base, end_effector, expressed_in, in_terms_of_qdot);
  else
    [J, v_or_qdot_indices] = rigidBodyManipulatormex(obj.GEOMETRIC_JACOBIAN_COMMAND,obj.mex_model_ptr, base, end_effector, expressed_in, in_terms_of_qdot);
  end
else
