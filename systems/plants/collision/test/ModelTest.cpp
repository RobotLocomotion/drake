...
int main()
{
  ...
  id1 = model->addElement(unique_ptr<Element>(new Element(unique_ptr<DrakeShapes::Geometry>(new DrakeShapes::Box(Vector3d(1,1,1))))));
  id2 = model->addElement(unique_ptr<Element>(new Element(unique_ptr<DrakeShapes::Geometry>(new DrakeShapes::Sphere(0.5)))));
  id3 = model->addElement(unique_ptr<Element>(new Element(unique_ptr<DrakeShapes::Geometry>(new DrakeShapes::Sphere(0.5)))));
