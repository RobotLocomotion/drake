...
void mexFunction( int nlhs, mxArray *plhs[],
  ...
  if (nrhs != 4) {
    mexErrMsgIdAndTxt("Drake:forwardKinVelpmex:NotEnoughInputs", "Usage forwardKinVelpmex(model_ptr,body_index,pts,qd)");
  }
  ...
  if (!mxIsNumeric(prhs[0]) || mxGetNumberOfElements(prhs[0])!=1)
    mexErrMsgIdAndTxt("Drake:forwardKinVelpmex:BadInputs","the first argument should be the model_ptr");
