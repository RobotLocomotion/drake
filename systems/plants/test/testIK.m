...
l_knee_idx = find(strcmp(r.getStateFrame.coordinates,'l_leg_kny'));
r_knee_idx = find(strcmp(r.getStateFrame.coordinates,'r_leg_kny'));
...
[qmex,info_mex,infeasible_constraint_mex] = inverseKinPointwise(r,[0,1],[q_seed q_seed],[q_nom q_nom],kc_err,kc2l,kc2r,ikmexoptions);
display('The infeasible constraints are');
disp(infeasible_constraint_mex);
...
kc5 = WorldGazeDirConstraint(r,l_hand,[1;0;0],[1;0;0],0.4*pi,tspan);
