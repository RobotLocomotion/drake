...
ikoption = ikoption.setQ(diag(cost(1:r.getNumDOF)));

nom_data = load('../../../examples/Atlas/data/atlas_fp.mat');
q0 = nom_data.xstar(1:r.getNumDOF);
...
kc1 = constructKinematicConstraint(KinematicConstraint.WorldCoMConstraint,true,r,[0;0;nan],[0;0;nan]);
kc2 = constructKinematicConstraint(KinematicConstraint.WorldPositionConstraint,true,r,l_foot,l_foot_pts,l_foot_pos(1:3,:),l_foot_pos(1:3,:));
kc3 = constructKinematicConstraint(KinematicConstraint.WorldEulerConstraint,true,r,l_foot,l_foot_pos(4:6,1),l_foot_pos(4:6,1));
kc4 = constructKinematicConstraint(KinematicConstraint.WorldPositionConstraint,true,r,r_foot,r_foot_pts,r_foot_pos(1:3,:),r_foot_pos(1:3,:));
kc5 = constructKinematicConstraint(KinematicConstraint.WorldEulerConstraint,true,r,r_foot,r_foot_pos(4:6,1),r_foot_pos(4:6,1));
...
tic
[q_app_mex,info] = approximateIK(r,q_seed,q_nom,ikmexoption.Q,varargin{1:end-1});
toc
if(info~=0)
