classdef PolynomialSystem < RobotLibSystem, 
  ...
  methods
    function obj = PolynomialSystem(num_xc,num_xd,num_u,num_y,direct_feedthrough_flag,time_invariant_flag,p_dynamics,p_update,p_output)
      ...
      if (nargin>8 && num_y>0)
        ...
        if any([p_update.m,p_update.n] ~= [num_y,1]) error('p_output does not match num_y'); end
  ...
  methods  % for constructing and manipulating polynomial systems
    function polysys = timeReverse(obj)
      ...
      polysys = PolynomialSystem(obj.num_xc,obj.num_xd,obj.num_u,obj.num_u,obj.time_invariant_flag,obj.direct_feedthrough_flag,...
