...
# This variable is forked from bazelbuild/rules_cc as of:
# https://github.com/bazelbuild/rules_cc/blob/262ebec3c2296296526740db4aefce68c80de7fa/cc/action_names.bzl
...
def _cc_whole_archive_library_impl(ctx):
    ...
    for old_library_to_link in old_libraries_to_link:
        new_library_to_link = cc_common.create_library_to_link(
            ...
            dynamic_library = old_library_to_link.resolved_symlink_dynamic_library,
            interface_library = old_library_to_link.resolved_symlink_interface_library,
