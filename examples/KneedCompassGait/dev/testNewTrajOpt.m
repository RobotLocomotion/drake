...
periodic_constraint.mgr = ConstraintManager(LinearConstraint(zeros(p.getNumStates,1),zeros(p.getNumStates,1),R_periodic));
periodic_constraint.i = {[1 N]};
