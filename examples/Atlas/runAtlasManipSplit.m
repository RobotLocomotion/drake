...
[r_hand_xyzexp_breaks(4:6,:),r_hand_xyzexpdot_breaks(4:6,:)] = quat2expmapSequence(r_hand_breaks(4:7,:),r_hand_dot_breaks(4:7,:));
...
body_motions(2) = BodyMotionData(r_hand,t_breaks);
