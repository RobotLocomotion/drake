...
r = addRobotFromURDF(r,'steering.urdf',[0;0;0]);
v = r.constructVisualizer();

lhand = findLinkInd(r,'l_hand',0,true);
rhand = findLinkInd(r,'r_hand',0,true);
rfoot = findLinkInd(r,'r_foot');
lfoot = findLinkInd(r,'l_foot');

wheel = findLinkInd(r,'steering_wheel',0,true);
...
rfoot0 = forwardKin(r,kinsol,rfoot,[nan;nan;0],true);
lfoot0 = forwardKin(r,kinsol,lfoot,[nan;nan;0],true);
