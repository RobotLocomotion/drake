function [xtraj,utraj,ltraj,ljltraj,z,F,info,traj_opt] = fixedModeTrajOptPlanarAtlas(p,xtraj,utraj,ltraj,ljltraj,options)
...
traj_opt = FixedModeImplicitTrajectoryOptimization(p,N_vec,T_span,mode_seq_vec,to_options);
