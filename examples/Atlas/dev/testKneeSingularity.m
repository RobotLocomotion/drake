...
zmp_knots = struct('t', {foot_ts(1), foot_ts(2), foot_ts(end)},...
                   'zmp', {[0;0], rfoot_pose(1:2), rfoot_pose(1:2)},...
                   'supp', {RigidBodySupportState(r, [r.foot_body_id.left, r.foot_body_id.right]), r.right_full_support, r.right_full_support});
