function [p,v,xtraj,utraj,ltraj,z,F,info,traj_opt] = step4ModeOneArmHybridConstrainedDircol(z0,xtraj,utraj,ltraj)
step_height = .3;
...
% N = [6,6,5,5,6];
N = [5,4,4,5];
duration = {[.2 .7],[.1 1.5] [.1 1.5] [.1 2]};
modes = {[1;2],[1;2;5],[2;3;4;5], [3;4]};
% 
% N = N(1:3);
...
if length(N) > 2
  traj_opt = traj_opt.addConstraint(BoundingBoxConstraint(-.33,-.2),traj_opt.mode_opt{3}.cstrval_inds(2) + traj_opt.var_offset(3));
end
