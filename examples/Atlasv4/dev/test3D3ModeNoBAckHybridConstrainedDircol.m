function [p,v,xtraj,utraj,ltraj,z,F,info,traj_opt] = test3D3ModeNoBAckHybridConstrainedDircol(z0,xtraj,utraj,ltraj)
...
%   R_periodic(21,21) = -1; %bkx
  R_periodic(19:36,19:36) = R_periodic(1:18,1:18);
  R_periodic(19,19) = 1; % xvel  
