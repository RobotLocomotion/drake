function [p,v,xtraj,utraj,ltraj,z,F,info,traj_opt] = testPassiveHybridConstrainedDircol(z0,xtraj,utraj,ltraj)
...
if length(N) > 4
  ...
  traj_init.mode{5}.u = PPTrajectory(foh(t_init{5},randn(5,N(5))));
