function [p,v,xtraj,utraj,ltraj,z,F,info,traj_opt] = finish3ModeStepHybridConstrainedDircol(z0,xtraj,utraj,ltraj)
step_height = .1;
...
% % N = N+1;
% % N = [7,3,3,3,7];
duration = {[.1 1.5],[.1 .5],[.1 .5]};
modes = {[3;4],[2;3;4],[1;2;3;4]};
...
to_options.mode_options{2}.active_inds = [1;2;3;4;6];
