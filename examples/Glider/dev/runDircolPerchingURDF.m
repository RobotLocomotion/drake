...
x0 = getInitialState(p); tf0 = 1;
xf = [0,0,pi/4,0,0,-.5,-0.5,0]';
N=3; %=21;
...
con.x0.lb = x0;
con.x0.ub = x0;
con.xf.lb = xf-[ 0, 0, inf, inf, inf, inf, inf, inf]';
con.xf.ub = xf+[ 0, 0, pi/2, inf, inf, inf, inf, inf]';
con.T.lb = .5;   
con.T.ub = 1.5;
