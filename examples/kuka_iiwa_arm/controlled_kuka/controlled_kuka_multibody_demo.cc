/// @file
///
/// This demo sets up a position controlled and gravity compensated
/// KUKA iiwa robot within a MultibodyPlant simulation to follow an
/// arbitrarily designed plan. The generated plan takes the arm from
/// the zero configuration to reach to a position in space and then
/// repeat this reaching task with a different joint configuration
/// constraint.
...
int DoMain() {
  ...
  std::cerr << "cwd: " << getcwd(NULL, 0) << " loading "
            << FindResourceOrThrow(kSdfPath) << "\n";
