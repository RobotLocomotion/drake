...
template <typename T>
class KukaTorqueController : public Diagram<T>,
 ...
 public:
  ...
  const InputPort<T>& get_input_port_commanded_torque() const {
    return Diagram<T>::get_input_port(input_port_index_commanded_torque_);
  }
