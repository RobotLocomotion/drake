...
DEFINE_string(lcm_command_channel, "KINOVA_JACO_COMMAND",
              "Channel on which to listen for lcmt_jaco_status messages.");
DEFINE_double(x, 0.3, "x coordinate to move to");
DEFINE_double(y, -0.26, "y coordinate to move to");
DEFINE_double(z, 0.5, "z coordinate to move to");
DEFINE_double(roll, -1.7, "target roll about world x axis for end effector");
DEFINE_double(pitch, -1.3, "target pitch about world y axis for end effector");
DEFINE_double(yaw, -1.8, "target yaw about world z axis for end effector");
