...
void SolarSystem<T>::AllocateGeometry(SceneGraph<T>* scene_graph) {
  ...
  id = scene_graph->RegisterAnchoredGeometryWithoutRole(
      source_id_,
  ...
  Isometry3<double> XX_OlL_LGl{Translation3<double>{luna_position}};
  id = scene_graph->RegisterGeometryWithoutRole(
      source_id_, luna_id, make_unique<GeometryInstance>(
          XX_OlL_LGl, make_unique<Sphere>(0.075f), "Luna"));
  ...
  id = scene_graph->RegisterGeometryWithoutRole(
      ...
      make_unique<GeometryInstance>(
          XX_OlL_LGl, make_unique<Convex>(convexsat_absolute_path, 0.075),
          "convexsat"));
  scene_graph->AssignRole(source_id_, id,
                          MakeDrakeVisualizerProperties(Vector4d(1, 1, 0, 1)));
  ...
  id = scene_graph->RegisterGeometryWithoutRole(
      ...
      make_unique<GeometryInstance>(
          XX_OlL_LGl, make_unique<Box>(0.15, 0.15, 0.15), "boxsat"));
  scene_graph->AssignRole(source_id_, id,
  ...
  GeometryId mars_geometry_id = scene_graph->RegisterGeometryWithoutRole(
      source_id_, planet_id,
