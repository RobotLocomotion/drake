/** @file
 A simple binary for profiling computation of ContactSurfaces of thin objects.
 ...
 It serves as a test bed for profiling ContactSurface-computing algorithms
...
/** Places a ball and defines its velocity as being sinusoidal in time in the
 ...
 The moving soft ball starts from a point O at the mid-height of the bowl.
   1. It goes up to the rim of the bowl
   2. It comes back to O.
   3. It goes down to the lowest of the bowl.
