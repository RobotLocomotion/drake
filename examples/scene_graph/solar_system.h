...
/** A model of an orrery -- a simple mechanical model of the solar system.
 ...
 Legend:
    ...
    :-----------:|:--------------------
        ...
        Oᵢ       | Bodies orbit in circular paths. The frame of orbit's origin
                   lies at the circle's center and it's z-axis is perpendicular
                   to the plane of the circle. `i ∈ {e, m, l, p}` for Earth,
                   Mars, Luna, and Phobos, respectively.
    ...
    :-----------:|:--------------------
       ...
       `X_MR`    | Mars's rings R relative to Mars's frame M (not shown in
                   diagram).
