...
/** A model of an orrery -- a simple mechanical model of the solar system.
 ...
 Legend:
    ...
    :-----------:|:--------------------
        ...
        Oᵢ       | Body's orbit in circularFrame of orbit; `i ∈ {e, m, l, p}` for Earth, Mars, Luna, and Phobos, respectively.
                   Bodies orbit in circular paths. The frame of orbit's origin
