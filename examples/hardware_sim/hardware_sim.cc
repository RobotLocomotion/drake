...
void Simulation::Simulate() {
  simulator_->AdvanceTo(std::min(10.0, scenario_.simulation_duration / 2));
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
  // This call, followed by a two-second sleep, should give us a block of
  // erroneous real time rate; specifically an infinite rate (because we advance
  // sim time from -infinity to some positive finite value in finite wall
  // time), but only for MeshcatVisualizer; meldis shows zero realtime rate.
