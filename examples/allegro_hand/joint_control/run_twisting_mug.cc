...
public:
  ...
  void Run() {
      ...
      // close other fingers
      target_joint_pose.segment(0,4) = hand_state.FingerGraspPose(0);
      target_joint_pose.segment(4, 4) = hand_state.FingerGraspPose(1);
      target_joint_pose.segment(8, 4) = hand_state.FingerGraspPose(2);
      target_joint_pose.segment(12, 4) = hand_state.FingerGraspPose(3);
