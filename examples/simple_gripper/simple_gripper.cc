...
DEFINE_bool(hydroelasticate, false,
            "Enable hydroelastication. See https://drake.mit.edu/doxygen_cxx/"
            "group__hydroelastic__user__guide.html#hug_hydroelastication.");
...
int do_main() {
  ...
  scene_graph_config.hydroelastication.enabled = FLAGS_hydroelasticate;
