...
class RimlessWheel final : public systems::LeafSystem<T> {
 public:
  ...
  template <typename U>
  explicit RimlessWheel(const RimlessWheel<U>& other) : RimlessWheel<T>() {}
 ...
 private:
  // TODO(edrumwri): Consider generalizing this as sugar for any system class.
   ...
   public:
    ...
    explicit MyWitnessFunction(
        ...
        : systems::WitnessFunction<T>(
              ...
              // TODO(edrumwri): This is using an internal constructor that was
