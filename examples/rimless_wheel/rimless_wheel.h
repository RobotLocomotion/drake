...
/// of the stance toe position along the ramp - this is updated with the step
/// length at each collision event.
///
/// Inputs: None.
/// States: theta, thetadot, and toe position of the stance leg.
/// Outputs:
///   0) minimal state output (theta and thetadot only)
...
namespace scalar_conversion {
  template <>
  struct Traits<examples::rimless_wheel::RimlessWheel> : public NonSymbolicTraits {};
}  // namespace scalar_conversion
}  // namespace systems
