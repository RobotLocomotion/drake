...
def load_scenario(*, filename=None, data=None, scenario_name):
    """Given a scenario `filename` xor `data` and `scenario_name`, loads and
    returns one acrobot scenario from the file.
    """
