...
///   @input_port{acrobot state},
///   @output_port{elbow torque} }
///
...
class AcrobotSpongController : public systems::LeafSystem<T> {
 public:
  AcrobotSpongController()
    ...
    this->DeclareVectorInputPort("acrobot state", AcrobotState<T>());
    this->DeclareVectorOutputPort("elbow torque", AcrobotInput<T>(),
