...
The acrobot plant is implemented analytically rather than from the URDF or
SDFormat files, which are used only for visualization.
...
outputs the scenario that was actually run (ie with no stochastic elements)
