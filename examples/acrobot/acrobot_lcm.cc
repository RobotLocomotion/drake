...
AcrobotStateReceiver::AcrobotStateReceiver() {
  ...
  this->DeclareVectorOutputPort("acrobot state",
...
AcrobotCommandSender::AcrobotCommandSender() {
  this->DeclareInputPort("elbow torque", systems::kVectorValued, 1);
...
AcrobotCommandReceiver::AcrobotCommandReceiver() {
  ...
  this->DeclareVectorOutputPort("elbow torque", systems::BasicVector<double>(1),
...
AcrobotStateSender::AcrobotStateSender() {
  this->DeclareInputPort("acrobot state", systems::kVectorValued,
                         kNumJoints * 2);
