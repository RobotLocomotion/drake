...
/// Expresses a AcrobotPlant's geometry to a SceneGraph.
///
...
class AcrobotGeometry final : public systems::LeafSystem<double> {
 public:
  ...
  /// Creates, adds, and connects a AcrobotGeometry system into the given
 ...
 private:
  explicit AcrobotGeometry(const AcrobotParams<double>& acrobot_params,
