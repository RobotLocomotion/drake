...
The plate-ball, ball-floor, and plate-floor contacts are rigid-compliant,
compliant-compliant, and rigid-compliant. The hydroelastic contact model can
work with non-convex shapes accurately without resorting to their convex
hulls. Launch meldis before running this example. See the README.md file for
more information.)""");
