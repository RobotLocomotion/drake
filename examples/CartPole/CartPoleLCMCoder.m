...
% Encodes and Decodes pendulum-specific LCM smessages 
  ...
  methods
    ...
    function msg = encodeX(obj,t,x)
      ...
      msg = drake.examples.CartPole.lcmt_cartpole_x();
    ...
    function [x,t] = decodeX(obj,msg)
      ...
      msg = drake.examples.CartPole.lcmt_cartpole_x(msg.data);
    ...
    function msg = encodeU(obj,t,u)
      ...
      msg = drake.examples.CartPole.lcmt_cartpole_u();
      msg.timestamp = t*1000;
      msg.f = u(1);
    end
    ...
    function [u,t] = decodeU(obj,msg)
      ...
      msg = drake.examples.CartPole.lcmt_cartpole_u(msg.data);
      u = msg.f;
      t = msg.timestamp/1000;
    end
  end
