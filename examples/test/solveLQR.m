...
if nargin < 5
  Q = diag([10*ones(p.getNumPositions,1);0.1*ones(p.getNumVelocities,1)]);
...
[c,Ktraj,Straj,Ptraj,Btraj,tvec,Straj_full,Ftraj,xtraj,utraj] = hybridconstrainedtvlqr(p,xtraj,utraj,ltraj,Q,R,Qf);
