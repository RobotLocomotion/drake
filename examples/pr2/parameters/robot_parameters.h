...
#include "drake/examples/pr2/common/model_instance_info.h"
...
struct RobotParameters {
  std::string name;
  pr2::common::ModelInstanceInfo model_instance_info;
  std::map<std::string, CameraParameters> cameras_parameters;
  std::map<std::string, SensorLocationParameters> force_sensors_parameters;
  std::map<std::string, SensorLocationParameters> imus_parameters;
