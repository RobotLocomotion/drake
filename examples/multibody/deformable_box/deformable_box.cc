...
int do_main() {
  ...
  /* Minimumly required proximity properties for rigid bodies to interact with
   ...
   2. A resolution hint (because similar to hydroelastics, rigid bodies need to
   be tesselated so that collision queries can be performed against deformable
   geometries). */
  ProximityProperties rigid_proximity_props;
  /* Set the friction coeffcient close to that of rubber against rubber. */
