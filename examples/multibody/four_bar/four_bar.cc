...
shows:
  - How to describe a four bar linkage in SDFormat as a plain loop of four
    joints, with no attempt to specify a spanning tree and no stand-in for
    the "extra" joint (see four_bar.sdf).
