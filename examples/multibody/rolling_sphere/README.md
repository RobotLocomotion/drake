...
The "hydroelastic" model doesn't all combinations of geometries and compliance
types. There are some types of geometries that cannot yet be given a
...
|  Ground   |  Wall  |  Sphere  | Contact Model | Note |
| --------- | ------ | -------- | ------------- | ------- |
...
|   soft    |   -    | soft (d) |       -       | Soft-soft contact requires "hybrid" or "point" -- crashes with "hydroelastic |  
|   soft    |   -    |  rigid   |       -       | Behavior as described in Figure 2 - contact visualized depends on model |  
