...
|   soft    |   either    | soft (d) |       -       | Soft-soft contact requires "hybrid" or "point" -- crashes with "hydroelastic |  
|   soft    |   either    |  rigid   |       -       | Behavior as described in Figure 2 - contact visualized depends on model |  
