...
DEFINE_bool(rigid_ball, false,
            ...
            " or 'hybrid' (and the elastic_modulus and dissipation values "
            "will likewise be ignored).");
DEFINE_bool(add_wall, false,
            "If true, adds a wall with soft rigid hydroelastic representation "
            "in the path of the default ball trajectory. This requires the "
            "'hybrid' or 'point' contact model to evaluate");
