...
SuctionCup<T>* AddToBuilder(systems::DiagramBuilder<T>* builder,
                            ...
                            const OutputPort<T>& pressure_source,
  ...
  // Wire into the diagram.
  builder->Connect(pressure_source, owned_cup->suction_pressure);
  builder->Connect(plant->get_body_poses_output_port(),
                   owned_cup->body_poses_input_port());
  builder->ConnectToSame(plant->get_geometry_query_input_port(),
                         owned_cup->query_object_input_port());
  builder->Connect(owned_cup->spatial_forces_output_port(),
