...
This example demonstrates the dynamics of a cloth modeled as a mass-spring system. The cloth, fixed at two corners and initially horizontal drapes down and swings under gravity.
