...
/// Given a @p plant (and associated @p iiwa_instance) and a @p builder, install
/// in that builder the systems necessary to control and monitor an Iiwa
/// described by @p controller_plant in that plant.
///
