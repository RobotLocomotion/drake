...
namespace {
// Returns either port1.Eval or port2.Eval, whichever has a value.
// If min_num_connected is zero and both are ports are empty, return zeros.
// If less than min_num_connected of (port1,port2) are connected, throws.
// If more than max_num_connected of (port2,port2) are connected, throws.
