...
SimIiwaDriver<T>::SimIiwaDriver(
  ...
  // limits might be infinite, in which case the saturtion won't do anything.
  ...
  auto torque_limiter =
      builder.template AddNamedSystem<drake::systems::Saturation>(
          "torque limiter", -torque_limits, torque_limits);
