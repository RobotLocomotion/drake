...
def add_visualizers_argparse_arguments(args_parser):
    ...
    args_parser.add_argument(
        ...
        help="Disable opening windows and quit after loading, for testing.")
...
def parse_visualizers(args_parser, args):
    ...
    def connect_visualizers(builder, plant, scene_graph,
        ...
        collision = MeshcatVisualizer.AddToBuilder(
            builder, scene_graph, meshcat,
            MeshcatVisualizerParams(role=Role.kProximity,
                                    prefix="collision"))
        ...
        if not args.test:
            ...
            # Connect to PyPlot.
            if args.pyplot:
                pyplot = ConnectPlanarSceneGraphVisualizer(builder,
                                                           scene_graph)
