  ...
  MakeArmControllerModelTest()
      : builder_{},
        ...
        wsg_model_path_(FindResourceOrThrow(
            ...
            "schunk_wsg_50.sdf")) {
    // Add empty model intsance to ensure model instance lookups are correct
    // between this plant and the newly constructed control plant.
...
TEST_F(MakeArmControllerModelTest, SingleIiwaWithoutWsg) {
  ...
  // the simulation plant to have meaningfully different model instance
  // indices between the two plants.
