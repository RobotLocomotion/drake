...
/// for the command timestamp.  Finger velocities will be translated to the
...
class JacoCommandSender : public systems::LeafSystem<double> {
 public:
  ...
  /// Gets the optional input port for the message time.  If this port is not
  /// connected, the context time will be used.
