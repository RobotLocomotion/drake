...
// λf ∈ R^{nc}: friction components along each of the tangent vectors.
...
class QuasistaticSystem : public systems::LeafSystem<Scalar> {
 ...
 private:
  ...
  std::shared_ptr<solvers::BoundingBoxConstraint> bounds_delta_q_{nullptr};
  std::shared_ptr<solvers::BoundingBoxConstraint> bounds_gamma_{nullptr};
  std::shared_ptr<solvers::BoundingBoxConstraint> bounds_lambda_n_{nullptr};
  std::shared_ptr<solvers::BoundingBoxConstraint> bounds_lambda_f_{nullptr};
  std::shared_ptr<solvers::LinearEqualityConstraint> force_balance_{nullptr};
  std::shared_ptr<solvers::LinearConstraint> non_penetration_{nullptr};
  std::shared_ptr<solvers::LinearConstraint> coulomb_friction1_{nullptr};
  std::shared_ptr<solvers::LinearConstraint> coulomb_friction2_{nullptr};
  std::shared_ptr<solvers::LinearConstraint> non_penetration_complementary_{
      nullptr};
  std::shared_ptr<solvers::LinearConstraint> coulomb_friction1_complementary_{
      nullptr};
  std::shared_ptr<solvers::LinearConstraint> coulomb_friction2_complementary_{
      nullptr};
  std::shared_ptr<solvers::LinearConstraint> decision_variables_complementary_{
      nullptr};

  std::shared_ptr<solvers::QuadraticCost> objective_{nullptr};
};
