...
/// Receives lcmt_schunk_wsg_command for a Schunk WSG (input port 0) along
/// with the current state of the simulated WSG (input port 1), and emits
/// target position/velocity for the actuated finger to reach the commanded
/// target.  The force portion of the command message is passed through this
