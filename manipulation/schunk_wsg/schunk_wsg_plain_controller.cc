...
SchunkWsgPlainController::SchunkWsgPlainController(ControlMode control_mode,
  ...
  switch (control_mode) {
    case ControlMode::kPosition: {
      ...
      systems::SelectorParams params;
      params.input_names.push_back("desired_mean_finger_state");
      params.input_sizes.push_back(2);
      params.input_names.push_back("desired_grip_state");
      params.input_sizes.push_back(2);
      params.output_names.push_back("x_tilde_desired");
