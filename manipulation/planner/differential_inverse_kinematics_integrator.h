...
Alternatively, one can connect the optional `robot_state` input port -- which is
only used at Initialization, and simply sets the positions to the positions on
this input port.
