  ...
  if(USE_COVERAGE)
    ...
    if(USE_COVERAGE STREQUAL "Gcov")
      ...
      if(LCOV_EXECUTABLE AND GENHTML_EXECUTABLE)
        add_custom_command(OUTPUT lcov_output
          COMMAND "${LCOV_EXECUTABLE}" --capture --directory . --output-file coverage.info
          COMMAND "${GENHTML_EXECUTABLE}" "${CMAKE_CURRENT_BINARY_DIR}/coverage.info" --output-directory "${CMAKE_CURRENT_BINARY_DIR}/coverage-html")
        set_property(SOURCE lcov_output PROPERTY SYMBOLIC ON)
        add_custom_target(lcov DEPENDS lcov_output)
      else()
        message(STATUS
