...
const maliput::multilane::EndpointZ kEndZ{0., 0., 0., 0.};
...
std::unique_ptr<const maliput::api::RoadGeometry> MakeThreeSegmentRoad(
  ...
  auto builder = BuilderFactory().Make(
      2. * std::abs(kEgoRPosition) + 4. /* lane width */,
      HBounds(0., 5.) /* elevation bounds */, 0.01 /* linear tolerance */,
      0.01 /* angular_tolerance */, 1.0 /* scale length */,
      ComputationPolicy::kPreferAccuracy);
  const LaneLayout lane_layout(0. /* left shoulder */, 0. /* right shoulder */,
  ...
  const int lane_id = 0;
  if (is_opposing) {
    builder->SetDefaultBranch(c0, lane_id, LaneEnd::kFinish, c1, lane_id,
                              LaneEnd::kFinish);
    builder->SetDefaultBranch(c1, lane_id, LaneEnd::kStart, c2, lane_id,
                              LaneEnd::kStart);
  } else {
    builder->SetDefaultBranch(c0, lane_id, LaneEnd::kFinish, c1, lane_id,
                              LaneEnd::kStart);
    builder->SetDefaultBranch(c1, lane_id, LaneEnd::kFinish, c2, lane_id,
                              LaneEnd::kStart);
  }
...
std::unique_ptr<const maliput::api::RoadGeometry> BuildOnrampRoad() {
  auto builder = BuilderFactory().Make(
      4. /* lane width */, HBounds(0., 5.), 0.01 /* linear_tolerance */,
      0.01 /* angular_tolerance */, 1. /* scale_length */,
      ComputationPolicy::kPreferAccuracy);
  const LaneLayout lane_layout(2. /* left shoulder */, 2. /* right_shoulder */,
                               1 /* num lanes */, 0 /* ref lane */,
                               0. /* ref r0 */);
  ...
  const int lane_id = 0;
  builder->SetDefaultBranch(lane0, lane_id, LaneEnd::kStart, lane1, lane_id,
                            LaneEnd::kFinish);
  builder->SetDefaultBranch(lane1, lane_id, LaneEnd::kStart, lane2, lane_id,
                            LaneEnd::kFinish);
  builder->SetDefaultBranch(lane2, lane_id, LaneEnd::kStart, lane3, lane_id,
                            LaneEnd::kFinish);
  builder->SetDefaultBranch(lane3, lane_id, LaneEnd::kStart, lane4, lane_id,
                            LaneEnd::kFinish);
  builder->SetDefaultBranch(lane4, lane_id, LaneEnd::kStart, lane5, lane_id,
                            LaneEnd::kFinish);
  builder->SetDefaultBranch(lane5, lane_id, LaneEnd::kStart, lane6, lane_id,
                            LaneEnd::kFinish);
  builder->SetDefaultBranch(b0_lane1, lane_id, LaneEnd::kStart, lane1, lane_id,
                            LaneEnd::kFinish);
  builder->SetDefaultBranch(b0_lane0, lane_id, LaneEnd::kStart, b0_lane1,
                            lane_id, LaneEnd::kFinish);
  builder->SetDefaultBranch(b1_lane1, lane_id, LaneEnd::kStart, lane3, lane_id,
                            LaneEnd::kFinish);
  builder->SetDefaultBranch(b1_lane0, lane_id, LaneEnd::kStart, b1_lane1,
                            lane_id, LaneEnd::kFinish);
  builder->SetDefaultBranch(b2_lane1, lane_id, LaneEnd::kStart, lane5, lane_id,
                            LaneEnd::kFinish);
  builder->SetDefaultBranch(b2_lane0, lane_id, LaneEnd::kStart, b2_lane1,
                            lane_id, LaneEnd::kFinish);
