...
class AgentTrajectory final {
 ...
 private:
  ...
  // Makes a raw pose and velocity data in the form of a VectorXd from the
  // specified PoseVelocity assuming the ordering enumerated within
  // AgentTrajectory::Indices.
