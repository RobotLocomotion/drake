...
class BranchPoint : public api::BranchPoint {
 public:
  ...
  ///
  /// @throws if the specified LaneEnds do not belong to opposite sides of
  ///         this BranchPoint.
  ...
  void AttachToRoadGeometry(const RoadGeometryBadge&,
...
#ifndef DRAKE_DOXYGEN_CXX
class BranchPointBadge { friend class BranchPoint; };
#endif  // DRAKE_DOXYGEN_CXX
