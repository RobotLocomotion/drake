...
/// specific backend.
///
/// @todo TODO(maddog@tri.global) Provide a basic naive implementation
///                               of RoadGeometry::DoToRoadPosition()
///                               which only requires generic calls to
///                               Lane::ToLanePosition().
...
class RoadGeometry : public api::RoadGeometry {
 public:
  ...
  ///
  /// @throws if `branch_point` is empty.
  template <class T>
