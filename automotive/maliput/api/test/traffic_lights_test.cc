 ...
 public:
  TrafficLightTest()
      : north_bulb_(Bulb::Id("north_bulb"), GeoPosition(0, 0, 0),
                    Rotation::FromRpy(0, 0, 0), BulbColor::kRed,
                    BulbType::kRound),
        south_bulb_(Bulb::Id("north_bulb"), GeoPosition(0, 0, 0),
                    Rotation::FromRpy(0, 0, 0), BulbColor::kRed,
                    BulbType::kRound),
        ...
        west_bulb_(Bulb::Id("west_bulb"), GeoPosition(0, 0, 0),
                   Rotation::FromRpy(0, 0, 0), BulbColor::kRed,
                   BulbType::kRound),
        north_bulb_group_(BulbGroup::Id("north_group"), GeoPosition(0.1, 0, 0),
                          Rotation::FromRpy(0, 0, 0), {north_bulb_}),
        south_bulb_group_(BulbGroup::Id("south_group"), GeoPosition(0.1, 0, 0),
                          Rotation::FromRpy(0, 0, M_PI), {south_bulb_}),
        east_bulb_group_(BulbGroup::Id("east_group"), GeoPosition(0.1, 0, 0),
                         Rotation::FromRpy(0, 0, -M_PI_2), {east_bulb_}),
        west_bulb_group_(BulbGroup::Id("west_group"), GeoPosition(0.1, 0, 0),
                         Rotation::FromRpy(0, 0, M_PI_2), {west_bulb_}),
        traffic_light_(TrafficLight::Id("four_way_stop"), GeoPosition(0, 0, 3),
...
TEST_F(TrafficLightTest, Accessors) {
  ...
  EXPECT_EQ(traffic_light_.position_road_network(), GeoPosition(0, 0, 3));
