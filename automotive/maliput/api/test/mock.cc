...
class MockIntersection final : public Intersection {
 public:
  ...
  explicit MockIntersection(const Intersection::Id& id,
                            rules::RightOfWayPhaseRing* ring)
