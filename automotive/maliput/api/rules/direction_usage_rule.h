...
/// semantics.
///
/// TODO(andrew.best@tri.global): A StateProvider is not supported for
/// DirectionUsageRule at this time. It is enforced that all rules have exactly
/// one state and are therefore static.
///
  ...
  class State final {
   public:
    ...
    enum class Type {
      ...
      kBidirectional,  /// Travel is allowed both with the lane direction
                       /// (+S) or against it.
