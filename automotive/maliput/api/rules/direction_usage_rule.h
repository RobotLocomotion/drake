 ...
 public:
  ...
  class State final {
   public:
    ...
    enum class Severity {
      kStrict = 0,  /// No vehicle should travel on this lane in violation of
                    /// this rule.
    ...
    enum class Type {
      kWithS = 0,              /// Travel should proceed in the direction of the
                               /// +S axis.
      kAgainstS,               /// Travel should proceed opposite the +S axis
                               /// direction.
      kBidirectional,          /// Travel is allowed both with the lane
                               /// direction(+S) or against it.
      kBidirectionalTurnOnly,  /// Travel is allowed both with the lane
                               /// direction(+S) or against it but should be
                               /// limited in duration, e.g. when approaching
                               /// turns.
      kNoUse,                  /// Travel on this lane is prohibited.
      kParking,                /// This lane is used to define a parking area.
    };
