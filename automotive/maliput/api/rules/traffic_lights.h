...
class Bulb final {
 public:
  ...
  ///
  /// @param arrow_orientation_rad The orientation of the arrow, which only must
  /// be defined when @p type is BulbType::kArrow (it will be ignored for other
  /// BulbType values). This is the angle along the bulb's +X axis relative to
  ...
  /// (i.e., left from an approaching vehicle's perspective).
