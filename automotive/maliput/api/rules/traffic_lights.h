...
class Bulb final {
 public:
  ...
  /// approximate dimensions of a bulb with a 12" lens and a visor. These
  /// dimensions are 14" (0.356m) tall, 14" (0.356m) wide, and 16.62" (0.422m)
  /// deep. The visor is 9.62" (0.245m) deep, meaning the body of the light bulb
  /// is 7" (0.177m) deep. These dimensions were obtained from the following
  /// website: https://www.oksolar.com/images/signal_dimensions_large.jpg.
  /// Assuming the visor has negligible mass and the origin of the bulb's frame
  /// is in the middle of the light bulb's body, the bounding box has a lower
  /// bound of (-2.75", -7", -7") and an upper bound of (2.75", 7", 7"). In
  /// metric units, this is a lower bound of (-0.06985m, -0.1778m, -0.1778m) and
  /// an upper bound of (0.06985m, 0.1778m, 0.1778m).
