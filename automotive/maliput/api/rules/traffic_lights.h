...
class Bulb final {
 public:
  ...
  ///
  /// @param color The color of this bulb. This can be any value other than
  /// BulbColor::kUnknown.
  ///
  /// @param type The type of this bulb. This can be any value other than
  /// BulbType::kUnknown.
 ...
 private:
  ...
  BulbColor color_ = BulbColor::kUnknown;
  BulbType type_ = BulbType::kUnknown;
};
