...
GTEST_TEST(MultilaneLanesTest, DoToRoadPosition) {
  ...
  const LaneLayout kMonolaneLayout(
      kNoShoulder, kNoShoulder, kOneLane, kRefLane, kZeroR0);
...
GTEST_TEST(MultilaneLanesTest, MultipleLineLaneSegmentWithoutHint) {
  ...
  const LaneLayout kThreeLaneLayout(
      kShoulder, kShoulder, kThreeLanes, kRefLane, kZeroR0);
