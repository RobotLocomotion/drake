...
class TestLoading2x2IntersectionRules : public ::testing::Test {
 protected:
  ...
  std::vector<DirectionUsageRule> CreateDirectionUsageRules() const {
    ...
    const std::vector<TestCase> test_cases = {
        // Turn cases.
        {"l:north_right_turn_segment_0", "l:north_right_turn_segment_0",
         "WithS", DirectionUsageRule::State::Type::kWithS,
         DirectionUsageRule::State::Severity::kStrict},
        {"l:north_left_turn_segment_0", "l:north_left_turn_segment_0", "WithS",
         DirectionUsageRule::State::Type::kWithS,
         DirectionUsageRule::State::Severity::kStrict},
        {"l:south_right_turn_segment_0", "l:south_right_turn_segment_0",
         "WithS", DirectionUsageRule::State::Type::kWithS,
         DirectionUsageRule::State::Severity::kStrict},
        {"l:south_left_turn_segment_0", "l:south_left_turn_segment_0", "WithS",
         DirectionUsageRule::State::Type::kWithS,
         DirectionUsageRule::State::Severity::kStrict},
        {"l:east_right_turn_segment_0", "l:east_right_turn_segment_0", "WithS",
         DirectionUsageRule::State::Type::kWithS,
         DirectionUsageRule::State::Severity::kStrict},
        {"l:east_left_turn_segment_0", "l:east_left_turn_segment_0", "WithS",
         DirectionUsageRule::State::Type::kWithS,
         DirectionUsageRule::State::Severity::kStrict},
        {"l:west_left_turn_segment_0", "l:west_left_turn_segment_0", "WithS",
         DirectionUsageRule::State::Type::kWithS,
         DirectionUsageRule::State::Severity::kStrict},
        {"l:west_right_turn_segment_0", "l:west_right_turn_segment_0", "WithS",
         DirectionUsageRule::State::Type::kWithS,
         DirectionUsageRule::State::Severity::kStrict},

        {"l:n_segment_0", "l:n_segment_0", "WithS",
         DirectionUsageRule::State::Type::kWithS,
         DirectionUsageRule::State::Severity::kPreferred},
        {"l:n_segment_1", "l:n_segment_1", "AgainstS",
         DirectionUsageRule::State::Type::kAgainstS,
         DirectionUsageRule::State::Severity::kPreferred},
        {"l:s_segment_0", "l:s_segment_0", "WithS",
         DirectionUsageRule::State::Type::kWithS,
         DirectionUsageRule::State::Severity::kPreferred},
        {"l:s_segment_1", "l:s_segment_1", "AgainstS",
         DirectionUsageRule::State::Type::kAgainstS,
         DirectionUsageRule::State::Severity::kPreferred},
        {"l:e_segment_0", "l:e_segment_0", "WithS",
         DirectionUsageRule::State::Type::kWithS,
         DirectionUsageRule::State::Severity::kPreferred},
        {"l:e_segment_1", "l:e_segment_1", "AgainstS",
         DirectionUsageRule::State::Type::kAgainstS,
         DirectionUsageRule::State::Severity::kPreferred},
        {"l:w_segment_0", "l:w_segment_0", "WithS",
         DirectionUsageRule::State::Type::kWithS,
         DirectionUsageRule::State::Severity::kPreferred},
        {"l:w_segment_1", "l:w_segment_1", "AgainstS",
         DirectionUsageRule::State::Type::kAgainstS,
         DirectionUsageRule::State::Severity::kPreferred},

        // Intersection straight segments travel with the same +S direction as
        // the connected segments.
        {"l:ns_intersection_segment_0", "l:ns_intersection_segment_0", "WithS",
         DirectionUsageRule::State::Type::kWithS,
         DirectionUsageRule::State::Severity::kStrict},
        {"l:ns_intersection_segment_1", "l:ns_intersection_segment_1",
         "AgainstS", DirectionUsageRule::State::Type::kAgainstS,
         DirectionUsageRule::State::Severity::kStrict},
        {"l:ew_intersection_segment_0", "l:ew_intersection_segment_0", "WithS",
         DirectionUsageRule::State::Type::kWithS,
         DirectionUsageRule::State::Severity::kStrict},
        {"l:ew_intersection_segment_1", "l:ew_intersection_segment_1",
         "AgainstS", DirectionUsageRule::State::Type::kAgainstS,
         DirectionUsageRule::State::Severity::kStrict}};
    ...
    for (const auto& test_case : test_cases) {
      ...
      result.push_back(DirectionUsageRule(
          ...
          {DirectionUsageRule::State(
              DirectionUsageRule::State::Id(test_case.state_name),
