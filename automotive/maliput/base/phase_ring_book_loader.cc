...
using drake::maliput::api::rules::BulbStates;
...
using drake::maliput::api::rules::RuleStates;
using drake::maliput::api::rules::TrafficLight;
using drake::maliput::api::rules::TrafficLightBook;
using drake::maliput::api::rules::UniqueBulbId;

namespace YAML {

template <>
struct convert<BulbState> {
  static Node encode(const BulbState& rhs) {
    Node node;
  ...
  static bool decode(const Node& node, BulbState& rhs) {
