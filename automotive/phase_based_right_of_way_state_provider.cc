...
const RightOfWayPhaseBook& PhaseBasedRightOfWayStateProvider::phase_book()
    const {
  return phase_book_;
}

const RightOfWayPhaseProvider&
PhaseBasedRightOfWayStateProvider::phase_provider() const {
